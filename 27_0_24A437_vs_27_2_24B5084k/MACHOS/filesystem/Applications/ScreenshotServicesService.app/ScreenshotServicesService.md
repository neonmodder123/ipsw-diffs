...
-447.100.0.0.0
-  __TEXT.__text: 0x7c31c
+451.0.0.0.0
+  __TEXT.__text: 0x7c734
...
-  __TEXT.__objc_methname: 0x17d9c
+  __TEXT.__objc_methname: 0x17e1c
   __TEXT.__objc_classname: 0x1319
   __TEXT.__objc_methtype: 0x582f
   __TEXT.__gcc_except_tab: 0xe80
   __TEXT.__cstring: 0x27c3
   __TEXT.__dlopen_cstrs: 0x38a
-  __TEXT.__oslogstring: 0x20c8
+  __TEXT.__oslogstring: 0x2168
...
+  __TEXT.__unwind_info: 0x2330
   ...
   __DATA.__objc_const: 0xb998
-  __DATA.__objc_selrefs: 0x5510
...
CStrings:
+ "Did not present share sheet because there are no activity items to share"
+ "_contentSwitcherMovesDownInCurrentConfiguration"
+ "_contentSwitcherPaletteHeightToReserve"
+ "_shouldShowContentSwitcherForScreenshotView:"
+ "present activity vc from bar button called but there is no activity vc to present"
```
