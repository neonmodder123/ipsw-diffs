...
-  __DATA_CONST.__const: 0xbde9
+  __TEXT.__unwind_info: 0x6cf0
+  __TEXT.__eh_frame: 0x907c
+  __DATA_CONST.__const: 0xbf99
...
-  __DATA_CONST.__auth_ptr: 0x2168
...
-  __DATA.__objc_data: 0x1e80
-  __DATA.__data: 0x129e8
-  __DATA.__bss: 0x10b98
-  __DATA.__common: 0x680
+  __DATA.__objc_selrefs: 0x1420
+  __DATA.__objc_data: 0x1e88
+  __DATA.__data: 0x12aa0
+  __DATA.__bss: 0x10bc8
...
Symbols:
+ _$s12TextComposer0aB6ClientCMn
...
CStrings:
+ "_rewritingClient"
+ "applyFollowUpTurn: len=%ld versions=%ld (history preserved)"
+ "info.circle.badge"
+ "performRequestedTool: ignoring %s (inflight=%{bool}d)"
+ "performRequestedTool: no externalResultModel to apply precomputedData to"
+ "performRequestedTool: no writingToolsModel"
+ "performRequestedTool: precomputedData had no result text; re-running inference"
+ "performRequestedTool:precomputedData:"
+ "precomputedCitationsJSON"
+ "precomputedContentAdvisoriesJSON"
+ "precomputedResultReplacesExisting"
+ "precomputedResultText"
+ "systemRedColor"
- "Report a Concern"
