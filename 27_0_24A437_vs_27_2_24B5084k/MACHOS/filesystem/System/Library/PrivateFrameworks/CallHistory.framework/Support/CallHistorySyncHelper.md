...
-153.100.1.2.29
-  __TEXT.__text: 0x40844
+156.200.70.2.2
+  __TEXT.__text: 0x409a0
...
Functions:
~ sub_10003f4f4 : 2880 -> 3228
CStrings:
+ "Coalescing %@ transaction(s); waiting up to %fs for more"
+ "Ignoring non-positive txCount %@"
+ "applicationMigrationEnabled"
- "Waiting %f seconds for more transactions"
```
