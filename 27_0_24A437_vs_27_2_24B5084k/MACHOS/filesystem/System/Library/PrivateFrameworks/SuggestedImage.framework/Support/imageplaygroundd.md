...
-198.1.102.0.0
-  __TEXT.__text: 0x10fe8
-  __TEXT.__auth_stubs: 0xef0
-  __TEXT.__objc_stubs: 0x260
+198.2.7.0.0
+  __TEXT.__text: 0x13bb4
...
+ _$s14SuggestedImage15SecureContainerV17excludeFromBackupyyKFZ
...
- _objc_retain_x24
CStrings:
+ "Cannot exclude the shared secure container from backup: %{private}@"
+ "Default event consumer background task expired - cancelling generation and completing the task."
+ "Failed to sweep orphaned notification thumbnail: %s"
+ "Failed to unstage notification thumbnail: %s"
+ "Swept %ld orphaned notification thumbnail(s)."
+ "com.apple.imageplaygroundd/NotificationThumbnails"
