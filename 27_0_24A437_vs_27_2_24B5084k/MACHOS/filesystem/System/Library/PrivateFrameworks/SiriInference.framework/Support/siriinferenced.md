...
-3600.34.21.0.0
-  __TEXT.__text: 0x11ef4
-  __TEXT.__auth_stubs: 0x12b0
+3605.12.1.0.0
+  __TEXT.__text: 0x122fc
...
+  __TEXT.__oslogstring: 0xddf
   __TEXT.__objc_methtype: 0x4d9
...
- _objc_retain
CStrings:
+ "com.apple.siriinferenced.startup"
- "cancelled BackgroundQueue ops, calling xpc_transaction_exit_clean"
- "got SIGTERM signal"
```
