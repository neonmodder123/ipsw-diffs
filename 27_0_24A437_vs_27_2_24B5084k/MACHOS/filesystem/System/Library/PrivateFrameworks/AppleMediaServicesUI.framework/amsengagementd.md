...
-  __TEXT.__cstring: 0xd156
+  __TEXT.__cstring: 0xd136
   __TEXT.__oslogstring: 0x1320
   __TEXT.__objc_classname: 0x29f2
   __TEXT.__dlopen_cstrs: 0x104
-  __TEXT.__objc_methtype: 0x36c9
-  __TEXT.__constg_swiftt: 0x5f80
-  __TEXT.__swift5_typeref: 0x6cc3
+  __TEXT.__objc_methtype: 0x3739
+  __TEXT.__constg_swiftt: 0x5fb0
+  __TEXT.__swift5_typeref: 0x6c6f
   __TEXT.__swift5_builtin: 0x280
   __TEXT.__swift5_reflstr: 0x2f29
   __TEXT.__swift5_fieldmd: 0x4a00
   __TEXT.__swift5_assocty: 0x6f8
   __TEXT.__swift5_proto: 0xaf8
   __TEXT.__swift5_types: 0x5f0
-  __TEXT.__objc_methname: 0x8c38
-  __TEXT.__swift5_capture: 0x44f0
+  __TEXT.__objc_methname: 0x8d68
+  __TEXT.__swift5_capture: 0x4630
...
-  __TEXT.__eh_frame: 0xd308
-  __DATA_CONST.__const: 0x11770
+  __TEXT.__unwind_info: 0x7508
+  __TEXT.__eh_frame: 0xd428
+  __DATA_CONST.__const: 0x119c8
...
+ "Account change sync"
+ "Failed to fetch selected profile: "
+ "Failed to fetch simple profiles: "
+ "Failed to send metrics identifier records to iCloud with error: "
+ "Invalid media type"
+ "Sending changes to cloud"
+ "Sending changes to cloud (group: "
+ "ams_isSimpleProfile"
...
+ "sponsor"
+ "v16@?0@\"ACAccount\"8"
- "Account change sync completed"
- "Account change sync failed: "
- "Daily sync completed"
- "Daily sync failed: "
- "Failed to save metrics identifier records to iCloud with error: "
- "Saving changes to cloud (group: "
- "Syncing changes to cloud"
- "ams.metricsIds.accountChange.fetch"
- "ams.metricsIds.accountChange.modify"
- "ams.metricsIds.dailySync.fetch"
- "ams.metricsIds.dailySync.modify"
