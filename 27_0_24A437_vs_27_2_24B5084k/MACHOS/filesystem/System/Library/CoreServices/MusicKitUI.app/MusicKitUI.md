...
+  __TEXT.__constg_swiftt: 0x72c
   ...
   __TEXT.__swift5_reflstr: 0x32a

   __TEXT.__swift5_types: 0x60
   __TEXT.__objc_classname: 0x5aa
   __TEXT.__objc_methname: 0x1adf
-  __TEXT.__objc_methtype: 0x12ed
+  __TEXT.__objc_methtype: 0x12f7
...
CStrings:
+ "Failed to destroy scene session for %{public}s: %{public}@."
+ "v16@?0@\"NSError\"8"
```
