...
-3240.9.0.0.0
-  __TEXT.__text: 0x2bd38
+3245.7.1.0.0
+  __TEXT.__text: 0x2c418
...
CStrings:
+ "Idle watchdog: haptic engine exists but isn't running, tearing it down"
+ "IdleWatchdogInterval"
+ "SiriActiveDebounceInterval"
+ "idleWatchdogTimer"
+ "setAutoShutdownTimeout:"
+ "siriActiveDebounceTimer"
```
