...
-141.30.6.14.13
-  __TEXT.__text: 0x58fd5c
-  __TEXT.__auth_stubs: 0x5d00
+141.31.6.16.16
+  __TEXT.__text: 0x597f28
...
+  __TEXT.__unwind_info: 0x15f60
+  __TEXT.__eh_frame: 0x48ea8
...
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityV0eF007IndexedI0AAMc
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityV0eF00eI0AAMc
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityV2id4name6person16labeledLocationsAESS_SS0eF006IntentH0VSayAC0hI8LocationVGtcfC
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityV2idSSvg
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityVMa
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO12PersonEntityVMn
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO20PersonEntityLocationV5label8latitude9longitudeAESSSg_S2dtcfC
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO20PersonEntityLocationVMa
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO20PersonEntityLocationVMn
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO20PersonLocationEntityV0eF00eJ0AAMc
+ _$s12FindMyLocate0aB20CoreAppIntentsMirrorO20PersonLocationEntityVMa
+ _$s12FindMyLocate0aB2IDV2idACSS_tcfC
+ _$s12FindMyLocate0aB2IDVSHAAMc
+ _$s12FindMyLocate0aB2IDVSQAAMc
+ _$s12FindMyLocate11PlacedLabelV7labelID0F08latitude9longitudeACSS_AA08LocationE0OS2dtcfC
+ _$s12FindMyLocate11PlacedLabelVMa
+ _$s12FindMyLocate11PlacedLabelVMn
+ _$s12FindMyLocate12ClientTargetV8rawValueSSvg
+ _$s12FindMyLocate12ClientTargetVMa
+ _$s12FindMyLocate12ClientTargetVMn
+ _$s12FindMyLocate13RequestOriginV13contextTargetAA06ClientG0VSgvg
+ _$s12FindMyLocate13RequestOriginV_12clientTargetAcA06ClientE0O_AA0hG0VSgtcfC
+ _$s12FindMyLocate15FriendContainerV9followers9following15futureFollowers0H9Following13pendingOffers12placedLabelsACSayAA0D0VG_A4LSDyAA0aB2IDVSayAA11PlacedLabelVGGtcfC
...
+ _$s12FindMyLocate29LocationSharingCapableDevicesV8meDevice013quickSwitchedG006autoMeF7WatchesAcA0I0VSg_SayAHGSayAA04AutomF5WatchVGtcfC
...
- _$s12FindMyLocate29LocationSharingCapableDevicesV8meDevice013quickSwitchedG006autoMeF7WatchesAcA0I0V_SayAHGSayAA04AutomF5WatchVGtcfC
...
CStrings:
+ "%{public}s: Donating me PersonEntity %{private,mask.hash}s"
+ "%{public}s: Indexed %{private,mask.hash}s"
+ "%{public}s: No account available; skipping me PersonEntity"
+ "%{public}s: deleteAppEntities failed %{public}s"
+ "%{public}s: indexAppEntities failed %{public}s"
+ "Failed to await initialized state: %@"
+ "Failed to remove donated PersonEntities: %{public}s"
+ "Removed donated PersonEntities"
+ "_redonatePersonEntitiesIfNeeded()"
+ "activeDeviceId: "
+ "donatedPersonEntityFormatVersion"
+ "getNameAndIdentifier: no contact for handle %{private}s, error: %s"
+ "handleSubmitResponse(response:)"
+ "makeMePersonEntity()"
+ "mockSender@example.com"
+ "subscribeAndFetchLocation(forIds:context:contextTarget:)"
- "%{public}s: Created %{private,mask.hash}s"
- "%{public}s: Modified %{private,mask.hash}s"
- "%{public}s: No serverID for friend with handle %{private,mask.hash}s"
- "MIRROR_DAEMON_ENTITY"
- "MIRROR_DAEMON_TYPE"
- "activeDeviceIds: "
- "checkConfigVersionFromSubmitResponse(response:)"
- "mockSender@icloud.com"
