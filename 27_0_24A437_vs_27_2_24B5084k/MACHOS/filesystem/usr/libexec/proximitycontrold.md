...
+ _$s16ProximityControl17PCHandoffSettingsVMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03GetD8SettingsC7Sharing22SFXPCInvocableProtocolAAMc
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03GetD8SettingsC8ResponseV8settingsAgA09PCHandoffH0V_tcfC
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03GetD8SettingsCMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03GetD8SettingsCMn
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03SetD8SettingsC10ParametersV14handoffEnabledSbvg
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03SetD8SettingsC10ParametersVMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03SetD8SettingsC7Sharing22SFXPCInvocableProtocolAAMc
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03SetD8SettingsCMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO03SetD8SettingsCMn
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonKeepAliveEnabledC7Sharing22SFXPCInvocableProtocolAAMc
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonKeepAliveEnabledC8ResponseV04keepJ0AGSbSg_tcfC
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonKeepAliveEnabledCMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonKeepAliveEnabledCMn
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonLaunchEventArmedC7Sharing22SFXPCInvocableProtocolAAMc
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonLaunchEventArmedC8ResponseV5armedAGSb_tcfC
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonLaunchEventArmedCMa
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25GetDaemonLaunchEventArmedCMn
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25SetDaemonLaunchEventArmedC7Sharing22SFXPCInvocableProtocolAAMc
+ _$s16ProximityControl36PCProximityHandoffServiceInvocationsO25SetDaemonLaunchEventArmedCMa
...
+ _$s7Sharing13SFXPCListenerC25connectionHasEntitlements0C4UUID12entitlementsSb10Foundation0F0V_SaySSGtYaF
+ _$s7Sharing13SFXPCListenerC25connectionHasEntitlements0C4UUID12entitlementsSb10Foundation0F0V_SaySSGtYaFTu
...
CStrings:
+ "### %s RangingTokenRequest returned an undeserializable token"
+ "### %s failed: %@"
+ "### Client missing %s"
+ "### Failed to merge HandoffDevices: %@"
+ "### No bluetoothScanManager?"
+ "### No matching HandoffDevice for %@"
+ "$__lazy_storage_$_subtitleHostingController"
+ "%s:\n  -%s\n  -%s"
+ "%s:\n  device=%s\n  identity=%s\n  preferringSelf=%{bool}d"
+ "%s: featureEnabled=%{bool}d, isSetUp%{bool}d"
+ "%s: isEnabled=%{bool}d"
+ "== BluetoothScanManager =="
+ "Adding BLE and UWB because nearbyToken exists"
+ "Already targeting %s; nothing to transition."
+ "BluetoothScanManagerState_isRangingCandidateNearby"
+ "BluetoothScanManagerState_shouldKeepDaemonAlive"
+ "Client missing entitlement."
+ "Fade to %f was not reported complete within %fs; continuing without it."
+ "GetDaemonKeepAliveEnabled invoked"
+ "GetDaemonLaunchEventArmed invoked"
+ "GetHandoffSettings invoked"
+ "HandoffSettingsStore"
+ "SFClientIdentity"
+ "SetDaemonLaunchEventArmed invoked: %s"
+ "SetHandoffSettings invoked: enabled=%{bool}d"
+ "Setting launch event armed to '%{bool}d'..."
+ "Successfully merged HandoffDevices: %s"
+ "Task.race finished without returning a value. It should have at least thrown a cancellation error."
+ "Writing %s/%s = %{bool}d"
+ "_TtC17proximitycontrold20BluetoothScanManager"
+ "_TtC17proximitycontrold22HandoffSettingsManager"
+ "_TtC17proximitycontrold25BluetoothScanManagerModel"
+ "_TtC17proximitycontrold25BluetoothScanManagerState"
+ "_accentColor"
+ "_bannerContentModeAnimationDuration"
+ "_contentOpacity"
+ "_deviceCloseServiceGoodbyeWindow"
+ "_displayedContentMode"
+ "_pendingContentMode"
+ "_proxHandoffEnabled"
+ "_shouldKeepDaemonAlive"
+ "_statusSymbolName"
+ "bannerContentModeAnimationDuration"
+ "bluetoothScanManager"
+ "bluetoothScanManagerState"
+ "bluetoothSignalTasks"
+ "com.apple.Home.HomeUIService"
+ "com.apple.proximitycontrol.handoffSettings"
+ "contentTransitionTask"
+ "conversationManager:conversation:participant:didUpdateNickname:reason:"
+ "createOrUpdateHandoffDevice(with:noReplace:)"
+ "deviceCloseServiceGoodbyeWindow"
+ "handleSystemState(featureEnabled:isSetUp:)"
+ "handoffSettingsManager"
+ "handoffSuppressed"
+ "identityTasks"
+ "isHandoffReady: nearbyToken exists"
+ "isMergingHandoffDevices"
+ "mergeHandoffDevices(_:_:)"
+ "nearbyToken"
+ "proxHandoffEnabledSettingDidChange(proxHandoffEnabled:)"
+ "proximitycontrold/Task+Extensions.swift"
+ "rangingProxyActivationTask"
+ "removeAllHandoffDevices()"
+ "replaceHandoffDevice(_:using:)"
+ "rpCLDeviceChanged(_:)"
+ "setIsEnabled(_:)"
+ "setUserInteractionEnabled:"
+ "suppressedTransaction"
+ "updateOrReplaceHandoffDevice(_:with:preferringSelf:)"
...
- "== BluetoothProxy =="
- "Adding BLE AND UWB because nearbyID exists"
...
- "State does not allow Handoff feature."
- "WarpShockwaveEffectDuration_connectionHint"
- "WarpShockwaveEffectDuration_shockwave"
- "WarpShockwaveEffectTransitionSpeed"
- "_TtC17proximitycontrold14BluetoothProxy"
- "_TtC17proximitycontrold19BluetoothProxyModel"
- "_TtC17proximitycontrold19BluetoothProxyState"
- "_TtC17proximitycontrold28HandoffEnabledSettingManager"
- "_allowGuestDevicesToStartRanging"
- "_contentMode"
- "_handoffBannerAnimationExtraBounce"
- "_isHandoffCandidateNearby"
- "_progress"
- "_transferToHomePod"
- "activateOrDeactivateByFeatureToggle(enabled:)"
- "allowGuestDevicesToStartRanging"
- "animateWithDuration:animations:completion:"
- "bluetoothProxy"
- "bluetoothProxyState"
- "conversationManager:conversation:participant:didUpdateNickname:"
- "discoveredColorCode"
- "discoveredMediaRouteID"
- "discoveryTasks"
- "handleAttributesChanged(for:)"
- "handoffBannerAnimationExtraBounce"
- "handoffEnabledSettingManager"
...
- "setTransferToHomePod:"
- "transferToHomePod"
- "transferToHomePodSettingDidChange(transferToHomePod:)"
- "v12@?0B8"
