...
+ _$s17RelevanceServices24ConsiderateVolumeProfileO8rawValueACSgSi_tcfC
+ _$s17RelevanceServices24ConsiderateVolumeProfileO8rawValueSivg
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC012ringtoneUserD0SfSgvg
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC012ringtoneUserD0SfSgvs
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC10setEnabled_3forySb_AA0cD13AudioCategoryOtF
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC14getUserProfile3forAA0cdI0OAA0cD13AudioCategoryO_tF
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC14setUserProfile_3foryAA0cdI0O_AA0cD13AudioCategoryOtF
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC26prefsDidChangeNotificationSSvgZ
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerC9isEnabled3forSbAA0cD13AudioCategoryO_tF
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerCACycfC
+ _$s17RelevanceServices35ConsiderateVolumeSettingsControllerCMa
...
+ _$s22UniformTypeIdentifiers6UTTypeV7_deviceACvgZ
...
- _$s26RelevanceServicesCompanion24ConsiderateVolumeProfileO8rawValueACSgSi_tcfC
- _$s26RelevanceServicesCompanion24ConsiderateVolumeProfileO8rawValueSivg
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC012ringtoneUserE0SfSgvg
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC012ringtoneUserE0SfSgvs
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC10setEnabled_3forySb_AA0dE13AudioCategoryOtF
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC14getUserProfile3forAA0deJ0OAA0dE13AudioCategoryO_tF
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC14setUserProfile_3foryAA0deJ0O_AA0dE13AudioCategoryOtF
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC26prefsDidChangeNotificationSSvgZ
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerC9isEnabled3forSbAA0dE13AudioCategoryO_tF
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerCACycfC
- _$s26RelevanceServicesCompanion35ConsiderateVolumeSettingsControllerCMa
...
- _$s7SwiftUI4ViewPAAE05splitC15ControllerProxyyQryAA07UISplitceF0VzcF
...
CStrings:
+ "%s: isNetworkRelayPairing: %{BOOL}d remotePairingPeerInfo: %@"
+ "-[COSScanWatchViewController didCompleteNetworkRelayManualPairingWithDevice:remotePairingPeerInfo:]"
+ "-[COSSecurePairingPasskeyEntryViewController onPairingPeerInfoAvailable:]"
...
+ "COSDeviceSymbol"
+ "COSEraseWatchSheetPresenter"
+ "Device is unknown to Core Types; using %{public}s"
+ "Device type %{public}s resolved to symbol %{public}s"
+ "ERASE_WATCH_CONTINUE"
+ "ERASE_WATCH_MESSAGE"
+ "ERASE_WATCH_NOT_NOW"
+ "ERASE_WATCH_OVERWRITE_FOOTER"
+ "ERASE_WATCH_TITLE"
+ "Erase sheet dismissed. shouldErase: %{BOOL}d overwriteStorage: %{BOOL}d"
+ "F47B90E6-F2D5-49D0-A8F2-C880AA3FED19"
+ "Indexing search manifests (reason: %{public}s)"
+ "Localizable-OverwriteStorage"
+ "ModalSetupFlow"
+ "No image for symbol '%{public}@'; using '%{public}@'"
+ "No symbol for device type %{public}s: %{public}s; using %{public}s"
+ "OVERWRITE_STORAGE_CONFIRMATION_ACCEPT"
+ "OVERWRITE_STORAGE_CONFIRMATION_CANCEL"
+ "OVERWRITE_STORAGE_CONFIRMATION_MESSAGE"
+ "OVERWRITE_STORAGE_CONFIRMATION_TITLE"
+ "OVERWRITE_STORAGE_TOGGLE_LABEL"
+ "OverwriteStorage"
+ "Received pairing peer info %@"
+ "Search manifests are up to date and index reports first party items, skipping indexing"
+ "T@\"BPSSheetBackdrop\",&,N,V_sheetBackdrop"
+ "T@\"NSDictionary\",&,N,V_remotePairingPeerInfo"
+ "T@\"PSSpecifier\",&,N,V_victoryGroup"
+ "TB,N,V_overwriteStorage"
+ "TB,N,V_registeredForPairingPeerInfo"
+ "TB,R,N,V_shouldUseSheetBackdrop"
+ "UIAdaptivePresentationControllerDelegate"
+ "Unable to act on the erase sheet, object deallocated"
+ "Unable to erase, object deallocated"
+ "_TtC6BridgeP33_FF5EF4C9D7534701CF802BC8E6FF902C35EraseWatchSheetNavigationController"
+ "_TtCV6BridgeP33_FF5EF4C9D7534701CF802BC8E6FF902C10TrayButton11Coordinator"
+ "_isOverwriteStorageEligible"
+ "_overwriteStorage"
+ "_registeredForPairingPeerInfo"
+ "_remotePairingPeerInfo"
+ "_sheetBackdrop"
+ "_shouldUseSheetBackdrop"
+ "_systemImageNamed:withConfiguration:"
+ "_victoryGroup"
+ "adaptivePresentationStyleForPresentationController:"
+ "adaptivePresentationStyleForPresentationController:traitCollection:"
+ "addAction:forControlEvents:"
+ "didCompleteNetworkRelayManualPairingWithDevice:remotePairingPeerInfo:"
+ "evaluateCompatibilityForManualPairingPathWithDevice:remotePairingPeerInfo:"
+ "genericPhoneSymbolName"
+ "hasfirstPartyIndexItems:"
+ "index reports no first party items"
+ "initWithHostViewController:"
+ "initWithNavigationBarClass:toolbarClass:"
+ "initWithSheetBackdrop:"
+ "isSheetBackdropEnabled"
+ "obliterateGizmoPreservingeSIM:overwriteStorage:completionHandler:"
+ "onInteractiveDismiss"
+ "onPairingPeerInfoAvailable:"
+ "overwriteStorage"
+ "phoneSymbolName"
+ "presentEraseWatchSheet"
+ "presentEraseWatchSheetForSpecifier:"
...
+ "registeredForPairingPeerInfo"
+ "remotePairingPeerInfo"
+ "resetVictorySpecifier"
+ "setOverwriteStorage:"
+ "setRegisteredForPairingPeerInfo:"
+ "setRemotePairingPeerInfo:"
+ "setSemanticContentAttribute:"
+ "setSheetBackdrop:"
+ "setUserInterfaceLevel:"
+ "setVictoryGroup:"
+ "sheetBackdrop"
+ "shouldUseSheetBackdrop"
+ "symbolForTypeIdentifier:withResolutionStrategy:variantOptions:error:"
+ "tearDownIfHostIsBeingDismissed"
+ "traitOverrides"
+ "v24@0:8@\"UIPresentationController\"16"
+ "v32@0:8@\"NRDevice\"16@\"NSDictionary\"24"
...
- "-[COSSetupController popViewController:]"
- "Failed to register block and get notify token for %@"
- "Indexing search manifests"
- "Received com.apple.nanoregistry.isbeginningtopair darwin notification"
- "Search manifests are up to date, skipping indexing"
- "Ti,N,V_pairingStartedNotificationToken"
- "View.task @ Bridge/SidebarOverlayModifier.swift:"
- "_pairingStartedNotificationToken"
- "_unregisterPairingStartedNotification"
- "com.apple.nanoregistry.isbeginningtopair"
...
- "pairingStartedNotificationToken"
- "preferredSplitBehavior"
- "setPairingStartedNotificationToken:"
