...
+ "<<<< CMISoftwareFlashRendering >>>> %s: Manual WB (no usable auto ambient WP: usePrevFrameWP=%d, biasDegenerate=%d) - mixed strobe toward manual WP at strength %.3f: [R:%.3f, G:%.3f, B:%.3f]"
...
+ "<<<< CMISoftwareFlashRendering >>>> %s: Manual WB applied strobe white point bias [R:%.3f, G:%.3f, B:%.3f] at strength %.3f: [R:%.3f, G:%.3f, B:%.3f]"
...
+ "<<<< DenoiseFusePipeline >>>> %s: setupUDNet failed, bailing (%d)"
...
+ "<<<< FlareSourceDetector >>>> %s: Forcing flare result to False"
+ "<<<< FlareSourceDetector >>>> %s: Forcing flare result to True"
+ "<<<< FlareSourceDetector >>>> %s: pixels=%u, threshold=%u, flareDetected=%d"
+ "<<<< FlareSourceDetectorPlist >>>> %s: EnableFlareSourceDetector parameter not found in params dict"
+ "<<<< FlareSourceDetectorPlist >>>> %s: LocalMinThreshold missing/empty in params dict; keeping default"
+ "<<<< FlareSourceDetectorPlist >>>> %s: LocalWindowSize missing/empty in params dict; keeping default"
+ "<<<< FlareSourceDetectorPlist >>>> %s: LumaGapThreshold missing/empty in params dict; keeping default"
+ "<<<< FlareSourceDetectorPlist >>>> %s: MinAreaRatio missing/empty in params dict; keeping default"
+ "<<<< FlareSourceDetectorPlist >>>> %s: MinPixelCount missing/empty in params dict; keeping default"
+ "<<<< FlareSourceDetectorPlist >>>> %s: Overriding enableFlareSourceDetector value; was '%d', now '%d'"
...
+ "<<<< LearnedHRNRProcessor >>>> %s: Error: convertRGBToYUV failed, bailing (%d)"
...
+ "<<<< LearnedHRNRProcessor >>>> %s: Running UDNet with RGB input, YUV output"
...
+ "<<<< LearnedHRNRProcessor >>>> %s: UDNet RGB->YUV runWithInputMetadata failed with err = %d"
...
+ "<<<< LearnedHRNRProcessor >>>> %s: downsampleRGBInPlaceIfNeeded failed with err = %d"
...
+ "<<<< NRFMetadata >>>> %s: EffectiveApertureDiameter must not be 0"
...
+ "<<<< NRFMetadata >>>> %s: exposure time: %f, gain: %f, red_gain: %f, blue_gain: %f, average focus score: %f, exposure bias: %f is_long: %d lsModulationWeight: %f effectiveApertureDiameter: %f "
...
+ "<<<< RawDFProcessor >>>> %s: _computeProxyGainMap (UDNet) failed, bailing (%d)"
...
+ "<<<< RawDFProcessor >>>> %s: flareSourceDetector startDetectionOnEv0 failed with err = %d"
...
+ "<<<< RawNightMode >>>> %s: RawNM AdaptiveFusion detectors: hasFlicker=%d refIsEVM=%d forceFlicker=%d isFlareDetected=%d"
...
+ "<<<< SoftISP >>>> %s: Blemish database from processing options is not a CMILCBDatabase (got %@)"
...
+ "<<<< SoftISP >>>> %s: Creating new (empty) LCB database"
...
+ "<<<< SoftISP >>>> %s: Either detection or correction must be enabled"
+ "<<<< SoftISP >>>> %s: Error: downscale factor value is not supported."
...
+ "<<<< SoftISP >>>> %s: Failed to allocate rlutTex"
...
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Correction::applyCorrection"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Correction::createCorrection"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Detector::lcbDetector"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Detector::localMaximaFinder"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Extractor::lcbExtractor"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Filtering::clearLUT"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Filtering::perFrameFilterExtractedLCBs"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicBayer"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicBayerYRGB"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicDownsampleBayer"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicDownsampleBayerYRGB"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicDownsampleQuadra"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicDownsampleQuadraYRGB"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicQuadra"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::demosaicQuadraYRGB"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::downsample"
+ "<<<< SoftISP >>>> %s: Failed to create LCB::Pyramid::downsampleYRGB"
...
+ "<<<< SoftISP >>>> %s: Failed to create texture descriptor"
...
+ "<<<< SoftISP >>>> %s: LCB DB nDeletions=%d, nUpdates=%d, nAdditions=%d"
+ "<<<< SoftISP >>>> %s: LCB nNew+: %d, nMatched+: %d, nExtracted+: %d, nExtracted-: %d, nCorrectionsOnIRCF: %d, nCorrectionsOnLens: %d"
...
+ "<<<< SoftISP >>>> %s: SoftISPCalibration::convertYRGBToRGBYForDebug is nil"
+ "<<<< SoftISP >>>> %s: SoftISPCalibration::downsample is nil"
+ "<<<< SoftISP >>>> %s: SoftISPCalibration::expandSkipMaskForDebug is nil"
...
+ "<<<< SoftISP >>>> %s: SoftISPCalibrationStage: failed to init _lcb"
...
+ "<<<< SoftISP >>>> %s: ThumbnailData length smaller than width*height"
+ "<<<< SoftISP >>>> %s: Too many temporal blemishes provided"
+ "<<<< SoftISP >>>> %s: Trying to use blemish database for wrong sensor (expected sensor ID:%@ actual sensor ID:%@, expected module serial:%@, actual module serial: %@)"
...
+ "<<<< SoftISP >>>> %s: Warning: LCB correction is enabled, but per-frame filtering is disabled; skipping correction map generation"
+ "<<<< SoftISP >>>> %s: Warning: LCB correction is enabled, correction map not available"
...
+ "<<<< SoftISP >>>> %s: Warning: SoftISPCalibrationStage: getLSCMetadata failed: %d"
...
+ "<<<< SoftISP >>>> %s: [LCB] Delete %@; pos=(%4d, %4d) radius=%d"
+ "<<<< SoftISP >>>> %s: [LCB] Update %@ - input:  pos=(%4d, %4d) radius=%d dc=%d features r=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f] g=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f] b=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f]"
+ "<<<< SoftISP >>>> %s: [LCB] Update %@ - result: pos=(%4d, %4d) radius=%d dc=%d features r=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f] g=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f] b=[%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f] conf=%.2f det=%.2f"
+ "<<<< SoftISP >>>> %s: [LCB] Update position of blemish %@: (%0.1f, %0.1f) -> (%0.1f, %0.1f)"
...
+ "<<<< SoftISP >>>> %s: bayerBinningFactor = %u"
...
+ "<<<< SoftISP >>>> %s: failed to create LCBCorrectionShaders"
+ "<<<< SoftISP >>>> %s: failed to create LCBDetectorShaders"
+ "<<<< SoftISP >>>> %s: failed to create LCBExtractorShaders"
+ "<<<< SoftISP >>>> %s: failed to create LCBFilteringShaders"
+ "<<<< SoftISP >>>> %s: failed to create LCBPyramidShaders"
+ "<<<< SoftISP >>>> %s: failed to create radius LUT"
...
+ "<<<< SoftISP >>>> %s: frameMetadata is nil"
...
+ "<<<< SoftISP >>>> %s: prewarm failed to create LCBCorrectionShaders"
+ "<<<< SoftISP >>>> %s: prewarm failed to create LCBDetectorShaders"
+ "<<<< SoftISP >>>> %s: prewarm failed to create LCBExtractorShaders"
+ "<<<< SoftISP >>>> %s: prewarm failed to create LCBFilteringShaders"
+ "<<<< SoftISP >>>> %s: prewarm failed to create LCBPyramidShaders"
...
+ "<<<< UBProcessor >>>> %s: UDNet plist %{public}s, enableUDNet = %{public}d"
...
+ "<<<< UDNet >>>> %s: UDNet gainValue: %f"
+ "<<<< UDNetNetworkStage >>>> %s: UDNet CMILSC: shaderToSensorTransform(scale=%.4f,%.4f offset=%.1f,%.1f) gridIntervalReciprocal(%.8f,%.8f) gridDims(%dx%d) lscGridMaxGain=%.4f lscLayout=%d fullSizeDims=%dx%d"
+ "<<<< UDNetNetworkStage >>>> %s: UDNet tiling: tileDimensions=%dx%d overlap=%dx%d step=%dx%d tileCount=%ux%u (total=%u) for frame %lux%lu"
+ "<<<< UDNetPlist >>>> %s: EnableUDNet parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: InputNoiseScalingFactorBody parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: InputNoiseScalingFactorSkin parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: InputNoiseScalingFactorSky parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: Overriding enableUDNet value; was '%d', now '%d'"
+ "<<<< UDNetPlist >>>> %s: addbackClampFactor parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: addbackLumaAddbackThreshold parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: addbackLumaAddbackWeight parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: addbackNoiseScalingFactor parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: inputNoiseScalingFactor parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: networkType parameter not found in params dict"
+ "<<<< UDNetPlist >>>> %s: tilePadding parameter not found in params dict"
...
+ "CIC coefficients exceed data length"
...
+ "CameraInfo is missing IsQuadraSensor"
+ "CameraInfo is missing SensorDimensions or invalid"
...
+ "EffectiveApertureLut is invalid"
+ "Empty ISP Hall data"
...
+ "Exceed max number of supported apertures."
+ "Exceeded max number of combined detections"
...
+ "Extracted blemish pyramid level mismatch"
+ "Extracted blemish pyramid position mismatch"
+ "Extraction sets and results should have same count (number of levels"
...
+ "FlareSourceDetector readPlist failed"
...
+ "FocusPixelMap is not NSData"
+ "FocusPixelMap is shorter than its version requires"
+ "FocusPixelMap is too short to hold a version"
...
+ "LCB DB add operation failed"
+ "LCB DB deletion operation failed"
+ "LCB DB update operation failed"
+ "LCB algorithm didn't return results object, which is expected when temporal filtering runs"
+ "LSC Grid data is NULL"
+ "LSC coefficients exceed data length"
...
+ "Metadata is missing FocusAccelerometerVector"
+ "Metadata is missing kFigCaptureStreamMetadata_Fnumber"
+ "Metadata is missing kFigCaptureStreamMetadata_FocusLensPosition"
...
+ "Patch atlas has fewer slices than extractions"
...
+ "UDNet readPlist failed"
+ "UDNet: _cameraInfoByPortType is nil"
+ "UDNet: inputMetadata is nil"
+ "UDNet: lscGainMapMetadata is nil"
+ "UDNet: lscGainMapTexture is nil"
+ "UDNet: udNetPlist is nil"
...
+ "Unable to initialize night mode deblur inference"
...
+ "Unable to reload DNR TIP in bypass mode"
...
+ "_dnrNetworkPath nil; cannot reload DNR TIP for bypass"
...
+ "combinedDetections is NULL"
+ "combinedDetectionsData is NULL"
...
+ "config.inputDimensionsInBayerPixels.x incorrect"
+ "config.inputDimensionsInBayerPixels.y incorrect"
+ "config.inputPyramidEnabled must be TRUE"
...
+ "correctionLUT is NULL"
+ "correctionMapTex is NULL"
+ "correctionType out of bounds."
+ "correctionsArray is NULL"
+ "cps is NULL"
+ "cps is nil"
...
+ "currentPyrTex dimensions not correct"
+ "currentPyrTex is NULL"
+ "currentStage nil"
...
+ "detected"
+ "detectionCountHistogram is NULL"
+ "detectionCountHistogramRaw is NULL"
+ "detectionResultPyramid is NULL"
+ "detectionsBuf is NULL"
+ "detectorResultTexture is NULL"
+ "determineCFALayout"
...
+ "dstLumaTex is NULL"
+ "e is NULL"
+ "effectiveApertureDiameterUmFromBrightnessLut"
...
+ "extractionInput is NULL"
+ "extractionPatchAtlasPyramid"
+ "extractionPatchAtlasPyramid is NULL"
+ "extractionResultPyramid is NULL"
+ "extractionSetForLevels.count == extractionResultsForLevels.count is NULL"
+ "extractionSetPyramid is NULL"
+ "extractionsBuf is NULL"
+ "faceBodyBoundaries is NULL"
+ "facesScores.count is different than faceRects.count"
+ "false"
+ "filteredDefectLocations allocation failed"
+ "filteredLCBsBuf is NULL"
+ "firstFrame.properties is NULL"
+ "firstPix only supports R/B"
+ "firstPixelFromBayerPhase"
+ "flareMapConfig is NULL"
+ "flareSourceDetector startDetectionOnEv0 failed"
...
+ "inputPatchAtlas"
+ "inputPatchAtlas is NULL"
+ "inputPixBuf nil"
+ "inputPyrTex is NULL"
+ "inputPyramid is NULL"
+ "inputPyramid->textureUV is not valid"
+ "inputPyramid->textureY[band0 + 1] is not valid"
+ "inputPyramid->textureY[band1 + 1] is not valid"
+ "inputPyramidLevel must be equal or less than firstPyramidLevel - the input image has been downsampled too much earlier in the pipeline"
+ "inputPyramidTexturesToRelease is NULL"
+ "inputRGBTex is nil"
...
+ "kSoftISPProcessorError_InvalidApertureData"
...
+ "kSoftISPProcessorError_Invalidated"
...
+ "longRgbTex is NULL"
+ "loresLevelIndex >= 0 is NULL"
+ "loresPyrTex is NULL"
+ "loresTexture is NULL"
+ "lscConfig NULL"
+ "lscConfig is NULL"
...
+ "temporalFilteringResults is NULL"
+ "temporalHasPatchData"
+ "temporalHasPatchData is NULL"
+ "temporalLCBs is NULL"
+ "temporalLCBsData is NULL"
+ "temporalLCBsOnLevel is NULL"
+ "tex is NULL"
+ "texDesc is NULL"
