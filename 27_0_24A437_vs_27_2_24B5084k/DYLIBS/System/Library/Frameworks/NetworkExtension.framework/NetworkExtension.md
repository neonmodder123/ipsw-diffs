...
+ -[NEDeclarationInstaller dnsSettingsExternalRepresentation:forVPN:]
+ -[NERelayConfiguration overlapsWithRelayConfiguration:overlapDescription:]
+ -[NEURLFilterConfiguration infoPlistPIRServerURL]
+ -[NEURLFilterConfiguration infoPlistPrivacyPassIssuerURL]
+ -[NEURLFilterConfiguration setInfoPlistPIRServerURL:]
+ -[NEURLFilterConfiguration setInfoPlistPrivacyPassIssuerURL:]
...
+ GCC_except_table998
+ GCC_except_table999
+ _NEDomainIsSubdomainOf
+ _OBJC_IVAR_$_NEURLFilterConfiguration._infoPlistPIRServerURL
+ _OBJC_IVAR_$_NEURLFilterConfiguration._infoPlistPrivacyPassIssuerURL
...
+ _kNEDDMVPNProxiesAutoConfigEnableKey
+ _kNEDDMVPNProxiesAutoConfigURLStringKey
+ _kNEDDMVPNProxiesAutoDiscoveryEnableKey
+ _kNEDDMVPNProxiesHTTPEnableKey
+ _kNEDDMVPNProxiesHTTPPortKey
+ _kNEDDMVPNProxiesHTTPProxyKey
+ _kNEDDMVPNProxiesHTTPProxyPasswordKey
+ _kNEDDMVPNProxiesHTTPProxyUsernameKey
+ _kNEDDMVPNProxiesHTTPSEnableKey
...
- -[NERelayConfiguration overlapsWithRelayConfiguration:]
...
+ "Relay %@ overlaps with relay %@ (%@), disabling %@"
+ "SupplementalMatchDomainsNoSearch"
+ "apps overlap"
+ "domain %@ matches domain %@"
+ "infoPlistPIRPrivacyPassIssuerURL"
