...
+  __AUTH_CONST.__objc_const: 0x2dc80
...
+ GCC_except_table313
+ GCC_except_table314
+ ___block_descriptor_40_ea8_32s_e11_v24?0q8q16ls32l8
...
- -[LPAnimationMaskView initWithFrame:]
- -[LPAnimationMaskView layoutSubviews]
- -[LPAnimationMaskView setAnimationOrigin:]
- -[LPAnimationMaskView setImage:]
- -[LPLinkView _maskEnabled]
- -[LPLinkView _setMaskEnabled:]
- -[LPLinkView _setMaskEnabledForAnimation:]
- -[LPLinkView _setMaskImage:]
- -[LPLinkView _setSuppressChatKitMask:]
- -[LPLinkView _updateMasking]
- GCC_except_table137
- GCC_except_table147
- GCC_except_table190
- GCC_except_table193
...
- _OBJC_CLASS_$_LPAnimationMaskView
- _OBJC_IVAR_$_LPAnimationMaskView._animationOrigin
- _OBJC_IVAR_$_LPAnimationMaskView._image
- _OBJC_IVAR_$_LPAnimationMaskView._imageView
- _OBJC_IVAR_$_LPLinkView._animationMaskView
- _OBJC_IVAR_$_LPLinkView._maskEnabled
- _OBJC_IVAR_$_LPLinkView._maskEnabledForAnimation
- _OBJC_METACLASS_$_LPAnimationMaskView
- __OBJC_$_INSTANCE_METHODS_LPAnimationMaskView(Swift)
- __OBJC_$_INSTANCE_VARIABLES_LPAnimationMaskView
- __OBJC_$_PROP_LIST_LPAnimationMaskView
- __OBJC_CLASS_RO_$_LPAnimationMaskView
- __OBJC_METACLASS_RO_$_LPAnimationMaskView
- _appleMusicKeyColor.color
- _objc_msgSend$_setMaskEnabled:
- _objc_msgSend$_setMaskEnabledForAnimation:
- _objc_msgSend$_setMaskImage:
- _objc_msgSend$_setSuppressChatKitMask:
- _objc_msgSend$_updateMasking
- _objc_msgSend$anchorPoint
- _objc_msgSend$animationOrigin
- _objc_msgSend$capInsets
- _objc_msgSend$internalLayoutSubviews
- _objc_msgSend$mask
- _objc_msgSend$maskView
- _objc_msgSend$setAnimationOrigin:
- _objc_msgSend$setContents:
- _objc_msgSend$setContentsCenter:
- _objc_msgSend$setMaskView:
- _objc_msgSend$setSublayerTransform:
- _objc_msgSend$setSuppressMask:
- _symbolic Ig_
- _symbolic So19LPAnimationMaskViewC
- _symbolic So7UIImageC
CStrings:
+ "v24@?0q8q16"
+ "\xf0\xf0\xf0\xc1"
- "CKBalloonView"
- "LPAppleMusicKeyColor"
- "LinkPresentation/LPAnimationMaskView.swift"
- "imageViewAnimation"
- "maskHeightSpring"
- "maskViewSpring"
- "maskWidthSpring"
