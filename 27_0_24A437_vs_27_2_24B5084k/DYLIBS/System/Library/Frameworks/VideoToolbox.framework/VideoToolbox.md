...
-3350.77.1.6.0
-  __TEXT.__text: 0x53bf18
+3385.7.1.0.0
+  __TEXT.__text: 0x7248b8
...
+  __TEXT.__cstring: 0x44495
+  __TEXT.__oslogstring: 0x2da03
...
Symbols:
+ -[VTTemporalNoiseFilterImplementation _validateParameters:]
+ GCC_except_table35
+ GCC_except_table86
...
+ _OBJC_IVAR_$_VTFrameProcessor._firstProcessCallTimeMs
+ _OBJC_IVAR_$_VTFrameProcessor._lastErrorCode
+ _OBJC_IVAR_$_VTFrameProcessor._lastProcessCallTimeMs
+ _OBJC_IVAR_$_VTFrameProcessor._processCallCount
+ _OBJC_IVAR_$_VTFrameProcessor._sourceFrameRateTotalMeasuredDurationSeconds
+ _OBJC_IVAR_$_VTFrameProcessor._sourceFrameRateTotalMeasuredFrames
...
+ ___block_descriptor_48_e8_32o40r_e53_v24?0"VTTemporalNoiseFilterParameters"8"NSError"16ls32l8r40l8
...
+ _kFigReportingEventKey_VTFP_ClientBundleID
+ _kFigReportingEventKey_VTFP_ProcessCallRate
+ _kFigReportingEventKey_VTFP_SourceFrameRate
+ _logNodeInfo
+ _objc_autorelease
+ _objc_msgSend$_validateParameters:
...
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] %@"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] %@ : %@"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] %d: IOSurfacePort %d, pixelBufferAtomData %p, pixelBufferAtomDataCnt %d, iClient->lastSerializedPixelBufferDataSize %zd"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] %d: tagCollectionDataLength -> %d"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] %s %@"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] ***FRAME IS PENDING"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] CompleteFrames"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] CompleteFramesReturn"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] CreatePixelBuffer failed (%i)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] CreatePropertyList failed (%i)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] CreateSampleBuffer failed (%i)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] EncodeReturn"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] FigTaggedBufferGroupGetCount(taggedBufferGroup %p) -> %d"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] PrepareToEncodeFramesReturn"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] PrepareToEncodeTilesReturn"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] Session was invalidated"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] beginning pass"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] calling VTCompressionSessionRemoteClient_Create"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] calling VTTileCompressionSessionRemote_Create"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] calling client with frame"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] client callback for frame (%llu) with error (%d)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] clientCallbackQueue enter"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] clientCallbackQueue exit"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] completing tiles"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] copying serializable properties"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] copying supported property dictionary"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] creating pixel buffer pool failed %i"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] ending pass"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] enter"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] error serializing tagged buffer group %p index %d pixel buffer:%p err:%i"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] exit"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] finalizing remote session"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] frameRefcon (%llu) missing in pendingFrames, frameErrorStatus (%d)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] getting time ranges for next pass"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] handleDeadServerConnection"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] invalidating remote session"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] neither callback nor handler?"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] new remote session attached to compression session %p"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] new remote session attached to tile compression session %p"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] no frame available"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] pending notification!"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] remapped %i to kVTVideoEncoderMalfunctionErr (%i)"
+ "<<<< CompressionSessionRemote >>>> %s: [%p:%{public}s] server connection died"
+ "<<<< CompressionSessionRemote >>>> %s: [%p] lookup for client 0x%llx"
...
+ "<<<< CompressionSessionServer >>>> %s: No client record was found for UNREGISTERING"
...
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] %s, done waiting for pendingFrameSemaphore"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] CompressionOutputCallback"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] FigRemote_CreatePixelBufferFromSerializedAtomData failed for tagged buffer %d"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] FigTaggedBufferGroupCreate(count %d) -> %p, err %d"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] TileCompressionOutputCallback"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] beginning pass"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] client allocated for pid %i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] client record created compression session %p with err %i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] client record created tile compression session %p with err %i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] client record is UNREGISTERING"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] client with pid %u being notified of application state change to %{public}s"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] completing frames"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] completing tiles"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] copying property"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] copying serializable properties"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] copying supported property dictionary"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] ending pass"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] enter"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] error serializing pixelbuffer buffer:%p err:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] error serializing sample buffer:%p err:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] exit"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] exit: morePending:%i, error:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] finalizing client record"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] frameProperties:%@"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] getting next pending notification"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] getting time ranges for next pass"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] kFigProcessLifecycleMonitorParameter_NewState not present in payloadDict"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] key:\"VTMultiPassStorage\" value:%@ err:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] key:%@ value:%@ err:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] new client record"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] preparing to encode frames"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] preparing to encode tiles"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] properties:%@ err:%i"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] setting kVTCompressionPropertyKey_ClientPID failed (err=%d)"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] setting multi-pass storage"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] setting properties"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] setting property"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is NOT running foreground - invalidating session"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is running background"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is running foreground"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) unexpected app state %u"
+ "<<<< CompressionSessionServer >>>> %s: [%p:%{public}s] tileProperties:%@"
...
+ "<<<< CompressionSessionServer >>>> %s: created motion estimation session:%p with err:%i"
...
+ "<<<< CompressionSessionServer >>>> %s: iClient is NULL"
...
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] %@"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] %@ : %@"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] %s %@"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Added pending frame info: nextFrameIdentifier: %ld, frameID: %llu, original refcon: %p, sample count: %zu"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] CanAcceptFormatDescription"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] CopyBlackPixelBuffer"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] CopySerializableProperties"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] CopySupportedPropertyDictionary"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] DecodeFrameReturn"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] DecodeTile"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] EventLink decode frame message was cancelled"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] EventLink waitForAsynchronousFrames message was cancelled"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FRAME IS PENDING ***"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FigRemote_CreatePixelBufferFromSerializedAtomData failed for tagged buffer %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FigTaggedBufferGroupCreate(count %d) -> %p, err %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FinishDelayedFrames"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FinishDelayedFramesReturn"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FinishDelayedTiles"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] FlushPixelBufferPool"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] GetMinAndMaxOutputPresentationTimeStampOfFramesBeingDecoded"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] GetMinAndMaxOutputPresentationTimeStampOfFramesBeingDecoded("
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] GetMinOutputPresentationTimeStampOfFramesBeingDecoded"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Lost server connection"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Property key: %@"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Property key: %@, value: %@"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Received emitframe: frameID %d, status %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Received emitframe: frameID: %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Received emitframe: frameID: %d, status = %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Sending message through EventLink failed. Err %d. Falling back to XPC."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Session was invalidated"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] SetProperties"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Took EventLink path"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Took XPC path"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] Unknown opCode: 0x%0x"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] VTDecompressionSessionRemoteClient_DequeueNextPendingFrame -> gotFrame %d, serverErr %d, morePending %d; frameIOSurfacePort %d, taggedBuffers[0].IOSurfacePort %d, taggedBuffers[1].IOSurfacePort %d, taggedBuffers[2].IOSurfacePort %d, taggedBuffers[3].IOSurfacePort %d, taggedBuffers[4].IOSurfacePort %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: Done waiting for decodeReturnSemaphore"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: Done waiting for finishDelayedTilesReturnSemaphore"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: Emitting frameID: (%llu) with error: %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: finished waiting for decompression session to complete asynchronous frames %s%s%s."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: finished waiting for decompression session to finish delayed frames %s%s%s."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for decompression session to finish delayed frames."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for video decompress session to complete asynchronous frames."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for video decompress session to finish delayed tiles."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for video decompression session decode frames return."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for video decompression session decode tile; maybe it is stuck for app cannot handle emit-tile ?"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] WaitForAsynchronousFrames"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] async emit callback "
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] callback: %p, refcon: %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] called [outputHandler: %p] [multiImageOutputHandler: %p] [sampleCount: %d] remoteRefCon %d originalRefCon %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] calling client with frame remoteRefCon %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] clientCallbackQueue enter"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] clientCallbackQueue exit"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] dequeue failed (%i)"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] emit callback: frameID %d, status %d "
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] emit callback: frameID: %llu, DS output refCon: %p, originalRefCon: %p, imageBuffer: %p, framePTS: %lld/%d, frameDuration:  %lld/%d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] emit pending frames"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] enter"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] exit"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] failed to send emit return message to server: %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] finalizing remote session"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] found frame with frame remoteRefCon %d original refCon %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] frameID: %llu, outstanding sample count: %zu, outstanding emit count: %zu"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] got FinishDelayedFramesReturn from server"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] got FinishDelayedTilesReturn from server"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] got decode status from Server"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] got finishReturn from Server"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] handle EmitTile"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] handle server session is gone"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] invalidating remote session"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] memory origin copied: %p, err: %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] neither callback nor handler?"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] new remote session attached to decompression session %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] new remote session attached to tile decompression session %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] no client callback?"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] no frame available"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] no multi image callback ?"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] pending notification!"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] remapped %i to kVTVideoDecoderMalfunctionErr (%i)"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] resetting error (%d), since emit callback has been called"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] return err: %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] return err: %d "
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] return err: %d canDoIt : %d"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] sampleBuffer: %p, decodeFlags: 0x%x, frameOptions: %p, outputHandler: %p, multiImageOutputHandler: %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] sampleBuffer: %p, decodeFlags: 0x%x, frameOptions: %p, sourceFrameRefCon: %p"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] sampleBuffer: %p, decodeFlags: 0x%x, tileCropOffset: (%d, %d), tileCropDimension: %d x %d, imageBuffer: %p, offsetWithinImageBuffer: (%d, %d)"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] server connection died"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] skipping emit callback."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] sync frame - dequeue anything pending"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] tagCollectionCFData is %p while pixelBuffer is %p. Dump these data."
+ "<<<< DecompressionSessionRemote >>>> %s: [%p:%{public}s] waited %d ms for outputCallbackDispatchGroup. (Long wait time can happen when the client app goes to background)"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p] lookup for client 0x%llx"
+ "<<<< DecompressionSessionRemote >>>> %s: [%p] new remote session attached to decompression session %p"
+ "<<<< DecompressionSessionRemote >>>> %s: called"
...
+ "<<<< DecompressionSessionRemote >>>> %s: failed to rebuild secondary connection: %d"
...
+ "<<<< DecompressionSessionRemote >>>> %s: retrying with freshly built secondary connection failed (objectID %llu)"
...
+ "<<<< DecompressionSessionRemote >>>> %s: secondary connection lost, rebuilding now (objectID %llu)"
+ "<<<< DecompressionSessionRemote >>>> %s: server connection died!"
+ "<<<< DecompressionSessionRemote >>>> Fig"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] %d: IOSurfacePortOut %d, pixelBufferAtomDataOut %p, pixelBufferAtomDataCntOut %d, iClient->lastSerializedPixelBufferDataSize %zd"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] %d: tagCollectionDataLength -> %d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] %s%s"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CanAcceptFormatDescription"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CopyBlackPixelBuffer"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CopyProperty"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CopyProperty %@ failed. err=%d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CopySerializableProperties"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] CopySupportedPropertyDictionary"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] FigTaggedBufferGroupGetCount(frame->taggedBufferGroup %p) -> %d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] FinishDelayedFrames"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] FinishDelayedTiles"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] FlushPixelBufferPool"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] GetNextPendingNotification"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] SetProperties"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] SetProperty"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] UNREGISTERING, setting clientDied"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] VTDecompressionSessionSetMultiImageCallback -> %d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] about to invalidate subDecompressionSession"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] about to invalidate subTileDecompressionSession"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] break from enforceQueueLimit loop. subSession: %p, subTileSession: %p, clientDied: %d, invalidated: %d, subSessionIsGone: %d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] client allocated for pid %i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] client died or invalidated (2)"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] client record created tile decompression session %p with err:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] client with pid %u being notified of application state change to %s"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] disposing clientConnection %p"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] enter"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] error %i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] error serializing pixel buffer:%@ err:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] error serializing pixel buffer:%p err:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] error serializing tagged buffer group %p index %d pixel buffer:%p err:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] exit"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] exit: morePending:%i, error:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] finalizing client record"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] frame %p enqueued"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] freeing queued frames"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] invalidating client record"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] kFigProcessLifecycleMonitorParameter_NewState not present in payloadDict"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] new client record"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] returning (%i)"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] setting kVTDecompressionPropertyKey_ClientPID failed (err=%d)"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] signalling pendingFrameSemaphore, waiting on asyncMessageHandlerGroup"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] status %d, taggedBufferGroup %p, pts %1.3f, dur %1.3f %s%s"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is NOT running foreground - invalidating session"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is running background"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) is running foreground"
+ "<<<< DecompressionSessionServer >>>> %s: [%p:%{public}s] task (pid %u) unexpected app state %u"
+ "<<<< DecompressionSessionServer >>>> %s: [%p] Tile statistics: count: %d, %{public}s: %d x %d, canvas size: %d x %d"
+ "<<<< DecompressionSessionServer >>>> %s: [%p] client record created decompression session %p with err:%i"
+ "<<<< DecompressionSessionServer >>>> %s: [%p] new client record"
+ "<<<< DecompressionSessionServer >>>> %s: [%p] setting kVTDecompressionPropertyKey_ClientPID failed (err=%d)"
+ "<<<< DecompressionSessionServer >>>> %s: called"
+ "<<<< DecompressionSessionServer >>>> %s: client [%p] allocated for pid %i"
+ "<<<< DecompressionSessionServer >>>> %s: client record not found for cmd_port %d"
+ "<<<< DecompressionSessionServer >>>> %s: destroying client record for cmd_port %d"
...
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Cannot create more event links. Will not use event link for thread %p"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] DecompressionSessionMessageQueue create with FigThreadPriority %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Dispose message received."
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Encountered new thread %p. Created event link %d of %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Failed to set up emit frame event link. Err = %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] No sub session"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Output shows 0 MultiImage, at presentation time %1.3f, duration %1.3f"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Received async message '%c%c%c%c'"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Received message '%c%c%c%c' from connection: %p"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Unknown NoReply opCode: 0x%0x"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Unknown opCode: 0x%0x"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Unsupported DecoderEmitsFramesFromConsistentThread"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] Unsupported MachThreadPriorityForThreadEmittingFrames"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] VTDecompressionSessionSetMultiImageCallback -> %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] WARNING: semaphore wait done."
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] WARNING: waited %lld seconds for emit frame return."
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] being notified of application state change to %u"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] client record created decompression session %p with err:%i"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] client record created tile decompression session %p with err:%d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] creating new client record (client process: %s)"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] decoderEmitsFramesFromConsistentThread != true"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] decoderEmitsFramesFromConsistentThread: %@"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] decoderMachThreadPriority %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] dispatch to asyncMessageHandlerQueue"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] dispose client record due to err: %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] disposing client record"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] emit frame EventLink message cancelled: err=%d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] emit frame EventLink message failed: err=%d. Fall back to XPC path"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] err %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] finalizing client record"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] finishDelayedFrames: send return message"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] finishDelayedTiles: send return message"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] got 'emit callback return' xpc message. singnal emitFrameReturnSemaphore"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] invalidating client record"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] kFigProcessLifecycleMonitorParameter_NewState not present in payloadDict"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] memory recipient copied: %p, err: %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] new client record (client process: %s)"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] pixel buffer origin copied: %p, err: %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] setting kVTDecompressionPropertyKey_ClientPID failed (err=%d)"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] signal emitFrameReturnSemaphore before invalidation"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] sourceFrameRefcon: %lld, infoFlags: 0x%x, imageBuffer: %p, pst: %lld / %d, duration: %lld / %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] taggedBufferGroup count = %ld, frameID = %d, status = %d"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] task is NOT running foreground. Invalidating client"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] task is running background"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] task is running foreground"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] task unexpected app state %u"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] tileRefCon %lld, infoFlags 0x%x, imageBuffer %p, cropOffset (%d, %d), cropDimensions %d x %d, offsetWithinImageBuffer (%d, %d)"
+ "<<<< DecompressionSessionXPCServer >>>> %s: [%p:%{public}s] wait for emitFrameReturnSemaphore"
...
+ "<<<< VT-CS >>>> %s: [%p:%{public}s] 'AllowClientProcessEncode' in compressionSessionOptions is: %@"
...
+ "<<<< VT-CS >>>> %s: [%p:%{public}s] WARNING: invalidated session still has %d pending frame%s, %d of which are in the encoder"
...
+ "<<<< VT-CS >>>> %s: [%p:%{public}s] vtCompressionSessionIOSurfaceSynchronizationWork %d"
...
+ "<<<< VT-DS >>>> %s: [%p:%{public}s] calling VTDecoderSessionRegisterCustomPixelFormat on unsupported platform"
+ "<<<< VT-DS >>>> %s: [%p:%{public}s] changing format description from %p to %p"
+ "<<<< VT-DS >>>> %s: [%p:%{public}s] client PID is unknown"
...
+ "<<<< VT-DS >>>> %s: status of create reporting agent: %d (%p)"
...
+ "<<<< VTPixelRotationSession >>>> %s: %p %{public}@ %d -> %d"
+ "<<<< VTPixelRotationSession >>>> %s: %p %{public}@ %f -> %f"
...
+ "<<<< VTPixelRotationSession >>>> %s: bad property value for %{public}@"
...
+ "<<<< VTPixelTransferSession >>>> %s: %p %{public}@ %f -> %f"
...
+ "<<<< VTTileDecompressionSession >>>> %s: [%p:%{public}s] unsupported kVTDecompressionPropertyKey_PixelBufferPool request for VTTileDecompressionSession"
...
+ "DecompressionSessionClient_Finalize"
...
+ "description=CoreMedia_VideoToolbox-3385.7.1"
...
+ "dsrxpc_rebuildSecondaryConnectionLocked"
+ "dsrxpc_sendEmitCallbackReturnValueMessage"
...
+ "no secondary connection available"
...
+ "primary remote client not initialized"
...
+ "scaleOrSetAlpha8"
+ "secondary connection lock not initialized"
+ "secondary connection rebuild returned NULL"
...
+ "vtDecompressionSession_initializeReportingAgent"
...
+ "vtdsr_handleMachErrorsInternal"
