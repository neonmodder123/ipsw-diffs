...
-  __TEXT.__const: 0x3a9c
-  __TEXT.__cstring: 0xa25
+749.2.4.0.0
+  __TEXT.__text: 0x3e344
+  __TEXT.__objc_methlist: 0x228
+  __TEXT.__const: 0x3adc
+  __TEXT.__cstring: 0xa85
   __TEXT.__swift5_typeref: 0xcb2
...
+ _objc_msgSend$replaceApplication:with:completion:
...
CStrings:
+ "com.apple.chrono.accessoryLiveActivities.app.migration"
+ "replaceApplication(from:to:)"
+ "xpc error: replaceApplication - unable to obtain the remote target"
+ "xpc: replaceApplication"
```
