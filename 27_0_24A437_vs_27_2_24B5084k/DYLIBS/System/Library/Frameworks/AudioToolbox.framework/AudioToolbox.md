...
+1638.208.0.0.0
+  __TEXT.__text: 0x275e08
+  __TEXT.__realtime: 0x29ba4
...
+ _LoudnessManager_IsHardwareSupported
+ __Z16interpret_stringPKv
+ __ZGVZN21SpatializationManager14GetPreferencesERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE18screenSharingState
+ __ZL33RemoteIO_MinimalFormatSafetyCheckRK27AudioStreamBasicDescription
+ __ZN10AQMEIO_DSP20getDeviceSubCategoryEv
+ __ZN10AQMEIO_HAL20getDeviceSubCategoryEv
+ __ZN11AQMEIO_Base20getDeviceSubCategoryEv
+ __ZN11HapticSynth18queryEventEnvelopeEjRbRNSt3__18optionalIfEE
+ __ZN11HapticSynth22getRawEventReleaseTimeEj
+ __ZN11HapticSynth22setRawLayerReleaseTimeEjf
+ __ZN15HapticAudioUnit26getLayerAndZoneWithEventIDEjPjS0_
+ __ZN15InputDispatcherD2Ev
+ __ZN15LoudnessManager11GetSettingsEjP18AQConverterOrCodecjjjjbPiPNS_8SettingsE
+ __ZN15LoudnessManager12EnableLMAULNER14AQIONodeClientP8AQIONode
+ __ZN15LoudnessManager13DisableLMAULNER14AQIONodeClientP8AQIONode
+ __ZN15LoudnessManager17IsLMAULNPermanentEv
+ __ZN15LoudnessManager25ConfigureBothCodecAndAULNEv
+ __ZN15LoudnessManager26SetCodecOutputPeakLevelMaxEP18AQConverterOrCodecf
+ __ZN15LoudnessManager28ApplyCodecLoudnessPropertiesEP18AQConverterOrCodecjRKNS_8SettingsE
+ __ZN15LoudnessManager29SetCodecDRCCompressionProfileEP18AQConverterOrCodecj
+ __ZN15LoudnessManager30SetCodecMomentaryLoudnessLimitEP18AQConverterOrCodecf
+ __ZN15LoudnessManager30SetCodecNormalizationGainLimitEP18AQConverterOrCodecf
+ __ZN15LoudnessManager35SetCodecLoudnessNormalizationTargetEP18AQConverterOrCodecf
+ __ZN15LoudnessManager36SetDolbyCodecDynamicRangeControlModeEP18AQConverterOrCodecj
+ __ZN15LoudnessManager43ApplyCodecLoudnessPropertiesFromPreferencesEP18AQConverterOrCodecj
+ __ZN16AudioQueueObject19GetOrCreateCapturerE8TapPoint
+ __ZN16AudioQueueObject29SetContentSourceFromMediaKindEPK10__CFString
+ __ZN16AudioQueueObject34SetContentSourceFromISOContentTypeEjj
+ __ZN17AQMECaptureInsert12StartCaptureEONSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE8TapPoint
+ __ZN20AudioCapturerManager9SetFormatERK27AudioStreamBasicDescription8TapPoint
+ __ZN20AudioCapturerManagerD2Ev
+ __ZN20CodecProcessingBlock15GetAvailableAUsERNSt3__16vectorI21AudioClassDescriptionNS0_9allocatorIS2_EEEE
+ __ZN20CodecProcessingBlockD0Ev
+ __ZN20CodecProcessingBlockD1Ev
+ __ZN20CodecProcessingBlockD2Ev
+ __ZN20SpatializationLogger20PrefsFormattedStringERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEES8_
+ __ZN20SpatializationLoggerD2Ev
+ __ZN23RouteQueryingNodeClientD2Ev
+ __ZN24CodecProcessingBlockItem12GetParameterEjjjPf
+ __ZN24CodecProcessingBlockItem12SetParameterEjjjf
+ __ZN24CodecProcessingBlockItem16GetParameterInfoEjjR22AudioUnitParameterInfo
+ __ZN24CodecProcessingBlockItem16GetParameterListEjPjRj
+ __ZN24CodecProcessingBlockItem24GetParameterValueStringsEjjPPK9__CFArray
+ __ZN24CodecProcessingBlockItemD0Ev
+ __ZN24CodecProcessingBlockItemD1Ev
+ __ZN27AUProcessingBlockBase_NonAU13AUGetPropertyEP21OpaqueRemoteAudioUnitjjjPvPj
+ __ZN27AUProcessingBlockBase_NonAU13AUSetPropertyEP21OpaqueRemoteAudioUnitjjjPKvj
+ __ZN27AUProcessingBlockBase_NonAU14AUGetParameterEP21OpaqueRemoteAudioUnitjjjPf
+ __ZN27AUProcessingBlockBase_NonAU14AUSetParameterEP21OpaqueRemoteAudioUnitjjjf
+ __ZN27AUProcessingBlockBase_NonAU14AddItemToBlockERK21AudioClassDescriptionNSt3__110shared_ptrI31AUProcessingBlockBase_NonAUItemEE
+ __ZN27AUProcessingBlockBase_NonAU17AUGetPropertyInfoEP21OpaqueRemoteAudioUnitjjjPjPh
+ __ZN27AUProcessingBlockBase_NonAU19RemoveItemFromBlockENSt3__110shared_ptrI31AUProcessingBlockBase_NonAUItemEE
+ __ZN27AUProcessingBlockBase_NonAUD2Ev
+ __ZN31AUProcessingBlockBase_NonAUItem11GetBypassedEv
+ __ZN31AUProcessingBlockBase_NonAUItem11GetPropertyEjjjPvPj
+ __ZN31AUProcessingBlockBase_NonAUItem11SetBypassedEb
+ __ZN31AUProcessingBlockBase_NonAUItem11SetPropertyEjjjPKvj
+ __ZN31AUProcessingBlockBase_NonAUItem15GetPropertyInfoEjjjPjPh
+ __ZN31AUProcessingBlockBase_NonAUItemD2Ev
+ __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI20AudioCapturerManagerEEE5writeES5_
+ __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI20AudioCapturerManagerEEEC2Ev
+ __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI20AudioCapturerManagerEEED2Ev
+ __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__113unordered_mapIjfNS2_4hashIjEENS2_8equal_toIjEENS2_9allocatorINS2_4pairIKjfEEEEEEED2Ev
+ __ZN5caulk14cf_preferences7monitor11add_handlerIbEEbPK10__CFStringS5_PFNSt3__18optionalIT_EEPKvERKNS6_8functionIFvS8_EEE
+ __ZN9Registrar10mTapPointsE
+ __ZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPoint
+ __ZN9Registrar16mRingBufferModesE
+ __ZN9Registrar7DisableE8TapPointPKcS2_
+ __ZNK15LoudnessManager19IsHardwareSupportedEP14AQIONodeClientP8AQIONode
+ __ZNK16AudioQueueObject19ConverterConnection17DecoderHandlesDRCEj
+ __ZNK20AudioCapturerManager12WritePacketsEPKvjPK28AudioStreamPacketDescriptionjPK17AudioCaptureTrace
+ __ZNK20AudioCapturerManager15WriteBufferListEPK15AudioBufferListjxPK17AudioCaptureTrace
+ __ZNK5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI20AudioCapturerManagerEEE12begin_accessEv
+ __ZNKSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEE7__cloneEPNS0_6__baseISI_EE
+ __ZNKSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEE7__cloneEPNS0_6__baseISD_EE
+ __ZNKSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EE7__cloneEPNS0_6__baseISM_EE
+ __ZNKSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEE7__cloneEPNS0_6__baseISC_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EE7__cloneEPNS0_6__baseIS7_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEE7__cloneEv
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEE7__cloneEPNS0_6__baseIS4_EE
+ __ZNKSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEE7__cloneEv
+ __ZNSt3__110__function12__value_funcIFvPK10__CFStringEEC2B9foe220106ERKS6_
+ __ZNSt3__110__function12__value_funcIFvPK10__CFStringEED2B9foe220106Ev
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEE7destroyEv
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEED0Ev
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEED1Ev
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEEclESC_SH_
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEE7destroyEv
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEED0Ev
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEED1Ev
+ __ZNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEEclEOSC_
+ __ZNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EE7destroyEv
+ __ZNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EED0Ev
+ __ZNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EED1Ev
+ __ZNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EEclEOSD_
+ __ZNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EEclEOS5_
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEEclEOb
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEEclEOx
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEEclEOx
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEEclEOx
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEEclEOx
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEE18destroy_deallocateEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEE7destroyEv
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEED0Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEED1Ev
+ __ZNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEEclEOx
+ __ZNSt3__111make_uniqueB9foe220106I20AudioCapturerManagerJNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEEELi0EEENS_10unique_ptrIT_NS_14default_deleteIS9_EEEEDpOT0_
+ __ZNSt3__111make_uniqueB9foe220106I8XPromiseJZN20MEDeviceStreamClient16AddRunningClientER14AQIONodeClientbbE3$_0ELi0EEENS_10unique_ptrIT_NS_14default_deleteIS7_EEEEDpOT0_
...
+ __ZNSt3__120__shared_ptr_emplaceI20AudioCapturerManagerNS_9allocatorIS1_EEE16__on_zero_sharedEv
+ __ZNSt3__120__shared_ptr_emplaceI20AudioCapturerManagerNS_9allocatorIS1_EEE21__on_zero_shared_weakEv
+ __ZNSt3__120__shared_ptr_emplaceI20AudioCapturerManagerNS_9allocatorIS1_EEED0Ev
+ __ZNSt3__120__shared_ptr_emplaceI20AudioCapturerManagerNS_9allocatorIS1_EEED1Ev
+ __ZNSt3__120__shared_ptr_pointerIP24CodecProcessingBlockItemNS_10shared_ptrIS1_E27__shared_ptr_default_deleteIS1_S1_EENS_9allocatorIS1_EEE16__on_zero_sharedEv
+ __ZNSt3__120__shared_ptr_pointerIP24CodecProcessingBlockItemNS_10shared_ptrIS1_E27__shared_ptr_default_deleteIS1_S1_EENS_9allocatorIS1_EEE21__on_zero_shared_weakEv
+ __ZNSt3__120__shared_ptr_pointerIP24CodecProcessingBlockItemNS_10shared_ptrIS1_E27__shared_ptr_default_deleteIS1_S1_EENS_9allocatorIS1_EEED0Ev
+ __ZNSt3__120__shared_ptr_pointerIP24CodecProcessingBlockItemNS_10shared_ptrIS1_E27__shared_ptr_default_deleteIS1_S1_EENS_9allocatorIS1_EEED1Ev
...
+ __ZNSt3__19allocatorI21AudioClassDescriptionE17allocate_at_leastB9foe220106Em
+ __ZTV20CodecProcessingBlock
+ __ZTV24CodecProcessingBlockItem
+ __ZTVNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_0FvRN4swix12ipc_endpointERKN10applesauce3xpc6objectEEEE
+ __ZTVNSt3__110__function6__funcIZN2AQ3API7ManagerC1EbN5caulk19lifetime_erased_ptrI23AudioQueueXPC_InterfaceEEE3$_1FiN10applesauce3xpc6objectEEEE
+ __ZTVNSt3__110__function6__funcIZN5caulk14cf_preferences7monitor11add_handlerIPK10__CFStringEEbS8_S8_PFNS_8optionalIT_EEPKvERKNS_8functionIFvSA_EEEEUlSD_E_FbSD_EEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar12RegisterFlagERN5caulk14cf_preferences7monitorEPK10__CFString8TapPointEUlbE_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlPK10__CFStringE_FvS5_EEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE0_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE1_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE2_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE3_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlbE_FvbEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE0_FvxEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE1_FvxEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE2_FvxEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE3_FvxEEE
+ __ZTVNSt3__110__function6__funcIZN9Registrar17RegisterListenersEvEUlxE_FvxEEE
+ __ZTVNSt3__120__shared_ptr_emplaceI20AudioCapturerManagerNS_9allocatorIS1_EEEE
+ __ZTVNSt3__120__shared_ptr_pointerIP24CodecProcessingBlockItemNS_10shared_ptrIS1_E27__shared_ptr_default_deleteIS1_S1_EENS_9allocatorIS1_EEEE
+ __ZThn160_N11AQAC3IONode15IO_PerformInputEiRK15AudioBufferListRK14AudioTimeStamp
+ __ZThn160_N11AQAC3IONode16IO_PerformOutputEiR15AudioBufferListRK14AudioTimeStamp
+ __ZThn160_N11AQAC3IONodeD0Ev
+ __ZThn160_N11AQAC3IONodeD1Ev
+ __ZThn160_N11AQTapIONode10getWeakPtrEv
+ __ZThn160_N11AQTapIONode14IO_MuteChangedEv
+ __ZThn160_N11AQTapIONode16IO_AdaptToDeviceEi
+ __ZThn160_N11AQTapIONode16IO_VolumeChangedEb
+ __ZThn160_N11AQTapIONode17IO_LatencyChangedEb
+ __ZThn160_N11AQTapIONode23IO_DefaultDeviceChangedEb
+ __ZThn160_N11AQTapIONode25IO_DeviceStoppedFromBelowEbb
+ __ZThn160_N11AQTapIONodeD0Ev
+ __ZThn160_N11AQTapIONodeD1Ev
+ __ZThn160_N18AQHapticOutputNode15IO_PerformInputEiRK15AudioBufferListRK14AudioTimeStamp
+ __ZThn160_N18AQHapticOutputNode16IO_PerformOutputEiR15AudioBufferListRK14AudioTimeStamp
+ __ZThn160_N18AQHapticOutputNodeD0Ev
+ __ZThn160_N18AQHapticOutputNodeD1Ev
+ __ZThn168_N11AQAC3IONode10getWeakPtrEv
+ __ZThn168_N11AQAC3IONode14IO_MuteChangedEv
+ __ZThn168_N11AQAC3IONode16IO_AdaptToDeviceEi
+ __ZThn168_N11AQAC3IONode16IO_VolumeChangedEb
+ __ZThn168_N11AQAC3IONode17IO_LatencyChangedEb
+ __ZThn168_N11AQAC3IONode23IO_DefaultDeviceChangedEb
+ __ZThn168_N11AQAC3IONode25IO_DeviceStoppedFromBelowEbb
+ __ZThn168_N11AQAC3IONodeD0Ev
+ __ZThn168_N11AQAC3IONodeD1Ev
+ __ZThn168_N18AQHapticOutputNode10getWeakPtrEv
+ __ZThn168_N18AQHapticOutputNode14IO_MuteChangedEv
+ __ZThn168_N18AQHapticOutputNode16IO_AdaptToDeviceEi
+ __ZThn168_N18AQHapticOutputNode16IO_VolumeChangedEb
+ __ZThn168_N18AQHapticOutputNode17IO_LatencyChangedEb
+ __ZThn168_N18AQHapticOutputNode23IO_DefaultDeviceChangedEb
+ __ZThn168_N18AQHapticOutputNode25IO_DeviceStoppedFromBelowEbb
+ __ZThn168_N18AQHapticOutputNodeD0Ev
+ __ZThn168_N18AQHapticOutputNodeD1Ev
+ __ZZN18AQOfflineMixerBaseC1ER15AQIONodeManageriRK27AudioStreamBasicDescriptionRKN2CA13ChannelLayoutERiE23sCaptureInstanceCounter
+ __ZZN20AudioCapturerManager10InitializeEvE9onceToken
+ __ZZN21SpatializationManager14GetPreferencesERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE18screenSharingState
+ __ZZN21SpatializationManager14GetPreferencesERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE4once
+ ____ZN16AudioQueueObject19IONode_RouteChangedEv_block_invoke_5
+ ____ZN16AudioQueueObject19IONode_RouteChangedEv_block_invoke_6
+ ____ZN20AudioCapturerManager10InitializeEv_block_invoke
+ ____ZN21SpatializationManager14GetPreferencesERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbb_block_invoke
...
- __ZGVZN21SpatializationManager16GetPreferencesV1ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE18screenSharingState
- __ZGVZN21SpatializationManager16GetPreferencesV2ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDbbR23SpatialAudioPreferencesbbE18screenSharingState
- __ZL18gAQMEClientCapture
- __ZL20gOfflineMixerCapture
- __ZL21gAQMETimePitchCapture
- __ZL31ShouldRouteBypassSpatializationR14AQIONodeClientP8AQIONode
- __ZL34gOfflineMixerCaptureRingBufferMode
- __ZN11HapticSynth23eventHasDefaultEnvelopeEj
...
- __ZN21SpatializationManager16GetPreferencesV1ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbb
...
- __ZN21SpatializationManager32HasUntrackedHeadphoneEntitlementEj
...
- __ZN21SpatializationManager40Has3rdPartyUntrackedHeadphoneEntitlementEj
- __ZN22SpatializationLoggerV120PrefsFormattedStringERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEES8_
- __ZN22SpatializationLoggerV1D2Ev
- __ZN22SpatializationLoggerV220PrefsFormattedStringERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEES8_
- __ZN22SpatializationLoggerV2D2Ev
- __ZN23RouteQueryingNodeClientC2ERK11AQMESession
- __ZN2AQ3API15CaptureViaPrefs14createCapturerENS0_12CapturerTypeEjRK27AudioStreamBasicDescriptionPK8__CFData
- __ZN2AQ3API15CaptureViaPrefsD0Ev
- __ZN2AQ3API15CaptureViaPrefsD1Ev
- __ZN2AQ3APIL21gAQClientCaptureInputE
- __ZN2AQ3APIL22gAQClientCaptureOutputE
- __ZN2AQ3APIL29gAQClientCaptureOfflineRenderE
- __ZN2AT9MixServer4Base12capturePrefsEv
- __ZN2AT9MixServer6Common12capturePrefsEv
- __ZN2AT9MixServer6Common13sCapturePrefsE
- __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI16AudioCapturerIfcEEE7mutator5writeES5_
- __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI16AudioCapturerIfcEEE7mutatorD2Ev
- __ZN5caulk10concurrent26lf_read_synchronized_writeINSt3__110shared_ptrI16AudioCapturerIfcEEED2Ev
...
- __ZNK2AQ3API15CaptureViaPrefs14captureEnabledENS0_12CapturerTypeE
...
- __ZTVN2AQ3API15CaptureViaPrefsE
...
- __ZThn80_N11AQAC3IONode15IO_PerformInputEiRK15AudioBufferListRK14AudioTimeStamp
- __ZThn80_N11AQAC3IONode16IO_PerformOutputEiR15AudioBufferListRK14AudioTimeStamp
- __ZThn80_N11AQAC3IONodeD0Ev
- __ZThn80_N11AQAC3IONodeD1Ev
- __ZThn80_N11AQTapIONode10getWeakPtrEv
- __ZThn80_N11AQTapIONode14IO_MuteChangedEv
- __ZThn80_N11AQTapIONode16IO_AdaptToDeviceEi
- __ZThn80_N11AQTapIONode16IO_VolumeChangedEb
- __ZThn80_N11AQTapIONode17IO_LatencyChangedEb
- __ZThn80_N11AQTapIONode23IO_DefaultDeviceChangedEb
- __ZThn80_N11AQTapIONode25IO_DeviceStoppedFromBelowEbb
- __ZThn80_N11AQTapIONodeD0Ev
- __ZThn80_N11AQTapIONodeD1Ev
- __ZThn80_N18AQHapticOutputNode15IO_PerformInputEiRK15AudioBufferListRK14AudioTimeStamp
- __ZThn80_N18AQHapticOutputNode16IO_PerformOutputEiR15AudioBufferListRK14AudioTimeStamp
- __ZThn80_N18AQHapticOutputNodeD0Ev
- __ZThn80_N18AQHapticOutputNodeD1Ev
- __ZThn88_N11AQAC3IONode10getWeakPtrEv
- __ZThn88_N11AQAC3IONode14IO_MuteChangedEv
- __ZThn88_N11AQAC3IONode16IO_AdaptToDeviceEi
- __ZThn88_N11AQAC3IONode16IO_VolumeChangedEb
- __ZThn88_N11AQAC3IONode17IO_LatencyChangedEb
- __ZThn88_N11AQAC3IONode23IO_DefaultDeviceChangedEb
- __ZThn88_N11AQAC3IONode25IO_DeviceStoppedFromBelowEbb
- __ZThn88_N11AQAC3IONodeD0Ev
- __ZThn88_N11AQAC3IONodeD1Ev
- __ZThn88_N18AQHapticOutputNode10getWeakPtrEv
- __ZThn88_N18AQHapticOutputNode14IO_MuteChangedEv
- __ZThn88_N18AQHapticOutputNode16IO_AdaptToDeviceEi
- __ZThn88_N18AQHapticOutputNode16IO_VolumeChangedEb
- __ZThn88_N18AQHapticOutputNode17IO_LatencyChangedEb
- __ZThn88_N18AQHapticOutputNode23IO_DefaultDeviceChangedEb
- __ZThn88_N18AQHapticOutputNode25IO_DeviceStoppedFromBelowEbb
- __ZThn88_N18AQHapticOutputNodeD0Ev
- __ZThn88_N18AQHapticOutputNodeD1Ev
- __ZZL17InitializeGlobalsvE4once
...
- __ZZN21SpatializationManager16GetPreferencesV1ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE18screenSharingState
- __ZZN21SpatializationManager16GetPreferencesV1ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbbE4once
- __ZZN21SpatializationManager16GetPreferencesV2ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDbbR23SpatialAudioPreferencesbbE18screenSharingState
- __ZZZN18AQOfflineMixerBaseC1ER15AQIONodeManageriRK27AudioStreamBasicDescriptionRKN2CA13ChannelLayoutERiENK3$_0clEvE33offlineMixerCaptureRingBufferMode
- ____ZL17InitializeGlobalsv_block_invoke
...
- ____ZN21SpatializationManager16GetPreferencesV1ERK11AQMESessionRK14AQMEIO_Binding20SpatialContentTypeIDR23SpatialAudioPreferencesbb_block_invoke
CStrings:
+ "%25s:%-5d %.*s@%p %s: "
+ "%25s:%-5d %.*s@%p %s:   ->flushing pending input"
+ "%25s:%-5d %.*s@%p %s:   <-done flushing pending input: 0 packets produced"
+ "%25s:%-5d %.*s@%p %s:   <-done flushing pending input: no more buffers (%d frames in ring buffer)"
+ "%25s:%-5d %.*s@%p %s:   ScheduledSliceAllocator %p: sliceFormat %s"
+ "%25s:%-5d %.*s@%p %s:   [%d] %s"
+ "%25s:%-5d %.*s@%p %s:   changed existing slice player output format"
+ "%25s:%-5d %.*s@%p %s:   created new slice allocator %p for PCM format: %s"
+ "%25s:%-5d %.*s@%p %s:   flushing input: %d packets produced"
+ "%25s:%-5d %.*s@%p %s:   flushing pending input terminated - error %d"
+ "%25s:%-5d %.*s@%p %s: ### hardware bit depth was %d; now %d ###"
+ "%25s:%-5d %.*s@%p %s: %d"
+ "%25s:%-5d %.*s@%p %s: %d %d, preferred manuf %d; found hw=%d, sw=%d; policy %d, chose %d"
+ "%25s:%-5d %.*s@%p %s: %d (disposing=%d)"
+ "%25s:%-5d %.*s@%p %s: %d fr"
+ "%25s:%-5d %.*s@%p %s: %p, err=%d"
+ "%25s:%-5d %.*s@%p %s: %s"
+ "%25s:%-5d %.*s@%p %s: %s\n%s"
+ "%25s:%-5d %.*s@%p %s: %s spatialization compression."
+ "%25s:%-5d %.*s@%p %s: %s, mixer %p"
+ "%25s:%-5d %.*s@%p %s: %s: AudioCodec %p\n  from %s\n  to   %s"
+ "%25s:%-5d %.*s@%p %s: (%d bytes @ %p), err=%d"
+ "%25s:%-5d %.*s@%p %s: *** Queue needs no converter ***"
+ "%25s:%-5d %.*s@%p %s: *** inserting %d-frame alignment adjustment"
+ "%25s:%-5d %.*s@%p %s: ***** unpausing after being paused %lld - %lld = %lld sample frames *****"
+ "%25s:%-5d %.*s@%p %s: ->"
+ "%25s:%-5d %.*s@%p %s: -> aq = %p, state = %d, audioSessionID = 0x%x"
+ "%25s:%-5d %.*s@%p %s: / bcmd@%p: %s %u of %u frames (status=%s) to offset 0x%x (%p), %d bytes, t=0x%x (0x%x + 0x%x)"
+ "%25s:%-5d %.*s@%p %s: / bcmd@%p: %s %u of %u frames (status=%s) to offset 0x%x (%p), %d bytes, t=0x%x (0x%x + 0x%x) [%s]"
+ "%25s:%-5d %.*s@%p %s: 0x%x"
+ "%25s:%-5d %.*s@%p %s: <-"
+ "%25s:%-5d %.*s@%p %s: <- %d (raw) %d (scaled) fr avail, running=%d, EOS=%d"
+ "%25s:%-5d %.*s@%p %s: <-0x%x/0x%x packets, 0x%x/0x%x bytes%s [buffer %d]"
+ "%25s:%-5d %.*s@%p %s: AQ I/O sample rate zero: client format %s@%f I/O format %s@%f"
+ "%25s:%-5d %.*s@%p %s: AQ Time-stretcher: ionc@%p TimePitchProperty accessed; error %d"
+ "%25s:%-5d %.*s@%p %s: AQ Time-stretcher: ionc@%p TimePitchProperty set %s: %d"
+ "%25s:%-5d %.*s@%p %s: AQ underrun: current sample time %lld; dropping buffer spanning sample times %lld - %lld"
+ "%25s:%-5d %.*s@%p %s: AQAudioCodec received a metadata event with 0 audio frames %p (size= %d)!"
+ "%25s:%-5d %.*s@%p %s: AQAudioCodec received a metadata event with 0 audio frames!"
+ "%25s:%-5d %.*s@%p %s: AQAudioCodec requested to allocate metadata buffers without a memory pool!"
+ "%25s:%-5d %.*s@%p %s: AQBuffer * %p has enqueue count of %d"
+ "%25s:%-5d %.*s@%p %s: AQMetadataAudioConverter %s\n%s"
+ "%25s:%-5d %.*s@%p %s: AQSTL AudioQueueObject(%p)::GetCurrentQueueTime \n ionode now    %s (%.3f); qrate = %.3f \n queue anchor  %lld fr \n queue now     %s (%.3f)"
+ "%25s:%-5d %.*s@%p %s: AULN is permanent, installing (and bypassing for now)"
+ "%25s:%-5d %.*s@%p %s: AddProcessingNode Unable to get IONode for this AudioQueue. %s (err = %d)"
+ "%25s:%-5d %.*s@%p %s: AddProcessingNode failed on %p because it's already running"
+ "%25s:%-5d %.*s@%p %s: Attempt to create a FigCPECryptorRef from the cryptor recipe failed with error:%d"
+ "%25s:%-5d %.*s@%p %s: Audible client: hardcoding content source to kAudioCodecContentSource_Podcast_Audiobook_Traditional for kAudioFormatMPEGD_USAC (xHE-AAC)"
+ "%25s:%-5d %.*s@%p %s: AudioConverterFillComplexBuffer returned %d, packetCount %d"
+ "%25s:%-5d %.*s@%p %s: AudioConverterNew from AudioQueueNew returned %d\nio:    %s\nclient:   %s"
+ "%25s:%-5d %.*s@%p %s: AudioConverterNew returned %d"
+ "%25s:%-5d %.*s@%p %s: AudioConverterNew returned %d\n from: %s\nto:   %s"
+ "%25s:%-5d %.*s@%p %s: AudioIssueDetectorClientInitialize returned error %d"
+ "%25s:%-5d %.*s@%p %s: AudioIssueDetectorClientSetNodeFormat returned error %d"
+ "%25s:%-5d %.*s@%p %s: AudioQueue codec policy %d for audioSessionID 0x%x: session does not permit hardware codecs"
+ "%25s:%-5d %.*s@%p %s: AudioQueue codec policy %d: failed to find a codec of the requested type"
+ "%25s:%-5d %.*s@%p %s: AudioQueue: Error %d from AudioSessionSetClientPlayState(0x%x)"
+ "%25s:%-5d %.*s@%p %s: AudioQueue: request to trim %u + %u = %u frames from buffer containing %u frames"
+ "%25s:%-5d %.*s@%p %s: AudioQueueEnqueueBuffer: invalid attempt to enqueue buffer %d a second time (%d)"
+ "%25s:%-5d %.*s@%p %s: AudioQueueObject(%d)::StartRunning: ERROR: last sample time not set"
+ "%25s:%-5d %.*s@%p %s: AudioQueueObject(%d)::StartRunning: warning: last sample time not set for the audio tap"
+ "%25s:%-5d %.*s@%p %s: AudioQueueSetProperty: %s not supported on this platform"
+ "%25s:%-5d %.*s@%p %s: AudioQueueSetSiriProperty_EnableListening: %d. PlayState: %d"
+ "%25s:%-5d %.*s@%p %s: Cannot both trim and silence %u frames"
+ "%25s:%-5d %.*s@%p %s: Cannot locate requested codec: %s"
+ "%25s:%-5d %.*s@%p %s: Capturing AQ input: %s"
+ "%25s:%-5d %.*s@%p %s: Capturing AQ output on enqueue: %s"
+ "%25s:%-5d %.*s@%p %s: Capturing AQ(%p) output on decode: %s"
+ "%25s:%-5d %.*s@%p %s: Capturing offline AQ: %s"
+ "%25s:%-5d %.*s@%p %s: CheckSpatialization mAutomaticSpatialization=%d, mSpatializationEnabled=%d mContentRequiresAUSpatialMixer=%d mHasMetadata=%d mIsOffline=%d STSLabel valid:%d is stereo: %d"
+ "%25s:%-5d %.*s@%p %s: Considering async stop: recentRenderTime %lld, recentBufferRenderTime %lld, endOfTimeline %lld (latency %d, srScalar %.3f)"
+ "%25s:%-5d %.*s@%p %s: Constructed an AudioConverter for the client %s."
+ "%25s:%-5d %.*s@%p %s: ConvertOutput/SlicePlayer: MarkEndOfStream"
+ "%25s:%-5d %.*s@%p %s: CoreAudioServices/LoudnessManagerV2 feature flag is off, LM AULN disabled"
+ "%25s:%-5d %.*s@%p %s: Could not add processing node err: %ld"
+ "%25s:%-5d %.*s@%p %s: Could not instantiate AQAudioCodec instance for codec: %d!"
+ "%25s:%-5d %.*s@%p %s: Could not instantiate AQMetadataAudioConverter failed to create the underlying AudioConverter: %d"
+ "%25s:%-5d %.*s@%p %s: Could not instantiate requested codec: %s; error %d"
+ "%25s:%-5d %.*s@%p %s: Could not update reporterID to %lld due to error %d"
+ "%25s:%-5d %.*s@%p %s: Couldn't configure AC-3 conversion: %d"
+ "%25s:%-5d %.*s@%p %s: Couldn't get mConverterResetMutex"
+ "%25s:%-5d %.*s@%p %s: Decoder channel layout set to (%s), maximumDecodeChannels=%d"
+ "%25s:%-5d %.*s@%p %s: Deleting"
+ "%25s:%-5d %.*s@%p %s: Destroying AudioQueueObject with present mIONodeConnection"
+ "%25s:%-5d %.*s@%p %s: Entering (0x%x frames requested)"
+ "%25s:%-5d %.*s@%p %s: Error in AudioFormatGetProperty (err=%d, %s), tag=0x%x"
+ "%25s:%-5d %.*s@%p %s: Exiting because 0x%x frames were primed (0x%x were requested)"
+ "%25s:%-5d %.*s@%p %s: Exiting because mConverterError is %d (0x%x req, 0x%x primed)"
+ "%25s:%-5d %.*s@%p %s: Exiting because mPrimeComplete is true (0x%x req, 0x%x primed)"
+ "%25s:%-5d %.*s@%p %s: Failed to apply loudness info: aq = %p, conv = %p, lid = %@, err =  %d\n"
+ "%25s:%-5d %.*s@%p %s: Failed to create AudioIssueDetector"
+ "%25s:%-5d %.*s@%p %s: Failed to set BestAvailableContentType"
+ "%25s:%-5d %.*s@%p %s: Failed to set contentIsAudioOnly"
+ "%25s:%-5d %.*s@%p %s: Failed to set downmix channel layout: %d"
+ "%25s:%-5d %.*s@%p %s: First buffer, will start in 2 I/O cycles (t = 0x%x)"
+ "%25s:%-5d %.*s@%p %s: ForceSoundCheck: %d"
+ "%25s:%-5d %.*s@%p %s: Forcing 7.1.4 decoder for Atmos (mChannelLayout (%s), streamLayout(%s))"
+ "%25s:%-5d %.*s@%p %s: GetCodecOutput: AudioCodecAppendInputData returned %d"
+ "%25s:%-5d %.*s@%p %s: GetIONode_Init failed in SetSTSLabel with %d"
+ "%25s:%-5d %.*s@%p %s: GetParameterList() numparams %d"
+ "%25s:%-5d %.*s@%p %s: GetProposedIOFormat: Before: streamLayout (%s), mChannelLayout (%s), mCodecChannelLayout (%s), maximumDecodeChannels=%d"
+ "%25s:%-5d %.*s@%p %s: Got err %d while getting IO node"
+ "%25s:%-5d %.*s@%p %s: IONode_DeviceStoppedFromBelow"
+ "%25s:%-5d %.*s@%p %s: Input ring buffer returning 0x%x frames of silence (trying to read: %u - %u; current bounds %u - %u) (%d previous warnings suppressed)"
+ "%25s:%-5d %.*s@%p %s: Input ring buffer returning 0x%x frames, t: 0x%x - 0x%x"
+ "%25s:%-5d %.*s@%p %s: Interval-based start after pause: mHostTime=%lld interval=%lld intervals=%f"
+ "%25s:%-5d %.*s@%p %s: Interval-based start: mHostTime=%lld interval=%lld maxIntervals=%lld"
+ "%25s:%-5d %.*s@%p %s: Invalid format (%s) would cause zero-length buffers"
+ "%25s:%-5d %.*s@%p %s: Invalid format (%s) would overflow integer buffer size"
+ "%25s:%-5d %.*s@%p %s: IsInputMutedBecauseDeviceIsRemoteControlled(): %i session: 0x%x"
+ "%25s:%-5d %.*s@%p %s: LM disabled, not looking for SC overrides"
+ "%25s:%-5d %.*s@%p %s: Latency changed from %.6f to %.6f"
+ "%25s:%-5d %.*s@%p %s: LoudnessManager::GetSettings() returned %d (%s): %s"
+ "%25s:%-5d %.*s@%p %s: LoudnessManager::GetSettings() returned %d (%s): disabling LM-AULN"
+ "%25s:%-5d %.*s@%p %s: Netflix client: hardcoding content source to AV_Traditional_Offline for kAudioFormatMPEGD_USAC (xHE-AAC)"
+ "%25s:%-5d %.*s@%p %s: New %s; format %s (passthrough? %s)"
+ "%25s:%-5d %.*s@%p %s: Not enough frames to cover time-pitch zero latency pull (%u) framesAvailable: %lld"
+ "%25s:%-5d %.*s@%p %s: OfflineFOA metadata set (size %ld)"
+ "%25s:%-5d %.*s@%p %s: OfflineFOA: %s"
+ "%25s:%-5d %.*s@%p %s: Overriding max frames from prime to %d"
+ "%25s:%-5d %.*s@%p %s: Passthrough AQ sample rate mismatch: client format %s@%f I/O format %s@%f: %s"
+ "%25s:%-5d %.*s@%p %s: PreflightOfflineRender"
+ "%25s:%-5d %.*s@%p %s: PreflightOfflineRender - failed to query InputPullAheadFrameCount: %d"
+ "%25s:%-5d %.*s@%p %s: PreflightOfflineRender <- %d (scaled) fr avail, running=%d, EOS=%d framesRequired=%lld"
+ "%25s:%-5d %.*s@%p %s: PreflightOfflineRender clientSampleRate %f mixerSampleRate %f inCurrentSampleTime: %lld anchor: %lld queueTimeScaled: %lld framesAvailable(scaled): %lld decodedFrames(unscaled): %lld framesRequired(scaled): %lld framesRequired(unscaled): %lld done decoding: %d recentRenderEndTime(unscaled): %lld scaledLastRenderTime: %lld currentEndOfTimeline(unscaled): %lld scaledEndOfTimeline: %lld mOfflineEndOfStreamSampleTime= %lld unscaledInputSampleTime=%lld pullAheadFramesUnscaled=%u pullAheadFramesScaled=%u sspFramesRemaining=%lld unflushedSamplesFromTimePitch: %lld "
+ "%25s:%-5d %.*s@%p %s: PreflightOfflineRender ran converter %d times. Work queue empty: %d unflushed: %d mAnchorIOSampleTime: %lld"
+ "%25s:%-5d %.*s@%p %s: Prime ignoring recoverable decode error 'bada' (%d frames primed)"
+ "%25s:%-5d %.*s@%p %s: Prime: Exiting because the work queue has reached a %s command (0x%x req, 0x%x primed)"
+ "%25s:%-5d %.*s@%p %s: Processing Node deliver pending parameters: targetSampleTime: %lld mNextIOSampleTime: %lld Anchor: %lld offset: %lld"
+ "%25s:%-5d %.*s@%p %s: ProcessingNodeCancelScheduledParameters: failed on %u err: %d"
+ "%25s:%-5d %.*s@%p %s: ProcessingNodeScheduleParameters: %p invalid timestamp!"
+ "%25s:%-5d %.*s@%p %s: ProcessingNodeScheduleParameters: failed on %u err: %d"
+ "%25s:%-5d %.*s@%p %s: ProcessingNodeScheduleParametersDEBUG: failed on %u err: %d"
+ "%25s:%-5d %.*s@%p %s: Querying output formats for %s, using codec %s"
+ "%25s:%-5d %.*s@%p %s: Queue was still running when re-evaluating spatialization after a route change!"
+ "%25s:%-5d %.*s@%p %s: Queue's formats:\n  i/o format     %s\n  PCM format     %s\n  client format  %s"
+ "%25s:%-5d %.*s@%p %s: Rate1 cannot be set immediately after Rate2 has been committed (current, new rate1: %.2f, %.2f)."
+ "%25s:%-5d %.*s@%p %s: RealClientPIDForInterruptionPurposes %d"
+ "%25s:%-5d %.*s@%p %s: RealClientSession 0x%x"
+ "%25s:%-5d %.*s@%p %s: RemoveProcessingNode failed on %p because it's still running"
+ "%25s:%-5d %.*s@%p %s: SSP::Render: CopySlice returned %d"
+ "%25s:%-5d %.*s@%p %s: ScheduledSliceAllocator %p's AudioConverter:\n%s"
+ "%25s:%-5d %.*s@%p %s: ScheduledSlicePlayer2::ClearSchedule: %d frame imbalance"
+ "%25s:%-5d %.*s@%p %s: ScheduledSlicePlayer_Legacy::ClearSchedule: %d frame imbalance"
+ "%25s:%-5d %.*s@%p %s: SetProperty(kAudioQueueProperty_LoudnessData)"
+ "%25s:%-5d %.*s@%p %s: SetSessionPlayStateToStopped_Deferred(0x%x)"
+ "%25s:%-5d %.*s@%p %s: Setting Atmos decoder to client requested channel layout"
+ "%25s:%-5d %.*s@%p %s: Setting Atmos decoder to output stream channel layout"
+ "%25s:%-5d %.*s@%p %s: Setting Spatial Tracking Label %@ from client"
+ "%25s:%-5d %.*s@%p %s: Starting"
+ "%25s:%-5d %.*s@%p %s: Stopping (wasStarted=%d)"
+ "%25s:%-5d %.*s@%p %s: Tap process not set"
+ "%25s:%-5d %.*s@%p %s: Trying to start an already running queue, that's also interrupted."
+ "%25s:%-5d %.*s@%p %s: Unable to deliver processing node parameters."
+ "%25s:%-5d %.*s@%p %s: Unable to fetch routing behaviors for this AudioQueue. %s"
+ "%25s:%-5d %.*s@%p %s: Unable to get IONode for this AudioQueue. %s (err = %d)"
+ "%25s:%-5d %.*s@%p %s: Updated mAssignedIOSpecifier for Siri injection: %s"
+ "%25s:%-5d %.*s@%p %s: Using (%s) layout for Atmos decoder, streamLayout(%s)"
+ "%25s:%-5d %.*s@%p %s: [1] start host time is %lld; %.3fs from now"
+ "%25s:%-5d %.*s@%p %s: [2] start host time is %lld; %.3fs from now"
+ "%25s:%-5d %.*s@%p %s: ^^^ actual start time %s"
+ "%25s:%-5d %.*s@%p %s: activating=%d, started=%d, paused=%d, interrupted=%d, wasPausedWhenInterrupted=%d, fadeTime=%g, isFading=%d"
+ "%25s:%-5d %.*s@%p %s: adding set loudness command to work queue"
+ "%25s:%-5d %.*s@%p %s: already assigned to submix tap"
+ "%25s:%-5d %.*s@%p %s: apply-custom-aqme-lm-auln-settings is on, configuring LM-AULN from preferences"
+ "%25s:%-5d %.*s@%p %s: aq@%p error %d while passing scheduled parameters to submix tap"
+ "%25s:%-5d %.*s@%p %s: aq@%p: About to perform async command: %s"
+ "%25s:%-5d %.*s@%p %s: aq@%p: sending kAudioQueueProperty_HasDecodeFormatMismatch notification"
+ "%25s:%-5d %.*s@%p %s: aq@%p: unable to dynamically change converter %s format (%d)"
+ "%25s:%-5d %.*s@%p %s: aqc@%p: GetParameter(%d, %f) err = %d"
+ "%25s:%-5d %.*s@%p %s: aqc@%p: SetParameter(%d, %f) err = %d"
+ "%25s:%-5d %.*s@%p %s: associated with %s subsession ref %p, ID %llX"
+ "%25s:%-5d %.*s@%p %s: associated with subsession ref %p, ID %llX"
+ "%25s:%-5d %.*s@%p %s: attempt to set %u channels with IOFormat: %s (kAudioQueueErr_InvalidPropertySize)"
+ "%25s:%-5d %.*s@%p %s: audioSession 0x%x, server pid %d, offline %d, pmset %p, muted %d, subsession muted %d"
+ "%25s:%-5d %.*s@%p %s: automatic spatialization check: spatialize=%d"
+ "%25s:%-5d %.*s@%p %s: being assigned to submix tap %p"
+ "%25s:%-5d %.*s@%p %s: beingInterrupted %d"
+ "%25s:%-5d %.*s@%p %s: bufid %d 0x%x/0x%x bytes, %d/%d packets, mNumPacketDescriptions=%d"
+ "%25s:%-5d %.*s@%p %s: bufid %d, cmd %p, data %p: %u bytes, %d frames (trim %d/%d), %d packets, %s, outActualStartTime %p"
+ "%25s:%-5d %.*s@%p %s: can schedule disposal: %d"
+ "%25s:%-5d %.*s@%p %s: can't assign to submix tap while running"
+ "%25s:%-5d %.*s@%p %s: can't enable AULN, so can't configure from preferences"
+ "%25s:%-5d %.*s@%p %s: can't get audio mode from session, going with default"
+ "%25s:%-5d %.*s@%p %s: cannot enable spatialization.  IO channels (%d) != client channels (%d)"
+ "%25s:%-5d %.*s@%p %s: cannot trim silence"
+ "%25s:%-5d %.*s@%p %s: capability from decoder: 0x%02x required: 0x%02x decision: %s"
+ "%25s:%-5d %.*s@%p %s: cinematic audio latency %.3f s, tail time %.3f s"
+ "%25s:%-5d %.*s@%p %s: cinematic audio: %s"
+ "%25s:%-5d %.*s@%p %s: cinematic mode is on with no codec"
+ "%25s:%-5d %.*s@%p %s: cinematic remix: gaindb = %f, capture loudness = %f, setting linear gain = %f"
+ "%25s:%-5d %.*s@%p %s: cmd %p, flags=%d, t=%lld"
+ "%25s:%-5d %.*s@%p %s: com.apple.coreaudio/apply-custom-loudness-settings is on, configuring codec from preferences"
+ "%25s:%-5d %.*s@%p %s: configuring AULN in addition to codec"
+ "%25s:%-5d %.*s@%p %s: conn %p RunsOnAP %d"
+ "%25s:%-5d %.*s@%p %s: constructor"
+ "%25s:%-5d %.*s@%p %s: content source is now: %d"
+ "%25s:%-5d %.*s@%p %s: content source is now: %u"
+ "%25s:%-5d %.*s@%p %s: conv = %p, isoe = %@, err = %d\n"
+ "%25s:%-5d %.*s@%p %s: conv = %p, lid = %@, err = %d\n"
+ "%25s:%-5d %.*s@%p %s: conv = %p, property = %s, size = %u, err = %d\n"
+ "%25s:%-5d %.*s@%p %s: could not get DRC output params from codec, error %d (%s)"
+ "%25s:%-5d %.*s@%p %s: could not get SourceLoudness from DRC output params dictionary"
+ "%25s:%-5d %.*s@%p %s: could not set loudness, error %d (%s)"
+ "%25s:%-5d %.*s@%p %s: could not set spatial mixer binaural rendering override to %d spatialize=%d"
+ "%25s:%-5d %.*s@%p %s: couldn't apply loudness info, failed to init converter connection err: %d."
+ "%25s:%-5d %.*s@%p %s: couldn't apply loudness info, no ionode."
+ "%25s:%-5d %.*s@%p %s: decode buffer sizes: %u frames, low-water %u, max-decode %u"
+ "%25s:%-5d %.*s@%p %s: disabling AULN"
+ "%25s:%-5d %.*s@%p %s: error %d"
+ "%25s:%-5d %.*s@%p %s: error %d setting kAudioCodecPropertyCurrentOutputFormat to %s"
+ "%25s:%-5d %.*s@%p %s: error allocating buffer"
+ "%25s:%-5d %.*s@%p %s: error getting max frame size %i"
+ "%25s:%-5d %.*s@%p %s: exiting"
+ "%25s:%-5d %.*s@%p %s: failed (%d)"
+ "%25s:%-5d %.*s@%p %s: failed (%d); will stop (%d/%d frames)"
+ "%25s:%-5d %.*s@%p %s: failing due to unspecified session"
+ "%25s:%-5d %.*s@%p %s: failure when %s: %d"
+ "%25s:%-5d %.*s@%p %s: flushing immediately"
+ "%25s:%-5d %.*s@%p %s: format: %s required capability: 0x%02x checking? %s"
+ "%25s:%-5d %.*s@%p %s: found AULN config, configuring AULN"
+ "%25s:%-5d %.*s@%p %s: found codec config, configuring codec"
+ "%25s:%-5d %.*s@%p %s: found override SC max peak level in plist: %f"
+ "%25s:%-5d %.*s@%p %s: found override SC target loudness in plist: %f"
+ "%25s:%-5d %.*s@%p %s: framesAvailable after decoding %d"
+ "%25s:%-5d %.*s@%p %s: gets mOutputSource %p"
+ "%25s:%-5d %.*s@%p %s: got AQIONode::Description of: %s"
+ "%25s:%-5d %.*s@%p %s: got audio mode from session: %s"
+ "%25s:%-5d %.*s@%p %s: got null AQIONode::Description"
+ "%25s:%-5d %.*s@%p %s: hardware not supported, Loudness Manager disabled"
+ "%25s:%-5d %.*s@%p %s: inCurrentSampleTime = %lld, mOfflineEndOfStreamSampleTime = %lld"
+ "%25s:%-5d %.*s@%p %s: input queue, returning immediately"
+ "%25s:%-5d %.*s@%p %s: internally handling dynamic routing behavior change"
+ "%25s:%-5d %.*s@%p %s: invalid buffer ID"
+ "%25s:%-5d %.*s@%p %s: invalid buffer size"
+ "%25s:%-5d %.*s@%p %s: ionode %p"
+ "%25s:%-5d %.*s@%p %s: ionode@%p, enqueueing %d samples of silence"
+ "%25s:%-5d %.*s@%p %s: is sound check enabled? %s"
+ "%25s:%-5d %.*s@%p %s: is the CoreAudioServices/LoudnessManager fflag enabled? %s"
+ "%25s:%-5d %.*s@%p %s: is the CoreAudioServices/LoudnessManagerV2 fflag enabled? %s"
+ "%25s:%-5d %.*s@%p %s: is the CoreAudioServices/LoudnessManagerV3 fflag enabled? %s"
+ "%25s:%-5d %.*s@%p %s: is the CoreAudioServices/lm-disable-hardware-check preference on? %s"
+ "%25s:%-5d %.*s@%p %s: is the hardware supported? %s"
+ "%25s:%-5d %.*s@%p %s: kAudioCodecPrivatePropertyMaximumMetadataFrameByteSize getinfo failed"
+ "%25s:%-5d %.*s@%p %s: kAudioCodecPropertySupportedOutputFormats getinfo failed"
+ "%25s:%-5d %.*s@%p %s: kAudioCodecPropertySupportedOutputFormats getproperty failed"
+ "%25s:%-5d %.*s@%p %s: kCMSession_AudioQueueOptionsKey_IsMuted returns %d for subsession ref=%p"
+ "%25s:%-5d %.*s@%p %s: last rate change at %lld, ignoring out-of-order new one at %lld"
+ "%25s:%-5d %.*s@%p %s: lm-set-content-source-to-av is on: hardcoding content source to AV_Traditional_Offline for all formats"
+ "%25s:%-5d %.*s@%p %s: mClientMaxPacketSize = %d"
+ "%25s:%-5d %.*s@%p %s: mInterrupted %d"
+ "%25s:%-5d %.*s@%p %s: mNextIOSampleTime %lld, mAnchorIOSampleTime %lld, mPauseSampleTime %lld"
+ "%25s:%-5d %.*s@%p %s: map buf %d"
+ "%25s:%-5d %.*s@%p %s: mixing to %d bits, %s quality"
+ "%25s:%-5d %.*s@%p %s: no AULN config found, disabling AULN"
+ "%25s:%-5d %.*s@%p %s: no codec config found, resetting codec config"
+ "%25s:%-5d %.*s@%p %s: no codec output formats!"
+ "%25s:%-5d %.*s@%p %s: no ionode, can not install AULN"
+ "%25s:%-5d %.*s@%p %s: no ionode, unable to set loudness in cinematic mode"
+ "%25s:%-5d %.*s@%p %s: no loudness info available, can't override SC properties"
+ "%25s:%-5d %.*s@%p %s: no matching codec output format"
+ "%25s:%-5d %.*s@%p %s: nothing to silence"
+ "%25s:%-5d %.*s@%p %s: null LID passed in, using cached: %p"
+ "%25s:%-5d %.*s@%p %s: offline queue, resetting codec and disabling LM-AULN"
+ "%25s:%-5d %.*s@%p %s: outparaminfo %d %f err = %d"
+ "%25s:%-5d %.*s@%p %s: passthrough queue, returning immediately"
+ "%25s:%-5d %.*s@%p %s: port/transport type %d device subcategory %d"
+ "%25s:%-5d %.*s@%p %s: procNode:%d timestamp:%s targetSampleTime: %lld  anchor st: %lld  mLastIOSampleTime: %lld mNextIOSampleTime: %lld"
+ "%25s:%-5d %.*s@%p %s: queue must be stopped before switching to offline mode, is currently %s!"
+ "%25s:%-5d %.*s@%p %s: rate change: %lld = %lld scaled, rate %.3f"
+ "%25s:%-5d %.*s@%p %s: rate2 scheduling not enabled; ignoring event"
+ "%25s:%-5d %.*s@%p %s: reporterID=%lld"
+ "%25s:%-5d %.*s@%p %s: resetting codec"
+ "%25s:%-5d %.*s@%p %s: scheduling rate change at unscaled t=%lld, but we previously did a conversion for t=%lld"
+ "%25s:%-5d %.*s@%p %s: scheduling rationale %d: %s"
+ "%25s:%-5d %.*s@%p %s: session category '%s' not supported"
+ "%25s:%-5d %.*s@%p %s: session category '%s' supported"
+ "%25s:%-5d %.*s@%p %s: session mode '%s' not supported"
+ "%25s:%-5d %.*s@%p %s: session mode '%s' supported"
+ "%25s:%-5d %.*s@%p %s: set content source from content type: %u flags: 0x%04x"
+ "%25s:%-5d %.*s@%p %s: set content source from media kind: %s"
+ "%25s:%-5d %.*s@%p %s: set mEnqueueAnchorTime.mSampleTime to 0x%x"
+ "%25s:%-5d %.*s@%p %s: setting loudness immediately, since the queue is not running."
+ "%25s:%-5d %.*s@%p %s: spatialization %s, %s. Format %s"
+ "%25s:%-5d %.*s@%p %s: starting"
+ "%25s:%-5d %.*s@%p %s: t=%lld, reqFrames=%u, actualBytes=%d, actualFrames=%d"
+ "%25s:%-5d %.*s@%p %s: unable to get session category"
+ "%25s:%-5d %.*s@%p %s: unable to get session mode"
+ "%25s:%-5d %.*s@%p %s: unmap buf %d"
+ "%25s:%-5d %.*s@%p %s: unsupported hardware, disabling codec compression"
+ "%25s:%-5d %.*s@%p %s: unsupported hardware, supported under LMV3"
+ "%25s:%-5d %.*s@%p %s: updating issue detector %lld with reporting session %lld"
+ "%25s:%-5d %.*s@%p %s: using AQMetadataAudioConverter"
+ "%25s:%-5d %.*s@%p %s: using AULN for loudness control, resetting codec config"
+ "%25s:%-5d %.*s@%p %s: using codec for loudness control"
+ "%25s:%-5d %.*s@%p %s: volume %.3f %.3f %.3f %.3f %.3f %.3f, %.3f"
+ "%25s:%-5d %s: ERROR: Rejecting custom audio event declaring %llu frames of %u bytes against a %llu byte waveform"
+ "%25s:%-5d %s: ERROR: Rejecting custom audio event with invalid format ASBD: %s"
+ "%25s:%-5d %s: Error %d querying envelope for event with ID %u"
+ "%25s:%-5d %s: Event with ID %u contains%s default envelope"
+ "%25s:%-5d %s: Event with ID %u has attack time %.2fs"
+ "%25s:%-5d %s: Storing raw release time %f for layer %u"
+ "%25s:%-5d %s: eventID %u (layer %u) has no stored raw release time"
+ "%25s:%-5d %s: eventID %u (layer %u) has raw release time %f"
+ "%25s:%-5d %s: eventID %u does not resolve to a layer, no raw release time"
+ "%25s:%-5d AQOfflineMixer(%p): capturing post-encode: %s"
+ "%25s:%-5d AQOfflineMixer(%p): capturing pre-encode: %s"
+ "%25s:%-5d AQOfflineMixer(%p): could not start post-encode capture for %s; disabling it"
+ "%25s:%-5d AQOfflineMixer(%p): could not start pre-encode capture for %s; disabling it"
+ "%25s:%-5d Audio capture preference '%s' cannot be used together with '%s'; ignoring '%s'."
+ "%25s:%-5d AudioCapture is unavailable; audio captures are disabled."
+ "%25s:%-5d AudioCaptureInitialize failed; audio captures are disabled."
+ "%25s:%-5d Can not enable MEMixerChannel time/pitch captures at this time due to VP."
+ "%25s:%-5d Could not create audio capturer for '%s'."
+ "%25s:%-5d Could not create encoded audio capturer for '%s'."
+ "%25s:%-5d Could not re-create audio capturer for '%s' on flush."
+ "%25s:%-5d Could not start AC3 output capture"
+ "%25s:%-5d Could not start audio capture"
+ "%25s:%-5d Could not start haptic output capture"
+ "%25s:%-5d Could not successfully allocate magic cookie buffer"
+ "%25s:%-5d Could not successfully allocate packet table"
+ "%25s:%-5d EXCEPTION (%d): \"\""
+ "%25s:%-5d SetLoudnessFromLM(): is the CoreAudioServices/LoudnessManager fflag enabled? %s"
+ "%25s:%-5d SetLoudnessFromLM(): is the CoreAudioServices/LoudnessManagerV2 fflag enabled? %s"
+ "%25s:%-5d SetLoudnessFromLM(): is the CoreAudioServices/lm-disable-hardware-check preference on? %s"
+ "%25s:%-5d SetLoudnessFromLM(): is the hardware supported? %s"
+ "%25s:%-5d [static] %s:   aq@%p: FlushPending, end of stream"
+ "%25s:%-5d [static] %s:   aq@%p: done with buffer cmd %p"
+ "%25s:%-5d [static] %s:   aq@%p: mFirstPostFlushBufferTimestamp %s"
+ "%25s:%-5d [static] %s:   aq@%p: no more buffers"
+ "%25s:%-5d [static] %s:   aq@%p: supplied %d packets, 0x%x bytes @ %p"
+ "%25s:%-5d [static] %s: *** AudioQueue ignoring hardware codecs (aq_ignorehwcodecs pref set) ***"
+ "%25s:%-5d [static] %s: Error creating AQTapIONode for binding: %s, tap specifier: %s"
+ "%25s:%-5d [static] %s: GetHardwarePlatformKey(): hardware platform key is %s"
+ "%25s:%-5d [static] %s: LM AULN is permanent, bypassing"
+ "%25s:%-5d [static] %s: LM AULN is permanent, un-bypassing"
+ "%25s:%-5d [static] %s: LM AULN permanence is set from fflag: %s"
+ "%25s:%-5d [static] %s: LM AULN permanence is set from lm-auln-is-permanent: %s"
+ "%25s:%-5d [static] %s: LMV3 is off; defeating normalisation for APAC AV content over BT|LineOut|USB|HDMI"
+ "%25s:%-5d [static] %s: Siri entitlement check failed"
+ "%25s:%-5d [static] %s: SiriUseInjectionOutputDevice entitlement check failed"
+ "%25s:%-5d [static] %s: SiriUseInjectionOutputDevice is only allowed in internal builds"
+ "%25s:%-5d [static] %s: applying settings to aqc%p"
+ "%25s:%-5d [static] %s: aq@%p: ->%d fr, %d bytes @ t=%lld fr"
+ "%25s:%-5d [static] %s: aq@%p: ConnectToOfflineMixer %p"
+ "%25s:%-5d [static] %s: aq@%p: end of flushing input"
+ "%25s:%-5d [static] %s: can not determine content source"
+ "%25s:%-5d [static] %s: cannot get acoustic ID"
+ "%25s:%-5d [static] %s: client is running, can't disable the LM AULN, defaulting its config"
+ "%25s:%-5d [static] %s: client is running, can't enable the LM AULN"
+ "%25s:%-5d [static] %s: codec.GetProperty(kAudioCodecPrivatePropertyContentOrigin) returns unknown OS type: %d, defaulting"
+ "%25s:%-5d [static] %s: could not determine embedded platform type, going with default"
+ "%25s:%-5d [static] %s: could not find top level 'Format' key in plist"
+ "%25s:%-5d [static] %s: could not set DRC compression profile, setting DRC mode to %d"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPrivatePropertyAdjustLoudnessNormalizationLimit, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPrivatePropertyAdjustMomentaryLoudnessLimit, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPrivatePropertyAdjustPeakLevelMax, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPrivatePropertyAdjustTargetLevel, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPrivatePropertyAdjustTargetLevelConstant, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPropertyAdjustCompressorBoostFactor, err = %d (%s)"
+ "%25s:%-5d [static] %s: could not set kAudioCodecPropertyAdjustCompressorCutFactor, err = %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_AlgorithmVersion, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_DownwardCompressionRange, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_DownwardCompressionRatio, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_EnableCompressor, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_EnableOutputCeiling, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_InputGain, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_LookaheadDelayMS, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_LoudnessAfterReset, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_LoudnessTarget, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_MaxGain, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_OutputCeiling, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_OutputGain, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_PeakLevelOffset, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_RenderQuality, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_ResetMode, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_ResetTimeout, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_SideChainHighPassFrequency, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_UpwardCompressionRange, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_UseDownwardCompressionRateio, error %d (%s)"
+ "%25s:%-5d [static] %s: could not set kMELMLoudnessNormalizerProperty_WeightingFilter, error %d (%s)"
+ "%25s:%-5d [static] %s: could set neither compression profile nor DRC mode"
+ "%25s:%-5d [static] %s: disabling normalisation target"
+ "%25s:%-5d [static] %s: disabling the LM AULN"
+ "%25s:%-5d [static] %s: enabling the LM AULN"
+ "%25s:%-5d [static] %s: found acoustic ID: %d"
+ "%25s:%-5d [static] %s: found default dictionary for encoder OS type"
+ "%25s:%-5d [static] %s: found default dictionary for hardware platform"
+ "%25s:%-5d [static] %s: found default dictionary for late night / sound check"
+ "%25s:%-5d [static] %s: found default dictionary for media format"
+ "%25s:%-5d [static] %s: found default dictionary for media type"
+ "%25s:%-5d [static] %s: found default dictionary for route"
+ "%25s:%-5d [static] %s: found dictionary for media format: %s"
+ "%25s:%-5d [static] %s: getActiveOutputPortType() returns unknown type: %d (%s), defaulting route key"
+ "%25s:%-5d [static] %s: got audio mode from session: %s"
+ "%25s:%-5d [static] %s: invalid compression profile: %d"
+ "%25s:%-5d [static] %s: lm-configure-both-codec-and-auln is on: will configure both codec and AULN from prefs"
+ "%25s:%-5d [static] %s: lm-set-content-source-to-av is on: hardcoding content source to AV_Traditional_Offline for all formats"
+ "%25s:%-5d [static] %s: looking for hardware platform: %s"
+ "%25s:%-5d [static] %s: looking for late night / soundcheck key: %s"
+ "%25s:%-5d [static] %s: looking for media format: '%s'"
+ "%25s:%-5d [static] %s: looking for media type and encoder OS and version: %d (%s) %s %d.%d"
+ "%25s:%-5d [static] %s: looking for route: %s"
+ "%25s:%-5d [static] %s: no codec, cannot apply codec loudness properties"
+ "%25s:%-5d [static] %s: no codec, cannot apply codec loudness properties from properties"
+ "%25s:%-5d [static] %s: no dictionary (or default) for encoder OS version: %s %d.%d"
+ "%25s:%-5d [static] %s: no dictionary for encoder OS type: %s"
+ "%25s:%-5d [static] %s: no dictionary for hw platform: %s"
+ "%25s:%-5d [static] %s: no dictionary for media type: %s"
+ "%25s:%-5d [static] %s: no dictionary for route: %s"
+ "%25s:%-5d [static] %s: no ionode, can't disable the LM AULN"
+ "%25s:%-5d [static] %s: no ionode, can't enable the LM AULN"
+ "%25s:%-5d [static] %s: no ionode: can not set LM AULN properties"
+ "%25s:%-5d [static] %s: no ionode: can not set LM AULN properties from preferences"
+ "%25s:%-5d [static] %s: no plist loaded, disallowing hardware"
+ "%25s:%-5d [static] %s: parse of LoudnessManager plist failed with no error code"
+ "%25s:%-5d [static] %s: parse of LoudnessManager plist failed: error %d: %s"
+ "%25s:%-5d [static] %s: parse of LoudnessManager plist failed: error %d: no reason available"
+ "%25s:%-5d [static] %s: setting DRC compression profile to %d"
+ "%25s:%-5d [static] %s: setting Dolby DRC control mode to %d"
+ "%25s:%-5d [static] %s: setting LM AULN algorithm version to %f"
+ "%25s:%-5d [static] %s: setting LM AULN downward compression range to %f"
+ "%25s:%-5d [static] %s: setting LM AULN downward compression ratio to %f"
+ "%25s:%-5d [static] %s: setting LM AULN enable compressor to %f"
+ "%25s:%-5d [static] %s: setting LM AULN enable output ceiling to %f"
+ "%25s:%-5d [static] %s: setting LM AULN input gain to %f"
+ "%25s:%-5d [static] %s: setting LM AULN lookahead delay ms to %f"
+ "%25s:%-5d [static] %s: setting LM AULN loudness after reset to %f"
+ "%25s:%-5d [static] %s: setting LM AULN loudness target to %f"
+ "%25s:%-5d [static] %s: setting LM AULN max gain to %f"
+ "%25s:%-5d [static] %s: setting LM AULN output ceiling to %f"
+ "%25s:%-5d [static] %s: setting LM AULN output gain to %f"
+ "%25s:%-5d [static] %s: setting LM AULN peak level offset to %f"
+ "%25s:%-5d [static] %s: setting LM AULN render quality to %f"
+ "%25s:%-5d [static] %s: setting LM AULN reset mode to %f"
+ "%25s:%-5d [static] %s: setting LM AULN reset timeout to %f"
+ "%25s:%-5d [static] %s: setting LM AULN sidechain highpass frequency to %f"
+ "%25s:%-5d [static] %s: setting LM AULN upward compression range to %f"
+ "%25s:%-5d [static] %s: setting LM AULN use downward compression ratio (not range) to %d"
+ "%25s:%-5d [static] %s: setting LM AULN weighting filter to %f"
+ "%25s:%-5d [static] %s: setting compression profile to %d"
+ "%25s:%-5d [static] %s: setting compressor cut/boost factors to zero"
+ "%25s:%-5d [static] %s: setting momentary limit to %f"
+ "%25s:%-5d [static] %s: setting normalisation target to %f"
+ "%25s:%-5d [static] %s: setting normalization gain limit to %f"
+ "%25s:%-5d [static] %s: setting peak level to %f"
+ "%25s:%-5d [static] %s: unable to make URL for LoudnessManager plist file path"
+ "%25s:%-5d [static] %s: unable to open stream for LoudnessManager plist"
+ "%25s:%-5d [static] %s: unknown content source: %d, defaulting"
+ "%25s:%-5d [static] %s: unrecognised compression profile string: '%s'"
+ "%25s:%-5d [static] %s: unrecognised compression profile type ID: %lu"
+ "%25s:%-5d [static] %s: unsupported hardware, not enabling the LM AULN"
+ "%25s:%-5d setting kMELMLoudnessNormalizerProperty_Enable failed with error: %d"
+ "(notify_register_dispatch(\"com.apple.accessibility.hac.status\", &token, AudioControlQueue(), ^(int token) { AT::ScopedACQBlock scopedACQBlock(\"notify_register_dispatch\", __func__, \"DSP_Routing_VP.cpp\" , 501); do { auto logobj = CALog::LogObjIfEnabled(5, gAQMELogScope); if (logobj) __extension__({ os_log_t _log_tmp = ((logobj)); os_log_type_t _type_tmp = (OS_LOG_TYPE_DEBUG); if (os_log_type_enabled(_log_tmp, _type_tmp)) { __extension__({ _Pragma(\"clang diagnostic push\") _Pragma(\"clang diagnostic ignored \\\"-Wvla\\\"\") _Pragma(\"clang diagnostic error \\\"-Wformat\\\"\") _Static_assert(__builtin_constant_p(\"%25s:%-5d \" \"HACStatusChanged %p\"), \"format/label/description argument must be a string constant\"); __attribute__((section(\"__TEXT,__oslogstring,cstring_literals\"),internal_linkage)) static const char _os_fmt_str[] __asm(\"LOS_LOG888\") = \"%25s:%-5d \" \"HACStatusChanged %p\"; __attribute__((stack_protector_ignore)) uint8_t _Alignas(16) __attribute__((uninitialized)) _os_fmt_buf[__builtin_os_log_format_buffer_size(\"%25s:%-5d \" \"HACStatusChanged %p\", \"DSP_Routing_VP.cpp\", 502, gInstance.load())]; _os_log_impl(&__dso_handle, _log_tmp, _type_tmp, _os_fmt_str, (uint8_t *)__builtin_os_log_format(_os_fmt_buf, \"%25s:%-5d \" \"HACStatusChanged %p\", \"DSP_Routing_VP.cpp\", 502, gInstance.load()), (uint32_t)sizeof(_os_fmt_buf)) _Pragma(\"clang diagnostic pop\"); }); } }); } while (0); std::unique_lock locker1(mgr.GetMutex()); if (gInstance) { gInstance.load()->mParent.TriggerAdaptToDevice(); } })) == 0"
...
+ "AQAudioCodec::AQAudioCodec(int, const CAStreamBasicDescription &, const CAStreamBasicDescription &, const AudioClassDescription &, std::shared_ptr<MetadataMemoryPool>, bool, OSStatus &)"
+ "AQAudioConverter::AQAudioConverter(int, AudioConverterRef, const std::string &)"
+ "AQConverterOrCodec"
+ "AQMetadataAudioConverter::AQMetadataAudioConverter(int, AudioConverterRef, std::shared_ptr<MetadataMemoryPool>, bool, const std::string &)"
+ "ApplyCodecLoudnessProperties"
+ "ApplyCodecLoudnessPropertiesFromPreferences"
+ "ApplyLMAULNLoudnessProperties"
+ "ApplyLMAULNLoudnessPropertiesFromPreferences"
+ "Argo"
+ "Audible"
+ "AudioCapturerManager.cpp"
+ "AudioChannelLayoutTag AudioQueueObject::GetUpdatedAudioChannelLayoutTagFromDescriptionsOrBitmap(const CA::ChannelLayout &)"
+ "AudioQueueObject::AudioQueueObject(AQIONodeManager &, bool, const AudioStreamBasicDescription &, UInt32, std::shared_ptr<AQ::Server::RemoteClientBase>, AudioQueueOwner *, const AQMESession &, audit_token_t, OSStatus &)"
+ "AudioQueueObject::EConvertOutputStatus AudioQueueObject::ConvertOutput(ConverterConnection *, AQBufferCommand *, int, bool)"
+ "AudioQueueObject::WorkQueue::CheckAsyncCommandReturn AudioQueueObject::WorkQueue::CheckAsyncCommand(bool)"
+ "ClientInput"
+ "ClientOutput"
+ "CodecProcessingBlockItem"
+ "CodecProcessingBlockItem::CodecProcessingBlockItem(AQConverterOrCodec *)"
+ "Compression Profile"
+ "ConfigureBothCodecAndAULN"
+ "DRC Mode"
+ "DisableLMAULN"
+ "EClientRoutingBehaviorFlags AudioQueueObject::AudioSessionStateChanged(bool, UInt32, CFDictionaryRef)"
+ "EnableLMAULN"
+ "Expected<ATAudioProcessingNodeConnectionInfo> AudioQueueObject::AddProcessingNode(AudioComponentDescription, uint32_t, aqprocnode_t &)"
+ "GetParameterInfo"
+ "GetParameterList"
+ "IONode_RouteChanged_block_invoke_5"
+ "IsLMAULNPermanent"
+ "LoudnessManagerV3"
+ "Max Peak Level"
+ "Momentary Loudness Limit"
+ "Normalisation Gain Limit"
+ "OSStatus AQAudioCodec::CheckInitialize()"
+ "OSStatus AQAudioCodec::FillComplexBuffer_ProduceOutputPackets(AudioConverterComplexInputDataProc, void *, UInt32 *, AudioBufferList *, AudioStreamPacketDescription *)"
+ "OSStatus AQAudioCodec::PullInput(AudioBufferList &, AudioConverterComplexInputDataProc, void *, UInt32, UInt32)"
+ "OSStatus AudioQueueObject::AQRateChangeHistory::SetRate1Immediate(Float32)"
+ "OSStatus AudioQueueObject::AcquirePlayResources()"
+ "OSStatus AudioQueueObject::AssignToSubmixTap(SubmixTapObject *)"
+ "OSStatus AudioQueueObject::BeginPause(XSampleTime &, bool)"
+ "OSStatus AudioQueueObject::ChooseCodec(UInt32)"
+ "OSStatus AudioQueueObject::ConnectToIONodeEffects(AQIONode &)"
+ "OSStatus AudioQueueObject::ConverterConnection::ApplyCachedCodecProperties(const std::unordered_map<UInt32, std::vector<Byte>> &)"
+ "OSStatus AudioQueueObject::ConverterConnection::ApplyCookie(CFDataRef)"
+ "OSStatus AudioQueueObject::ConverterConnection::ApplyCryptor(CFTypeRef)"
+ "OSStatus AudioQueueObject::ConverterConnection::ApplyISOExtendedInfo(CFDictionaryRef)"
+ "OSStatus AudioQueueObject::ConverterConnection::ApplyLoudnessInfo(CFDictionaryRef)"
+ "OSStatus AudioQueueObject::ConverterConnection::BuildConverter(const std::string &)"
+ "OSStatus AudioQueueObject::DoIONodeConnect(bool)"
+ "OSStatus AudioQueueObject::EndPause(const XAudioTimeStamp *, bool, UInt32, std::optional<UInt64>, std::optional<UInt64>)"
+ "OSStatus AudioQueueObject::EnqueueBuffer(AudioQueueBufferRef, UInt32, const AudioStreamPacketDescription *, int32_t, int32_t, UInt32, AudioQueueParameterEvent *, const XAudioTimeStamp &, XAudioTimeStamp *)"
+ "OSStatus AudioQueueObject::EnqueueSilence(UInt32, int64_t)"
+ "OSStatus AudioQueueObject::GetCodecOutputFormats()"
+ "OSStatus AudioQueueObject::GetCurrentQueueTime(timeline_t, XAudioTimeStamp &, bool &)"
+ "OSStatus AudioQueueObject::IONodeConnection::IO_ChangeIOFormat()"
+ "OSStatus AudioQueueObject::IONodeConnection::SetIONode(const std::shared_ptr<AQIONode> &)"
+ "OSStatus AudioQueueObject::OfflineRender(const XAudioTimeStamp &, AudioQueueBufferRef, UInt32, std::vector<aqbuffer_t> &)"
+ "OSStatus AudioQueueObject::PerformFlush()"
+ "OSStatus AudioQueueObject::PreflightOfflineRenderV1(Float64, SInt64, UInt32, UInt32 *, Boolean *, Boolean *)"
+ "OSStatus AudioQueueObject::PreflightOfflineRenderV2(Float64, SInt64, UInt32, UInt32 *, Boolean *, Boolean *)"
+ "OSStatus AudioQueueObject::Prime(UInt32, UInt32 &)"
+ "OSStatus AudioQueueObject::ProcessingNodeCancelScheduledParameters(aqprocnode_t)"
+ "OSStatus AudioQueueObject::ProcessingNodeDeliverPendingParameters()"
+ "OSStatus AudioQueueObject::ProcessingNodeScheduleParameters(aqprocnode_t, const XAudioTimeStamp &, UInt32, const ATAudioProcessingNodeParameterID *, const ATAudioProcessingNodeParameterValue *)"
+ "OSStatus AudioQueueObject::RemoveProcessingNode(aqprocnode_t)"
+ "OSStatus AudioQueueObject::Reset(bool)"
+ "OSStatus AudioQueueObject::ResetSubsessionMute()"
+ "OSStatus AudioQueueObject::ScheduleFlush()"
+ "OSStatus AudioQueueObject::ScheduleParameters(const XAudioTimeStamp &, UInt32, const AudioQueueParameterID *, const AudioQueueParameterValue *)"
+ "OSStatus AudioQueueObject::SetOfflineRenderFormat(const AudioStreamBasicDescription *, const AudioChannelLayout *, AQOfflineMixerBase *)"
+ "OSStatus AudioQueueObject::SetProperty(AudioQueuePropertyID, CADeserializer &)"
+ "OSStatus AudioQueueObject::StartRunning(AQIONode *)"
+ "OSStatus AudioQueueObject::Stop(bool, bool, StopStatus *)"
+ "OSStatus AudioQueueObject::_Start(const XAudioTimeStamp &, UInt32, std::optional<UInt64>, std::optional<UInt64>)"
+ "OSStatus QueueAccessor::SetSessionPlayState(AVAudioSessionClientPlayState, ATAudioSessionDuckingInfo *)"
+ "OSStatus RemoteIOClient::Initialize(int32_t, AudioStreamBasicDescription &, AudioStreamBasicDescription &, CA::ChannelLayout &, CA::ChannelLayout &, UInt32 &, SharableMemoryBlock::MachServerToken &, SharableMemoryBlock::MachServerToken &)"
+ "PRECONDITION FAILURE (std::logic_error)"
+ "Podcast_Audiobook_Spatial"
+ "Podcast_Audiobook_Traditional"
+ "ServerInput"
+ "ServerOutput"
+ "SetCodecDRCCompressionProfile"
+ "SetCodecLoudnessNormalizationTarget"
+ "SetCodecMomentaryLoudnessLimit"
+ "SetCodecNormalizationGainLimit"
+ "SetCodecOutputPeakLevelMax"
+ "SetContentSourceFromISOContentType"
+ "SetContentSourceFromMediaKind"
+ "SetDolbyCodecDynamicRangeControlMode"
+ "Target Loudness"
+ "UInt32 AudioQueueObject::SetDecoderChannelLayout(AudioChannelLayoutTag)"
+ "XSampleTime AudioQueueObject::ProcessingNodeGetTargetIONodeSampleTime(const XAudioTimeStamp &, AQIONode &)"
+ "aq_enq"
+ "aq_input"
+ "aqme_captureobjectmix"
+ "aqout-{:#x}"
+ "aurio_capture"
+ "aurio_capture_ring_buffer_mode"
+ "auto AudioQueueObject::PreflightOfflineRenderV2(Float64, SInt64, UInt32, UInt32 *, Boolean *, Boolean *)::(anonymous class)::operator()(bool) const"
+ "auto ScheduledSlicePlayer2::Render(const XAudioTimeStamp &, int, AudioBufferList &, bool)::(anonymous class)::operator()() const"
+ "bool AudioQueueObject::AQRateChangeHistory::AppendRateChange(RateSchedule &, XSampleTime, double)"
+ "bool AudioQueueObject::CanFlushImmediately()"
+ "bool AudioQueueObject::CanScheduleDisposal() const"
+ "bool AudioQueueObject::ConverterConnection::DecoderHandlesDRC(UInt32) const"
+ "bool AudioQueueObject::RunConverter(int, bool)"
+ "bool AudioQueueObject::SetLoudnessFromLM(ConverterConnection *, CFDictionaryRef)"
+ "bool AudioQueueObject::StartFade(bool, Float32, Float32)"
+ "client-{}"
+ "getRawEventReleaseTime"
+ "int AudioQueueObject::ConvertInput(ConverterConnection *, AQBufferCommand *, UInt32 &, bool, bool)"
+ "library loudness"
+ "lm-auln-is-permanent"
+ "lm-configure-both-codec-and-auln"
+ "lm-set-content-source-to-av"
+ "offpost-{}"
+ "offpre-{}"
+ "queryEventEnvelope"
+ "setRawLayerReleaseTime"
+ "std::pair<XSampleTime, XSampleTime> AudioQueueObject::GetTimePitchUnflushedFrames(const Float64, const Float64, const XSampleTime, AQIONode &)"
+ "timepitch-{}"
+ "unsigned int AudioQueueObject::InputRingBuffer::AQFetch(bool, unsigned int, AudioBufferList &, SampleTime &, bool &)"
+ "virtual AudioQueueObject::~AudioQueueObject()"
+ "virtual CA::StreamDescription AudioQueueObject::GetProposedIOFormat(const CA::StreamDescription &, bool)"
+ "virtual Expected<AQMESession> AT::SessionFacade::Manager::sessionForNewAPIObject(pid_t, AudioSessionID)"
+ "virtual OSStatus AQAudioCodec::SetProperty(AudioConverterPropertyID, UInt32, const void *)"
+ "virtual OSStatus CodecProcessingBlockItem::GetParameter(AudioUnitParameterID, AudioUnitScope, AudioUnitElement, AudioUnitParameterValue *)"
+ "virtual OSStatus CodecProcessingBlockItem::GetParameterInfo(AudioUnitScope, AudioUnitParameterID, AudioUnitParameterInfo &)"
+ "virtual OSStatus CodecProcessingBlockItem::GetParameterList(AudioUnitScope, AudioUnitParameterID *, UInt32 &)"
+ "virtual OSStatus CodecProcessingBlockItem::SetParameter(AudioUnitParameterID, AudioUnitScope, AudioUnitElement, AudioUnitParameterValue)"
+ "virtual void AQAudioCodec::LogDescription(const char *)"
+ "virtual void AQAudioConverter::LogDescription(const char *)"
+ "virtual void AQMetadataAudioConverter::LogDescription(const char *)"
+ "virtual void AudioQueueObject::ApplyParameters(AQIONode &)"
+ "virtual void AudioQueueObject::CheckConnectionAndIOFormats(SInt32)"
+ "virtual void AudioQueueObject::IONode_DeviceStoppedFromBelow(bool)"
+ "virtual void AudioQueueObject::IONode_FormatChanged(UInt32, AQIONodeFormatChangeFlags)"
+ "virtual void ScheduledSlicePlayer2::ClearSchedule()"
+ "virtual void ScheduledSlicePlayer_Legacy::ClearSchedule()"
+ "void AQAudioCodec::AllocateBuffersForMetadata(AudioBufferList *, const AudioCodec &, UInt32)"
+ "void AQAudioCodec::ClearUnusedMetadataBuffers(AudioBufferList *)"
+ "void AQConverterManager::AQConverterThread::Run()"
+ "void AQMetadataAudioConverter::AllocateBuffersForMetadata(AudioBufferList *, UInt32)"
+ "void AQMetadataAudioConverter::ClearUnusedMetadataBuffers(AudioBufferList *)"
+ "void AudioQueueObject::ApplyLoudnessInfo(bool, bool)"
+ "void AudioQueueObject::CheckSpatialization(AQIONode *)"
+ "void AudioQueueObject::CheckSpatializationAfterRouteChange()"
+ "void AudioQueueObject::ConverterConnection::AdaptToFormats()"
+ "void AudioQueueObject::ConverterConnection::CheckChangeDecodeFormat()"
+ "void AudioQueueObject::ExamineScheduledParams(const XAudioTimeStamp &, unsigned int, AudioQueueParameterEvent *, AQIONode &)"
+ "void AudioQueueObject::FlushPendingInput(bool, bool)"
+ "void AudioQueueObject::LatencyChanged()"
+ "void AudioQueueObject::PerformTrimming(AudioBufferList &, UInt32 &, AudioRingAllocator::Range &, int)"
+ "void AudioQueueObject::PropertyChanged(AudioQueuePropertyID, bool)"
+ "void AudioQueueObject::Queue_ChangeIOFormat()"
+ "void AudioQueueObject::ReleasePlayResources()"
+ "void AudioQueueObject::ReleasePlayResourcesForInterruption()"
+ "void AudioQueueObject::ResetIsInputMutedBecauseDeviceIsRemoteControlled()"
+ "void AudioQueueObject::ResetProcessMute()"
+ "void AudioQueueObject::ResetSpatializationCompression(AQIONode *)"
+ "void AudioQueueObject::ScheduleDisposal(bool)"
+ "void AudioQueueObject::SetContentSourceFromISOContentType(UInt32, UInt32)"
+ "void AudioQueueObject::SetContentSourceFromMediaKind(CFStringRef)"
+ "void AudioQueueObject::SetDecodeBufferLowWaterMark(UInt32)"
+ "void AudioQueueObject::SetDecodeBufferMaxFramesToConvert(UInt32)"
+ "void AudioQueueObject::SetDecodeBufferSizeFrames(UInt32)"
+ "void AudioQueueObject::SetDecodeSizesToDefault()"
+ "void AudioQueueObject::SetOutputSource(AQOutputSource *)"
+ "void AudioQueueObject::SetSTSLabel(applesauce::CF::StringRef)"
+ "void AudioQueueObject::StopFromPause()"
+ "void AudioQueueObject::StopRunning(AQIONode *, bool)"
+ "void AudioQueueObject::TrimQueue::AddTrimOrSilence(UInt32, UInt32, UInt32, UInt32)"
+ "void AudioQueueObject::UpdateMetricsReporting()"
+ "void AudioQueueObject::buffersCreatedAndDestroyed(AQ::Server::RemoteBufferMap &, std::span<const AQBufferCreateDestroyEvent>)"
+ "void QueueAccessor::SetSessionPlayStateToStopped_Deferred(bool) const"
+ "void RemoteIOClient::SetLoudnessFromLM()"
+ "void ScheduledSlicePlayer2::BufferComplete(SyncRenderGuarded::Guard &, XScheduledAudioSlice *, XSampleTime)"
+ "void ScheduledSlicePlayer_Legacy::BufferComplete(XScheduledAudioSlice *, XSampleTime)"
+ "{}-{:#x}"
+ "{}-{}"
- "%25s:%-5d %s:   ->flushing pending input"
- "%25s:%-5d %s:   <-done flushing pending input: 0 packets produced"
- "%25s:%-5d %s:   <-done flushing pending input: no more buffers (%d frames in ring buffer)"
- "%25s:%-5d %s:   ScheduledSliceAllocator %p: sliceFormat %s"
- "%25s:%-5d %s:   [%d] %s"
- "%25s:%-5d %s:   aq@%p: FlushPending, end of stream"
- "%25s:%-5d %s:   aq@%p: done with buffer cmd %p"
- "%25s:%-5d %s:   aq@%p: no more buffers"
- "%25s:%-5d %s:   aq@%p: supplied %d packets, 0x%x bytes @ %p"
- "%25s:%-5d %s:   changed existing slice player output format"
- "%25s:%-5d %s:   created new slice allocator %p for PCM format: %s"
- "%25s:%-5d %s:   flushing input: %d packets produced"
- "%25s:%-5d %s:   flushing pending input terminated - error %d"
- "%25s:%-5d %s:   mFirstPostFlushBufferTimestamp %s"
- "%25s:%-5d %s: ### aq@%p: hardware bit depth was %d; now %d ###"
- "%25s:%-5d %s: %p, err=%d"
- "%25s:%-5d %s: %s"
- "%25s:%-5d %s: %s\n%s"
- "%25s:%-5d %s: %s: AudioCodec %p\n  from %s\n  to   %s"
- "%25s:%-5d %s: (%d bytes @ %p), err=%d"
- "%25s:%-5d %s: *** AudioQueue ignoring hardware codecs (aq_ignorehwcodecs pref set) ***"
- "%25s:%-5d %s: *** Queue needs no converter ***"
- "%25s:%-5d %s: ***** unpausing after being paused %lld - %lld = %lld sample frames *****"
- "%25s:%-5d %s: -> aq = %p, state = %d, audioSessionID = 0x%x"
- "%25s:%-5d %s: -> aq@%p"
- "%25s:%-5d %s: -> aq@%p: "
- "%25s:%-5d %s: ->%d fr, %d bytes @ t=%lld fr"
- "%25s:%-5d %s: <-0x%x/0x%x packets, 0x%x/0x%x bytes%s [buffer %d]"
- "%25s:%-5d %s: <-aq@%p: %d (raw) %d (scaled) fr avail, running=%d, EOS=%d"
- "%25s:%-5d %s: AQ I/O sample rate zero: client format %s@%f I/O format %s@%f"
...
- "%25s:%-5d %s: AQ underrun: current sample time %lld; dropping buffer spanning sample times %lld - %lld"
- "%25s:%-5d %s: AQAudioCodec received a metadata event with 0 audio frames %p (size= %d)!"
- "%25s:%-5d %s: AQAudioCodec received a metadata event with 0 audio frames!"
- "%25s:%-5d %s: AQAudioCodec requested to allocate metadata buffers without a memory pool!"
- "%25s:%-5d %s: AQBuffer * %p has enqueue count of %d"
- "%25s:%-5d %s: AQMetadataAudioConverter %s\n%s"
- "%25s:%-5d %s: AQSTL AudioQueueObject(%p)::GetCurrentQueueTime \n ionode now    %s (%.3f); qrate = %.3f \n queue anchor  %lld fr \n queue now     %s (%.3f)"
- "%25s:%-5d %s: AddProcessingNode Unable to get IONode for this AudioQueue. %s (err = %d)"
- "%25s:%-5d %s: AddProcessingNode failed on %p because it's already running"
- "%25s:%-5d %s: Attempt to create a FigCPECryptorRef from the cryptor recipe failed with error:%d"
- "%25s:%-5d %s: AudioConverterNew from AudioQueueNew returned %d\nio:    %s\nclient:   %s"
- "%25s:%-5d %s: AudioConverterNew returned %d"
- "%25s:%-5d %s: AudioConverterNew returned %d\n from: %s\nto:   %s"
- "%25s:%-5d %s: AudioIssueDetectorClientInitialize returned error %d"
- "%25s:%-5d %s: AudioIssueDetectorClientSetNodeFormat returned error %d"
- "%25s:%-5d %s: AudioQueue codec policy %d for audioSessionID 0x%x: session does not permit hardware codecs"
- "%25s:%-5d %s: AudioQueue codec policy %d: failed to find a codec of the requested type"
- "%25s:%-5d %s: AudioQueue: Error %d from AudioSessionSetClientPlayState(0x%x)"
- "%25s:%-5d %s: AudioQueue: request to trim %u + %u = %u frames from buffer containing %u frames"
- "%25s:%-5d %s: AudioQueueEnqueueBuffer: invalid attempt to enqueue buffer %d a second time (%d)"
- "%25s:%-5d %s: AudioQueueObject(%p, %d)::StartRunning: ERROR: last sample time not set"
- "%25s:%-5d %s: AudioQueueObject(%p, %d)::StartRunning: warning: last sample time not set for the audio tap"
- "%25s:%-5d %s: AudioQueueSetProperty: %s not supported on this platform"
- "%25s:%-5d %s: AudioQueueSetSiriProperty_EnableListening: %d. PlayState: %d"
- "%25s:%-5d %s: Cannot locate requested codec: %s"
- "%25s:%-5d %s: Capturing AQ(%p) input: %s"
- "%25s:%-5d %s: Capturing AQ(%p) output on decode: %s"
- "%25s:%-5d %s: Capturing AQ(%p) output on enqueue: %s"
- "%25s:%-5d %s: Capturing offline AQ(%p): %s"
- "%25s:%-5d %s: Considering async stop: recentRenderTime %lld, recentBufferRenderTime %lld, endOfTimeline %lld (latency %d, srScalar %.3f)"
- "%25s:%-5d %s: Constructed an AudioConverter for the client %s."
- "%25s:%-5d %s: ConvertOutput/SlicePlayer: MarkEndOfStream"
...
- "%25s:%-5d %s: Could not instantiate AQAudioCodec instance for codec: %d!"
- "%25s:%-5d %s: Could not instantiate AQMetadataAudioConverter failed to create the underlying AudioConverter: %d"
- "%25s:%-5d %s: Could not instantiate requested codec: %s; error %d"
- "%25s:%-5d %s: Could not update reporterID to %lld due to error %d"
- "%25s:%-5d %s: Couldn't configure AC-3 conversion: %d"
- "%25s:%-5d %s: Couldn't get mConverterResetMutex"
- "%25s:%-5d %s: DRC capability from decoder: %s (0x%x)\n"
- "%25s:%-5d %s: Error creating AQTapIONode for binding: %s, tap specifier: %s"
- "%25s:%-5d %s: Exiting because 0x%x frames were primed (0x%x were requested)"
- "%25s:%-5d %s: Exiting because mConverterError is %d (0x%x req, 0x%x primed)"
- "%25s:%-5d %s: Exiting because mPrimeComplete is true (0x%x req, 0x%x primed)"
- "%25s:%-5d %s: Failed to apply loudness info: aq = %p, conv = %p, lid = %@, err =  %d\n"
- "%25s:%-5d %s: Failed to create AudioIssueDetector for aq@%p"
- "%25s:%-5d %s: Failed to set downmix channel layout: %d"
- "%25s:%-5d %s: ForceSoundCheck: %d"
- "%25s:%-5d %s: GetCodecOutput: AudioCodecAppendInputData returned %d"
- "%25s:%-5d %s: GetHardwarePlatformKey(): hardware platform key is %s"
- "%25s:%-5d %s: GetIONode_Init failed in SetSTSLabel with %d"
- "%25s:%-5d %s: GetProposedIOFormat: aq@%p: Before: streamLayout (%s), mChannelLayout (%s), mCodecChannelLayout (%s), maximumDecodeChannels=%d"
- "%25s:%-5d %s: Input ring buffer returning 0x%x frames of silence (trying to read: %u - %u; current bounds %u - %u) (%d previous warnings suppressed)"
- "%25s:%-5d %s: Input ring buffer returning 0x%x frames, t: 0x%x - 0x%x"
...
- "%25s:%-5d %s: Invalid format (%s) would overflow integer buffer size"
- "%25s:%-5d %s: LM disabled, not looking for SC overrides"
- "%25s:%-5d %s: Latency changed from %.6f to %.6f"
...
- "%25s:%-5d %s: Overriding max frames from prime to %d"
- "%25s:%-5d %s: Passthrough AQ sample rate mismatch: client format %s@%f I/O format %s@%f: %s"
...
- "%25s:%-5d %s: Prime: Exiting because the work queue has reached a %s command (0x%x req, 0x%x primed)"
- "%25s:%-5d %s: ProcessingNodeCancelScheduledParameters: %p failed on %u err: %d"
- "%25s:%-5d %s: ProcessingNodeScheduleParameters: %p failed on %u err: %d"
- "%25s:%-5d %s: ProcessingNodeScheduleParameters: %p invalid timestamp!"
- "%25s:%-5d %s: ProcessingNodeScheduleParametersDEBUG: %p failed on %u err: %d"
- "%25s:%-5d %s: Querying output formats for %s, using codec %s"
- "%25s:%-5d %s: Queue's formats:\n  i/o format     %s\n  PCM format     %s\n  client format  %s"
- "%25s:%-5d %s: Rate1 cannot be set immediately after Rate2 has been committed (current, new rate1: %.2f, %.2f)."
- "%25s:%-5d %s: RemoveProcessingNode failed on %p because it's still running"
- "%25s:%-5d %s: SSP::Render: CopySlice returned %d"
- "%25s:%-5d %s: ScheduledSliceAllocator %p's AudioConverter:\n%s"
...
- "%25s:%-5d %s: SetSessionPlayStateToStopped_Deferred(0x%x)"
- "%25s:%-5d %s: Siri entitlement check failed"
...
- "%25s:%-5d %s: Tap process not set"
- "%25s:%-5d %s: This event contains%s default envelope"
- "%25s:%-5d %s: Unable to fetch routing behaviors for this AudioQueue. %s"
- "%25s:%-5d %s: Unable to get IONode for this AudioQueue. %s (err = %d)"
- "%25s:%-5d %s: Updated mAssignedIOSpecifier for Siri injection: %s"
- "%25s:%-5d %s: ^^^ actual start time %s"
...
- "%25s:%-5d %s: aq@%p"
- "%25s:%-5d %s: aq@%p / bcmd@%p: %s %u of %u frames (status=%s) to offset 0x%x (%p), %d bytes, t=0x%x (0x%x + 0x%x)"
- "%25s:%-5d %s: aq@%p / bcmd@%p: %s %u of %u frames (status=%s) to offset 0x%x (%p), %d bytes, t=0x%x (0x%x + 0x%x) [%s]"
- "%25s:%-5d %s: aq@%p CheckSpatialization mAutomaticSpatialization=%d, mSpatializationEnabled=%d mContentRequiresAUSpatialMixer=%d mHasMetadata=%d mIsOffline=%d STSLabel valid:%d is stereo: %d"
...
- "%25s:%-5d %s: aq@%p Setting Spatial Tracking Label %@ from client"
- "%25s:%-5d %s: aq@%p Unable to deliver processing node parameters."
- "%25s:%-5d %s: aq@%p Unable to get IONode for this AudioQueue. %s (err = %d)"
- "%25s:%-5d %s: aq@%p already assigned to submix tap"
- "%25s:%-5d %s: aq@%p associated with %s subsession ref %p, ID %llX"
- "%25s:%-5d %s: aq@%p associated with subsession ref %p, ID %llX"
- "%25s:%-5d %s: aq@%p automatic spatialization check: spatialize=%d"
- "%25s:%-5d %s: aq@%p being assigned to submix tap %p"
- "%25s:%-5d %s: aq@%p can't assign to submix tap while running"
- "%25s:%-5d %s: aq@%p could not set spatial mixer binaural rendering override to %d spatialize=%d"
- "%25s:%-5d %s: aq@%p error %d while passing scheduled parameters to submix tap"
- "%25s:%-5d %s: aq@%p flushing immediately"
- "%25s:%-5d %s: aq@%p gets mOutputSource %p"
- "%25s:%-5d %s: aq@%p kCMSession_AudioQueueOptionsKey_IsMuted returns %d for subsession ref=%p"
- "%25s:%-5d %s: aq@%p procNode:%d timestamp:%s targetSampleTime: %lld  anchor st: %lld  mLastIOSampleTime: %lld mNextIOSampleTime: %lld"
- "%25s:%-5d %s: aq@%p updating issue detector %lld with reporting session %lld"
- "%25s:%-5d %s: aq@%p using AQMetadataAudioConverter"
- "%25s:%-5d %s: aq@%p volume %.3f %.3f %.3f %.3f %.3f %.3f, %.3f"
- "%25s:%-5d %s: aq@%p: %d"
- "%25s:%-5d %s: aq@%p: %d %d, preferred manuf %d; found hw=%d, sw=%d; policy %d, chose %d"
- "%25s:%-5d %s: aq@%p: %d (disposing=%d)"
- "%25s:%-5d %s: aq@%p: %d fr"
- "%25s:%-5d %s: aq@%p: %s"
- "%25s:%-5d %s: aq@%p: %s spatialization compression."
- "%25s:%-5d %s: aq@%p: %s, mixer %p"
- "%25s:%-5d %s: aq@%p: *** inserting %d-frame alignment adjustment"
- "%25s:%-5d %s: aq@%p: 0x%x"
- "%25s:%-5d %s: aq@%p: About to perform async command: %s"
- "%25s:%-5d %s: aq@%p: AudioConverterFillComplexBuffer returned %d, packetCount %d"
- "%25s:%-5d %s: aq@%p: Cannot both trim and silence %u frames"
- "%25s:%-5d %s: aq@%p: ConnectToOfflineMixer %p"
- "%25s:%-5d %s: aq@%p: Decoder channel layout set to (%s), maximumDecodeChannels=%d"
- "%25s:%-5d %s: aq@%p: Deleting"
- "%25s:%-5d %s: aq@%p: Entering (0x%x frames requested)"
- "%25s:%-5d %s: aq@%p: Error in AudioFormatGetProperty (err=%d, %s), tag=0x%x"
- "%25s:%-5d %s: aq@%p: Failed to set BestAvailableContentType"
- "%25s:%-5d %s: aq@%p: Failed to set contentIsAudioOnly"
- "%25s:%-5d %s: aq@%p: First buffer, will start in 2 I/O cycles (t = 0x%x)"
...
- "%25s:%-5d %s: aq@%p: IsInputMutedBecauseDeviceIsRemoteControlled(): %i session: 0x%x"
...
- "%25s:%-5d %s: aq@%p: RealClientPIDForInterruptionPurposes %d"
- "%25s:%-5d %s: aq@%p: RealClientSession 0x%x"
...
- "%25s:%-5d %s: aq@%p: Starting"
- "%25s:%-5d %s: aq@%p: Stopping (wasStarted=%d)"
...
- "%25s:%-5d %s: aq@%p: [1] start host time is %lld; %.3fs from now"
- "%25s:%-5d %s: aq@%p: [2] start host time is %lld; %.3fs from now"
- "%25s:%-5d %s: aq@%p: activating=%d, started=%d, paused=%d, interrupted=%d, wasPausedWhenInterrupted=%d, fadeTime=%g, isFading=%d"
- "%25s:%-5d %s: aq@%p: audioSession 0x%x, server pid %d, offline %d, pmset %p, muted %d, subsession muted %d"
- "%25s:%-5d %s: aq@%p: beingInterrupted %d"
- "%25s:%-5d %s: aq@%p: bufid %d, cmd %p, data %p: %u bytes, %d frames (trim %d/%d), %d packets, %s, outActualStartTime %p"
- "%25s:%-5d %s: aq@%p: can schedule disposal: %d"
- "%25s:%-5d %s: aq@%p: cannot enable spatialization.  IO channels (%d) != client channels (%d)"
- "%25s:%-5d %s: aq@%p: cannot trim silence"
- "%25s:%-5d %s: aq@%p: cinematic audio latency %.3f s, tail time %.3f s"
- "%25s:%-5d %s: aq@%p: cinematic audio: %s"
- "%25s:%-5d %s: aq@%p: cmd %p, flags=%d, t=%lld"
- "%25s:%-5d %s: aq@%p: conn %p RunsOnAP %d"
...
- "%25s:%-5d %s: aq@%p: decode buffer sizes: %u frames, low-water %u, max-decode %u"
- "%25s:%-5d %s: aq@%p: error allocating buffer"
- "%25s:%-5d %s: aq@%p: internally handling dynamic routing behavior change"
- "%25s:%-5d %s: aq@%p: invalid buffer ID"
- "%25s:%-5d %s: aq@%p: invalid buffer size"
- "%25s:%-5d %s: aq@%p: ionode %p"
- "%25s:%-5d %s: aq@%p: ionode@%p, enqueueing %d samples of silence"
- "%25s:%-5d %s: aq@%p: mInterrupted %d"
- "%25s:%-5d %s: aq@%p: map buf %d"
- "%25s:%-5d %s: aq@%p: nothing to silence"
- "%25s:%-5d %s: aq@%p: null LID passed in, using cached: %p"
- "%25s:%-5d %s: aq@%p: queue must be stopped before switching to offline mode, is currently %s!"
- "%25s:%-5d %s: aq@%p: rate2 scheduling not enabled; ignoring event"
- "%25s:%-5d %s: aq@%p: reporterID=%lld"
- "%25s:%-5d %s: aq@%p: scheduling rationale %d: %s"
- "%25s:%-5d %s: aq@%p: sending kAudioQueueProperty_HasDecodeFormatMismatch notification"
- "%25s:%-5d %s: aq@%p: spatialization %s, %s. Format %s"
- "%25s:%-5d %s: aq@%p: t=%lld, reqFrames=%u, actualBytes=%d, actualFrames=%d"
- "%25s:%-5d %s: aq@%p: unable to dynamically change converter %s format (%d)"
- "%25s:%-5d %s: aq@%p: unmap buf %d"
- "%25s:%-5d %s: attempt to set %u channels with IOFormat: %s (kAudioQueueErr_InvalidPropertySize)"
- "%25s:%-5d %s: bufid %d 0x%x/0x%x bytes, %d/%d packets, mNumPacketDescriptions=%d"
...
- "%25s:%-5d %s: conv = %p, isoe = %@, err = %d\n"
- "%25s:%-5d %s: conv = %p, lid = %@, err = %d\n"
- "%25s:%-5d %s: conv = %p, property = %s, size = %u, err = %d\n"
...
- "%25s:%-5d %s: could not set loudness, error %d (%s)"
- "%25s:%-5d %s: decoder does not handle DRC, looking for SC overrides"
- "%25s:%-5d %s: decoder handles DRC, not looking for SC overrides"
- "%25s:%-5d %s: disabling normalisation target"
- "%25s:%-5d %s: end of flushing input"
- "%25s:%-5d %s: error %d"
- "%25s:%-5d %s: error %d setting kAudioCodecPropertyCurrentOutputFormat to %s"
- "%25s:%-5d %s: error getting max frame size %i"
- "%25s:%-5d %s: exiting"
- "%25s:%-5d %s: failed (%d)"
- "%25s:%-5d %s: failed (%d); will stop (%d/%d frames)"
- "%25s:%-5d %s: failing due to unspecified session"
- "%25s:%-5d %s: failure when %s: %d"
...
- "%25s:%-5d %s: framesAvailable after decoding %d"
...
- "%25s:%-5d %s: inCurrentSampleTime = %lld, mOfflineEndOfStreamSampleTime = %lld"
- "%25s:%-5d %s: input queue, returning immediately"
- "%25s:%-5d %s: invalid profile: %d"
...
- "%25s:%-5d %s: kAudioCodecPrivatePropertyMaximumMetadataFrameByteSize getinfo failed"
- "%25s:%-5d %s: kAudioCodecPropertySupportedOutputFormats getinfo failed"
- "%25s:%-5d %s: kAudioCodecPropertySupportedOutputFormats getproperty failed"
- "%25s:%-5d %s: last rate change at %lld, ignoring out-of-order new one at %lld"
...
- "%25s:%-5d %s: mClientMaxPacketSize = %d"
- "%25s:%-5d %s: mNextIOSampleTime %lld, mAnchorIOSampleTime %lld, mPauseSampleTime %lld"
- "%25s:%-5d %s: mixing to %d bits, %s quality"
...
- "%25s:%-5d %s: no codec output formats!"
...
- "%25s:%-5d %s: no matching codec output format"
...
- "%25s:%-5d %s: rate change: %lld = %lld scaled, rate %.3f"
- "%25s:%-5d %s: scheduling rate change at unscaled t=%lld, but we previously did a conversion for t=%lld"
...
- "%25s:%-5d %s: set mEnqueueAnchorTime.mSampleTime to 0x%x"
- "%25s:%-5d %s: setting DRC compression profile to %d"
...
- "%25s:%-5d %s: setting momentary limit to %f"
- "%25s:%-5d %s: setting normalisation target to %f"
- "%25s:%-5d %s: setting normalization gain limit to %f"
- "%25s:%-5d %s: setting peak level to %f"
- "%25s:%-5d %s: starting"
