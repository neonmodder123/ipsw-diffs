...
-5027.0.69.0.0
-  __TEXT.__text: 0x1d3148
+5027.1.2.0.0
+  __TEXT.__text: 0x1d4bc4
...
+ GCC_except_table176
+ GCC_except_table206
+ __CFAuditTokenForSelf.auditToken
+ __CFAuditTokenForSelf.onceToken
+ __CFBundleCopyFromTablesForURL
+ __CFBundleCopyLanguageSearchListWithRootDirectory
+ __CFBundleDetermineDefaultLocalizationStringSources
+ __CFBundleFindFirstNonLoctableFilesForLocalizations
+ __CFBundleFindLoctableContentsForLocalizationsIfNecessary
...
+ __CFBundleResolveOverlaidLoctableAndNonLoctableSources
...
+ ____CFBundleSearchForLocalizedString_block_invoke_3
+ ____copyIngestedCacheResult_block_invoke_3
+ ____copyIngestedCacheResult_block_invoke_4
+ ___block_descriptor_72_e8_32r_e18_v32?0r^v8r^v16*24lr32l8
+ ___block_descriptor_83_e8_32o40r_e25_v16?0^{__CFDictionary=}8lr40l8s32l8
+ ___block_descriptor_90_e8_32r40r48r_e13_v24?0r^v8*16lr32l8r40l8r48l8
...
- GCC_except_table87
- GCC_except_table91
- _CFBundleGlobalDataLock
- __CFBundleIngestDefaultLocalizationResultsIntoExistingCachedResult
...
- ___block_descriptor_64_e8_32r_e18_v32?0r^v8r^v16*24lr32l8
- ___block_descriptor_82_e8_32o40r_e25_v16?0^{__CFDictionary=}8lr40l8s32l8
- __bundlesByIdentifier
- __loadStringsTable
- __releaseStringsSource
- _withSourceForIdentifier:user:byHost:container:cloud:perform:.registerOnce
CStrings:
+ "!addToTables"
