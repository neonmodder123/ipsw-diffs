...
+ _objc_msgSend$isBiometricTypeForced
+ _objc_msgSend$shouldShowRestingUnlock
...
- _objc_msgSend$beginBiometricReplacementWithAuthenticationHandler:andCompletion:
- _objc_msgSend$replaceFingerprint:
- _objc_msgSend$updateWithReplacedUUIDs:
CStrings:
+ "%@: Set: %@"
