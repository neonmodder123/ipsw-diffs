...
+ _objc_msgSend$isSearchFieldAutocorrectAlwaysEnabled
+ _objc_msgSend$numberWithInteger:
+ _objc_msgSend$stringValue
+ _objc_msgSend$updateAutoCorrectionBehavior
...
- _objc_msgSend$hasSelectedItem
- _objc_msgSend$updateAutoCorrectionEnabled:
CStrings:
