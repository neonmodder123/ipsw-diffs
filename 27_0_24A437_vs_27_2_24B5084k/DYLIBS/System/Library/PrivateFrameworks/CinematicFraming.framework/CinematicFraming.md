...
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CinematicFraming/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ holds %zu bytes, expected %zu bytes"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CinematicFraming/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ is missing"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CinematicFraming/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ is not an NSData"
...
+ "<<<< DeskCamRenderingSession >>>> %s: Ignoring unusable calibration data for frame!"
...
+ "cmdBuffer is NULL"
+ "com.apple.coremedia"
+ "validatedCalibrationDataForKey"
