...
+3977.1.3.1.0
+  __TEXT.__text: 0x48f28
+  __TEXT.__objc_methlist: 0x62b4
+  __TEXT.__cstring: 0x19a9
...
+ _objc_msgSend$_accessibilityLayoutTopOffset
+ _objc_msgSend$_isLaidOutEdgeToEdgeWithWindow
+ _objc_msgSend$_restoreStashedTitles
+ _objc_msgSend$_setDisableFadeInAnimation:
+ _objc_msgSend$_setSafeAreaAnchoringTrustedForContentGutter:
+ _objc_msgSend$_stashTitles
+ _objc_msgSend$_titleTextStyle
+ _objc_msgSend$dotSize
+ _objc_msgSend$enumerateKeysAndObjectsUsingBlock:
+ _objc_msgSend$forceHeaderInLeadingColumn
+ _objc_msgSend$lastIntrinsicContentSizeWidth
+ _objc_msgSend$layoutFrame
+ _objc_msgSend$leadingColumnHeaderCenterYConstraint
+ _objc_msgSend$setLastIntrinsicContentSizeWidth:
+ _objc_msgSend$setLeadingColumnHeaderCenterYConstraint:
+ _objc_msgSend$setStashedAttributedTitles:
+ _objc_msgSend$setStashedTitles:
+ _objc_msgSend$stashedAttributedTitles
+ _objc_msgSend$stashedTitles
...
- _objc_msgSend$_updateTextColor
CStrings:
+ "-seed"
