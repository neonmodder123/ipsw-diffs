...
+ _objc_msgSend$_reservedSceneAccessoryWithConfiguration:userInfo:
+ _objc_msgSend$_supportedInterfaceOrientationsForWindow:
+ _objc_msgSend$accessoryRegistration
+ _objc_msgSend$initWithWindowScene:
+ _objc_msgSend$makeKeyAndVisible
+ _objc_msgSend$registerSceneAccessory:
+ _objc_msgSend$serviceSupportedInterfaceOrientations
+ _objc_msgSend$setAccessoryRegistration:
...
+ _objc_msgSend$setServiceSupportedInterfaceOrientations:
+ _objc_msgSend$setWindow:
+ _objc_msgSend$unregisterSceneAccessory:
+ _objc_msgSend$unsignedIntegerValue
+ _objc_msgSend$viewServiceDidDismissAccessoryContent
+ _objc_msgSend$viewServiceDidRequestAccessoryContent
+ _objc_msgSend$viewServiceDidSetSupportedInterfaceOrientations:
CStrings:
+ "$"
