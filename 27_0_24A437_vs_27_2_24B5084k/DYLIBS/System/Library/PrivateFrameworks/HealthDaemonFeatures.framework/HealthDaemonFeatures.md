...
+7027.1.36.2.7
+  __TEXT.__text: 0xcec4
+  __TEXT.__objc_methlist: 0x50c
+  __TEXT.__const: 0x73e
...
Symbols:
+ __CATEGORY_HKFeatureAvailabilityRequirementSet_$_HealthDaemonFeatures
+ __OBJC_$_CLASS_METHODS_HKFeatureAvailabilityRequirementSet(HealthDaemonFeatures|HealthDaemonFeatures1|HealthDaemonFeatures2|HealthDaemonFeatures3)
...
+ __swift_FORCE_LOAD_$_swiftCoreImage_$_HealthDaemonFeatures
...
+ _objc_msgSend$hkme_exampleFeatureRequirementSetForFeatureIdentifier:
+ _objc_msgSend$hkme_glucoseEnhancedChartingRequirementSetForFeatureIdentifier:
+ _objc_msgSend$hkme_respiratoryRateMeasurementsRequirementSetForFeatureIdentifier:
+ _objc_msgSend$hkme_wristTemperatureMeasurementsRequirementSetForFeatureIdentifier:watchCapability:
+ _objc_retain_x24
