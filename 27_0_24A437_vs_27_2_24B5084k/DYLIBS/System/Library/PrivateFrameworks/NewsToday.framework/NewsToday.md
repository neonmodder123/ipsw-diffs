...
-5934.3.0.0.0
-  __TEXT.__text: 0x46098
-  __TEXT.__objc_methlist: 0x652c
+5960.0.0.0.0
+  __TEXT.__text: 0x45c74
...
+  __AUTH_CONST.__objc_const: 0xdf78
...
+ _objc_msgSend$_fetchTodayModuleDescriptorsWithContentRequest:qualityOfService:completion:
+ _objc_retain_x10
...
- _objc_msgSend$_fetchTodayModuleDescriptorsWithContentRequest:requireRefreshedAppConfig:qualityOfService:completion:
- _objc_msgSend$fetchAppConfigurationIfNeededWithCompletion:
- _objc_msgSend$refreshAppConfigurationIfNeededWithCompletionQueue:refreshCompletion:
- _objc_msgSend$registerDefaults:
- _objc_msgSend$requireRefreshedAppConfig
- _objc_msgSend$setBool:forKey:
- _objc_msgSend$setRequireRefreshedAppConfig:
- _objc_msgSend$userSegmentationInWidgetAllowed
CStrings:
- "marker"
