...
-117.0.0.0.0
-  __TEXT.__text: 0x11df0
-  __TEXT.__objc_methlist: 0x1b4c
+117.125.3.0.0
+  __TEXT.__text: 0x12138
...
+ _objc_msgSend$_ttrURLForRequest:
+ _objc_msgSend$attachmentURLs
+ _objc_msgSend$autoDiagnostics
+ _objc_msgSend$classification
+ _objc_msgSend$path
+ _objc_msgSend$reproducibility
+ _objc_msgSend$skipsConfirmationAlert
- GCC_except_table11
CStrings:
+ "Attachments"
```
