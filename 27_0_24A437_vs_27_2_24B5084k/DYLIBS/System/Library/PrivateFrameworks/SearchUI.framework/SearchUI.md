...
+ _objc_msgSend$liveCellReuseIdentifierForRowModel:
+ _objc_msgSend$liveReuseIdentifiersInSnapshot:
+ _objc_msgSend$logSnapshotDiffFromCurrentSnapshot:toNewSnapshot:
+ _objc_msgSend$numberOfVisibleAppsForCurrentWidth
+ _objc_msgSend$pixelWidthForView:
+ _objc_msgSend$reconfiguredItemIdentifiers
+ _objc_msgSend$reloadItemsWithIdentifiers:
+ _objc_msgSend$reloadRowModelsWithChangedCellClassInSnapshot:
+ _objc_msgSend$reloadedItemIdentifiers
+ _objc_msgSend$rowModelsForCardSections:result:queryId:builder:
+ _objc_msgSend$setUpdateCompletionBlock:
+ _objc_msgSend$shouldReloadRowModel:appliedReuseIdentifiers:
+ _symbolic SSSgycSg
...
- _objc_msgSend$applySnapshotUsingReloadData:completion:
