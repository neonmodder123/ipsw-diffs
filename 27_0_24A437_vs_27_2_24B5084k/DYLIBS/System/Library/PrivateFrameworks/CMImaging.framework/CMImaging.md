...
+ -[CMITextureStylesProcessor canRenderInPlace:]
+ -[CMITextureStylesUnderEyeBrighten _logParameters]
+ GCC_except_table3
+ _CMIShadingFPNCorrectionImageMetadataToShortString
+ _CRGGetMachElapsedTimeMs
+ _CRGGetMachElapsedTimeMs.machTimeToMS
+ _FILM_GRAIN_Effect_PARAMETERS_NOTE_VARIABLE
...
+ _gCMITIPConfig
+ _gCMITIPTrace
+ _gCMITextureStylesBloomTrace
+ _gCMITextureStylesDiffusionTrace
+ _gCMITextureStylesEffect
+ _gCMITextureStylesGlowTrace
+ _gCMITextureStylesHalationTrace
+ _gCMITextureStylesUEBTrace
+ _gCMITuningTrace
...
+ _gTextureStylesMattifyTrace
+ _gTextureStylesProcessorTrace
+ _gTextureStylesTuningLookupTrace
+ _gVNRTrace
+ _getFloatParameter
+ _getFloatValue
...
+ " (pass-through)"
+ " | "
+ "! CGRectIsEmpty( _personData.faceROI ) is NULL"
+ "! CGRectIsEmpty( regionToRender ) is NULL"
+ "! CGRectIsEmpty( roi ) is NULL"
+ "! CGRectIsNull( _regionToRender ) && ! CGRectIsEmpty( _regionToRender ) is NULL"
+ "! CGRectIsNull( extendedFaceROI ) is NULL"
+ "! CGRectIsNull( inputOutput.inputFaceRect ) is NULL"
+ "! CGRectIsNull( intermediatesAndStats->_extendedFaceROI ) is NULL"
+ "%d"
...
+ "'regionToRender' is empty"
+ "'regionToRender' not contained within 'imageSize' extent"
+ "'regionToRender' not contained within the intersection of 'inputImageRect' and 'outputImageRect'"
+ "'regionToRender' not contained within the intersection of all set images"
...
+ "( -73465 )"
+ "( _streamingMode ) || ( _personData.faceLandmarks && ( _personData.faceLandmarkType != CMITextureStylesFaceLandmarkType_Invalid ) && ( ! CGRectIsEmpty( _personData.faceROI ) ) && io.inputFaceMask.texture ) is NULL"
+ "( _streamingMode ) || ( triangleVerticesLeft && triangleVerticesRight && ( ! CGRectIsNull( leftCheekROI ) ) && ( ! CGRectIsNull( rightCheekROI ) ) ) is NULL"
...
+ "+[CMITextureStyleTuningLookup defaultTextureStyleForSmartStyleCastType:]_block_invoke"
...
+ "+[CMITextureStylesPersonInputDataUtilities personInputDataArrayFromLivePhotoMetadataAndStatsTracks:faceAttitudesMetadataTrack:effectsStatsTrack:effectsToRender:]_block_invoke"
+ "+[CMITextureStylesPersonInputDataUtilities personInputDataArrayFromLivePhotoMetadataAndStatsTracks:faceAttitudesMetadataTrack:effectsStatsTrack:effectsToRender:]_block_invoke_2"
...
+ "-[CMITextureStylesMattify process]_block_invoke"
...
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CMImaging/CMImaging/Sources/TextureStyles/Implementation/Utilities/Filter/CMITextureStylesFilter.m %s: Could not allocate sortedFilterRadii array"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CMImaging/CMImaging/Sources/TextureStyles/Implementation/Utilities/Filter/CMITextureStylesFilter.m %s: Could not find suitable guided filter radius for min scale factor: %.3f and target full res radius: %.3f"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture_CMImaging/CMImaging/Sources/TextureStyles/Implementation/Utilities/TextureWarping/CMITextureStylesTextureWarping.m %s: Unsupported output pixel format: %lu"
...
+ "<<<< CMILCB >>>> %s: Decoding LCB database written at version %d (current version is %d); properties added after version %d will be absent until the affected blemishes are next detected."
+ "<<<< CMILCB >>>> %s: LCB database - new key = %@"
+ "<<<< CMILCB >>>> %s: LCB database key (%@) conflict - trying new key"
+ "<<<< CMILCB >>>> %s: Warning: Failed to add blemish - unable to find non-conflicting key - this should never happen"
+ "<<<< CMILCB >>>> %s: Warning: attempting to add blemish that is already in database - skipping"
+ "<<<< CMILCB >>>> %s: Warning: possible race condition in LCB database update - key = %@"
...
+ "<<<< CMITIP >>>> %s: Background QoS detected with %zu ANE cores — configuring single ANE core execution by configuring background ANEHW execution priority on E5RT request to reduce power at Vmin, overriding configured ANEHW execution priority %d"
+ "<<<< CMITIP >>>> %s: Background QoS detected with %zu ANE cores — configuring single ANE core execution by configuring background ANEHW execution priority on EspressoV1 request to reduce power at Vmin, overriding configured ANEHW execution priority %d"
...
+ "<<<< CMITIP >>>> %s: espresso_plan_set_priority failed to set ESPRESSO_PLAN_PRIORITY_4 (%d)"
...
+ "<<<< CMITextureStyles::Bloom >>>> %s: CMITextureStylesBloomParameters: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::Bloom >>>> %s: Called"
+ "<<<< CMITextureStyles::Bloom >>>> %s: sigmaGlare defaults does not have 4 entries"
+ "<<<< CMITextureStyles::Bloom >>>> %s: sigmaGlare tuning does not have 4 entries"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: ( ! dictionary ) || ( ! [dictionary isKindOfClass:[NSDictionary class]] )"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: ( ! pointDict ) || ( ! errorNum )"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: FigLivePhotoMetadataComputeDeserializationSize failed"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: FigLivePhotoMetadataDeserializeIntoBuffer failed"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: Malformed entry in the stats track: %@"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: Unexpected FigLivePhotoMetadataVersion"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: Unsupported CMITextureStylesEffectType"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: effectStatsDictsByFaceID[faceID] is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceAttitudeDictsByFaceID is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceAttitudeDictsByFaceID[faceID] is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceIDsForEffect is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceROIDictsByFaceID is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceROIDictsByFaceID[faceID] is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: faceROIDictsFromLivePhotoInfoTrack is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: figLivePhotoMetadataDecodedBinaryData is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: figLivePhotoMetadataPlaceholder is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: kFigCaptureStreamMetadata_AngleInfoPitch not found"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: kFigCaptureStreamMetadata_AngleInfoRoll not found"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: kFigCaptureStreamMetadata_AngleInfoYaw not found"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: kFigCaptureStreamMetadata_FaceID not found"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: kFigCaptureStreamMetadata_Rect not found"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: peopleDataDictsByFaceID is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: personData is nil"
+ "<<<< CMITextureStyles::CMITextureStylesPersonInputData >>>> %s: personDataDict is nil"
+ "<<<< CMITextureStyles::Diffusion >>>> %s: CMITextureStylesDiffusionParameters: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::Diffusion >>>> %s: CMITextureStylesDiffusionParameters: Validation failed for parameter: %s"
+ "<<<< CMITextureStyles::Diffusion >>>> %s: Called"
+ "<<<< CMITextureStyles::FastGaussian >>>> %s: CAPPED: blur will run at %ux%u, sigma=%.6f, kernel=%d (R=%d)"
+ "<<<< CMITextureStyles::FilmGrain >>>> %s: Called"
+ "<<<< CMITextureStyles::FilmGrain >>>> %s: FilmGrain:fullImageSize: %.1f x %.1f, naturalResolution: %.1f, grainSamplingScale: %.4f"
+ "<<<< CMITextureStyles::FilmGrainEffectParameters >>>> %s: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::FilmGrainEffectParameters >>>> %s: Missing '%s', using default %lu"
+ "<<<< CMITextureStyles::Glow >>>> %s: CMITextureStylesGlowParameters: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::Glow >>>> %s: CMITextureStylesGlowParameters: Missing '%s', using default %s"
+ "<<<< CMITextureStyles::Glow >>>> %s: Called"
+ "<<<< CMITextureStyles::Glow >>>> %s: linearBaseGain = %f"
+ "<<<< CMITextureStyles::GuidedFilterV3 >>>> %s: GuidedFilterV3: Calculated dimensions - FullImage: %.0fx%.0f at offset (%u,%u), TextureSize: %lux%lu, Sigma: %.3f, OrigBlurRadius: %.3f, MediumRes: %ux%u, LowRes: %ux%u, MediumToLow: %u, MediumSampling: %u, OutputBlurRadius: %.3f"
+ "<<<< CMITextureStyles::GuidedFilterV3 >>>> %s: GuidedFilterV3: Output texture format mismatch. Expected: RGBA16Float"
+ "<<<< CMITextureStyles::GuidedFilterV3 >>>> %s: GuidedFilterV3: Output texture size mismatch. Expected: %ux%u, Got: %lux%lu"
+ "<<<< CMITextureStyles::GuidedFilterV3 >>>> %s: Image dimensions must be greater than 2*radius+1. FullImage: {%d x %d}, radius: %f"
+ "<<<< CMITextureStyles::Halation >>>> %s: CMITextureStylesHalationParameters: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::Halation >>>> %s: CMITextureStylesHalationParameters: Validation failed for parameter: %s"
+ "<<<< CMITextureStyles::Halation >>>> %s: Called"
+ "<<<< CMITextureStyles::Halation >>>> %s: Halation: params.inputSpread is too small (%f), clamping it to: %f"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Called"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Downsample requested but outputDownsampledAndBlurredSize is not smaller than the crop / input size"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Either personData.faceLandmarks or personData.faceLandmarkType are NULL, or streamingMode should be set to YES"
+ "<<<< CMITextureStyles::Mattify >>>> %s: No downsampling requested requested but outputDownsampledAndBlurredSize is not equal to the crop / input size"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Skipping processing because minimum mask requirements are not met"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Unexpected number of levels in maxPyramidLevels: %d"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Upsampling requested but output is not inputImage sized"
+ "<<<< CMITextureStyles::Mattify >>>> %s: Upsampling requested with no downsampling but output is not outputDownsampledAndBlurredImage sized"
+ "<<<< CMITextureStyles::Mattify >>>> %s: [_parameters validate] returned error"
+ "<<<< CMITextureStyles::Mattify >>>> %s: downsampleFactor is not in [0..1] range"
+ "<<<< CMITextureStyles::Mattify >>>> %s: err=0x%x styleEngineThumbnailMode=%d"
+ "<<<< CMITextureStyles::Mattify >>>> %s: faceROI={%5.2f,%5.2f,%5.2f,%5.2f} extendedFaceROI={%5.2f,%5.2f,%5.2f,%5.2f}"
+ "<<<< CMITextureStyles::Mattify >>>> %s: image.fullImageRegion is null / empty"
+ "<<<< CMITextureStyles::Mattify >>>> %s: image.texture is nil"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputDownsampledAndBlurredImage fullImageRegion is not contained within inputImage fullImageRegion"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputDownsampledAndBlurredImage.fullImageRegion is null / empty"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputDownsampledAndBlurredImage.texture is nil"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputImage parameter not aligned with stopAfterDownsample parameter"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputImage.fullImageRegion is null / empty"
+ "<<<< CMITextureStyles::Mattify >>>> %s: outputImage.texture is nil"
+ "<<<< CMITextureStyles::Mattify >>>> %s: personData.faceROI is NULL"
+ "<<<< CMITextureStyles::Mattify >>>> %s: statsDict={ {%d}, {%5.2f,%5.2f,%5.2f}, {%5.2f} }"
+ "<<<< CMITextureStyles::MattifyStandaloneDynamicParameters >>>> %s: Missing '%s', using default value from kParameterEntries %.4f"
+ "<<<< CMITextureStyles::MattifyStandaloneDynamicParameters >>>> %s: Tuning entries not found. Will fall back to values from kParameterEntries"
+ "<<<< CMITextureStyles::MattifyStandaloneDynamicParameters >>>> %s: Validation rule failed for parameter: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s:   - degrungeSliderValue: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s:   - enableTextureAddback: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s:   - poresSliderValue: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s:   - useInPlaceShader: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s:   - useLivePhotoPath: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: Called"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Allocating and computing guided filter with highlight retention: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Calculated blur sigma - small: %f, large: %f, textureBlur: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Cannot fit within pool budget, skipping"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Computing stats via GPU shader"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Face rect height: %f, pores: %f, degrunge: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Face[%lu] transform - input: {%.4f, %.4f, %.4f, %.4f} -> output: {%.4f, %.4f, %.4f, %.4f}"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Failed to create compute encoder"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Final blending parameters:"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Generating intermediates to external outputs"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Invalid faceRoughness value from external stats: %.6f (expected in range [0.0, 1.0] and finite)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: LandmarkType is Vision76, Eye Protection possible"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Loaded external stats: skipPerson: %u, faceRoughness: %.6f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Mask coordinate transform - fullImage: {%.0f, %.0f}, maskRegion: {%.2f, %.2f, %.2f, %.2f}, maskRegionNorm: {%.4f, %.4f, %.4f, %.4f}, coversFullImage: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Multi-person mask failed (err=%d)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Nothing to do, skipping the face"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Processing  started with reference texture size: %lux%lu"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Processing skin mask with %lu faces%s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Region after padding: {%.2f, %.2f, %.2f, %.2f} (padding: %u)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Region before padding: {%.2f, %.2f, %.2f, %.2f}"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Skipping pack precomputed masks (streaming mode)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Stats buffer pool exhausted, allocating new buffer (%@)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Synthetic skin texture overlay disabled (minTexture and varTexture are zero)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Synthetic skin texture overlay enabled (minTexture: %.3f, varTexture: %.3f)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Texture addback computation completed with textureDetectScale: %.3f  strongTextureProtect: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Texture addback is disabled"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Tile padding calculation - smallBlurSigma: %.2f, largeBlurSigma: %.2f, smallBlurSupport: %u, largeBlurSupport: %u, tilePadding: %u (rounded to multiple of 16)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Using stats from personData.imageStats (bypassing GPU computation)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [Face Size] - Face too small relative to image. faceHeight=%.1f, diagRatio=%.1f%% (minimum=%.1f%%). Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [Large Blur] - Cannot find valid filter radius for guided filter. largeBlurSigma=%.2f, regionSize=%.0fx%.0f, faceHeight=%.1f, gFRadius=%.3f. Would fail in large blur calculation. Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [Sigma Sanity] - Blur sigma(s) too small or zero. smallBlurSigma=%.2f, largeBlurSigma=%.2f, textureBlurSigma=%.2f (minimum=%.2f). faceHeight=%.1f, detailSize=%.3f, gFRadius=%.3f. Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [Small Blur] - Cannot find valid filter radius for separable Gaussian. smallBlurSigma=%.2f, regionSize=%.0fx%.0f, faceHeight=%.1f, detailSize=%.3f. Would fail in small blur calculation. Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [Texture Blur] - Cannot find valid filter radius for texture blur. textureBlurSigma=%.2f, regionSize=%.0fx%.0f, faceHeight=%.1f, detailSize=%.3f. Would fail in texture blur calculation. Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: VALIDATION FAILED [fullImageSize Sanity] - fullImageSize.width = %.3f, fullImageSize.height = %.3f Skipping effect."
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: Validation PASSED - faceHeight=%.1f (diagRatio=%.1f%%), smallBlurSigma=%.2f, largeBlurSigma=%.1f, textureBlurSigma=%.2f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: bodyMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: budget clamp k=%.2f (peak=%.1fMB pool=%.1fMB) largeDS %.2f->%.2f smallDS %.2f->%.2f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: earsMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: eyebrowsMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: face region {%.2f, %.2f, %.2f, %.2f} (buffer {%.2f, %.2f, %.2f, %.2f}) has no overlap with texture bounds (%lux%lu); skipping face"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: faceSkinMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: glassesMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: hairMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: handsMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: lipsMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: packPrecomputedMasks capped dims - (%lux%lu)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: packPrecomputedMasks scale=(%.4f, %.4f) dims=(%lux%lu) max=(%lux%lu)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: personMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: tattoosMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone: teethMask is nil in stills mode"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:brightnessValue: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:degrunge: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:degrungeBody: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:detailSize: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:enableTextureAddback: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:eyeProtection: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:eyebrows: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:faceRect: {%.2f, %.2f, %.2f, %.2f}"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:fastMode: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:fullImageSize: (%.2f, %.2f)"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:gFContrast: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:gFRadius: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:hairClothes: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:hairTxFloor: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:handsAndEars: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:highlightRetention: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:hlBlurStrength: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:hlTextureRestore: %f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:lipContrast: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:lipCrease: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:lipHighlights: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:lipNegClar: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:maxDarknessTrigger: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:minDarknessTrigger: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:minTexture: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:nightMode: %s"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:nightModeSharpness: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:plusGreenGuide: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:pores: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:poresBody: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:regionToRender: {%.2f, %.2f, %.2f, %.2f}"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:roughSamples: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:skipping the face, no padding needed, returning _regionToRender with no extra padding"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:strongTextureProtect: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:tattooSmoothing: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:tattooWeight: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:teeth: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:textureClamp: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:textureDetectScale: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:textureRestore: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandalone >>>> %s: SkinSmoothStandalone:varTexture: %.3f"
+ "<<<< CMITextureStyles::SkinSmoothStandaloneDynamicParameters >>>> %s: Missing '%s', using default value from kParameterEntries %.4f"
+ "<<<< CMITextureStyles::SkinSmoothStandaloneDynamicParameters >>>> %s: Missing 'enableTextureAddback', using default %d"
+ "<<<< CMITextureStyles::SkinSmoothStandaloneDynamicParameters >>>> %s: Missing 'nightMode', using default %d"
+ "<<<< CMITextureStyles::SkinSmoothStandaloneDynamicParameters >>>> %s: Tuning entries not found. Will fall back to values from kParameterEntries"
+ "<<<< CMITextureStyles::SkinSmoothStandaloneDynamicParameters >>>> %s: Validation rule failed for parameter: %s"
+ "<<<< CMITextureStyles::UEB >>>> %s: CMITextureStylesUnderEyeBrightenParameters: Missing '%s', using default %.2f"
+ "<<<< CMITextureStyles::UEB >>>> %s: CMITextureStylesUnderEyeBrightenParameters: Missing '%s', using default %d"
+ "<<<< CMITextureStyles::UEB >>>> %s: Called"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:averageColorMix: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:bimodalVarianceFalloff: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:blendConditionFilterScale: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:brightnessMix: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:brightnessValue: %f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:colorBlendFilterScale: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:dominantYawTapering: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:hueMaskFilterScale: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maskThreshold: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maxDarknessTrigger: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maxFaceFrac: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maxHueTolerance: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maximumBimodalVariance: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:maximumUnimodalVariance: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:minDarknessTrigger: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:minFaceFrac: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:minHueTolerance: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:minTextureAddBack: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:nightMode: %s"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:nightModeSharpness: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:regionMaskThreshold: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:textureAddBackFilterScale: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:textureAddBackScale: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:unimodalVarianceFalloff: %.4f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:yawFallOff: %.3f"
+ "<<<< CMITextureStyles::UEB >>>> %s: UnderEyeBrighten:yawOffset: %.3f"
...
+ "<<<< TextureStylesProcessor >>>> %s: -[FigMetalAllocatorBackend setupWithDescriptor:] failed with err:%d"
+ "<<<< TextureStylesProcessor >>>> %s: Allocated render buffer %p for region (%g,%g,%g,%g)"
+ "<<<< TextureStylesProcessor >>>> %s: Allocating effect processors"
+ "<<<< TextureStylesProcessor >>>> %s: Could not create CMIExternalMemoryResource"
+ "<<<< TextureStylesProcessor >>>> %s: Could not create FigMetalAllocatorBackend"
+ "<<<< TextureStylesProcessor >>>> %s: Count not create FigMetalAllocatorBackendDescriptor"
+ "<<<< TextureStylesProcessor >>>> %s: Done waiting on effect processor allocations"
+ "<<<< TextureStylesProcessor >>>> %s: Failed to get effect renderer for type: %lu"
+ "<<<< TextureStylesProcessor >>>> %s: Invalid CMITextureStylesEffectDescriptor (%@) type CMITextureStylesEffectType_Invalid"
+ "<<<< TextureStylesProcessor >>>> %s: Texture and PixelBuffer bound to io property: %@"
+ "<<<< TextureStylesProcessor >>>> %s: Unable to create metal buffer cache"
+ "<<<< TextureStylesProcessor >>>> %s: Unsupported effect"
+ "<<<< TextureStylesProcessor >>>> %s: allImageRectIntersections differs from rounded rect: original={%.2f, %.2f, %.2f, %.2f}, rounded={%.2f, %.2f, %.2f, %.2f}"
+ "<<<< TextureStylesTuningLookup >>>> %s: CaptureMode '%@' not found for HardwareModel '%@' PortType '%@'"
+ "<<<< TextureStylesTuningLookup >>>> %s: Could not find the expected SmartStyleToTextureStyleMapping plist at %@"
+ "<<<< TextureStylesTuningLookup >>>> %s: Could not load a default configuration for TextureStyle presetName[%@]"
+ "<<<< TextureStylesTuningLookup >>>> %s: HardwareModel %@ not found in tuning plist"
+ "<<<< TextureStylesTuningLookup >>>> %s: Loaded tuning plist with %lu devices"
+ "<<<< TextureStylesTuningLookup >>>> %s: No 'Common' baseline found in preset dictionary"
+ "<<<< TextureStylesTuningLookup >>>> %s: PortType '%@' not found for HardwareModel '%@'"
+ "<<<< TextureStylesTuningLookup >>>> %s: Preset '%@' not found for HardwareModel '%@' PortType '%@' CaptureMode '%@'"
+ "<<<< TextureStylesTuningLookup >>>> %s: SmartStyleToTextureStyleMapping missing TextureStyle for cast[%@], returning default"
+ "<<<< TextureStylesTuningLookup >>>> %s: SmartStyleToTextureStyleMapping plist not loaded, returning default for cast[%@]"
+ "<<<< TextureStylesTuningLookup >>>> %s: SmartStyleToTextureStyleMapping.plist missing SmartStyleCastToTexturePresetMapping"
+ "Accessing out-of-bound CIC table"
+ "Accessing out-of-bound LSC table"
+ "Aperture diameter cannot be non-positive."
+ "BT"
...
+ "Error setting up FigMetalAllocator"
...
+ "Failed to create blemish with different key"
...
+ "Failed to decode v5 LCB entry"
+ "Failed to decode/migrate v4 LCB entry"
...
+ "Input ROI not contained within input texture extent"
+ "Input and output ROI sizes don't match"
...
+ "LCB database file missing moduleSerial"
+ "LCB database file missing sensorID"
...
+ "Non-positive ROI passed to getStatisticsFromTexture."
+ "Not a 420 buffer"
...
+ "Output ROI not contained within output texture extent"
...
+ "Required shared memory too large"
...
+ "Stop after downsample requested but outputDownsampledAndBlurredImage does not match the downsampled input"
+ "Supported"
...
+ "Unable to initialize CMITextureStyleEffect class"
...
+ "Unsupported"
+ "Unsupported LCB database version"
+ "Unsupported LCB entry version"
...
+ "Upsampling requested but output is not outputDownsampledAndBlurredImage sized"
+ "V:%d, m:%d.%d, f:%@, s:%@"
...
+ "Wrong CR plane size"
+ "YES"
+ "[_inputOutput isKindOfClass:CMITextureStylesBloomIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesDiffusionIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesFilmGrainIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesGlowIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesHalationIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesMattifyIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesSkinSmoothIO.class] is NULL"
+ "[_inputOutput isKindOfClass:CMITextureStylesUnderEyeBrightenIO.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesBloomParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesDiffusionParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesFilmGrainParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesGlowParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesHalationParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesSkinSmoothParameters.class] is NULL"
+ "[_parameters isKindOfClass:CMITextureStylesUnderEyeBrightenParameters.class] is NULL"
+ "[_parameters isKindOfClass:[CMITextureStylesMattifyParameters class]] is NULL"
...
+ "_filterBuf is NULL"
+ "_fullImageSize.width > 0 && _fullImageSize.height > 0 is NULL"
+ "_gdcParams is NULL"
+ "_generateColorCubesPipelineState is NULL"
+ "_globalHistogramPipelineState is NULL"
+ "_globalStatsPipelineState is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 1 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 10 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 11 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 2 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 3 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 4 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 5 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 6 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 7 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 8 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_grainBlendPipeline[SHADER_ENUM( 9 )] = [_metalContext computePipelineStateFor:@ \"CMITextureStylesFilmGrain::GrainBlend\" constants:constants] is NULL"
+ "_guideTexture is NULL"
+ "_guidedFilterATextureAndFullImageRegion is NULL"
+ "_guidedFilterBTextureAndFullImageRegion is NULL"
+ "_halationMask is NULL"
+ "_histogram is NULL"
...
+ "_metalContext.commandBuffer is NULL"
+ "_nccWorkStorage nil"
...
+ "_paramsBuf is NULL"
+ "_personData.faceLandmarks is NULL"
...
+ "_shader is NULL"
+ "_shaders is NULL"
+ "_shadersWithConstants[SHADER_WITH_CONSTANTS_ENUM( ApplyRegionAddbackAndEditingStrength )][styleEngineThumbnailModeValI] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"ApplyRegionAddbackAndEditingStrength\" constants:constants] is NULL"
+ "_shadersWithConstants[SHADER_WITH_CONSTANTS_ENUM( CalculateBlendCondition )][styleEngineThumbnailModeValI] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateBlendCondition\" constants:constants] is NULL"
+ "_shadersWithConstants[SHADER_WITH_CONSTANTS_ENUM( CalculateValidMask )][styleEngineThumbnailModeValI] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateValidMask\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( BoxDownsample )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"BoxDownsample\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CalculateAverageColor )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateAverageColor\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CalculateFracMaskHighlights )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateFracMaskHighlights\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CalculateHistogramR )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateHistogramR\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CalculateHistogramRGBA )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateHistogramRGBA\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CalculateQuantiles )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CalculateQuantiles\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CopyStats )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CopyStats\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CreateExclusionMask )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CreateExclusionMask\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CropAndBoxDownsample )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CropAndBoxDownsample\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( CropAndReSample )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"CropAndReSample\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( GenerateHistogramInputColorImage )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"GenerateHistogramInputColorImage\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( GenerateMin3GrayHistogramInputImage )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"GenerateMin3GrayHistogramInputImage\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( GenerateStrengthHistogramInputImages )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"GenerateStrengthHistogramInputImages\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( ReSample )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"ReSample\" constants:constants] is NULL"
+ "_shadersWithoutConstants[SHADER_WITHOUT_CONSTANTS_ENUM( ScaleByValidMask )] = [_context computePipelineStateFor:@ \"CMITextureStylesMattify::\" \"ScaleByValidMask\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( AverageColor )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"AverageColor\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( Brighten )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"Brighten\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( CalculateLumaVarianceAndInferDistributionModality )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"CalculateLumaVarianceAndInferDistributionModality\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( CalculateVarianceBasedStrengthTaper )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"CalculateVarianceBasedStrengthTaper\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( Copy )] = [_context computePipelineStateFor:@ \"CMITextureStylesTextureCopy::\" \"Copy\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( CopyStats )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"CopyStats\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( CreateEyeMask )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"CreateEyeMask\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( CreateHueMask )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"CreateHueMask\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( DownSample )] = [_context computePipelineStateFor:@ \"CMITextureStylesDownSampler::\" \"DownSample\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( DownSample )] = [_context computePipelineStateFor:@ \"CMITextureStylesPyramid::\" \"DownSample\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( FinalMix )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"FinalMix\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_1 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_10 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_11 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_2 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_3 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_4 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_5 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_6 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_7 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_8 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GAUSSIAN_SHADER_NAME_9 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GAUSSIAN_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_10 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_11 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_4 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_5 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_6 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_7 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_8 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GF_SHADER_9 )] = [_context computePipelineStateFor:@ \"CMITextureStylesGuidedFilter::\" STRING( GF_SHADER ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_1 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_10 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_11 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_2 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_3 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_4 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_5 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_6 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_7 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_8 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GUIDED_SHADER_NAME_9 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GaussianBlur )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianFilter::\" \"GaussianBlur\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GaussianBlur2dShared )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianFilter::\" \"GaussianBlur2dShared\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GaussianBlurHorizontal )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianFilter::\" \"GaussianBlurHorizontal\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( GaussianBlurVertical )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianFilter::\" \"GaussianBlurVertical\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( MTLPixelFormatR16Float )] = [_context renderPipelineStateForVertexFunction:@\"CMITextureStylesTextureWarping::VertexWarp\" vertexDescriptor:nil fragmentFunction:@\"CMITextureStylesTextureWarping::FragmentWarp\" constants:nil colorAttachmentDescriptorArrray:@[desc]] is NULL"
+ "_shaders[SHADER_ENUM( Rescale )] = [_context computePipelineStateFor:@ \"CMITextureStylesDownSampler::\" \"Rescale\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_1 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_10 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_11 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_2 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_3 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_4 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_5 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_6 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_7 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_8 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SELF_GUIDED_SHADER_NAME_9 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( SELF_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SimdGaussianBlur )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianFilter::\" \"SimdGaussianBlur\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( SumColorAndFillLumaHistogram )] = [_context computePipelineStateFor:@ \"CMITextureStylesUnderEyeBrighten::\" \"SumColorAndFillLumaHistogram\" constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_1 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_10 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_11 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_2 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_3 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_4 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_5 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_6 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_7 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_8 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( WEIGHTED_GUIDED_SHADER_NAME_9 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFilter::\" STRING( WEIGHTED_GUIDED_SHADER_NAME ) constants:constants] is NULL"
+ "_shaders[SHADER_ENUM( build_lr_from_full )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianGuidedFilterV3::\" \"build_lr_from_full\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( downsample_area_pow2 )] = [_context computePipelineStateFor:@ \"CMITextureStylesFastGaussian::\" \"downsample_area_pow2\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( downsample_nearest2d )] = [_context computePipelineStateFor:@ \"CMITextureStylesFastGaussian::\" \"downsample_nearest2d\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( gaussian_h )] = [_context computePipelineStateFor:@ \"CMITextureStylesFastGaussian::\" \"gaussian_h\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( gaussian_v )] = [_context computePipelineStateFor:@ \"CMITextureStylesFastGaussian::\" \"gaussian_v\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( guided_lr_2d )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianGuidedFilterV3::\" \"guided_lr_2d\" constants:nil] is NULL"
+ "_shaders[SHADER_ENUM( upsample_apply_to_mr )] = [_context computePipelineStateFor:@ \"CMITextureStylesGaussianGuidedFilterV3::\" \"upsample_apply_to_mr\" constants:nil] is NULL"
+ "_shaders[Shader_computeFaceRoughnessKernel] is NULL"
+ "_shaders[Shader_computeTextureAmountKernel] is NULL"
+ "_shaders[Shader_copyStatsKernel] is NULL"
+ "_shaders[Shader_createWeightedAndGuideImages] is NULL"
+ "_shaders[Shader_downSample] is NULL"
+ "_shaders[Shader_finalBlendingKernelInPlace] is NULL"
+ "_shaders[Shader_finalBlendingKernel] is NULL"
+ "_shaders[Shader_multiPersonSkinMaskBlending] is NULL"
+ "_shaders[Shader_packPrecomputedMasksKernel] is NULL"
+ "_sharedEventListener is NULL"
+ "_skinSmoothGuidedAvgPipeline is NULL"
+ "_skinSmoothGuidedCoeffPipeline is NULL"
+ "_smallBlurTextureAndFullImageRegion is NULL"
...
+ "_statsBufferPool is NULL"
+ "_statsBuffers is NULL"
+ "_subtractMask is NULL"
...
+ "accelRef is NULL"
+ "all set image rects do not intersect"
+ "allocator is NULL"
...
+ "averageFaceColor && [averageFaceColor isKindOfClass:NSArray.class] && ( 3 == averageFaceColor.count ) && [averageFaceColor[0] isKindOfClass:NSNumber.class] && [averageFaceColor[1] isKindOfClass:NSNumber.class] && [averageFaceColor[2] isKindOfClass:NSNumber.class] is NULL"
+ "avg && [avg isKindOfClass:NSArray.class] && ( 3 == avg.count ) && [avg[0] isKindOfClass:NSNumber.class] && [avg[1] isKindOfClass:NSNumber.class] && [avg[2] isKindOfClass:NSNumber.class] is NULL"
+ "bd is NULL"
+ "benc is NULL"
+ "blemishType"
+ "blitEncoder is NULL"
+ "bloom is NULL"
+ "blurHPS is NULL"
+ "blurInputTex is NULL"
+ "blurOutputTex is NULL"
+ "blurVPS is NULL"
+ "blurredTex is NULL"
+ "boxDownsamplePS is NULL"
...
+ "cmi_texture_styles_bloom_trace"
+ "cmi_texture_styles_diffusion_trace"
+ "cmi_texture_styles_film_grain_trace"
+ "cmi_texture_styles_glow_trace"
+ "cmi_texture_styles_halation_trace"
+ "cmi_texture_styles_mattify_trace"
+ "cmi_texture_styles_skinsmooth_trace"
+ "cmi_texture_styles_ueb_trace"
+ "cmissim_trace"
+ "cmitexturestyleseffect_trace"
+ "cmitip_trace"
+ "cmitipconfig_trace"
+ "cmituning_trace"
...
+ "computeMinimumInputRegionInFullImageCoordsOut is NULL"
+ "computeTransformInternal failed"
+ "computeTransformInternal() failed"
+ "computedMinimumInputRegionInFullImageCoordsOut is NULL"
+ "config is NULL"
...
+ "correctionFeatures is NULL"
+ "correctionPatchBytes"
+ "crgApplyNode is NULL"
+ "crgInputDeltaMap set while crgInput/crgOutput not"
+ "cropAndDownsamplePS is NULL"
+ "croppedAndPartiallyDownsampledTex is NULL"
+ "croppedRescaledMattifyExcludeMask is NULL"
+ "croppedRescaledRefPersonUnderEyeMask is NULL"
+ "currentOutput is NULL"
+ "currentOutputPtr is NULL"
+ "curve is NULL"
+ "dataBuffer is NULL"
...
+ "diffusion is NULL"
+ "downScaledIm is NULL"
+ "downScaledTex is NULL"
+ "dryRunAllocations"
+ "dstSharedEvent is nil"
+ "effect dynamic parameters is nil"
...
+ "filename is null"
+ "filmGrain is NULL"
+ "filterRadius is NULL"
+ "filterScale >= 1.f is NULL"
+ "filter_coefficients"
+ "firstFilterRadius is NULL"
+ "firstFilterScale >= 1.f is NULL"
+ "gauss2D is NULL"
+ "gdcParams is nil"
...
+ "hd is NULL"
+ "heap is NULL"
+ "highlightsToMaskRatio && [highlightsToMaskRatio isKindOfClass:NSNumber.class] is NULL"
+ "histEqLUT nil"
+ "histEqTex is NULL"
+ "histogram has all-zero values"
+ "histogram nil"
+ "histogramBuffer is NULL"
+ "histogramColor is NULL"
+ "histogramImageHighlights is NULL"
+ "histogramMin3Gray is NULL"
+ "histogramWarpedMaskBinary is NULL"
...
+ "input is NULL"
+ "input.height == guide.height is NULL"
+ "input.height == output.height is NULL"
+ "input.height == outputA.height is NULL"
+ "input.height == outputB.height is NULL"
+ "input.texture is NULL"
+ "input.width == guide.width is NULL"
+ "input.width == output.width is NULL"
+ "input.width == outputA.width is NULL"
+ "input.width == outputB.width is NULL"
+ "inputCoefficients is NULL"
+ "inputDownsampledTex is NULL"
...
+ "inputOutput.inputImage.texture is NULL"
+ "inputOutput.inputSkinMaskAndFullImageRegion.texture is NULL"
+ "inputOutput.outputImage.texture is NULL"
+ "inputROI not contained within inputTexture bounds"
+ "inputReferenceMaskTexture is NULL"
+ "inputReferenceMaskTextureCoords is NULL"
+ "inputReferenceMaskTriangleVertices is NULL"
...
+ "intermediateTextureAndFullImageRegions is NULL"
+ "intermediatesAndStats is NULL"
+ "inverseScalingLUT is NULL"
+ "io.inputFaceMask.texture is NULL"
+ "io.inputImage.texture is NULL"
+ "io.inputInstanceMask.texture is NULL"
+ "io.outputImage.texture is NULL"
...
+ "keypoints nil"
+ "leftAvgCol && [leftAvgCol isKindOfClass:NSArray.class] && ( 3 == leftAvgCol.count ) && [leftAvgCol[0] isKindOfClass:NSNumber.class] && [leftAvgCol[1] isKindOfClass:NSNumber.class] && [leftAvgCol[2] isKindOfClass:NSNumber.class] is NULL"
+ "leftIsBiModal && [leftIsBiModal isKindOfClass:NSNumber.class] is NULL"
+ "leftVariance && [leftVariance isKindOfClass:NSNumber.class] is NULL"
+ "lhsDescriptor is NULL"
+ "lhsMatrix is NULL"
+ "linearMixForBG is nil"
+ "linearMixForSkin is nil"
+ "lr_x && lr_y && A_lr && b_lr is NULL"
...
+ "mattify is NULL"
+ "mattifyIO is NULL"
+ "memoryResource = self.memoryResource ?: ( self.memoryResource = [self _createMemoryResource] ) is NULL"
...
+ "outExtendedFaceROI is NULL"
+ "outLeftCheekROI is NULL"
+ "outMatrix nil"
+ "outRightCheekROI is NULL"
+ "outTexChma is not RG8Unorm"
+ "outTexLuma is not R8Unorm"
+ "outTotalCornerStrength nil"
+ "outTriangleVerticesLeft is NULL"
+ "outTriangleVerticesRight is NULL"
+ "output is NULL"
+ "outputA is NULL"
+ "outputB is NULL"
...
+ "rhsMatrix is NULL"
+ "rightAvgCol && [rightAvgCol isKindOfClass:NSArray.class] && ( 3 == rightAvgCol.count ) && [rightAvgCol[0] isKindOfClass:NSNumber.class] && [rightAvgCol[1] isKindOfClass:NSNumber.class] && [rightAvgCol[2] isKindOfClass:NSNumber.class] is NULL"
+ "rightIsBiModal && [rightIsBiModal isKindOfClass:NSNumber.class] is NULL"
+ "rightVariance && [rightVariance isKindOfClass:NSNumber.class] is NULL"
+ "roi parameters has issues"
+ "rough && [rough isKindOfClass:NSNumber.class] is NULL"
...
+ "secondFilterRadius is NULL"
+ "secondFilterScale >= 1.f is NULL"
+ "selectedShader is NULL"
+ "self nil"
+ "self->subAllocator[subAllocatorID] is NULL"
+ "self.metalCommandQueue is NULL"
...
+ "shader is NULL"
+ "sigma > 0.0f && nSamples > 0 && targetBlurRadius > 0.0f is NULL"
+ "simdGaussPipeline is NULL"
+ "simd_all( self.spotlightCount > 0 ) is NULL"
+ "skinSmoothStandalone is NULL"
+ "skip && [skip isKindOfClass:NSNumber.class] is NULL"
+ "smallBgLTMGainMap is NULL"
+ "smallBlurTex is NULL"
...
+ "ss_computeBlurDownScaleFactors"
...
+ "textureCopier is NULL"
+ "textureDesc nil"
+ "textureDescriptor is NULL"
+ "texture_styles_film_grain_effect_parameters_trace"
+ "texture_styles_mattify_dynamic_parameters_trace"
+ "texture_styles_person_input_data_trace"
+ "texture_styles_processor_trace"
+ "texture_styles_skin_smooth_dynamic_parameters_trace"
+ "texture_styles_tuning_lookup_trace"
...
+ "tmpBuffer is NULL"
+ "tmpData is NULL"
+ "tmpDownScaleFactor >= 1.f is NULL"
+ "tmpFilterRadius is NULL"
+ "tmpImage is NULL"
+ "tmpNearest is NULL"
+ "tmpTex is NULL"
+ "tmpTexture is NULL"
...
+ "triangleVertices is NULL"
+ "triangleVerticesOut || roiOut is NULL"
+ "triangleVerticesX is NULL"
+ "triangleVerticesXY is NULL"
+ "triangleVerticesY is NULL"
+ "tsf_findBestRadiusAndScale"
+ "uebIO is NULL"
+ "ueb_generateTrianglesAndComputeROI"
+ "ueb_unpackStats"
+ "uncroppedGrid is nil"
+ "underEyeBrighten is NULL"
+ "upsamplePS is NULL"
+ "v3 CIC data is nil"
+ "v3 LSC data is nil"
+ "validMask is NULL"
...
+ "vertexData is NULL"
+ "vnrprocessor_trace"
+ "warpedMaskAggregate is NULL"
+ "warpedTex is NULL"
+ "warpedUnderEyeReferenceMask.texture is NULL"
+ "weightedTex is NULL"
