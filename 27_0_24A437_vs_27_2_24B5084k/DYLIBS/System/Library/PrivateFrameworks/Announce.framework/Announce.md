...
-  __AUTH_CONST.__objc_const: 0x5610
...
+ _objc_msgSend$hmu_homesFromHomes:withHomeLocationStatus:
+ _objc_msgSend$isAnnounceAvailable
+ _symbolic SS4room_t
- ___swift_memcpy24_8
CStrings:
