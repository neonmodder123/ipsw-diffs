...
Symbols:
+ -[PXSyntheticUIMediaProvider delaysImageRequests]
+ -[PXSyntheticUIMediaProvider setDelaysImageRequests:]
+ -[PXUserTransformView setUserAffineTransform:asUserZoom:]
+ -[UIScrollView(PhotosUICore) px_setPocketPreferredUserInterfaceStyle:forEdges:]
...
+ _OBJC_IVAR_$_PXSyntheticUIMediaProvider._delaysImageRequests
+ _PXAssetActionTypeShowAdjustKeywords
+ _UIAccessibilityTraitHeader
+ _arc4random_uniform
+ _associated conformance 18PhotosUIFoundation0A18StatusSymbolEffectOSHAASQ
+ _objc_msgSend$delaysImageRequests
+ _objc_msgSend$setAccessibilityLabel:
+ _objc_msgSend$setIsAccessibilityElement:
+ _objc_msgSend$setUserAffineTransform:
+ _symbolic Ig_
+ _symbolic _____ 18PhotosUIFoundation0A18StatusSymbolEffectO
...
- _PXBarItemIdentifierShowAll
- _PXBarItemIdentifierSlideshow
- _PXBarItemIdentifierSummarize
- _PXResolvedPocketUserInterfaceStyle
- _objc_msgSend$orientation
CStrings:
+ "PXAssetActionTypeShowAdjustKeywords"
- "PXBarItemIdentifierAddTo"
- "PXBarItemIdentifierButtonEndSpacing"
- "PXBarItemIdentifierEdit"
- "PXBarItemIdentifierFavorite"
- "PXBarItemIdentifierSharedCollectionAddParticipants"
- "PXBarItemIdentifierSharedCollectionShowShareOptions"
- "PXBarItemIdentifierShowAll"
- "PXBarItemIdentifierSlideshow"
- "PXBarItemIdentifierSummarize"
```
