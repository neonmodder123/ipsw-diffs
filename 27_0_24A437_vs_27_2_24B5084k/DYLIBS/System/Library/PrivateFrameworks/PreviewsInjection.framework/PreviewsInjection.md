...
+ _symbolic _____AASgIegnr_ So6CGSizeV
+ _symbolic _____AASgIegyd_ So6CGSizeV
+ _symbolic _____Sg So6CGSizeV
+ _symbolic _____SgAAScMYcc So6CGSizeV
...
- _symbolic __________SgIegyn_ 19PreviewsOSSupportUI19ShellToAgentMessageO 0a8ServicesC005SceneG9ResponderV
- _type_layout_string So7CGPointV
CStrings:
+ "Reporting preferred size %{public}s within maximum %{public}s"
```
