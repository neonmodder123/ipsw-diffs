...
+ ___HKMCHistoricalAnalysisCategoryTypes_block_invoke
+ __swift_FORCE_LOAD_$_swiftCoreAudio
+ __swift_FORCE_LOAD_$_swiftCoreAudio_$_HealthMenstrualCycles
+ __swift_FORCE_LOAD_$_swiftCoreImage
+ __swift_FORCE_LOAD_$_swiftCoreImage_$_HealthMenstrualCycles
+ _associated conformance So42HKFeatureAvailabilityRequirementIdentifieraSHSCSQ
+ _associated conformance So42HKFeatureAvailabilityRequirementIdentifieras20_SwiftNewtypeWrapperSCSY
+ _associated conformance So42HKFeatureAvailabilityRequirementIdentifieras20_SwiftNewtypeWrapperSCs35_HasCustomAnyHashableRepresentation
+ _objc_allocWithZone
...
+ _symbolic _____ 21HealthMenstrualCycles27MenopauseRegionAvailabilityO
+ _symbolic _____ So42HKFeatureAvailabilityRequirementIdentifiera
