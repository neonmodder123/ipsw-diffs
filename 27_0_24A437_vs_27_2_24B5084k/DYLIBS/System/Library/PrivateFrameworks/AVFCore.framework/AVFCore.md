...
+ "<<<< AVActivityProgressClient >>>> %s: Clearing failed state for activity %@"
...
+ "<<<< AVActivityProgressClient >>>> %s: Dropping failActivityForTaskID %s: ActivityProgressUI server unavailable"
...
+ "<<<< AVActivityProgressClient >>>> %s: Dropping unfailActivityForTaskID %s: ActivityProgressUI server unavailable"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Cancelling %lu downloads for activity %@"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Download %@ not tracked at terminal (status=%ld)"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Download %@ not tracked; ignoring retry notification"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Failed to arm the cooldown hold for '%@'; ending the activity now"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Failed to generate activity ID for bundle '%@'"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Failing activity for '%@' (%ld completed, %ld failed)"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Holding activity for '%@' at its terminal frame for %lld ms before ending (%ld completed, %ld failed)"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Live Activity configuration loaded: cooldownMS=%lld"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: No bundle identifier for download %@"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Progress update: %lld/%lld for bundle '%@'"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Skipping Live Activity registration because bundle '%@' is disabled"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Starting new activity with ID %@ for bundle '%@'"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Still %lu downloads active for '%@', updating progress"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Terminal for '%@' (%ld completed, %ld failed); ending"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: Unregistering download (%@) (terminalStatus=%ld, error=%@ [%ld])"
...
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: registerDownload called with nil download"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: registerDownload called with no download identifier"
+ "<<<< AVAssetDownloadLiveActivity >>>> %s: unregisterDownload called with nil download"
