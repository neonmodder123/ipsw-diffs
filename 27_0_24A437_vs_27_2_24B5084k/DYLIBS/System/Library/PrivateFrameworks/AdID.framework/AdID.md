...
-638.1.7.0.0
-  __TEXT.__text: 0x18eb0
+638.2.0.0.0
+  __TEXT.__text: 0x18ee8
...
+ _objc_msgSend$remoteLoadFailedWithError:
Functions:
~ -[ADSegmentDataManager handleJingleSegmentResponse:activeRecord:completionHandler:] : 1840 -> 1896
```
