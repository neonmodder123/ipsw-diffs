...
+ _atan2
+ _hypot
+ _objc_msgSend$_acceptsTapNoiseForKey:
+ _objc_msgSend$_clampedThumbLengthCM:
+ _objc_msgSend$_configureKey:domain:defaultValue:
+ _objc_msgSend$_isLeftThumbOption:
+ _objc_msgSend$_thumbReachReference
+ _objc_msgSend$generatePerimeterPointWithCenter:bounds:offset:
+ _objc_msgSend$generateThumbReachPointForKeyCenter:reference:errorScale:millimetresPerPoint:
+ _objc_msgSend$millimetresPerPoint
+ _objc_msgSend$nativeScale
+ _objc_msgSend$senderProperties
+ _objc_msgSend$setShowAllKeysDebugHitArea:
+ _objc_msgSend$setTapKeyPerimeterOffset:
+ _objc_msgSend$setTapThumbAnchorY:
+ _objc_msgSend$setTapThumbErrorScale:
+ _objc_msgSend$setTapThumbHand:
+ _objc_msgSend$setTapThumbLength:
+ _objc_msgSend$tapKeyPerimeterOffset
+ _objc_msgSend$tapThumbAnchorY
+ _objc_msgSend$tapThumbErrorScale
+ _objc_msgSend$tapThumbHand
+ _objc_msgSend$tapThumbLength
+ _objc_msgSend$thumbBaseSigmaMMForLengthCM:
+ _objc_msgSend$thumbReachRadiusMMForLengthCM:
+ _objc_msgSend$thumbReachReferenceForLengthCM:anchor:isRightThumb:
+ _objc_msgSend$validateTouchPoint:withinBounds:
+ _sin
