...
- _objc_msgSend$_advertisableFeature
- _objc_msgSend$_backgroundDelivery
- _objc_msgSend$_classification
- _objc_msgSend$_eventSubmission
...
- _objc_msgSend$_promotionFeatureTag
- _objc_msgSend$_requirementIdentifiersForRequirements:
- _objc_msgSend$addObjectsFromArray:
- _objc_msgSend$ageIsPresent
- _objc_msgSend$areAllRequirementsSatisfied
- _objc_msgSend$countryCodeIsPresentForFeatureWithIdentifier:
- _objc_msgSend$countryIsSupportedOnLocalDeviceForFeatureWithIdentifier:
- _objc_msgSend$defaultOnboardingEligibilityRequirementsForFeatureIdentifier:
- _objc_msgSend$dictionaryWithObjects:forKeys:count:
- _objc_msgSend$featureIsOffWithIdentifier:isOffIfSettingIsAbsent:
- _objc_msgSend$featureIsOnWithIdentifier:isOnIfSettingIsAbsent:
- _objc_msgSend$featureStatusWithError:
- _objc_msgSend$fitnessTrackingIsEnabledInPrivacy
- _objc_msgSend$healthAppIsNotHidden
- _objc_msgSend$heightIsPresent
- _objc_msgSend$hk_map:
- _objc_msgSend$hk_removeObjectsPassingTest:
- _objc_msgSend$hkmobility_requestForCategory:shouldHidePregnancyContent:
- _objc_msgSend$initWithFeatureIdentifier:healthStore:countryCodeSource:
- _objc_msgSend$initWithHealthStore:
- _objc_msgSend$initWithRequirementsByContext:
- _objc_msgSend$isNotInPostPregnancy
- _objc_msgSend$mutableCopy
- _objc_msgSend$noOngoingPregnancy
- _objc_msgSend$notAgeGatedForUserDefaultsKey:
- _objc_msgSend$notificationAuthorizedWithBundleIdentifier:
...
- _objc_msgSend$postNotificationWithRequest:completion:
- _objc_msgSend$profileIsNotFamilySetupPairingProfile
- _objc_msgSend$requirementIdentifier
- _objc_msgSend$walkingSteadinessCapabilityIsSupportedOnLocalDevice
- _objc_release_x27
- _objc_release_x28
CStrings:
