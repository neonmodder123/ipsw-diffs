...
+ _objc_msgSend$ageRatingFrameWithSize:atEndOfLineFrame:
...
+ _objc_msgSend$preferredLabelAlignmentForSize:compatibleWithTraitCollection:
+ _objc_msgSend$resolveLayoutFittingSize:
+ _objc_msgSend$setAgeRatingImage:
...
- _objc_msgSend$asc_layoutTraitEnvironment
- _objc_msgSend$preferredLabelAlignmentForSize:
...
- _objc_msgSend$traitEnvironmentWithTraitCollection:
CStrings:
