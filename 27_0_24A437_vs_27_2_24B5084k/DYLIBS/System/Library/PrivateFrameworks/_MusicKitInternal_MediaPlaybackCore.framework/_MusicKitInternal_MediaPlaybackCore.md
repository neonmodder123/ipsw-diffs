...
-4026.110.3.0.0
-  __TEXT.__text: 0x155b4
+4026.210.18.1.0
+  __TEXT.__text: 0x16630
...
CStrings:
+ "Attached %{public}ld bytes of Siri asset info for %{public}s."
+ "Failed to serialize %{public}s as Siri asset info: %{public}@. Playing without it."
```
