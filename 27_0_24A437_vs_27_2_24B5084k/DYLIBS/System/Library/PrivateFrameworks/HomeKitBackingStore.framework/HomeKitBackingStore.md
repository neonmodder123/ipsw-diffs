...
-1493.1.5.1.1
-  __TEXT.__text: 0x9e414
-  __TEXT.__objc_methlist: 0x549c
+1514.0.0.0.1
+  __TEXT.__text: 0x9e5e4
...
CStrings:
+ "[%{public}@] [HMBModel hmbMerge:from:] called with nil container on source (worrisome in production code)."
+ "[%{public}@] [HMBModel hmbMerge:from:] called with nil container on target (worrisome in production code)."
+ "[HMBModel hmbMerge:from:] called with nil container on source (worrisome in production code)."
+ "[HMBModel hmbMerge:from:] called with nil container on target (worrisome in production code)."
