...
+  __AUTH_CONST.__const: 0xb7c0
+  __AUTH_CONST.__cfstring: 0xcf60
+  __AUTH_CONST.__objc_const: 0x221f0
...
+ _objc_msgSend$deallocEndNavigationReason
+ _objc_msgSend$path
+ _objc_msgSend$resetWithReason:
+ _objc_msgSend$setAvoidHighways:
+ _objc_msgSend$setAvoidTolls:
+ _objc_msgSend$setDeallocEndNavigationReason:
