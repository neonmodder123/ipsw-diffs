...
+ "-CMSVARouting- %s: Adding Speaker to nonDefault builtIn route(s) because Receiver is disabled."
...
+ "-CMSVARouting- %s: Found disabled port %u of type %c%c%c%c"
...
+ "-CMSessionMgr- %s: No format to set; just setting sample rate"
...
+ "-CMSessionMgr- %s: found a volumeButtonClient (or a playing 3P cast); BUT it is not active"
...
+ "-FigRouteDiscoveryManager- %s: requestedRouteUID='%{public}@', airPlayEndpointRouteUID='%{public}@', airPlayEndpointRouteName='%{public}@', airPlayEndpoint isRemoteControlOnly=%{BOOL}u, airPlayEndpoint isWHAGroupable=%{BOOL}u, airPlayEndpoint isLocalDevice = %{BOOL}u, routeDescriptor='%{public}@'"
...
+ "-MXCoreSessionBase- %s: Session '%@' is not routed to on-demand VAD, skipping"
...
+ "-MXSessionManagerUtilities- %s: Sending to banner for bundleID: %@ with localized string %@"
+ "-MXSessionManagerUtilities- %s: Sending volume-following toggle snapshot telemetry: %{public}@"
...
+ "-MXSystemSounds- %s: clamping system sound to min of: maxVolume = %f, media rawVolume = %f"
...
+ "-MXVolumeClient_Common- %s: Not posting notification to Control Center volume clients (category=%{public}@, routeChanged=%d, hasVolumeButtonClientSession=%d, isBroadcastRoute=%d)"
...
+ "-MXVolumeClient_Common- %s: Posting Audio/Video volume notification (volume %1.3f) for the current route to %lu AVVolumeClients"
...
+ "Active endpoint does not advertise the requested launch mode"
...
+ "IS NOT"
+ "Identifier is NULL"
+ "Ignoring GetMediaSourceData from non-active casting client"
+ "Ignoring SendData from non-active casting client"
+ "Ignoring SetMediaSourceData from non-active casting client"
+ "In"
+ "Incorrect priority"
...
+ "cmsmIsAnyPortOfTypeCurrentlyDisabled"
