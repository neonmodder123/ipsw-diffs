...
CStrings:
+ "AvailabilityReporter.coalescedWrite"
+ "XPC: invokedProviderName() returned %s"
+ "waitlistMessage: end"
+ "waitlistMessage: failed for featureID=%{public}s: %{public}@"
+ "waitlistMessage: featureID=%{public}s hasMessage=%{bool,public}d"
+ "waitlistMessage: missingEntitlementForAdditionalCapability"
+ "waitlistMessage: start"
```
