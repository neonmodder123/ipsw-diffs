...
+ _memcpy
+ _memmove
+ _objc_msgSend$firstInteractionClass
+ _objc_msgSend$localizedOntologyPreferredNames
+ _objc_msgSend$localizedOntologyPregnancyTrimesterLactationRatings
+ _objc_msgSend$secondInteractionClass
+ _objc_retain_x9
+ _swift_allocBox
+ _swift_allocError
+ _swift_allocObject
