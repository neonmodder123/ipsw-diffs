...
+  __DATA_CONST.__objc_selrefs: 0x7f70
...
+ _NSStringFromRect
+ _objc_msgSend$_sceneManagerForModalAlerts
+ _objc_msgSend$dictionaryWithObject:forKey:
+ _objc_msgSend$disambiguationLabelDetails
...
- _objc_msgSend$_sceneForModalAlerts
CStrings:
