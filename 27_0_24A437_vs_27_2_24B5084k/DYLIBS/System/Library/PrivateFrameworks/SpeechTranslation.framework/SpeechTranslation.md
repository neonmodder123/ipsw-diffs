...
-389.1.0.0.0
-  __TEXT.__text: 0x328c4
-  __TEXT.__objc_methlist: 0x1314
+393.1.0.0.0
+  __TEXT.__text: 0x33978
...
+ _objc_msgSend$addAudioBuffer:forSourceLocale:
+ _objc_msgSend$conversationalCoordinator
+ _objc_msgSend$finishInputForSourceLocale:
+ _objc_msgSend$inputDidFinish
+ _objc_msgSend$setConversationalCoordinator:
+ _objc_msgSend$setDelegate:forSourceLocale:
+ _objc_msgSend$supportsSourceLocale:targetLocale:
