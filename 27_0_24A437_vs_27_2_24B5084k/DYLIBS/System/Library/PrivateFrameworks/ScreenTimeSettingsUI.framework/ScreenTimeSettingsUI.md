...
-655.0.107.0.0
-  __TEXT.__text: 0x12a4e8
-  __TEXT.__objc_methlist: 0xc7e4
-  __TEXT.__const: 0x3db4
-  __TEXT.__cstring: 0xe475
-  __TEXT.__oslogstring: 0x6173
+655.1.6.1.0
+  __TEXT.__text: 0x12b160
+  __TEXT.__objc_methlist: 0xc84c
+  __TEXT.__const: 0x3da4
+  __TEXT.__cstring: 0xe5d5
+  __TEXT.__oslogstring: 0x61d3
...
-  __AUTH_CONST.__objc_const: 0x26128
...
-  __AUTH.__objc_data: 0x52c8
+  __AUTH_CONST.__auth_got: 0x18d8
+  __AUTH.__objc_data: 0x5278
   __AUTH.__data: 0xa58
...
+ _objc_msgSend$_accessibilityAskBypassCapabilityForItem:newValue:viewModel:
+ _objc_msgSend$_labelNameForItem:
+ _objc_msgSend$_openAccessibilityRestrictions
+ _objc_msgSend$_showAccessibilityAskBypassAlertForCapability:
+ _objc_msgSend$_showAccessibilityAskBypassAlertIfNeededForCapabilityNumber:
+ _objc_msgSend$_userStateWarrantsAccessibilityAskBypassAlertForViewModel:
+ _objc_msgSend$setUserIsChildOrTeenInFamily:
+ _objc_msgSend$showAccessibilityRestrictions:
+ _objc_msgSend$showAccessibilityRestrictionsPane
+ _objc_msgSend$tracksDataLinkingAcrossCompanies
+ _objc_msgSend$userIsChildOrTeenInFamily
...
- _objc_msgSend$passcodeOptionsHandler
- _objc_msgSend$pinView
CStrings:
