...
+  __TEXT.__unwind_info: 0x1ca38
+  __TEXT.__eh_frame: 0x2444c
...
+ +[WFWorkoutType iconImageForActivityType:]
+ +[WFWorkoutType pickerIconImageForActivityType:]
...
+ _FIUIWorkoutActivityTypeFunction
+ _FIWorkoutActivityTypeFunction
+ _FitnessLibrary.sLib
+ _FitnessLibrary.sOnce
+ _FitnessUILibrary.sLib
+ _FitnessUILibrary.sOnce
...
+ _OBJC_CLASS_$_WFRemoteDeviceCoordinator
...
+ _OBJC_IVAR_$_WFProgramNode._exportError
+ _OBJC_IVAR_$_WFWorkflowMigrationResult._migrationPerformed
+ _OBJC_IVAR_$_WFWorkflowMigrationResult._warnings
+ _OBJC_IVAR_$_WFWorkflowMigrationResult._workflow
+ _OBJC_IVAR_$_WFWorkflowRecord._tombstoned
+ _OBJC_IVAR_$_WFWorkflowReference._modifiedUsingDaS
+ _OBJC_IVAR_$_WFWorkflowReference._tombstoned
+ _OBJC_METACLASS_$_WFHomeAccessoryPresence
+ _OBJC_METACLASS_$_WFRemoteDeviceCoordinator
...
+ _WebContentRestrictionsLibraryCore.frameworkLibrary
+ __CLASS_METHODS_WFRemoteDeviceCoordinator
...
+ __CLASS_PROPERTIES_WFRemoteDeviceCoordinator
+ __CLASS_PROPERTIES_WFUseModelWebSearchResource
+ __DATA_WFRemoteDeviceCoordinator
...
+ __DATA__TtC11WorkflowKit31WFDisplayLayoutPresenceProvider
...
+ __INSTANCE_METHODS_WFRemoteDeviceCoordinator
...
+ __IVARS_WFRemoteDeviceCoordinator
...
+ __IVARS__TtC11WorkflowKit31WFDisplayLayoutPresenceProvider
...
+ __METACLASS_DATA_WFRemoteDeviceCoordinator
...
+ __METACLASS_DATA__TtC11WorkflowKit31WFDisplayLayoutPresenceProvider
...
+ ___25+[WFWorkoutType allTypes]_block_invoke_3
...
+ ___88+[WFScreenTimeHelper isContentDestinationAllowedByScreenTimeSettings:completionHandler:]_block_invoke_2
+ ___FitnessLibrary_block_invoke
+ ___FitnessUILibrary_block_invoke
+ ___WebContentRestrictionsLibraryCore_block_invoke
+ ___block_descriptor_33_e15_"NSSet"12?0B8l
+ ___block_descriptor_48_e8_32r40r_e38_v24?0"WFDialogResponse"8"NSError"16lr32l8r40l8
+ ___block_descriptor_48_e8_32s40s_e36_"WFWorkoutType"24?0"NSNumber"8Q16ls32l8s40l8
+ ___block_descriptor_48_e8_32s_e25_B32?0"WFAction"8Q16^B24ls32l8
+ ___block_descriptor_56_e8_32s40s48r_e19_v20?0B8"NSData"12lr48l8s32l8s40l8
...
+ _associated conformance 11WorkflowKit23RemoteDeviceCoordinatorC17TransportDecisionVSHAASQ
...
+ _classFIUIWorkoutActivityType
+ _classFIWorkoutActivityType
+ _getFIUIWorkoutActivityTypeClass
+ _getFIWorkoutActivityTypeClass
+ _getWCRBrowserEngineClientClass
+ _getWCRBrowserEngineClientClass.softClass
+ _get_enum_tag_for_layout_string 11WorkflowKit32WFShortcutSharingRejectionReasonO
+ _get_enum_tag_for_layout_string Ieg_Sg
+ _initFIUIDeviceSupportsSwimming
+ _initFIUIStaticScalableWorkoutIconImage
+ _initFIUIWorkoutActivityType
...
+ _symbolic Ieg_Sg
+ _symbolic SDySS_____G 7ToolKit16DeviceDescriptorV
...
+ _symbolic SDy_____yycG 10Foundation4UUIDV
...
+ _symbolic Say_____G 7ToolKit16DeviceDescriptorV7OptionsV
+ _symbolic SccySo19WFEncodedTypedValueC______pG s5ErrorP
...
+ _symbolic _____ 11WorkflowKit23RemoteDeviceCoordinatorC
+ _symbolic _____ 11WorkflowKit23RemoteDeviceCoordinatorC17TransportDecisionV
...
+ _symbolic _____ 11WorkflowKit31WFDisplayLayoutPresenceProviderC
+ _symbolic _____ 11WorkflowKit31WFDisplayLayoutPresenceProviderC5State33_5E2E360943EE47A2CBA9B8BBC9628A8DLLV
...
+ _symbolic _____ 7ToolKit16DeviceDescriptorV17InternetRelayModeO
...
+ _symbolic _____Sg 7ToolKit16DeviceDescriptorV
+ _symbolic _____SgXw 11WorkflowKit20WFAppInFocusObserverC
+ _symbolic _____SgXw 11WorkflowKit23RemoteDeviceCoordinatorC
+ _symbolic _____SgXw 11WorkflowKit26WFDebouncerSettleSchedulerC
+ _symbolic _____SgXw 11WorkflowKit31WFDisplayLayoutPresenceProviderC
+ _symbolic _____SgXw 11WorkflowKit32WFRemoteAppIntentExecutionActionC
+ _symbolic _____SgXwz_Xx 11WorkflowKit20WFAppInFocusObserverC
+ _symbolic _____SgXwz_Xx 11WorkflowKit23RemoteDeviceCoordinatorC
+ _symbolic _____SgXwz_Xx 11WorkflowKit26WFDebouncerSettleSchedulerC
+ _symbolic _____SgXwz_Xx 11WorkflowKit31WFDisplayLayoutPresenceProviderC
...
+ _symbolic _____ySDySS_____GG 15Synchronization5MutexVAARi_zrlE 7ToolKit16DeviceDescriptorV
...
+ _symbolic _____ySS_____G s17_NativeDictionaryV 7ToolKit16DeviceDescriptorV
...
+ _symbolic _____y_____G 15Synchronization5MutexVAARi_zrlE 11WorkflowKit31WFDisplayLayoutPresenceProviderC5State33_5E2E360943EE47A2CBA9B8BBC9628A8DLLV
...
+ _symbolic _____y_____G s23_ContiguousArrayStorageC 7ToolKit16DeviceDescriptorV
...
+ _symbolic _____y______G 18AppIntentsServices0bC0O14OptionsBuilderV AC016RemoteDispatcherD0V
+ _symbolic _____y______G 18AppIntentsServices0bC0O14OptionsBuilderV AC07NetworkD0V
...
+ _symbolic _____y_____y______GG s23_ContiguousArrayStorageC 18AppIntentsServices0eF0O14OptionsBuilderV AE016RemoteDispatcherG0V
+ _symbolic _____y_____y______GG s23_ContiguousArrayStorageC 18AppIntentsServices0eF0O14OptionsBuilderV AE07NetworkG0V
...
+ _type_layout_string 11WorkflowKit31WFDisplayLayoutPresenceProviderC5State33_5E2E360943EE47A2CBA9B8BBC9628A8DLLV
...
- +[WFMultiTaskingArrangementTrigger displayGlyphName]
- +[WFMultiTaskingArrangementTrigger isAllowedToRunAutomatically]
- +[WFMultiTaskingArrangementTrigger isSupportedOnThisDevice]
- +[WFMultiTaskingArrangementTrigger localizedDisplayExplanationWithContext:]
- +[WFMultiTaskingArrangementTrigger localizedDisplayNameWithContext:]
- +[WFMultiTaskingArrangementTrigger triggerBacking]
...
- -[WFMultiTaskingArrangementTrigger copyWithZone:]
- -[WFMultiTaskingArrangementTrigger hasValidConfiguration]
- -[WFMultiTaskingArrangementTrigger localizedDescriptionWithConfigurationSummary]
- -[WFMultiTaskingArrangementTrigger localizedPastTenseDescription]
...
- _OBJC_CLASS_$_WFRemoteDevicePrewarmCoordinator
...
- _OBJC_IVAR_$_WFConfiguredTrigger._disablementReason
- _OBJC_IVAR_$_WFConfiguredTrigger._editableShortcut
- _OBJC_IVAR_$_WFConfiguredTrigger._enabled
- _OBJC_IVAR_$_WFConfiguredTrigger._notificationLevel
- _OBJC_IVAR_$_WFConfiguredTrigger._potentialLoopDetected
- _OBJC_IVAR_$_WFConfiguredTrigger._selectedEntryMetadata
- _OBJC_IVAR_$_WFConfiguredTrigger._shouldNotify
- _OBJC_IVAR_$_WFConfiguredTrigger._shouldPrompt
- _OBJC_IVAR_$_WFConfiguredTrigger._shouldRecur
- _OBJC_IVAR_$_WFConfiguredTrigger._source
- _OBJC_IVAR_$_WFConfiguredTrigger._trigger
- _OBJC_IVAR_$_WFConfiguredTrigger._workflowID
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._disablementReason
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._editableShortcut
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._enabled
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._notificationLevel
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._potentialLoopDetected
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._selectedEntryMetadata
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._shouldNotify
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._shouldPrompt
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._shouldRecur
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._source
- _OBJC_IVAR_$_WFConfiguredTriggerRecord._triggerData
- _OBJC_IVAR_$_WFTriggerDisplayInfo._actionIcons
- _OBJC_IVAR_$_WFTriggerDisplayInfo._localizedDescription
- _OBJC_IVAR_$_WFTriggerDisplayInfo._localizedTitle
- _OBJC_IVAR_$_WFTriggerDisplayInfo._triggerClass
- _OBJC_IVAR_$_WFTriggerManager._database
- _OBJC_IVAR_$_WFVariableSuggester._currentVariables
- _OBJC_IVAR_$_WFVariableSuggester._delegate
- _OBJC_IVAR_$_WFVariableSuggester._maxSuggestionsCount
- _OBJC_IVAR_$_WFVariableSuggester._minSuggestionsCount
- _OBJC_IVAR_$_WFVariableSuggester._outputActions
- _OBJC_IVAR_$_WFVariableSuggester._suggestedVariables
- _OBJC_IVAR_$_WFVariableSuggester._userDefinedVariableNames
- _OBJC_IVAR_$_WFVariableSuggester._variableProvider
- _OBJC_IVAR_$_WFWorkflow._creationOptions
- _OBJC_IVAR_$_WFWorkflow._triggers
- _OBJC_IVAR_$_WFWorkflowMigration._completionHandler
- _OBJC_IVAR_$_WFWorkflowRecord._deleted
- _OBJC_IVAR_$_WFWorkflowReference._isDeleted
- _OBJC_METACLASS_$_WFConfiguredTrigger
- _OBJC_METACLASS_$_WFConfiguredTriggerRecord
- _OBJC_METACLASS_$_WFRemoteDevicePrewarmCoordinator
...
- _WebContentAnalysisLibraryCore.frameworkLibrary
- __CLASS_METHODS_WFRemoteDevicePrewarmCoordinator
- __CLASS_METHODS_WFTriggerDirectoryBridge
- __CLASS_METHODS__TtC11WorkflowKit27WFUseModelWebSearchResource
- __CLASS_PROPERTIES_WFRemoteDevicePrewarmCoordinator
- __DATA_WFRemoteDevicePrewarmCoordinator
...
- __INSTANCE_METHODS_WFRemoteDevicePrewarmCoordinator
...
- __IVARS_WFRemoteDevicePrewarmCoordinator
- __IVARS__TtC11WorkflowKit20WFTriggerInputAction
- __METACLASS_DATA_WFRemoteDevicePrewarmCoordinator
...
- ___WebContentAnalysisLibraryCore_block_invoke
- ___block_descriptor_32_e29_"WFIcon"24?0"WFAction"8Q16l
- ___block_descriptor_32_e36_"WFWorkoutType"24?0"NSNumber"8Q16l
...
- ___getUIImageSymbolConfigurationClass_block_invoke
- ___getWFUserSettingsClass_block_invoke
...
- _symbolic _____ 11WorkflowKit30RemoteDevicePrewarmCoordinatorC
...
- _symbolic _____SgXw 11WorkflowKit30RemoteDevicePrewarmCoordinatorC
- _symbolic _____SgXwz_Xx 11WorkflowKit30RemoteDevicePrewarmCoordinatorC
...
- _timestampDateFormatter.onceToken
CStrings:
...
+ "+[WFScreenTimeHelper isContentDestinationAllowedByScreenTimeSettings:completionHandler:]_block_invoke_2"
...
+ "Button that unlocks action for locked app"
...
+ "Error indicating app requires authentication to access; %1$@ is an app name, %2$@ is an authentication mechanism like FaceID or TouchID."
+ "Error message"
...
+ "FIUIDeviceSupportsSwimming"
+ "FIUIStaticScalableWorkoutIconImage"
...
+ "Pre-warmed remote device (coupled=%{bool}d, internetRelay=%s): %s"
...
+ "Requires a paired Apple Watch or the Fitness app."
...
+ "Term for a generic application."
...
+ "Title of list of workout types"
...
+ "WFPreprocessedDate"
+ "WFRemoteAppIntentExecutionAction: Batch iteration %s failed: %@."
+ "WFRemoteAppIntentExecutionAction: Batch iteration %s succeeded but failed to encode output: %@. Reporting success with no output."
+ "WFRemoteAppIntentExecutionAction: Batch iteration %s succeeded."
+ "WFRemoteAppIntentExecutionAction: Coerced parameter '%s' from %s to %s via shared App Intents schema."
+ "WFRemoteAppIntentExecutionAction: Coerced retry for parameter '%s' also failed converting to link value due to error: %s. Surfacing the original error instead."
+ "WFRemoteAppIntentExecutionAction: Executing remote batch with %ld iteration(s)."
+ "WFRemoteAppIntentExecutionAction: Reference values are not supported in batch iterations for parameter %s."
...
- "Class getUIImageSymbolConfigurationClass(void)_block_invoke"
...
- "Opened or closed “%@”"
- "Opened “%@”"
- "Pre-warmed remote device (coupled=%{bool}d): %s"
- "Pre-warmed remote device: %s"
- "Predict"
...
- "softlink:r:path:/System/Library/PrivateFrameworks/WebContentAnalysis.framework/WebContentAnalysis"
