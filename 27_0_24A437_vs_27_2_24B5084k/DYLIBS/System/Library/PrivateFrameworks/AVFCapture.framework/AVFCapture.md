...
+ _AVGQ3V7YJXOASPVYMCM5O5Y3GYHYJQ
+ _FigCaptureSkipTTR
+ _FigKTraceInit
+ _FigSignalErrorAt3
+ _IOSurfaceGetID
...
+ _gAVCaptureSecureVideoDataOutputTrace
...
- ___39-[AVProVideoStorage _reconnectToServer]_block_invoke_2
...
- ___99-[AVCaptureFigVideoDevice _setWhiteBalanceModeLockedWithDeviceWhiteBalanceGains:completionHandler:]_block_invoke_3
...
+ "-[AVCaptureBroadcastVideoOutput sendAncillaryUserDataToCCD:]_block_invoke"
...
+ "-[AVCaptureFigVideoDevice _setActiveFormat:resetVideoZoomFactorAndMinMaxFrameDurations:sessionPreset:]_block_invoke_26"
...
+ "-[AVCaptureFigVideoDevice _setExposureModeCustomWithLensAperture:duration:ISO:entryPoint:completionHandler:]_block_invoke_2"
...
+ "-[AVCaptureMetadataOutput captureFaceIDBracketWithConfiguration:]_block_invoke"
...
+ "-[AVCapturePhotoOutput _dispatchPersonalPhotographerSessionDidFinishCallbackForRequest:error:cleanupRequest:]_block_invoke"
...
+ "-[AVCapturePhotoOutput initiateManualPersonalPhotographerCapture]_block_invoke"
...
+ "-[AVCaptureSecureVideoDataOutput _updateRemoteQueue:]_block_invoke"
...
+ "<<<< AVCaptureBroadcastVideoOutput >>>> %s: %{public}@ Failed to send kFigCaptureSessionBroadcastVideoSinkProperty_AncillaryData %d"
...
+ "<<<< AVCaptureDevice >>>> %s: Invalid parameter"
...
+ "<<<< AVCaptureDevice >>>> %s: Unhandled case: %@"
...
+ "<<<< AVCaptureDeviceRotationCoordinator >>>> %s: Device angle changed, updating video rotation angle for horizon-level preview"
+ "<<<< AVCaptureDeviceRotationCoordinator >>>> %s: Device orientation: %d"
+ "<<<< AVCaptureDeviceRotationCoordinator >>>> %s: Device primary display region changed, updating video rotation angle for horizon-level preview"
...
+ "<<<< AVCaptureDeviceRotationCoordinator >>>> %s: Will update _videoRotationAngleForHorizonLevelPreview using system reference angle (%.1f) from active interface orientation (%d) on display region (%ld)"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] Active primary master source (deviceType %d) is not one of the constituent devices (%@) of this AVCaptureDevice"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] Preferred primary master source (deviceType %d) is not one of the constituent devices (%@) of this AVCaptureDevice"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] active exposure signals changed from %d to %d"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] called with %d -- no-op, use AVCaptureConnection.lowLightVideoNoiseReductionEnabled"
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] called with %f"
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] called with %lld / %d"
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] called with aperture: %f duration: %lld / %d ISO: %f"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] dockedTrackingActive %d"
...
+ "<<<< AVCaptureFigVideoDevice >>>> %s: [%{public}@] ignored exposure signals changed from %d to %d"
...
+ "<<<< AVCaptureInput >>>> %s: %@ %@"
+ "<<<< AVCaptureInputPort >>>> %s: AVCaptureDevice's activeOmahaConstituentDeviceType set to unsupported Constituent Device : %@"
+ "<<<< AVCaptureInputPort >>>> %s: Format required for Center Stage does not support Face ID Coexistence, not enabling Center Stage."
+ "<<<< AVCaptureInputPort >>>> %s: sourceConfig.requiredFormat is still nil"
+ "<<<< AVCaptureMetadataOutput >>>> %s: (%p) %@ : %@"
+ "<<<< AVCaptureMetadataOutput >>>> %s: (%p) Cannot capture Face ID Bracket since there is no FigCaptureSession instance"
...
+ "<<<< AVCaptureMetadataOutput >>>> %s: Face ID Result <rawFrameId: %lu, metadataFrameId: %lu, refFrameId: %lu, frameType: %d, projectorMode: %d>"
...
+ "<<<< AVCaptureMovieFileOutput >>>> %s: (%p) could not delete Timewarp timelapse classic intermediate movie:%@ (%@)"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: (%p) deleted Timewarp timelapse classic intermediate movie %@"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: (%p) failed to make final Timewarp Timelapse Classic movie from %@ with error (%@)"
...
+ "<<<< AVCaptureMovieFileOutput >>>> %s: Cannot add TW metadata track reference"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: Cannot add scene illumination track reference"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: Finished waiting on semaphore %s after %.3f seconds"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: Preview pixel buffer creation from IOSurface failed (%d)"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: SPS is too small (%d, must be at least 4), from %@"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: SPS profile %d is not the expected 100!"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: SPS profile %d, level %d"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: Still waiting on semaphore %s after %.3f seconds..."
...
+ "<<<< AVCaptureMovieFileOutput >>>> %s: end of TW timelapse intermediate metadata"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: end of TW timelapse intermediate video"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: end of scene illuminance timelapse intermediate metadata"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: error %d occured when creating updated format description!"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: getting PPS returned error %d from %@"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: getting SPS returned error %d from %@"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: read TW timelapse intermediate metadata sample %d. %.4lf"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: read TW timelapse intermediate video sample %d. %.4lf"
+ "<<<< AVCaptureMovieFileOutput >>>> %s: read scene illuminance timelapse intermediate metadata sample %d. %.4lf"
...
+ "<<<< AVCaptureOutput >>>> %s: (%p) AVCaptureTimewarpModeClassicTimelapse, scaling bitrate by %.2lf from %d to %d"
...
+ "<<<< AVCapturePersonalPhotographerSessionResults >>>> %s: Could not find photo with timestamp %@ in array of captured photos: %@"
+ "<<<< AVCapturePersonalPhotographerSessionResults >>>> %s: Photo with timestamp %@ already registered: %@"
+ "<<<< AVCapturePersonalPhotographerSessionResults >>>> %s: Photo with timestamp %@ is invalid!"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: (%p) Calling %@ didFinishPersonalPhotographerSessionWithResults:%@ error:%@"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: (%p) Calling StillImageSinkStartPersonalPhotographerSession with %@"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: (%p) Not calling, delegate %@ doesn't respond to didFinishPersonalPhotographerSessionWithResults:%@ error:%@"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: (%p) Personal Photographer capture complete, current session status: %@"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: (%p) Unable to stop personal photographer session as FigCaptureSession has been deallocated!"
...
+ "<<<< AVCapturePhotoOutput >>>> %s: More captures than expected; expected(%lu):%@, completed(%lu):%@"
...
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) %@ : %@"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) Disregarding notification %@ since sinkIDs don't match"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) Got unexpected dequeue error: %d"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) Got unknown opType %d"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) calling %@ didDropSampleBuffer:%p"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) calling %@ didOutputSampleBuffer:%p"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) configurationID %lld became live with updated format description %@"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) setting delegateOverride to %@ (%p)"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) setting delegateOverride to nil"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) setting sampleBufferDelegate to %@ (%p)"
+ "<<<< AVCaptureSecureVideoDataOutput >>>> %s: (%p) setting sampleBufferDelegate to nil"
+ "<<<< AVCaptureSession >>>> %s: (%p) "
+ "<<<< AVCaptureSession >>>> %s: (%p) %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) %@: %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) %d movie file outputs have low light video noise reduction enabled, cost exceeded"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active color space change (a session is configuring it automatically) %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active color space change (device.activeFormat just changed to a non wide-color format) %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active depth data format change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active depth data format change (it didn't really change) %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active format change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Ignoring active format change while preset = InputPriority (I didn't do it, but nothing's changed) %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) ServerConnectionDied"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Session is not running, fire dynamicAspectRatio completion handler."
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Setting preset to input priority *WITHOUT triggering buildAndRunGraph* (because nothing really changed) for change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Setting preset to input priority and triggering buildAndRunGraph for change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for activeColorSpace change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for activeOmahaConstituentDeviceType change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for backgroundBlurActive change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for backgroundReplacementActive change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for centerStageActive change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for client-initiated activeDepthDataFormat change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for client-initiated videoHDREnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for dynamicAspectRatio change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for faceIDCoexistenceEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for gazeSelectionEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for geometricDistortionCorrectionEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for lensSmudgeDetectionEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for lowLightVideoCaptureEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for manualFramingEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for manualFramingPanningAngleX change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for manualFramingPanningAngleY change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for primaryDisplayRegion change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for reactionEffectsActive change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for ringLightAvailable change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for studioLightingActive change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for suspended change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for variableFrameRateVideoCaptureEnabled change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for videoStabilizationStrength change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph for videoZoomFactor change %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) (pthread:%p) Triggering buildAndRunGraph while preset = InputPriority for change %@"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) AVCaptureSession.dot file written to %@ string:\n%@"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) Aggregate connection max frame rate (%f) is too high, changing it to %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Aggregate connection max frame rate (%f) is too low, changing it to %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Aggregate connection min frame rate (%f) is too high, changing it to %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Aggregate connection min frame rate (%f) is too low, changing it to %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Already shown opt-out message for bundleID: %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) Altering default video frame rate range to %lld-%d to maximize depth frame rate (%d)"
+ "<<<< AVCaptureSession >>>> %s: (%p) Computed NAND cost for %@ is %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Could not display Smart Styles Alert due to missing bundle name"
+ "<<<< AVCaptureSession >>>> %s: (%p) Creating new FigCaptureSessionRemote"
+ "<<<< AVCaptureSession >>>> %s: (%p) Encoder bandwidth for %@ output (%dx%d): %dMP/s"
+ "<<<< AVCaptureSession >>>> %s: (%p) Encoder cost: %f (%d / %d)"
+ "<<<< AVCaptureSession >>>> %s: (%p) Failed to build and run capture session (%@) (%d)!"
+ "<<<< AVCaptureSession >>>> %s: (%p) FigCaptureSessionRemoteCreate error %d retry %d"
+ "<<<< AVCaptureSession >>>> %s: (%p) Got interrupted: %d"
+ "<<<< AVCaptureSession >>>> %s: (%p) Hardware cost: %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Ignored active control update for unknown control"
+ "<<<< AVCaptureSession >>>> %s: (%p) Ignored active control update from unknown controls overlay"
+ "<<<< AVCaptureSession >>>> %s: (%p) Ignored interface-reduced update from unknown controls overlay"
+ "<<<< AVCaptureSession >>>> %s: (%p) Ignored visibility update from unknown controls overlay"
+ "<<<< AVCaptureSession >>>> %s: (%p) Interrupted with unexpected fig interruption reason (%d)"
+ "<<<< AVCaptureSession >>>> %s: (%p) Low light video noise reduction %s for %@, automaticCandidateCount %d, activeVideoDataOutputCount %d"
+ "<<<< AVCaptureSession >>>> %s: (%p) MSR bandwidth for %@ output: %d MP/s"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory cost: %f (%d / %d)"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory for RAW buffers: %dMB"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory for photo output: %dMB"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory for video encoder: %dMB"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory for video preview layer: %dMB"
+ "<<<< AVCaptureSession >>>> %s: (%p) Memory for video/movie output: %dMB"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) New fcs config: %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) Not calling -session:didChangeActiveControl: on delegate on an unsupported client"
+ "<<<< AVCaptureSession >>>> %s: (%p) Not calling -session:didChangeFocusLocked: on delegate on an unsupported client"
+ "<<<< AVCaptureSession >>>> %s: (%p) Not calling -session:didChangeFocusLocked: on delegate when Cinematic Video is enabled"
+ "<<<< AVCaptureSession >>>> %s: (%p) Not calling -session:didChangeFocusLocked: on delegate when delegate does not respond to session:controlsDidChangeAutoFocusLocked"
+ "<<<< AVCaptureSession >>>> %s: (%p) Not removing AVCaptureSessionConfiguration with configID %lld, since the commit operation failed with err %d, and the app may restart with the same config."
+ "<<<< AVCaptureSession >>>> %s: (%p) Old fcs config: %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) Picked a different activeFormat for wide color: %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) Removing orphaned AVCaptureSessionConfiguration with configID %lld"
+ "<<<< AVCaptureSession >>>> %s: (%p) Session %@ non-spatial audio configuration %@ is valid"
+ "<<<< AVCaptureSession >>>> %s: (%p) Session %@ spatial audio configuration %@ is valid"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) SmartStyles - CFUserNotificationCreate gave error %d"
+ "<<<< AVCaptureSession >>>> %s: (%p) Started running while interrupted, so ending interruption: (%d, %d)"
+ "<<<< AVCaptureSession >>>> %s: (%p) Starting fig capture session"
+ "<<<< AVCaptureSession >>>> %s: (%p) Stopping and uninitializing graph"
+ "<<<< AVCaptureSession >>>> %s: (%p) Texture style is disabled because active format doesn't support it %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) The fig capture session is already running. Will not start session."
+ "<<<< AVCaptureSession >>>> %s: (%p) Total NAND cost: %f"
+ "<<<< AVCaptureSession >>>> %s: (%p) Updating MFO (%p) output settings dimension to %dx%d for %@"
+ "<<<< AVCaptureSession >>>> %s: (%p) VEFrameRate Throttling (%p): needToThrottle (%d) minFDSetByClient: (%d) maxFDSetByClient: (%d). newMaxFD: ( %lld / %d ) newMinFD: ( %lld / %d )."
+ "<<<< AVCaptureSession >>>> %s: (%p) Video/Movie output cost: %f (bandwidth: %d / %d, outputs: %d, VIS: %d / %d)"
...
+ "<<<< AVCaptureSession >>>> %s: (%p) called while session is not running."
...
+ "<<<< AVCaptureSession >>>> %s: (%p) resetting the active min/max frame rate to the default values"
+ "<<<< AVCaptureSession >>>> %s: (%p) updating %@ to %@"
...
+ "<<<< AVMetadataMachineReadableCodeObject >>>> %s: Failed to create a valid CMVideoFormatDescription"
...
+ "AVGQ3V7YJXOASPVYMCM5O5Y3GYHYJQ"
...
+ "LastShownBuild:AVCaptureDevice.m:4815"
+ "LastShownBuild:AVCaptureDevice.m:4819"
+ "LastShownBuild:AVCaptureVideoPreviewLayer.m:1372"
+ "LastShownBuild:AVCaptureVideoPreviewLayer.m:2342"
+ "LastShownBuild:AVControlCenterModules.m:4543"
+ "LastShownBuild:AVControlCenterModules.m:4547"
+ "LastShownBuild:AVSpatialOverCaptureVideoPreviewLayer.m:292"
+ "LastShownDate:AVCaptureConnection.m:953"
+ "LastShownDate:AVCaptureDevice.m:4815"
+ "LastShownDate:AVCaptureDevice.m:4819"
+ "LastShownDate:AVCaptureVideoPreviewLayer.m:1372"
+ "LastShownDate:AVCaptureVideoPreviewLayer.m:2342"
+ "LastShownDate:AVControlCenterModules.m:4543"
+ "LastShownDate:AVControlCenterModules.m:4547"
+ "LastShownDate:AVSpatialOverCaptureVideoPreviewLayer.m:292"
...
+ "\\nVideo Format [%d]"
+ "_addAuxiliaryImage"
+ "_audioRoutesInfoFirstQueryGroup"
...
+ "_readyForMoreSemaphore"
+ "_refreshRegisteredDevices"
+ "_registerServerConnectionDiedNotification_block_invoke"
+ "_serverConnectionDiedSemaphore"
+ "afc222f662e4c62af12e1c3e4a3342700452280e"
+ "assetSemaphore"
+ "audio"
...
+ "avcapturesecurevideodataoutput_trace"
...
+ "avcapurepersonalphotographersessionresults_trace"
...
+ "avcmdo_faceIDCollectionForSampleBuffer"
...
+ "black"
+ "cc74ca08b8c8b3893a85b27322000f4408d32610"
+ "com.apple.coremedia"
+ "com.apple.private.avfoundation.capture.proprietary-defaults-migration"
+ "depth data"
+ "description=CameraCapture_AVF-764.40.4.122.1"
+ "digraph %@ {\n"
+ "disconnected"
...
+ "metadata items"
+ "metadata objects"
+ "mfo_createUpdatedDecimationVideoFormatDescriptionFromSampleBuffer"
+ "movie"
