...
+1.9.2.3.0
+  __TEXT.__text: 0xf728c
+  __TEXT.__objc_methlist: 0x3674
+  __TEXT.__const: 0x3c18
+  __TEXT.__cstring: 0xa28a
+  __TEXT.__oslogstring: 0x3d3e
...
+  __AUTH_CONST.__objc_const: 0x6ef0
...
+ _objc_msgSend$hadGroupingRelevantChanges
+ _objc_msgSend$initWithDbMgr:
+ _objc_msgSend$isHistoryTokenInvalidError:
+ _objc_msgSend$processAccountBatch:deletedAccounts:
+ _objc_msgSend$processTransactionBatch:deletedTransactionIDs:historyToken:
+ _objc_msgSend$streamTransactionsSince:savedAccounts:batchSize:transactionHandler:accountHandler:completionHandler:
+ _objc_msgSend$updateTransactionsAsyncWithForceFullSync:batchSize:completionHandler:
+ _objc_msgSend$updateTransactionsWithCompletion:
...
- _objc_msgSend$streamTransactionsSince:savedAccounts:transactionHandler:accountHandler:completionHandler:
CStrings:
