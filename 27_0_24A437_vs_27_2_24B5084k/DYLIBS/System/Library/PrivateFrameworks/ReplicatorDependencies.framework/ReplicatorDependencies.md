...
-176.0.0.0.0
-  __TEXT.__text: 0x29c74
+176.2.2.0.0
+  __TEXT.__text: 0x29efc
...
CStrings:
+ "com.apple.ReplicatorDependencies.IDSPinnedIdentityManagerImpl.ids"
- "com.apple.ReplicatorDependencies.IDSPinnedIdentityManagerImpl.fetch"
```
