...
+ -[AXMVisionEngineCache setResult:forKey:ifNotPurgedSince:]
+ -[AXMVisionPipelineContext cachePurgeCountWhenScheduled]
+ -[AXMVisionPipelineContext setCachePurgeCountWhenScheduled:]
...
+ _OBJC_IVAR_$_AXMVisionEngineCache._cacheQueue_purgeCount
+ _OBJC_IVAR_$_AXMVisionPipelineContext._cachePurgeCountWhenScheduled
...
+ "BrailleEdgesDetection"
+ "Failed to render screen grab into %{public}@: %{public}@"
+ "Failed to render screen grab: %@"
+ "IconClassDetection"
+ "SceneDetection"
+ "SceneprintCreation"
+ "discarding result for key: %p. cache has been purged %lu times since the request was issued"
+ "purge cache of all keys. purged %lu times total"
