...
-  __DATA.__bss: 0x86210
+  __AUTH.__data: 0x1ab8
+  __DATA.__data: 0xa8b0
+  __DATA.__bss: 0x86308
...
+ __METACLASS_DATA__TtC21SiriInferenceLearning23LiveTranscriptIngestion
+ ___swift_closure_destructor.12Tm
+ ___swift_closure_destructor.19Tm
+ ___swift_destroy_boxed_opaque_existential_1
+ ___swift_store_extra_inhabitant_index.115Tm
+ _associated conformance 21SiriInferenceLearning23LiveTranscriptIngestionC7TaskKey33_581426255FAE227862EDA633F7E79030LLVSHAASQ
+ _symbolic _____ 21SiriInferenceLearning23LiveTranscriptIngestionC
+ _symbolic _____ 21SiriInferenceLearning23LiveTranscriptIngestionC7TaskKey33_581426255FAE227862EDA633F7E79030LLV
+ _symbolic _____Sg 21SiriInferenceLearning16EvaluationResultV
+ _symbolic _____y__________G s17_NativeDictionaryV 21SiriInferenceLearning23LiveTranscriptIngestionC7TaskKey33_581426255FAE227862EDA633F7E79030LLV AC04FlowI0V
...
CStrings:
+ "LiveTranscriptIngestion: Failed to initialize Toolbox, evaluation will be skipped: %@"
+ "LiveTranscriptIngestion: Toolbox initialized successfully"
+ "LiveTranscriptIngestion: donating evaluation for statementId=%s in session %s"
+ "LiveTranscriptIngestion: evaluating session %s with %ld events, triggered by %s"
+ "LiveTranscriptIngestion: skipping evaluation, Toolbox not available"
```
