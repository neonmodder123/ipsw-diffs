...
+ _objc_msgSend$_accessibilityPuppetCollectionViewController:
+ _objc_msgSend$_axRecord
+ _objc_msgSend$_axRecordDescription
+ _objc_msgSend$_setAXRecord:
+ _objc_msgSend$_setAXRecordDescription:
