...
+ ___getAXDeviceIsViridianSymbolLoc_block_invoke
+ _getAXDeviceIsViridianSymbolLoc.ptr
+ _objc_msgSend$_frontWideCameraInputFromAllInputs
...
+ "AXDeviceIsViridian"
+ "AXSSMotionTrackingInputManager: alternate head-tracking override picked %@ (altHeadTrackingOverride=%d)"
```
