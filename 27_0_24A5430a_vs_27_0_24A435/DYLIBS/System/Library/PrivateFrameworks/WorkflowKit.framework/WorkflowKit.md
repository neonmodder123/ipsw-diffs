...
+ +[WFMTASupport mtaModeADescription]
+ +[WFMTASupport mtaModeAPastTense]
+ +[WFMTASupport mtaModeA]
+ +[WFMTASupport mtaModeAnyDescription]
+ +[WFMTASupport mtaModeAnyPastTense]
+ +[WFMTASupport mtaModeAny]
+ +[WFMTASupport mtaModeBDescription]
+ +[WFMTASupport mtaModeBPastTense]
+ +[WFMTASupport mtaModeB]
+ +[WFMTASupport mtaParameterSummaryFormat]
+ +[WFMTASupport mtaSymbolName]
+ +[WFMTASupport mtaTriggerDescription]
+ +[WFMTASupport mtaTriggerExplanation]
+ +[WFMTASupport mtaTriggerName]
...
+ +[WFMultiTaskingArrangementTrigger supportsSecureCoding]
+ +[WFMultiTaskingArrangementTrigger triggerBacking]
+ -[WFMultiTaskingArrangementTrigger copyWithZone:]
+ -[WFMultiTaskingArrangementTrigger encodeWithCoder:]
+ -[WFMultiTaskingArrangementTrigger hasValidConfiguration]
+ -[WFMultiTaskingArrangementTrigger initWithCoder:]
+ -[WFMultiTaskingArrangementTrigger init]
...
+ -[WFMultiTaskingArrangementTrigger mode]
+ -[WFMultiTaskingArrangementTrigger setMode:]
...
+ _CommunicationsUICoreLibrary.sLib
+ _CommunicationsUICoreLibrary.sOnce
+ _ISSymbolFunction
+ _MTPArrangementFunction
+ _OBJC_CLASS_$_WFMTASupport
+ _OBJC_CLASS_$_WFMultiTaskingArrangementTrigger
+ _OBJC_CLASS_$__TtC11WorkflowKit26WFMTACapableDeviceResource
+ _OBJC_IVAR_$_WFMultiTaskingArrangementTrigger._mode
+ _OBJC_METACLASS_$_WFMTASupport
+ _OBJC_METACLASS_$_WFMultiTaskingArrangementTrigger
+ _OBJC_METACLASS_$__TtC11WorkflowKit26WFMTACapableDeviceResource
+ __CLASS_METHODS__TtC11WorkflowKit26WFMTACapableDeviceResource
+ __DATA__TtC11WorkflowKit26WFMTACapableDeviceResource
+ __INSTANCE_METHODS__TtC11WorkflowKit26WFMTACapableDeviceResource
+ __METACLASS_DATA__TtC11WorkflowKit26WFMTACapableDeviceResource
+ __OBJC_$_CLASS_METHODS_WFMTASupport
+ __OBJC_$_CLASS_METHODS_WFMultiTaskingArrangementTrigger
+ __OBJC_$_CLASS_PROP_LIST_WFMTASupport
+ __OBJC_$_INSTANCE_METHODS_WFMultiTaskingArrangementTrigger
+ __OBJC_$_INSTANCE_VARIABLES_WFMultiTaskingArrangementTrigger
+ __OBJC_$_PROP_LIST_WFMultiTaskingArrangementTrigger
+ __OBJC_CLASS_RO_$_WFMTASupport
+ __OBJC_CLASS_RO_$_WFMultiTaskingArrangementTrigger
+ __OBJC_METACLASS_RO_$_WFMTASupport
+ __OBJC_METACLASS_RO_$_WFMultiTaskingArrangementTrigger
+ ___35+[WFMTASupport mtaDeviceSymbolName]_block_invoke
+ ___CommunicationsUICoreLibrary_block_invoke
+ _associated conformance So32WFMultiTaskingArrangementTriggerC11WorkflowKitE0C4ModeOSHACSQ
+ _associated conformance So32WFMultiTaskingArrangementTriggerC11WorkflowKitE0C4ModeOs12CaseIterableAC8AllCasessAFP_Sl
+ _associated conformance So32WFMultiTaskingArrangementTriggerC11WorkflowKitE12ParameterKeyOSHACSQ
+ _classISSymbol
+ _classMTPArrangement
+ _getISSymbolClass
+ _getMTPArrangementClass
+ _initISSymbol
+ _initMTPArrangement
...
+ _symbolic _____ 11WorkflowKit26WFMTACapableDeviceResourceC
+ _symbolic _____ So32WFMultiTaskingArrangementTriggerC11WorkflowKitE0C4ModeO
+ _symbolic _____ So32WFMultiTaskingArrangementTriggerC11WorkflowKitE12ParameterKeyO
...
CStrings:
+ "(This automation isn’t supported on this device.)"
...
+ "ModeA"
+ "ModeB"
+ "Multitasking Arrangement trigger not firing due to missing or invalid value"
+ "Multitasking Arrangement trigger not firing. (mode: %s))"
+ "WFArrangementMode"
+ "WFMultiTaskingArrangementTrigger"
+ "WorkflowKit.WFMTACapableDeviceResource"
+ "questionmark.square"
```
