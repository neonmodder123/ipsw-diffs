...
+ _AXDeviceIsViridian
+ _AXDeviceIsViridian.isViridian
+ _AXDeviceIsViridian.onceToken
...
+ __AXSBPopArrangementTitle.onceToken
+ __AXSBPopArrangementTitle.popBundle
+ ___AXDeviceIsViridian_block_invoke
+ ____AXSBPopArrangementTitle_block_invoke
...
- _keypath_set.900Tm
CStrings:
+ "$brailleGesturesAlwaysUseEightDotsInCommandMode"
+ "ARRANGEMENT_DISMISS_LEFT_APP_FULL_WIDTH"
+ "ARRANGEMENT_DISMISS_RIGHT_APP_FULL_WIDTH"
+ "ARRANGEMENT_FULLSCREEN_LEFT_APP_FULL_WIDTH"
+ "ARRANGEMENT_FULLSCREEN_RIGHT_APP_FULL_WIDTH"
+ "ARRANGEMENT_SPLIT_APP_LEFT"
+ "ARRANGEMENT_SPLIT_APP_RIGHT"
+ "AXAssistiveTouchIconTypeArrangementMultitasking"
+ "Accessibility-V64"
+ "BRAILLE_BSI_HOLD_TO_CALIBRATE_DESCRIPTION"
+ "BRAILLE_BSI_HOLD_TO_CALIBRATE_TITLE"
+ "BRAILLE_BSI_USE_EIGHT_DOTS_DESCRIPTION"
+ "BRAILLE_BSI_USE_EIGHT_DOTS_TITLE"
+ "LocalizedStrings-AXAction"
+ "SoundRecognition_WatchSupport"
+ "SpringBoardPopAccessibility.axbundle"
+ "TargetSubType"
+ "V68"
+ "VoiceOverBrailleGesturesAlwaysUseEightDotsInCommandMode"
+ "braillesensingmodedevice"
+ "n237"
+ "n238"
+ "n240"
```
