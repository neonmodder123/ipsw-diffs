...
Symbols:
+ +[DIPDeviceDetection isV68Device]
+ _MGCopyAnswer
+ _MGIsDeviceOfType
+ __OBJC_$_CLASS_METHODS_DIPDeviceDetection
+ __OBJC_$_CLASS_PROP_LIST_DIPDeviceDetection
+ ___33+[DIPDeviceDetection isV68Device]_block_invoke
+ _isV68Device.isV68Device
+ _isV68Device.onceToken
+ _objc_msgSend$containsString:
+ _objc_msgSend$isV68Device
CStrings:
+ "TargetSubType"
+ "V68"
```
