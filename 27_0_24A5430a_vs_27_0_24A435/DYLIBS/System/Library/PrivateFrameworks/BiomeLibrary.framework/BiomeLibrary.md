...
+ _objc_msgSend$appleReferenceImage
+ _objc_msgSend$clientRequestData
+ _objc_msgSend$imageCreationDate
+ _objc_msgSend$initWithAppleReferenceImage:
+ _objc_msgSend$initWithPhotosAssetLocalIdentifier:imageCreationDate:
+ _objc_msgSend$initWithTimestamp:requestId:pipelineKind:pipelineParameters:nodes:outboundCalls:assets:clientRequestData:
+ _objc_msgSend$photosAssetLocalIdentifier
