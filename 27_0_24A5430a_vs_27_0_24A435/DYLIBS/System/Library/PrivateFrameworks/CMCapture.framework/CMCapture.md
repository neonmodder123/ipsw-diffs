...
+ +[BWCinematographyObjectTrackingNode _detectionTypeMap]
...
+ +[BWInferenceTextureStylesPostProcessor initialize]
...
+ +[CMCaptureCinematicVideoTimedMetadataSampleGenerator initialize]
+ +[EGStillImageAdaptiveFusionNRFNode initialize]
+ +[EGStillImageAdaptiveFusionRoutingNode initialize]
...
+ +[FigCaptureSecureVideoDataSinkPipeline initialize]
...
+ +[PearlSecureFDRKeyUnwrapSession session]
+ +[PearlSecureSession initialize]
+ +[PearlSecureSession sessionWithCameraType:]
+ +[PearlSecureStreamingSession sessionWithCameraType:]
+ +[PearlSupportDefaults sharedInstance]
+ +[PearlSupportHelper sharedInstance]
+ +[SEPCameraProxy initServiceConnection]
+ +[SEPCameraProxy isValidCameraType:]
+ +[SEPCameraProxy pearlToSecureSessionError:]
+ +[SEPCameraProxy sharedInstanceWithCameraType:]
...
+ -[BWBaselineTextureStyleRenderer _newPixelBufferWithDimensions:pixelFormat:name:]
...
+ -[BWCameraStreamingMonitor _invalidateDisplayBlankingResources]
+ -[BWCameraStreamingMonitor _updateDisplayBlankingWithStreaming:clientAuditToken:]
+ -[BWCameraStreamingMonitor displayRegion:blankingStateDidChangeFrom:to:]
+ -[BWCameraStreamingMonitor displayRegion:blankingStateWillChangeFrom:to:]
+ -[BWCinematicPerceptionNode initWithConvEngineSupportWithCaptureDevice:scheduler:priority:depthInferenceEnabled:aspectRatio:opticalFlowInferenceEnabled:]
...
+ -[BWCinematographyObjectTrackingNode _accumulateCinematicMetadataStatisticsForSampleBuffer:metadata:]
+ -[BWCinematographyObjectTrackingNode _batchProcessDetectionsIntoTracks:withKind:intoTracks:]
+ -[BWCinematographyObjectTrackingNode _cinematicMetadataStatisticsDictionary]
+ -[BWCinematographyObjectTrackingNode _extractHumanPoseSignalsFromInferenceResult:trackingResult:captureSampleBuffer:]
+ -[BWCinematographyObjectTrackingNode _focusTrackedObjectResponseFromSampleBuffer:frameTimestamp:intoTracks:]
+ -[BWCinematographyObjectTrackingNode _handleMarkerBuffer:]
+ -[BWCinematographyObjectTrackingNode _initCinematographyAndGlobalMetadata]
+ -[BWCinematographyObjectTrackingNode _populateTrackingResult:fromSampleBuffer:withFrameTimestamp:]
+ -[BWCinematographyObjectTrackingNode _releaseResources]
+ -[BWCinematographyObjectTrackingNode _resetCinematicMetadataStatistics]
+ -[BWCinematographyObjectTrackingNode _tryToEmit:]
+ -[BWCinematographyObjectTrackingNode _visCropFactorFromMetadata:sampleBuffer:]
+ -[BWCinematographyObjectTrackingNode cinematographyModelVersionString]
+ -[BWCinematographyObjectTrackingNode configurationWithID:updatedFormat:didBecomeLiveForInput:]
+ -[BWCinematographyObjectTrackingNode dealloc]
+ -[BWCinematographyObjectTrackingNode didReachEndOfDataForConfigurationID:input:]
+ -[BWCinematographyObjectTrackingNode didSelectFormat:forInput:]
+ -[BWCinematographyObjectTrackingNode disabled]
+ -[BWCinematographyObjectTrackingNode globalMetadata]
+ -[BWCinematographyObjectTrackingNode handleDroppedSample:forInput:]
...
+ -[BWCinematographyObjectTrackingNode inputFormatForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode inputInferenceVideoFormatForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode inputVideoFormatForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode intermediateResourceTrackingAllowedForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode metadataCollectionSize]
+ -[BWCinematographyObjectTrackingNode newTemporaryFTCinematicInputFromTrackingResult:withFrameTimestamp:]
+ -[BWCinematographyObjectTrackingNode nodeSubType]
+ -[BWCinematographyObjectTrackingNode nodeType]
+ -[BWCinematographyObjectTrackingNode outputFormatForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode outputVideoFormatForAttachedMediaKey:]
+ -[BWCinematographyObjectTrackingNode prepareForCurrentConfigurationToBecomeLive]
+ -[BWCinematographyObjectTrackingNode renderSampleBuffer:forInput:]
...
+ -[BWDeferredProcessorController _handleDidDetermineReferenceFrameWithSortedIntermediates:provenanceSampleBufferOut:]
+ -[BWDeferredProcessorController _provenanceSensorRawSampleBufferUsingSensorRawBuffer:metadata:captureFrameFlags:sampleBufferOut:]
...
+ -[BWFigVideoCaptureDevice _segmentFocusTrackingConfigurationWithTrackingSeedingPointInSensorSpace:tracking:trackingLensPositionBias:zoomFactor:]
...
+ -[BWFigVideoCaptureDevice _updateApertureFlickerMitigationOnAutofocusQueue]
+ -[BWFigVideoCaptureDevice _updateApertureFlickerMitigation]
...
+ -[BWGlobalTextureStyleRenderer _newPixelBufferWithDimensions:pixelFormat:name:]
...
+ -[BWGlowTextureStyleRenderer _newPixelBufferWithDimensions:pixelFormat:name:]
...
+ -[BWHVSFrameAnalysisTask initWithYUVSampleBuffer:matchingMainSensorRawSampleBuffer:matchingSIFRSensorRawSampleBuffer:imageEmbeddingSampleBuffer:faceQualitySampleBuffer:subtaskGroup:subtaskWorkInterval:numberOfSubtaskThreads:]
...
+ -[BWHVSScoringNode _computeSharpnessFromSampleBuffer:personMask:]
+ -[BWHVSScoringNode _ensureMaskGDCOutputPoolWithDimensions:pixelFormat:]
+ -[BWHVSScoringNode _ensureMaskGDCProcessor]
...
+ -[BWHVSScoringNode _newGDCCorrectedMaskFromMaskPixelBuffer:maskSampleBuffer:frameMetadata:]
+ -[BWHVSScoringNode _releaseResources]
+ -[BWHVSScoringNode _resetAllTrackedStatuses]
+ -[BWHVSScoringNode _resetStatusInfo]
+ -[BWHVSScoringNode _runFaceQualityInferenceOnSampleBuffer:]
+ -[BWHVSScoringNode _runImageEmbeddingInferenceOnSampleBuffer:]
...
+ -[BWHVSScoringNode initializeInferencesWithSensorOrientation:inputPixelBufferDimensions:]
+ -[BWHVSScoringNode initiateManualPersonalPhotographerCapture]
+ -[BWHVSScoringNode inputFormatForAttachedMediaKey:]
+ -[BWHVSScoringNode inputInferenceVideoFormatForAttachedMediaKey:]
+ -[BWHVSScoringNode inputVideoFormatForAttachedMediaKey:]
+ -[BWHVSScoringNode intermediateResourceTrackingAllowedForAttachedMediaKey:]
+ -[BWHVSScoringNode loadInferenceNetwork]
+ -[BWHVSScoringNode nodeSubType]
+ -[BWHVSScoringNode nodeType]
+ -[BWHVSScoringNode outputFormatForAttachedMediaKey:]
+ -[BWHVSScoringNode outputVideoFormatForAttachedMediaKey:]
...
+ -[BWInferenceEngineController _addTextureStylesPostProcessorWithInstanceMaskInferenceType:validBufferRectAppliedToVisionFaceLandmarks:finalCropRectAppliedToFaceAndInstanceSegmentationMasks:finalCropRectAppliedToPersonSemanticMasks:]
+ -[BWInferenceTextureStylesPostProcessor dealloc]
+ -[BWInferenceTextureStylesPostProcessor description]
+ -[BWInferenceTextureStylesPostProcessor finalCropRectAppliedToFaceAndInstanceSegmentationMasks]
+ -[BWInferenceTextureStylesPostProcessor finalCropRectAppliedToPersonSemanticMasks]
+ -[BWInferenceTextureStylesPostProcessor initWithRequiredInferenceTypes:]
+ -[BWInferenceTextureStylesPostProcessor needsReprepareForLiveReconfiguration]
+ -[BWInferenceTextureStylesPostProcessor postProcessInferenceResults:attachingSampleBuffer:]
+ -[BWInferenceTextureStylesPostProcessor postProcessorType]
+ -[BWInferenceTextureStylesPostProcessor preparePostProcessor]
+ -[BWInferenceTextureStylesPostProcessor requiredInferenceTypes]
+ -[BWInferenceTextureStylesPostProcessor setFinalCropRectAppliedToFaceAndInstanceSegmentationMasks:]
+ -[BWInferenceTextureStylesPostProcessor setFinalCropRectAppliedToPersonSemanticMasks:]
+ -[BWInferenceTextureStylesPostProcessor setValidBufferRectAppliedToVisionFaceLandmarks:]
+ -[BWInferenceTextureStylesPostProcessor validBufferRectAppliedToVisionFaceLandmarks]
...
+ -[BWMultiStreamCameraSourceNode _establishSecureStreamingForFaceID]
...
+ -[BWMultiStreamCameraSourceNode initiateSecureStreamingForFaceID]
+ -[BWMultiStreamCameraSourceNode isUnsynchronizedPrimary]
+ -[BWMultiStreamCameraSourceNode secureVideoOutput]
...
+ -[BWMultiStreamCameraSourceNodeConfiguration secureVideoCaptureDimensions]
+ -[BWMultiStreamCameraSourceNodeConfiguration secureVideoOutputEnabled]
...
+ -[BWMultiStreamCameraSourceNodeConfiguration setSecureVideoCaptureDimensions:]
+ -[BWMultiStreamCameraSourceNodeConfiguration setSecureVideoOutputEnabled:]
+ -[BWNRFProcessorController _disableVitalityIfFlareDetectedInMetadata:]
+ -[BWNRFProcessorController _processAdaptiveFusion]
+ -[BWNRFProcessorControllerConfiguration adaptiveFusionEnabled]
+ -[BWNRFProcessorControllerConfiguration adaptiveFusionInputFormat]
+ -[BWNRFProcessorControllerConfiguration setAdaptiveFusionEnabled:]
+ -[BWNRFProcessorControllerConfiguration setAdaptiveFusionInputFormat:]
+ -[BWNodeInput mediaTypeIsSecureVideo]
+ -[BWNodeOutput mediaTypeIsSecureVideo]
...
+ -[BWPhotonicEngineNode _attemptPiecemealEncodingForProvenanceSensorRawSampleBuffer:]
+ -[BWPhotonicEngineNode _attemptPiecemealEncodingOfAuxImagesForTextureStylesCaptureWithSampleBuffer:portType:]
+ -[BWPhotonicEngineNode _propagateProvenanceSensorRawIfNeededForSampleBuffer:]
+ -[BWPhotonicEngineNode _setupProcessingStateForTextureStyleInferencesWithSettings:sequenceNumber:portType:processingPlan:]
+ -[BWPhotonicEngineNode _stashProvenanceSensorRawFrameIfNeededUsingSampleBuffer:]
+ -[BWPhotonicEngineNode processorController:didDetermineProvenanceFrame:processorInput:err:]
+ -[BWPhotonicEngineNode processorController:didSelectVitalityMode:forProcessorInput:]
+ -[BWPhotonicEngineNodeConfiguration optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported]
+ -[BWPhotonicEngineNodeConfiguration personalPhotographerEnabled]
+ -[BWPhotonicEngineNodeConfiguration portTypesWithAdaptiveFusionEnabled]
+ -[BWPhotonicEngineNodeConfiguration portTypesWithCalibrationEnabled]
+ -[BWPhotonicEngineNodeConfiguration portTypesWithTextureStyleBaseLookEnabled]
+ -[BWPhotonicEngineNodeConfiguration rawColorCalibrationsByPortType]
+ -[BWPhotonicEngineNodeConfiguration setOptimizedUltraHighResolutionProcessingWithAspectRatioCropSupported:]
+ -[BWPhotonicEngineNodeConfiguration setPersonalPhotographerEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setPortTypesWithAdaptiveFusionEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setPortTypesWithCalibrationEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setPortTypesWithTextureStyleBaseLookEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setPreNoiseReductionScalerCropSupported:]
+ -[BWPhotonicEngineNodeConfiguration setTextureStyleBaseLookEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setTextureStyleCreativeEffectsEnabled:]
+ -[BWPhotonicEngineNodeConfiguration setTextureStyleFSINCMasksRequired:]
+ -[BWPhotonicEngineNodeConfiguration setTextureStyleRenderingVersion:]
+ -[BWPhotonicEngineNodeConfiguration textureStyleBaseLookEnabled]
+ -[BWPhotonicEngineNodeConfiguration textureStyleCreativeEffectsEnabled]
+ -[BWPhotonicEngineNodeConfiguration textureStyleFSINCMasksRequired]
+ -[BWPhotonicEngineNodeConfiguration textureStyleRenderingVersion]
+ -[BWPhotonicEngineNodeConfiguration(Utilities) _inferenceAttachedMediaRequiredForTextureStyleBaseLookWithSettings:]
+ -[BWPhotonicEngineNodeConfiguration(Utilities) configureInferenceEngineControllerInputForTextureStyles:]
+ -[BWPhotonicEngineNodeConfiguration(Utilities) isDeferredAdaptiveFusionCapture:]
...
+ -[BWSensorRawTimeMachine _removeSampleBuffersThroughRange:frameType:]
...
+ -[BWSkinTextureStyleRenderer _newPixelBufferWithDimensions:pixelFormat:name:]
...
+ -[BWSoftISPProcessorController notifyLCBDatabaseUpdated:forPortType:]
+ -[BWSoftISPProcessorControllerConfiguration adaptiveFusionEnabled]
+ -[BWSoftISPProcessorControllerConfiguration calibrationEnabled]
+ -[BWSoftISPProcessorControllerConfiguration setAdaptiveFusionEnabled:]
+ -[BWSoftISPProcessorControllerConfiguration setCalibrationEnabled:]
...
+ -[BWStillImageFilterNode _shouldApplyBaselineTextureStyleForRenderContext:]
+ -[BWStillImageFilterNodeConfiguration setTextureStyleBaseLookEnabled:]
+ -[BWStillImageFilterNodeConfiguration setTextureStyleCreativeEffectsEnabled:]
+ -[BWStillImageFilterNodeConfiguration setTextureStyleRenderingVersion:]
+ -[BWStillImageFilterNodeConfiguration textureStyleBaseLookEnabled]
+ -[BWStillImageFilterNodeConfiguration textureStyleCreativeEffectsEnabled]
+ -[BWStillImageFilterNodeConfiguration textureStyleRenderingVersion]
+ -[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleBaseLineIsSetup]
+ -[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleIsSetup]
+ -[BWStillImageFilterNodeResourceCoordinator ensureTextureStyleIsSetup]
+ -[BWStillImageFilterNodeResourceCoordinator provideBaselineTextureStyleRenderer]
+ -[BWStillImageFilterNodeResourceCoordinator provideGlobalTextureStyleRenderer]
+ -[BWStillImageFilterNodeResourceCoordinator provideGlowTextureStyleRenderer]
+ -[BWStillImageFilterNodeResourceCoordinator provideSkinTextureStyleRenderer]
...
+ -[BWUBNode processorController:didDetermineProvenanceFrame:processorInput:err:]
...
+ -[BWVideoNoiseReductionNode _allocateIntermediateBufferPool]
+ -[BWVideoNoiseReductionNode _applyCrossFade:outputSampleBuffer:dissolveStrength:]
+ -[BWVideoNoiseReductionNode _asyncApplyNoiseReductionToFrontEndPyramidScalerImageFromSampleBuffer:]
+ -[BWVideoNoiseReductionNode _ispColorProcessFrontEndPyramidScalerImageFromSampleBuffer:]
+ -[BWVideoNoiseReductionNode _metalCommandQueueWithName:priority:]
+ -[BWVideoNoiseReductionNode _prepareISPProcessingSession]
...
+ -[BWVideoNoiseReductionNode _updateVideoNoiseReductionProcessingDimensions]
+ -[BWVideoNoiseReductionNode _waitForAsyncNoiseReductionProcessToComplete]
+ -[BWVideoNoiseReductionNode _workIntervalFinishWithInstance:index:]
+ -[BWVideoNoiseReductionNode _workIntervalStartWithFrameDuration:index:]
...
+ -[CMCaptureCinematicVideoTimedMetadataSampleGenerator dealloc]
+ -[CMCaptureCinematicVideoTimedMetadataSampleGenerator init]
+ -[CMCaptureCinematicVideoTimedMetadataSampleGenerator newTimedMetadataSampleBufferFromPayload:presentationTimeStamp:]
+ -[CMCaptureCinematicVideoTimedMetadataSampleGenerator timedMetadataSampleBufferFormatDescription]
+ -[EGStillImageAdaptiveFusionNRFNode _handleAnyErrorRecoveryLogicWithErr:]
+ -[EGStillImageAdaptiveFusionNRFNode _releaseErrorRecoveryResources]
+ -[EGStillImageAdaptiveFusionNRFNode attemptErrorRecoveryOutput]
+ -[EGStillImageAdaptiveFusionNRFNode attemptSingleImageErrorRecoveryOutput]
+ -[EGStillImageAdaptiveFusionNRFNode dealloc]
+ -[EGStillImageAdaptiveFusionNRFNode fusionModeOutput]
+ -[EGStillImageAdaptiveFusionNRFNode hdrErrorRecoveryEVZeroInput]
+ -[EGStillImageAdaptiveFusionNRFNode inferenceInputImageOutput]
+ -[EGStillImageAdaptiveFusionNRFNode initWithName:stillImageSettings:nodeConfiguration:provideInferenceInputImageForProcessing:addSyncErrorRecoveryPorts:portType:delegate:]
+ -[EGStillImageAdaptiveFusionNRFNode primarySbufInputs]
+ -[EGStillImageAdaptiveFusionNRFNode processSmartStyleRenderingInput]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:didFinishProcessingBuffer:metadata:type:captureFrameFlags:processorInput:err:]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:didFinishProcessingInput:err:]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:didFinishProcessingSampleBuffer:type:processorInput:err:]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:didSelectFusionMode:processorInput:]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:didSelectVitalityMode:forProcessorInput:]
+ -[EGStillImageAdaptiveFusionNRFNode processorController:willAddSampleBuffer:processorInput:]
+ -[EGStillImageAdaptiveFusionNRFNode processorInput]
+ -[EGStillImageAdaptiveFusionNRFNode queueManagedReceiveData:fromInput:]
+ -[EGStillImageAdaptiveFusionNRFNode referenceFrameInput]
+ -[EGStillImageAdaptiveFusionNRFNode sbufOutput]
+ -[EGStillImageAdaptiveFusionNRFNode setProcessSmartStyleRenderingInput:]
+ -[EGStillImageAdaptiveFusionNRFNode singleImageErrorRecoveryInput]
+ -[EGStillImageAdaptiveFusionRoutingNode dealloc]
+ -[EGStillImageAdaptiveFusionRoutingNode evMinusOutput]
+ -[EGStillImageAdaptiveFusionRoutingNode evZeroOutputs]
+ -[EGStillImageAdaptiveFusionRoutingNode hdrErrorRecoveryEVZeroOutput]
+ -[EGStillImageAdaptiveFusionRoutingNode initWithName:evZeroCount:hasEVMinus:longCount:hasHDRErrorRecoveryEVZero:]
+ -[EGStillImageAdaptiveFusionRoutingNode longOutputs]
+ -[EGStillImageAdaptiveFusionRoutingNode receiveData:fromInput:]
+ -[EGStillImageAdaptiveFusionRoutingNode referenceEVZeroOutput]
+ -[EGStillImageAdaptiveFusionRoutingNode sampleBufferInputs]
+ -[EGStillImageDeferredProcessingNode processorController:didDetermineProvenanceFrame:processorInput:err:]
+ -[EGStillImageDeferredProcessingNode provenanceFrameOutput]
+ -[FigCaptureAngleMonitor _handleAngleUpdate:]
...
+ -[FigCaptureCameraCalibrationDataSinkPipeline liveReconfigureForRotationDegrees:]
+ -[FigCaptureCameraCalibrationDataSinkPipeline sourceID]
...
+ -[FigCaptureCameraSourcePipeline initiateSecureStreamingForFaceID]
...
+ -[FigCaptureCameraSourcePipeline secureVideoOutputForSourceDeviceType:]
...
+ -[FigCaptureCameraSourcePipelineConfiguration setSecureVideoConnectionConfigurations:]
...
+ -[FigCaptureConnectionConfiguration secureVideoDataSinkConfiguration]
...
+ -[FigCaptureMagneticInterferenceMonitor _addServiceIfOnInnerDisplay:weakReference:]
...
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration learnedNRFlashSupported]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration portTypesWithAdaptiveFusionEnabled]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration portTypesWithTextureStyleBaseLookEnabled]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration secureSigningPhotoCaptureSupportEnabled]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setLearnedNRFlashSupported:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setOptimizedUltraHighResolutionProcessingWithAspectRatioCropSupported:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setPortTypesWithAdaptiveFusionEnabled:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setPortTypesWithTextureStyleBaseLookEnabled:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setSecureSigningPhotoCaptureSupportEnabled:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setTextureStyleCreativeEffectsEnabled:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setTextureStyleFSINCMasksRequired:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration setTextureStyleRenderingVersion:]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration textureStyleBaseLookEnabled]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration textureStyleCreativeEffectsEnabled]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration textureStyleFSINCMasksRequired]
+ -[FigCapturePhotonicEngineSinkPipelineConfiguration textureStyleRenderingVersion]
...
+ -[FigCaptureSecureVideoDataSinkConfiguration copyWithZone:]
+ -[FigCaptureSecureVideoDataSinkConfiguration copyXPCEncoding]
+ -[FigCaptureSecureVideoDataSinkConfiguration dealloc]
+ -[FigCaptureSecureVideoDataSinkConfiguration description]
+ -[FigCaptureSecureVideoDataSinkConfiguration discardsLateVideoFrames]
+ -[FigCaptureSecureVideoDataSinkConfiguration initWithXPCEncoding:]
+ -[FigCaptureSecureVideoDataSinkConfiguration isEqual:]
+ -[FigCaptureSecureVideoDataSinkConfiguration reasonForNotEqualingConfiguration:]
+ -[FigCaptureSecureVideoDataSinkConfiguration setDiscardsLateVideoFrames:]
+ -[FigCaptureSecureVideoDataSinkConfiguration sinkType]
+ -[FigCaptureSecureVideoDataSinkPipeline _buildSecureVideoDataSinkPipelineWithConfiguration:sourceOutput:graph:clientAuditToken:delegate:]
+ -[FigCaptureSecureVideoDataSinkPipeline dealloc]
+ -[FigCaptureSecureVideoDataSinkPipeline initWithConfiguration:sourceOutput:graph:name:clientAuditToken:delegate:]
...
+ -[FigCaptureSessionParsedCameraSourceConfiguration secureVideoConnectionConfigurations]
+ -[FigCaptureSessionParsedConfiguration parsedSecureVideoDataSinkConfigurations]
+ -[FigCaptureSessionParsedConfiguration textureStyleEnabled]
+ -[FigCaptureSessionParsedConfiguration textureStyle]
+ -[FigCaptureSessionParsedSecureVideoDataSinkConfiguration cameraConfiguration]
+ -[FigCaptureSessionParsedSecureVideoDataSinkConfiguration dealloc]
+ -[FigCaptureSessionParsedSecureVideoDataSinkConfiguration initWithSecureVideoDataConnectionConfiguration:]
+ -[FigCaptureSessionParsedSecureVideoDataSinkConfiguration secureVideoDataConnectionConfiguration]
+ -[FigCaptureSessionParsedSecureVideoDataSinkConfiguration sourceDeviceType]
+ -[FigCaptureSessionPipelines addSecureVideoDataSinkPipeline:]
+ -[FigCaptureSessionPipelines secureVideoDataSinkPipelines]
+ -[FigCaptureSessionPipelines secureVideoSinkPipelineWithSinkID:]
...
+ -[FigCaptureSourceManager _startFaceIDUnwrapWithStream:outError:]
+ -[FigCaptureSourceManager _updateDeviceAngleState]
+ -[FigCaptureSourceManager _updateFaceIDUnwrapResultWithStatus:pearlSecureSessionError:cameraStreamError:]
+ -[FigCaptureSourceManager _updateOccludedState]
+ -[FigCaptureSourceManager layoutMonitor:didUpdateLayout:]
+ -[FigCaptureSourceManager startFaceIDUnwrap]
...
+ -[FigFlashlightRemote setLowCurrentTorchEnabled:]
...
+ -[PearlSecureFDRKeyUnwrapSession .cxx_destruct]
+ -[PearlSecureFDRKeyUnwrapSession clearSession]
+ -[PearlSecureFDRKeyUnwrapSession establishSharedSecretWithSensorEphemeralKey:]
+ -[PearlSecureFDRKeyUnwrapSession generateHostEphemeralKeyWithBootNonce:]
+ -[PearlSecureFDRKeyUnwrapSession hostEphemeralKey]
+ -[PearlSecureFDRKeyUnwrapSession hostUnwrapData]
+ -[PearlSecureFDRKeyUnwrapSession setSensorUnwrapData:]
+ -[PearlSecureSession .cxx_destruct]
+ -[PearlSecureSession clearSession]
+ -[PearlSecureSession dealloc]
+ -[PearlSecureSession generateHostEphemeralKey:hostEphemeralKey:]
+ -[PearlSecureSession initWithCameraType:]
+ -[PearlSecureSession invalidate]
+ -[PearlSecureSession sessionID]
+ -[PearlSecureStreamingSession .cxx_destruct]
+ -[PearlSecureStreamingSession clearSession]
+ -[PearlSecureStreamingSession establishSharedSecretWithSensorEphemeralKey:sensorEphemeralKeySignature:]
+ -[PearlSecureStreamingSession generateHostEphemeralKey]
+ -[PearlSecureStreamingSession hostEphemeralKey]
+ -[PearlSupportDefaults .cxx_destruct]
+ -[PearlSupportDefaults debugEnabled]
+ -[PearlSupportDefaults init]
+ -[PearlSupportHelper init]
+ -[PearlSupportHelper isInternalBuild]
+ -[PearlUnwrapData .cxx_destruct]
+ -[PearlUnwrapData encryptionKeyHmac]
+ -[PearlUnwrapData encryptionKey]
+ -[PearlUnwrapData initWithEncryptionKey:encryptionKeyHmac:initializationVector:tag:signature:]
+ -[PearlUnwrapData initializationVector]
+ -[PearlUnwrapData signature]
+ -[PearlUnwrapData tag]
+ -[SEPCameraProxy .cxx_destruct]
+ -[SEPCameraProxy cameraType]
+ -[SEPCameraProxy clearSession]
+ -[SEPCameraProxy deregisterWithPearlSecureSession:]
+ -[SEPCameraProxy establishSharedSecretWithSession:sensorEphemeralKey:sensorEphemeralKeySignature:]
+ -[SEPCameraProxy generateHostEphemeralKeyWithSession:bootNonce:hostEphemeralKey:]
+ -[SEPCameraProxy generateHostUnwrapDataWithSession:wrappedHostEncKey:wrappedHostEncKeyHmac:hostIV:hostTag:hostSignature:]
+ -[SEPCameraProxy initWithCameraType:]
+ -[SEPCameraProxy registerWithPearlSecureSession:]
+ -[SEPCameraProxy setSensorUnwrapDataWithSession:unwrappedSensorEncKey:unwrappedSensorEncKeyHmac:sensorIV:sensorEphemeralKeySignature:]
...
+ _BWCreateSampleBufferWithSecureVideo
+ _BWDeferredIntermediateTagLCBDatabaseByPortType
+ _BWDeferredIntermediateTagProvenanceDNGDictionaryByPortTypePrefix
+ _BWDeviceIDComponents
+ _BWDeviceModelIsV68
+ _BWDeviceModelIsV6x
...
+ _BWFilterRendererTypeBaselineTextureStyleKey
+ _BWFilterRendererTypeGlobalTextureStyleKey
+ _BWFilterRendererTypeGlowTextureStyleKey
+ _BWFilterRendererTypeSkinTextureStyleKey
...
+ _BWShouldApplyTextureStylesInferences
+ _BWShouldDisableSRLForSceneFlags
...
+ _DeviceIdentityCopyCertificateProperties
+ _DeviceIdentityIssueClientCertificateWithCompletion
+ _FigCaptureBWInferenceConfigurationForDualANESupported
+ _FigCaptureBuildCinematicVideoDepthInferenceNodes
...
+ _FigCaptureCopyInternalDaemonDataContainerURL.sOnceToken
+ _FigCaptureCopyInternalDaemonDataContainerURL.sSigningIdentifier
...
+ _FigCaptureSessionIrisStillImageSinkInitiateManualPersonalPhotographerCapture
+ _FigCaptureSessionIrisStillImageSinkStartPersonalPhotographerSession
+ _FigCaptureSessionIrisStillImageSinkStopPersonalPhotographerSession
+ _FigCaptureSessionSetProperty
...
+ _FigCaptureSourceSetFaceIDUnwrapStatus
...
+ _FigImageControl_SetApertureFlickerMitigation
...
+ _OBJC_CLASS_$_BWInferenceTextureStylesPostProcessor
...
+ _OBJC_CLASS_$_EGStillImageAdaptiveFusionNRFNode
+ _OBJC_CLASS_$_EGStillImageAdaptiveFusionRoutingNode
...
+ _OBJC_CLASS_$_FigCaptureSecureVideoDataSinkPipeline
+ _OBJC_CLASS_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ _OBJC_CLASS_$_FigCaptureTextureStyle
+ _OBJC_CLASS_$_LLVPostProcessorFrameParameters
+ _OBJC_CLASS_$_LLVPostProcessorIBP
+ _OBJC_CLASS_$_LLVPreProcessorFrameParameters
+ _OBJC_CLASS_$_LLVPreProcessorIBP
+ _OBJC_CLASS_$_LLVProcessorFrameParameters
+ _OBJC_CLASS_$_LLVProcessorIBP
+ _OBJC_CLASS_$_MTLSharedEventListener
+ _OBJC_CLASS_$_NSInvocation
+ _OBJC_CLASS_$_PearlSecureFDRKeyUnwrapSession
+ _OBJC_CLASS_$_PearlSecureSession
+ _OBJC_CLASS_$_PearlSecureStreamingSession
+ _OBJC_CLASS_$_PearlSupportDefaults
+ _OBJC_CLASS_$_PearlSupportHelper
+ _OBJC_CLASS_$_PearlUnwrapData
+ _OBJC_CLASS_$_SEPCameraProxy
+ _OBJC_CLASS_$_TSSyncEntityManager
+ _OBJC_IVAR_$_BWAudioConverterNode._movieRecordingEndOfDataBehavior
+ _OBJC_IVAR_$_BWBaselineTextureStyleRenderer._baselineTextureStylesProcessor
+ _OBJC_IVAR_$_BWBaselineTextureStyleRenderer._configuration
+ _OBJC_IVAR_$_BWCameraStreamingMonitor._displayRegionBlankingAssertion
+ _OBJC_IVAR_$_BWCameraStreamingMonitor._displayRegionBlankingAssertionClientID
+ _OBJC_IVAR_$_BWCameraStreamingMonitor._displayRegionBlankingObserver
+ _OBJC_IVAR_$_BWCinematicPerceptionNode._opticalFlowInferenceEnabled
+ _OBJC_IVAR_$_BWCinematicVideoMetadataNode._disabled
+ _OBJC_IVAR_$_BWCinematicVideoMetadataNode._useRawCinematography
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cameraInfoByPortType
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._captureDevice
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicConversionDisabledOnModuleGating
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataFirstTenSecondsFrameCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataFirstTenSecondsFramesOnWideCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataFirstTwoSecondsFrameCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataFirstTwoSecondsFramesOnWideCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataFramesOnWideCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataRecordingStartPTS
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicMetadataTotalFrameCount
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicVideoMetadata
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematicVideoParameters
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematographyProcessingCadence
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._cinematographyStream
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._disabled
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._focusTapWindowSize
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._focusTrackedObjectLastID
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._focusTrackedObjectTrackAcquired
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._framesSinceCinematographyProcessing
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._framesSinceLastDDR
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._framesSinceLastMetadataOutput
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._globalCinematographyMetadata
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._globalMetadata
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._globalRenderingMetadata
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._globalRenderingMetadataVersion
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._globalVideoHeaderMetadata
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._humanPoseCadence
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._humanPosePreventionSet
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._inferenceEngine
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._inferenceEnginePrepared
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._inferenceScheduler
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._latestDetections
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._latestFocusDetectionTrackID
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._lowLightMonitor
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._metadataCollectionSize
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._portTypeProvidingSDOFRenderingParameters
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._prepareCinematographyOnInit
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._previousCinematographyFrame
+ _OBJC_IVAR_$_BWCinematographyObjectTrackingNode._reportCinematicMetadataStatistics
+ _OBJC_IVAR_$_BWDeferredPipelineParameters._portTypesWithTextureStyleBaseLookEnabled
+ _OBJC_IVAR_$_BWDeferredPipelineParameters._textureStyleBaseLookEnabled
+ _OBJC_IVAR_$_BWDeferredPipelineParameters._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_BWDeferredPipelineParameters._textureStyleFSINCMasksRequired
+ _OBJC_IVAR_$_BWDeferredPipelineParameters._textureStyleRenderingVersion
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._activeExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._activeOmahaConstituentDeviceType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._activeZeroShutterLagFlavorHighResolutionFlavor
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._adaptiveFusionDowngradeSceneByPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._apertureControlSceneMonitorEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._apertureFlickerMitigationEngaged
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._autoFullFullUltraHighResolutionZeroShutterLagEnabledByOmahaConstituentPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._automaticallyIgnoresExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._cameraControlsSemanticHints
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._cameraControlsSemanticHintsLock
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._continuousAutoFocusTrackingChangedDelegate
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._depthSupportedWithUltraHighResolutionCaptures
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._fullAutoExposureModeActive
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._hasAdaptiveFusion
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._highResolutionSecureSigningNondisruptiveSwitchingFormatIndexByPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._ignoredExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._learnedFusionHighResolutionDowngradeSceneByPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._learnedNRWithShutterPriorityEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._lensAperture
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._magneticInterferenceDetected
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._magneticInterferenceMonitor
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._numberOfMagneticInterferenceEventsDetected
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._omahaConstituentDeviceLiveReconfigurationInProgress
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._omahaRenoAngleWithinDropZone
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._omahaRenoCaptureStream
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._omahaRenoRotationOffsetDegrees
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._overrideIgnoredExposureSignalValues
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._overrideIgnoredExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._pendingLensApertureChange
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerSceneMonitor
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerSceneMonitorLock
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerSessionActive
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerStatus
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._personalPhotographerSubjectDetected
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._resolvedIgnoredExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._secureSigningPhotoCaptureEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._secureSigningPhotoCaptureSupportEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._secureSigningQueue
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._segmentFocusTrackingEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._segmentFocusTrackingSupported
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._shutterSoundRelaxationEnabledForDisplayRegion
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._supportedExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._timewarpActive
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._timewarpEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._timewarpMode
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._ultraHighResolutionZeroShutterLagSupportEnabledByOmahaConstituentPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._zeroShutterLagEnabledByOmahaConstituentPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureDevice._zeroShutterLagTimeMachineBufferCapacityByOmahaConstituentPortType
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._activeSecureSigningMode
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._autoExposureLensApertureRateLimit
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._defaultLensAperture
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._faceIDFrameTracker
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._faceImageQualityDetectionEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._ignoredExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._isOmahaVariant
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._maxLensAperture
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._minLensAperture
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._supportedExposureSignals
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._timewarpEnabled
+ _OBJC_IVAR_$_BWFigVideoCaptureStream._tnrMachineLearningImageRegistrationSupported
+ _OBJC_IVAR_$_BWFileCoordinatorNode._currTimewarpPTS
+ _OBJC_IVAR_$_BWFileCoordinatorNode._movieRecordingEndOfDataBehavior
+ _OBJC_IVAR_$_BWFileCoordinatorNode._timewarpEnabled
+ _OBJC_IVAR_$_BWFileCoordinatorNode._timewarpFrameDuration
+ _OBJC_IVAR_$_BWFileCoordinatorNode._timewarpFrameDurationForCapture
+ _OBJC_IVAR_$_BWFrameStatistics._defaultFNumber
+ _OBJC_IVAR_$_BWGlobalTextureStyleRenderer._configuration
+ _OBJC_IVAR_$_BWGlobalTextureStyleRenderer._globalTextureStylesProcessor
+ _OBJC_IVAR_$_BWGlowTextureStyleRenderer._configuration
+ _OBJC_IVAR_$_BWGlowTextureStyleRenderer._glowTextureStylesProcessor
+ _OBJC_IVAR_$_BWGlowTextureStyleRenderer._outputFormatDescription
+ _OBJC_IVAR_$_BWGlowTextureStyleRenderer._smartStyleClass
+ _OBJC_IVAR_$_BWGraph._liveExtensionSourceNodes
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._allPromotedFrameMetadata
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._autoFramesEvictedByManualIDs
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._breakDuplicateChains
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._breakPauseThresholdsInMS
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._bucketEntryTime
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._bucketFrame
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._budgetEnabled
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._budgetType
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._candidateEntryTimes
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._captureFolder
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._captureStartTime
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._cleanDuplicatesEnabled
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._contextCandidates
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._contextPriorities
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._currentSegmentIsValid
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._delegate
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._dumpInput
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._duplicateConstraintType
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._duplicateMaxTimeInMs
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._duplicateThresholds
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._failedCaptureFrameIDs
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._fixedBudgetMaxFrames
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._fixedBudgetMode
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._foundAnyValidCandidate
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._framePromotionHandler
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._frameRemovalHandler
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._framesToRemoveExtra
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._handlerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._inPause
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._isFinalizingBudget
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._largeFacePerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._legacy
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._manualFrameIDs
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxCandidateAgeInSec
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxCandidates
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxCandidatesPerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxFramesPer20Sec
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxRTBucketAgeInSec
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._maxScoreFrame
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._minBudget
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._minCandidateProximityInSec
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._minPauseDurationInSec
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._minPercentageOfMaxScoreThresholds
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._minThresholds
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._mostRecentFrameDict
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._pauseBreakCounter
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._pauseFrame
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._pauseSegmentCounter
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._pauseStartTime
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._prevScore
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._previousSimScore
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._promotedFrames
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._promotedMaxScoreFrameID
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._promotedMaxScoreValue
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._promotedPauseFrameIDs
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._recoverExtras
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._removalHandlerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._removedFramesForDuplicate
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._savePauseThresholdsInMS
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._simBoostPerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._simThreshold
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._tinyFacePerContext
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._tinyFaceRatio
+ _OBJC_IVAR_$_BWHVSCandidateFrameManager._tinyFaceReference
+ _OBJC_IVAR_$_BWHVSEmbeddingAnalysisResult._contextProbabilities
+ _OBJC_IVAR_$_BWHVSEmbeddingAnalysisResult._detectedContext
+ _OBJC_IVAR_$_BWHVSEmbeddingAnalysisResult._frameScore
+ _OBJC_IVAR_$_BWHVSEmbeddingAnalysisResult._imageEmbedding
+ _OBJC_IVAR_$_BWHVSEmbeddingAnalysisResult._similarityScore
+ _OBJC_IVAR_$_BWHVSFace._faceObservation
+ _OBJC_IVAR_$_BWHVSFace._isFrontal
+ _OBJC_IVAR_$_BWHVSFrame._auxScore
+ _OBJC_IVAR_$_BWHVSFrame._captureSettingsID
+ _OBJC_IVAR_$_BWHVSFrame._cropPenalty
+ _OBJC_IVAR_$_BWHVSFrame._deviceSharpnessIntercept
+ _OBJC_IVAR_$_BWHVSFrame._deviceSharpnessSlope
+ _OBJC_IVAR_$_BWHVSFrame._duplicateInfo
+ _OBJC_IVAR_$_BWHVSFrame._ev0RawCaptureID
+ _OBJC_IVAR_$_BWHVSFrame._faceObservations
+ _OBJC_IVAR_$_BWHVSFrame._finalCropRectLaplacianVariance
+ _OBJC_IVAR_$_BWHVSFrame._frameID
+ _OBJC_IVAR_$_BWHVSFrame._frameScore
+ _OBJC_IVAR_$_BWHVSFrame._frameStatisticsByPortType
+ _OBJC_IVAR_$_BWHVSFrame._frameTrackingEntry
+ _OBJC_IVAR_$_BWHVSFrame._isManualCapture
+ _OBJC_IVAR_$_BWHVSFrame._isPauseFrame
+ _OBJC_IVAR_$_BWHVSFrame._maxFaceProminence
+ _OBJC_IVAR_$_BWHVSFrame._metadata
+ _OBJC_IVAR_$_BWHVSFrame._orientation
+ _OBJC_IVAR_$_BWHVSFrame._originalCameraIntrinsicMatrix
+ _OBJC_IVAR_$_BWHVSFrame._originalCameraIntrinsicMatrixReferenceDimensions
+ _OBJC_IVAR_$_BWHVSFrame._pauseDurationInSec
+ _OBJC_IVAR_$_BWHVSFrame._people
+ _OBJC_IVAR_$_BWHVSFrame._personMaskPNGData
+ _OBJC_IVAR_$_BWHVSFrame._petCropPenalty
+ _OBJC_IVAR_$_BWHVSFrame._pets
+ _OBJC_IVAR_$_BWHVSFrame._rawEV0SampleBuffer
+ _OBJC_IVAR_$_BWHVSFrame._rawSIFRSampleBuffer
+ _OBJC_IVAR_$_BWHVSFrame._sbufPresentationTimestamp
+ _OBJC_IVAR_$_BWHVSFrame._segmentIdx
+ _OBJC_IVAR_$_BWHVSFrame._sessionID
+ _OBJC_IVAR_$_BWHVSFrame._sifrRawCaptureID
+ _OBJC_IVAR_$_BWHVSFrame._stillImageCaptureMetadata
+ _OBJC_IVAR_$_BWHVSFrame._stillImageSceneFlags
+ _OBJC_IVAR_$_BWHVSFrame._timestamp
+ _OBJC_IVAR_$_BWHVSFrame._unifiedEmbeddingsOutput
+ _OBJC_IVAR_$_BWHVSFrame._yuvDimensions
+ _OBJC_IVAR_$_BWHVSFrame._yuvPixelBuffer
+ _OBJC_IVAR_$_BWHVSFrame._yuvPixelFormat
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._analysisEnabled
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._faceObservations
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._faceQualitySampleBuffer
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._imageEmbedding
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._imageEmbeddingSampleBuffer
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._loggingPrefix
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._matchingMainSensorRawSampleBuffer
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._matchingSIFRSensorRawSampleBuffer
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._numberOfSubtaskThreads
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._personMaskPNGData
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._remainingSubtaskLeaves
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._sharpnessResults
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._subtaskGroup
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._subtaskWorkInterval
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._workIntervalDictionary
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._workIntervalInfo
+ _OBJC_IVAR_$_BWHVSFrameAnalysisTask._yuvSampleBuffer
+ _OBJC_IVAR_$_BWHVSObject._boundingBox
+ _OBJC_IVAR_$_BWHVSObject._confidence
+ _OBJC_IVAR_$_BWHVSObject._groupID
+ _OBJC_IVAR_$_BWHVSObject._imageDimensions
+ _OBJC_IVAR_$_BWHVSObject._laplacianVariance
+ _OBJC_IVAR_$_BWHVSPerson._body
+ _OBJC_IVAR_$_BWHVSPerson._face
+ _OBJC_IVAR_$_BWHVSPet._body
+ _OBJC_IVAR_$_BWHVSPet._face
+ _OBJC_IVAR_$_BWHVSScoringNode._bufferedYUVInputSampleBuffer
+ _OBJC_IVAR_$_BWHVSScoringNode._candidateFrameManager
+ _OBJC_IVAR_$_BWHVSScoringNode._candidateManagerLock
+ _OBJC_IVAR_$_BWHVSScoringNode._captureDevice
+ _OBJC_IVAR_$_BWHVSScoringNode._captureMode
+ _OBJC_IVAR_$_BWHVSScoringNode._consecutiveFramesWithoutSubject
+ _OBJC_IVAR_$_BWHVSScoringNode._contextEmbeddingsFP32
+ _OBJC_IVAR_$_BWHVSScoringNode._currentSettingsID
+ _OBJC_IVAR_$_BWHVSScoringNode._delayYUVInputByOneFrame
+ _OBJC_IVAR_$_BWHVSScoringNode._delegate
+ _OBJC_IVAR_$_BWHVSScoringNode._downscaledYUVPixelBuffer
+ _OBJC_IVAR_$_BWHVSScoringNode._enableFaceQualityInference
+ _OBJC_IVAR_$_BWHVSScoringNode._enableGDCCorrection
+ _OBJC_IVAR_$_BWHVSScoringNode._enableGDCCorrectionOnBackSuperWide
+ _OBJC_IVAR_$_BWHVSScoringNode._enableImageEmbeddingInference
+ _OBJC_IVAR_$_BWHVSScoringNode._enableSegmentationMaskFallback
+ _OBJC_IVAR_$_BWHVSScoringNode._enableSharpnessDetection
+ _OBJC_IVAR_$_BWHVSScoringNode._faceQualityDispatchQueue
+ _OBJC_IVAR_$_BWHVSScoringNode._faceQualityInferenceEngine
+ _OBJC_IVAR_$_BWHVSScoringNode._gdcMaskOutputPool
+ _OBJC_IVAR_$_BWHVSScoringNode._hueMapInput
+ _OBJC_IVAR_$_BWHVSScoringNode._hvsConfig
+ _OBJC_IVAR_$_BWHVSScoringNode._hvsEmbeddings
+ _OBJC_IVAR_$_BWHVSScoringNode._imageEmbeddingInferenceEngine
+ _OBJC_IVAR_$_BWHVSScoringNode._imageEmbeddingsDispatchQueue
+ _OBJC_IVAR_$_BWHVSScoringNode._inferenceScheduler
+ _OBJC_IVAR_$_BWHVSScoringNode._laplacianScratchBuffer
+ _OBJC_IVAR_$_BWHVSScoringNode._laplacianScratchBufferSize
+ _OBJC_IVAR_$_BWHVSScoringNode._lastFrame
+ _OBJC_IVAR_$_BWHVSScoringNode._lastFrameAvailabilitySemaphore
+ _OBJC_IVAR_$_BWHVSScoringNode._lastInitiatedSIFRSbufPTS
+ _OBJC_IVAR_$_BWHVSScoringNode._lastRenderedPTS
+ _OBJC_IVAR_$_BWHVSScoringNode._loggingPrefix
+ _OBJC_IVAR_$_BWHVSScoringNode._m2mController
+ _OBJC_IVAR_$_BWHVSScoringNode._manualCapturePending
+ _OBJC_IVAR_$_BWHVSScoringNode._manualFramePendingRegistration
+ _OBJC_IVAR_$_BWHVSScoringNode._maskGDCMetalContext
+ _OBJC_IVAR_$_BWHVSScoringNode._maskGDCProcessor
+ _OBJC_IVAR_$_BWHVSScoringNode._multiFramePipeliningEnabled
+ _OBJC_IVAR_$_BWHVSScoringNode._numActivePromptEmbeddings
+ _OBJC_IVAR_$_BWHVSScoringNode._numFramesWithOutOfSyncSemanticMasks
+ _OBJC_IVAR_$_BWHVSScoringNode._numFramesWithoutHueMap
+ _OBJC_IVAR_$_BWHVSScoringNode._numFramesWithoutMainSensorRaw
+ _OBJC_IVAR_$_BWHVSScoringNode._numFramesWithoutSIFRSensorRaw
+ _OBJC_IVAR_$_BWHVSScoringNode._numFramesWithoutSemanticMasks
+ _OBJC_IVAR_$_BWHVSScoringNode._numProcessedFrames
+ _OBJC_IVAR_$_BWHVSScoringNode._numPromptPairs
+ _OBJC_IVAR_$_BWHVSScoringNode._orientationHistory
+ _OBJC_IVAR_$_BWHVSScoringNode._pinnedGroupIDs
+ _OBJC_IVAR_$_BWHVSScoringNode._preparedInferences
+ _OBJC_IVAR_$_BWHVSScoringNode._prevFrameNetworkOutput
+ _OBJC_IVAR_$_BWHVSScoringNode._rawInput
+ _OBJC_IVAR_$_BWHVSScoringNode._recommendedMasterPortType
+ _OBJC_IVAR_$_BWHVSScoringNode._requestedSettings
+ _OBJC_IVAR_$_BWHVSScoringNode._scheduledFrameAnalysisTask
+ _OBJC_IVAR_$_BWHVSScoringNode._scoringEmbeddingsFP32
+ _OBJC_IVAR_$_BWHVSScoringNode._semanticMasksInput
+ _OBJC_IVAR_$_BWHVSScoringNode._sensorRawTimeMachine
+ _OBJC_IVAR_$_BWHVSScoringNode._serializeInferences
+ _OBJC_IVAR_$_BWHVSScoringNode._sessionActive
+ _OBJC_IVAR_$_BWHVSScoringNode._sessionFinalizationPending
+ _OBJC_IVAR_$_BWHVSScoringNode._sessionID
+ _OBJC_IVAR_$_BWHVSScoringNode._sharedStateLock
+ _OBJC_IVAR_$_BWHVSScoringNode._sharpnessDispatchQueue
+ _OBJC_IVAR_$_BWHVSScoringNode._statusInfo
+ _OBJC_IVAR_$_BWHVSScoringNode._statusInfoLock
+ _OBJC_IVAR_$_BWHVSScoringNode._stillImageCoordinator
+ _OBJC_IVAR_$_BWHVSScoringNode._stripSegmentationMask
+ _OBJC_IVAR_$_BWHVSScoringNode._subjectDetectedStabilizationFrames
+ _OBJC_IVAR_$_BWHVSScoringNode._threadPriority
+ _OBJC_IVAR_$_BWHVSScoringNode._wasSessionActive
+ _OBJC_IVAR_$_BWHVSScoringNode._weightsPerCtx
+ _OBJC_IVAR_$_BWHVSScoringNode._workInterval
+ _OBJC_IVAR_$_BWHVSScoringNode._yuvInput
+ _OBJC_IVAR_$_BWInferenceTextureStylesPostProcessor._finalCropRectAppliedToFaceAndInstanceSegmentationMasks
+ _OBJC_IVAR_$_BWInferenceTextureStylesPostProcessor._finalCropRectAppliedToPersonSemanticMasks
+ _OBJC_IVAR_$_BWInferenceTextureStylesPostProcessor._requiredInferenceTypes
+ _OBJC_IVAR_$_BWInferenceTextureStylesPostProcessor._validBufferRectAppliedToVisionFaceLandmarks
+ _OBJC_IVAR_$_BWIrisStagingNode._textureStyleRenderingEnabled
+ _OBJC_IVAR_$_BWLCBDatabaseManager._containerSandboxToken
+ _OBJC_IVAR_$_BWLCBDatabaseManager._databasePathFolder
+ _OBJC_IVAR_$_BWLCBDatabaseManager._databasePathPrefix
+ _OBJC_IVAR_$_BWLCBDatabaseManager._databasesWereUpdated
+ _OBJC_IVAR_$_BWLCBDatabaseManager._delegate
+ _OBJC_IVAR_$_BWLCBDatabaseManager._lcbDatabaseByPortType
+ _OBJC_IVAR_$_BWLCBDatabaseManager._lcbDatabaseQueue
+ _OBJC_IVAR_$_BWMemoryAnalyticsPayload._captureTypeAdaptiveFusion
+ _OBJC_IVAR_$_BWMovieFileOutputAnalyticsPayload._cinematicMetadataMovieRecordingStats
+ _OBJC_IVAR_$_BWMovieFileOutputAnalyticsPayload._cinematicVideoMetadataEnabled
+ _OBJC_IVAR_$_BWMultiCamConfiguration._colorAssistedSecureFaceIDEnabled
+ _OBJC_IVAR_$_BWMultiCamConfiguration._mutuallyExclusiveUnsynchronizedStreamsPortTypes
+ _OBJC_IVAR_$_BWMultiCamConfiguration._secureProcessingCoexEnabled
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._faceIDOutput
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._isUnsynchronizedPrimary
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._isUnsynchronizedPrimaryLock
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._lastFocusTrackedObjectPTS
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._lastPrimaryStreamingOutputISPAppliedZoomFactor
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._mostRecentFocusTrackedObject
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._previewStabilizationShift
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._previewStabilizationShiftLock
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._secureCameraSession
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._secureVideoDataOutputID
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNode._secureVideoOutput
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNodeConfiguration._faceImageQualityDetectionEnabled
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNodeConfiguration._focusTrackedObjectsDeliveryEnabled
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNodeConfiguration._secureStreamingForFaceIDEnabled
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNodeConfiguration._secureVideoCaptureDimensions
+ _OBJC_IVAR_$_BWMultiStreamCameraSourceNodeConfiguration._secureVideoOutputEnabled
+ _OBJC_IVAR_$_BWNRFProcessorControllerConfiguration._adaptiveFusionEnabled
+ _OBJC_IVAR_$_BWNRFProcessorControllerConfiguration._adaptiveFusionInputFormat
+ _OBJC_IVAR_$_BWNodeInput._mediaTypeIsSecureVideo
+ _OBJC_IVAR_$_BWNodeOutput._mediaTypeIsSecureVideo
+ _OBJC_IVAR_$_BWNondisruptiveSwitchingFormatSelector._ultraHighResolutionSecureSigningNondisruptiveStreamingFormatIndex
+ _OBJC_IVAR_$_BWNondisruptiveSwitchingFormatSelector._zoomFactorToNondisruptiveSwitchingFormatIndexSecureSigning
+ _OBJC_IVAR_$_BWOverCaptureSmartStyleApplyNode._skinSmoothMaskState
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._lowStorageSpaceThresholdCheckRateSeconds
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._maxPeakPowerPressureLevel
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._maxThermalPressureLevel
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._sceneIsTooDark
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._sceneTooDarkMonitoringEnabled
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._storageCheckLock
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._storageCheckTimer
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._storageSpaceIsTooLow
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._storageSpaceThresholdCheckRateSeconds
+ _OBJC_IVAR_$_BWPersonalPhotographerSceneMonitorV1._tuningParametersByPortType
+ _OBJC_IVAR_$_BWPhotoEncoderController._provenanceDNGInfo
+ _OBJC_IVAR_$_BWPhotoEncoderController._provenanceDNGInfoLock
+ _OBJC_IVAR_$_BWPhotoEncoderController._provenanceDngEncoderManager
+ _OBJC_IVAR_$_BWPhotoEncoderController._provenanceFormatDescription
+ _OBJC_IVAR_$_BWPhotoEncoderControllerConfiguration._secureSigningPhotoCaptureSupportEnabled
+ _OBJC_IVAR_$_BWPhotoEncoderControllerConfiguration._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_BWPhotoEncoderControllerInput._fsincMasksPrewarmedForCurrentEncoding
+ _OBJC_IVAR_$_BWPhotoEncoderControllerRequest._provenanceDNGSurface
+ _OBJC_IVAR_$_BWPhotoEncoderControllerRequest._provenanceDNGSurfaceSize
+ _OBJC_IVAR_$_BWPhotonicEngineNode._pendingTextureStyleBaseLookPeopleDataByPortType
+ _OBJC_IVAR_$_BWPhotonicEngineNode._provenanceFormatDescription
+ _OBJC_IVAR_$_BWPhotonicEngineNode._sensorRawProvenanceFrameByCaptureFrameFlags
+ _OBJC_IVAR_$_BWPhotonicEngineNode._textureStylesInferenceControllerInputByPortType
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._personalPhotographerEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._portTypesWithAdaptiveFusionEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._portTypesWithCalibrationEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._portTypesWithTextureStyleBaseLookEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._textureStyleBaseLookEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._textureStyleFSINCMasksRequired
+ _OBJC_IVAR_$_BWPhotonicEngineNodeConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_BWPhotonicEngineNodeResourceCoordinator._learnedFusionEnhancedResolutionOutputPool
+ _OBJC_IVAR_$_BWPreviewStabilizationNode._delegate
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._cinematicMetadataMovieRecordingStats
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._cinematicVideoMetadataEnabled
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._deliveredCinematicMetadataMovieRecordingStats
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._movieRecordingEndOfDataBehavior
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._numberOfTimewarpTimelapseFramesWritten
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._timewarpMode
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._timewarpTimelapseMaxDecimationLevel
+ _OBJC_IVAR_$_BWQuickTimeMovieFileSinkNode._timewarpTimelapseMaxSequenceNumber
+ _OBJC_IVAR_$_BWRealtimeCinematographyNode._cinematicVideoDisparityProvider
+ _OBJC_IVAR_$_BWRealtimeCinematographyNode._depthInputProvided
+ _OBJC_IVAR_$_BWRemoteQueueSinkNode._mediaTypeIsSecureVideo
+ _OBJC_IVAR_$_BWSecureFaceIDFrameTracker._frameIdentifiers
+ _OBJC_IVAR_$_BWSecureFaceIDFrameTracker._frameIdentifiersLock
+ _OBJC_IVAR_$_BWSecureMetadataOutputConfiguration._colorCameraAssistEnabled
+ _OBJC_IVAR_$_BWSecureMetadataOutputConfiguration._faceIDConfiguration
+ _OBJC_IVAR_$_BWSecureMetadataOutputConfiguration._faceIDEnabled
+ _OBJC_IVAR_$_BWSecureMetadataOutputConfiguration._rawFrameDeliveryEnabled
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._clientProvidedHash
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._clientProvidedHashHistory
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._delegate
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._fdrUnavailable
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._lowerBoundTimestampData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._refreshTimer
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sealingManifestData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sealingManifestError
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sealingManifestUniqueIDData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._secureBootTicketData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._secureBootTicketError
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sensorCertificateData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sensorCertificateError
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._sensorCertificateUniqueIDData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._timestampQueue
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._trustObjectData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._trustObjectDigestData
+ _OBJC_IVAR_$_BWSecureSigningUtilityManager._trustObjectError
...
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._configuration
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._lock
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._maxCounts
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._nonIncreasingPTSFailureCount
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._nonIncreasingPTSRadarThreshold
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._storedBuffers
+ _OBJC_IVAR_$_BWSensorRawTimeMachine._worstCaseStoredBufferCounts
+ _OBJC_IVAR_$_BWSensorRawTimeMachineConfiguration._frameConfigurationByFrameType
+ _OBJC_IVAR_$_BWSensorRawTimeMachineConfiguration._name
+ _OBJC_IVAR_$_BWSensorRawTimeMachineFrameConfiguration._allowedPTSDeltaFrameIntervalFactor
+ _OBJC_IVAR_$_BWSensorRawTimeMachineFrameConfiguration._expectsFrameSkipping
+ _OBJC_IVAR_$_BWSensorRawTimeMachineFrameConfiguration._maxCount
+ _OBJC_IVAR_$_BWSkinTextureStyleRenderer._configuration
+ _OBJC_IVAR_$_BWSkinTextureStyleRenderer._fileName
+ _OBJC_IVAR_$_BWSkinTextureStyleRenderer._skinTextureStylesProcessor
+ _OBJC_IVAR_$_BWSmartCropNode._activeOmahaConstituentDeviceType
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitor._subjectDistanceRangeInMM
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitor._subjectMotionSpeedPixelsPerSecond
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._persistentlySignificantSubjectCount
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._persistentlySignificantSubjectGroupIDs
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._significantSubjectCount
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._significantSubjectGroupIDs
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._subjectDistanceRange
+ _OBJC_IVAR_$_BWSmartFramingSceneMonitorResult._subjectMotionPerSecond
+ _OBJC_IVAR_$_BWSmartStyleApplyNode._skinSmoothMaskState
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._enableBloom
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._enableDiffusion
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._enableGlow
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._enableMattify
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._intermediatePixelBuffer
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._shouldApplyRadialExtension
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._statisticsToShare
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._targetPixelBufferWithTextureApplied
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._textureStyle
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._textureStyleEnabled
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._textureStylesProcessor
+ _OBJC_IVAR_$_BWSmartStyleLearningNode._textureStylesProcessorHasBeenPrepared
+ _OBJC_IVAR_$_BWSmartStyleRendererConfiguration._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_BWSmartStyleRendererConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_BWSoftISPProcessorControllerConfiguration._adaptiveFusionEnabled
+ _OBJC_IVAR_$_BWSoftISPProcessorControllerConfiguration._calibrationEnabled
+ _OBJC_IVAR_$_BWSphereModeSelector._magneticInterferenceDetected
+ _OBJC_IVAR_$_BWStartupCalibrationAnalyticsPayload._hingeAngle
+ _OBJC_IVAR_$_BWStartupCalibrationAnalyticsPayload._reason
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._activeExposureSignals
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._actualFNumber
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._apertureDiameter
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._ignoredExposureSignals
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._inputExposureSignals
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._maxVATrackingError
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._requestedFNumber
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._stdVATrackingError
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._textureStyleGrain
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._textureStyleIntensity
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._textureStylePreset
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._textureStyleRenderingSupported
+ _OBJC_IVAR_$_BWStillImageAnalyticsPayloadCommon._variableApertureTemperature
+ _OBJC_IVAR_$_BWStillImageCaptureAnalyticsPayload._lcbDetectionCountHistogram
+ _OBJC_IVAR_$_BWStillImageCaptureAnalyticsPayload._lcbDetectionCountHistogramSet
+ _OBJC_IVAR_$_BWStillImageCaptureAnalyticsPayload._numberOfLCBsCorrectedOnIRCF
+ _OBJC_IVAR_$_BWStillImageCaptureAnalyticsPayload._numberOfLCBsCorrectedOnLens
+ _OBJC_IVAR_$_BWStillImageCaptureAnalyticsPayload._numberOfLCBsDetected
+ _OBJC_IVAR_$_BWStillImageCaptureMetadata._ignoredExposureSignals
+ _OBJC_IVAR_$_BWStillImageCoordinatorNode._calibrationSettingsIDCounter
+ _OBJC_IVAR_$_BWStillImageCoordinatorNode._calibrationTimer
+ _OBJC_IVAR_$_BWStillImageDuplicateInfo._originalPresentationTimestamp
+ _OBJC_IVAR_$_BWStillImageDuplicateInfo._sbufPresentationTimestamp
+ _OBJC_IVAR_$_BWStillImageDuplicateInfo._settingsID
+ _OBJC_IVAR_$_BWStillImageFilterNodeConfiguration._textureStyleBaseLookEnabled
+ _OBJC_IVAR_$_BWStillImageFilterNodeConfiguration._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_BWStillImageFilterNodeConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_BWStillImageFilterNodeConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_BWStillImageFilterNodeResourceCoordinator._baselineTextureStyleRenderer
+ _OBJC_IVAR_$_BWStillImageFilterNodeResourceCoordinator._globalTextureStyleRenderer
+ _OBJC_IVAR_$_BWStillImageFilterNodeResourceCoordinator._glowTextureStyleRenderer
+ _OBJC_IVAR_$_BWStillImageFilterNodeResourceCoordinator._outputFormatUsedForTextureStyleConfiguration
+ _OBJC_IVAR_$_BWStillImageFilterNodeResourceCoordinator._skinTextureStyleRenderer
+ _OBJC_IVAR_$_BWStillImageNodeConfiguration._secureSigningPhotoCaptureSupportEnabled
+ _OBJC_IVAR_$_BWStillImageProcessingSettings._snapshottedLCBDatabaseByPortType
+ _OBJC_IVAR_$_BWStillImageSampleBufferSinkNodeAnalyticsConfiguration._isTextureStyleRenderingSupported
+ _OBJC_IVAR_$_BWStreamingFilterNode._computeFocusDisparity
+ _OBJC_IVAR_$_BWStreamingFilterNode._latestCinematicDisparityBuffer
+ _OBJC_IVAR_$_BWStreamingFilterNode._latestCinematicDisparityLock
+ _OBJC_IVAR_$_BWStreamingRaytracingSDOFRenderer._focusDisparitySampler
+ _OBJC_IVAR_$_BWStreamingSessionAnalyticsPayload._numberOfMagneticInterferenceEventsDetected
+ _OBJC_IVAR_$_BWStreamingSessionAnalyticsPayload._stylusDataReceivedDuringSession
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._boxedMetadataFormatDescription
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._boxedMetadataOutput
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._emptyMetadataSampleData
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._localIDForTextureStyleInfoPlistMetadata_BE
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._passthruOutput
+ _OBJC_IVAR_$_BWTextureStyleInfoMetadataNode._previousGeneratedMetadataBufferWasEmpty
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._boxedMetadataFormatDescription
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._boxedMetadataOutput
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._firstPreTimewarpPTSAsMillisecondsSince1970
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._firstPreTimewarpPTSInHostTime
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._localIDForPreTimewarpFrameMillisecondsSince1970Metadata_BE
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._localIDForTimewarpDecimationLevelMetadata_BE
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._localIDForTimewarpDecimationTagMetadata_BE
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._localIDForTimewarpSequenceCaptureIDMetadata_BE
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._maxDecimationLevel
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._maxSequenceNumber
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._passthruOutput
+ _OBJC_IVAR_$_BWTimewarpMetadataNode._sourceClock
+ _OBJC_IVAR_$_BWUBCaptureParameters._adaptiveFusionDowngradeSNRHysteresisLag
+ _OBJC_IVAR_$_BWUBCaptureParameters._adaptiveFusionDowngradeSNRThreshold
+ _OBJC_IVAR_$_BWUBCaptureParameters._learnedFusionHighResolutionDowngradeNormalizedSNRHysteresisLag
+ _OBJC_IVAR_$_BWUBCaptureParameters._learnedFusionHighResolutionDowngradeNormalizedSNRThreshold
+ _OBJC_IVAR_$_BWVISNode._textureStyle
+ _OBJC_IVAR_$_BWVISNode._textureStyleRenderingEnabled
+ _OBJC_IVAR_$_BWVISProcessorControllerConfiguration._textureStyleRenderingEnabled
+ _OBJC_IVAR_$_BWVariableFrameRateParameters._lowLightVideoNoiseReductionLuxThresholds
+ _OBJC_IVAR_$_BWVariableFrameRateSelector._lastPortType
+ _OBJC_IVAR_$_BWVariableFrameRateSelector._lastQuadraBinningFactor
+ _OBJC_IVAR_$_BWVariableFrameRateSelector._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_BWVariableFrameRateSelector._lowLightVideoNoiseReductionLuxScene
+ _OBJC_IVAR_$_BWVariableFrameRateSelector._lowLightVideoNoiseReductionLuxThresholdsByPortType
+ _OBJC_IVAR_$_BWVideoCompressorNode._movieRecordingEndOfDataBehavior
+ _OBJC_IVAR_$_BWVideoCompressorNode._timewarpMode
+ _OBJC_IVAR_$_BWVideoDepthNode._cachedDisparityPixelBuffer
+ _OBJC_IVAR_$_BWVideoDepthNode._depthPaddingPipelineState
+ _OBJC_IVAR_$_BWVideoDepthNode._highFrameRateModeEnabled
+ _OBJC_IVAR_$_BWVideoDepthNode._lastInferencePTS
+ _OBJC_IVAR_$_BWVideoDepthNode._paddedDisparityPool
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._cameraInfoByPortType
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._clearHistoryThresholdFrameCount
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._crossfadeInEnabled
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._crossfadeRamp
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._ispProcessingSession
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._ispStatus
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._ispWait
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastApertureDiameter
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastCaptureID
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastHumanFullBodiesMask
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastLSCGainGridData
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastPortType
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._lastQuadraBinningFactor
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvPostProcessorIBP
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvPreProcessorIBP
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessInputPixelBuffer
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessOutputPixelBuffer
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessPixelBufferPool
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessingQueue
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessorIBP
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._llvProcessorsLoaded
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maxLossyCompressionLevel
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maximumAllowedFrameRate
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maximumAllowedFrameRateReachedCount
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maximumAllowedOverscan
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maximumAllowedSystemPressureLevel
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._maximumAllowedSystemPressureLevelReached
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._metalCommandQueue
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._metalProcessingWaitSemaphore
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._metalSharedEvent
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._metalSharedEventListener
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._metalTextureCache
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._outputFormatDescription
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._requiredAttachedMediaKeys
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._sceneMonitor
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._videoNoiseReductionDimensions
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._videoNoiseReductionEnabled
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._videoNoiseReductionGainThresholdsByPortType
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._visInputValidDimensions
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._visOutputDimensions
+ _OBJC_IVAR_$_BWVideoNoiseReductionNode._workInterval
+ _OBJC_IVAR_$_CMCaptureCinematicVideoTimedMetadataSampleGenerator._metadataFormatDescription
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._attemptErrorRecoveryOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._attemptSingleImageErrorRecoveryOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._attemptedSingleImageRecovery
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._deliveredImage
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._errorCodeTriggeringErrorRecovery
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._fusionModeOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._handleSyncErrorRecovery
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._hdrErrorRecoveryEVZeroInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._inferenceInputImageOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._nodeConfiguration
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._nrfProcessorControllerErrorRecoveryInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._nrfProcessorControllerInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._nrfProcessorControllerSingleImageRecoveryInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._portType
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._primarySbufInputs
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._processSmartStyleRenderingInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._processorInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._provideInferenceInputImageForProcessing
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._referenceFrameInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._sbufOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._singleImageErrorRecoveryInput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._stashedNRFProcessorController
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionNRFNode._stillImageSettings
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._evMinusOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._evZeroEmitIndex
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._evZeroOutputs
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._hdrErrorRecoveryEVZeroOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._longEmitIndex
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._longOutputs
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._referenceEVZeroOutput
+ _OBJC_IVAR_$_EGStillImageAdaptiveFusionRoutingNode._sampleBufferInputs
+ _OBJC_IVAR_$_EGStillImageDeferredProcessingNode._provenanceFrameOutput
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._active
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._angleHandler
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._angleManager
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._angleNotificationLock
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._normalizedAngle
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._queue
+ _OBJC_IVAR_$_FigCaptureAngleMonitor._started
+ _OBJC_IVAR_$_FigCaptureCameraParameters._commonPersonalPhotographerParameters
+ _OBJC_IVAR_$_FigCaptureCameraParameters._lowLightVideoNoiseReductionParameters
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._attachedInfraredSourcePipeline
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._cinematographyObjectTrackingNodeForMetadata
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._colorAssistSourceNode
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._omahaPrimaryStreamSourceDeviceType
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._renoSuperWideSourceNode
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._secureVideoOutputsBySourceDeviceType
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._semanticMasksMetadataOutputBySourceDeviceType
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._semanticMasksSceneClassifierOutputBySourceDeviceType
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipeline._textureStyle
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._cinematicVideoCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._cinematicVideoMetadataDeliveryEnabled
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._clientIsAttachedInfraredMetadataSession
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._secureVideoConnectionConfigurations
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._textureStyle
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_FigCaptureCameraSourcePipelineConfiguration._timewarpMode
+ _OBJC_IVAR_$_FigCaptureCinematographyPipeline._textureStyle
+ _OBJC_IVAR_$_FigCaptureCinematographyPipelineConfiguration._depthInferenceEnabled
+ _OBJC_IVAR_$_FigCaptureCinematographyPipelineConfiguration._textureStyle
+ _OBJC_IVAR_$_FigCaptureCinematographyPipelineConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_FigCaptureCinematographyPipelineConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_FigCaptureCustomExposureConfiguration._enableFNumberForAperturePriority
+ _OBJC_IVAR_$_FigCaptureCustomExposureConfiguration._hasLockedAperture
+ _OBJC_IVAR_$_FigCaptureCustomExposureConfiguration._lensAperture
+ _OBJC_IVAR_$_FigCaptureDisplayLayout._displayRegion
+ _OBJC_IVAR_$_FigCaptureDisplayLayoutMonitor._isV68Device
+ _OBJC_IVAR_$_FigCaptureExposureLimits._defaultLensAperture
+ _OBJC_IVAR_$_FigCaptureExposureLimits._maxLensAperture
+ _OBJC_IVAR_$_FigCaptureExposureLimits._minLensAperture
+ _OBJC_IVAR_$_FigCaptureIrisSinkConfiguration._personalPhotographerEnabled
+ _OBJC_IVAR_$_FigCaptureIrisSinkConfiguration._secureSigningPhotoCaptureSupportEnabled
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._exitZoneDuration
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._exitZoneTimer
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._hidSystemClient
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._innerDisplaySenderIDs
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._isMonitoring
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._lock
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._magneticInterferenceDetected
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._magneticInterferenceHandler
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._magneticInterferenceZone
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._monitorQueue
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._stateMachine
+ _OBJC_IVAR_$_FigCaptureMagneticInterferenceMonitor._stylusDataReceivedDuringSession
+ _OBJC_IVAR_$_FigCaptureMetadataObjectSinkConfiguration._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureMetadataSinkPipeline._semanticMasksConverterNode
+ _OBJC_IVAR_$_FigCaptureMetadataSinkPipelineConfiguration._cinematicVideoMetadataTrackingOutput
+ _OBJC_IVAR_$_FigCaptureMetadataSinkPipelineConfiguration._continuousAutoFocusTrackingMetadataSupported
+ _OBJC_IVAR_$_FigCaptureMovieFileRecordingSettings._timewarpMode
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkConfiguration._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkConfiguration._cinematicVideoMetadataCaptureEnabledByClient
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkHeadPipeline._personalPhotographerDelegate
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkHeadPipelineConfiguration._personalPhotographerEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipeline._cinematographyObjectTrackingNode
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipeline._movieRecordingEndOfDataBehavior
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipelineConfiguration._cinematicVideoMetadataEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipelineConfiguration._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipelineConfiguration._personalPhotographerEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipelineConfiguration._personalPhotographerTypicalCaptureLatencyInSeconds
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkPipelineConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkTailPipeline._cinematographyObjectTrackingNode
+ _OBJC_IVAR_$_FigCaptureMovieFileSinkTailPipelineConfiguration._cinematicVideoMetadataEnabled
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._learnedNRFlashSupported
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._portTypesWithAdaptiveFusionEnabled
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._portTypesWithTextureStyleBaseLookEnabled
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._secureSigningPhotoCaptureSupportEnabled
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._textureStyleCreativeEffectsEnabled
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._textureStyleFSINCMasksRequired
+ _OBJC_IVAR_$_FigCapturePhotonicEngineSinkPipelineConfiguration._textureStyleRenderingVersion
+ _OBJC_IVAR_$_FigCapturePreviewSinkPipeline._omahaAdditionalPreviewRotationDegrees
+ _OBJC_IVAR_$_FigCapturePreviewSinkPipeline._personalPhotographerDelegate
+ _OBJC_IVAR_$_FigCapturePreviewSinkPipelineConfiguration._cinematicVideoSDOFRenderingEnabled
+ _OBJC_IVAR_$_FigCapturePreviewSinkPipelineConfiguration._depthInferenceForCinematicVideoEnabled
+ _OBJC_IVAR_$_FigCapturePreviewSinkPipelineConfiguration._personalPhotographerEnabled
+ _OBJC_IVAR_$_FigCaptureSecureVideoDataSinkConfiguration._discardsLateVideoFrames
+ _OBJC_IVAR_$_FigCaptureSecureVideoDataSinkPipeline._sourceID
+ _OBJC_IVAR_$_FigCaptureSessionConfiguration._textureStyle
+ _OBJC_IVAR_$_FigCaptureSessionConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_FigCaptureSessionParsedCameraSourceConfiguration._cinematicVideoMetadataDeliveryEnabled
+ _OBJC_IVAR_$_FigCaptureSessionParsedCameraSourceConfiguration._secureVideoCaptureConnectionConfigurations
+ _OBJC_IVAR_$_FigCaptureSessionParsedConfiguration._parsedSecureVideoDataSinkConfigurations
+ _OBJC_IVAR_$_FigCaptureSessionParsedConfiguration._textureStyle
+ _OBJC_IVAR_$_FigCaptureSessionParsedConfiguration._textureStyleEnabled
+ _OBJC_IVAR_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration._cameraConfiguration
+ _OBJC_IVAR_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration._secureVideoDataConnectionConfiguration
+ _OBJC_IVAR_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration._sourceDeviceType
+ _OBJC_IVAR_$_FigCaptureSessionPipelines._secureVideoDataSinkPipelines
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._lowCurrentTorchSupported
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._maxLensAperture
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._minLensAperture
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._primaryConstituentDeviceSwitchingBehaviorLockedWithDeviceSupported
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._recommendedLensApertures
+ _OBJC_IVAR_$_FigCaptureSourceAttributes._supportedExposureSignals
+ _OBJC_IVAR_$_FigCaptureSourceCommonSettings._cinematicVideoWithoutEmbeddedDepthSupported
+ _OBJC_IVAR_$_FigCaptureSourceCommonSettings._colorAssistedInfraredMetadataCameraSupported
+ _OBJC_IVAR_$_FigCaptureSourceCommonSettings._magneticInterferenceMitigationRequired
+ _OBJC_IVAR_$_FigCaptureSourceCommonSettings._textureStyleRenderingVersion
+ _OBJC_IVAR_$_FigCaptureSourceConfiguration._activeOmahaConstituentDeviceType
+ _OBJC_IVAR_$_FigCaptureSourceConfiguration._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureSourceConfiguration._faceIDCoexistenceEnabled
+ _OBJC_IVAR_$_FigCaptureSourceConfiguration._timewarpEnabled
+ _OBJC_IVAR_$_FigCaptureSourceExtendedAttributes._adaptiveFusionSupported
+ _OBJC_IVAR_$_FigCaptureSourceExtendedAttributes._magneticInterferenceZone
+ _OBJC_IVAR_$_FigCaptureSourceExtendedAttributes._tnrMachineLearningImageRegistrationSupported
+ _OBJC_IVAR_$_FigCaptureSourceManager._angleMonitor
+ _OBJC_IVAR_$_FigCaptureSourceManager._angleMonitorClientBundleIDs
+ _OBJC_IVAR_$_FigCaptureSourceManager._deviceAngleState
+ _OBJC_IVAR_$_FigCaptureSourceManager._displayAngleStateLock
+ _OBJC_IVAR_$_FigCaptureSourceManager._faceIDUnwrapQueue
+ _OBJC_IVAR_$_FigCaptureSourceManager._magneticInterferenceMonitor
+ _OBJC_IVAR_$_FigCaptureSourceManager._omahaRenoAngleWithinDropZone
+ _OBJC_IVAR_$_FigCaptureSourceManager._primaryDisplayRegion
+ _OBJC_IVAR_$_FigCaptureSourceManager._renoOccluded
+ _OBJC_IVAR_$_FigCaptureSourceVideoFormat._faceIDCompanionFormat
+ _OBJC_IVAR_$_FigCaptureStillImageSettings._activeOmahaConstituentDeviceType
+ _OBJC_IVAR_$_FigCaptureStillImageSettings._autoSecureSigningPhotoCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureStillImageSettings._personalPhotographerCapture
+ _OBJC_IVAR_$_FigCaptureStillImageSettings._personalPhotographerCaptureRate
+ _OBJC_IVAR_$_FigCaptureStillImageSettings._textureStyle
+ _OBJC_IVAR_$_FigCaptureTextureStyle._grain
+ _OBJC_IVAR_$_FigCaptureTextureStyle._hash
+ _OBJC_IVAR_$_FigCaptureTextureStyle._intensity
+ _OBJC_IVAR_$_FigCaptureTextureStyle._preset
+ _OBJC_IVAR_$_FigCaptureVideoDataSinkConfiguration._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureVideoDataSinkPipeline._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureVideoDataSinkPipelineConfiguration._cinematicVideoMetadataCaptureEnabled
+ _OBJC_IVAR_$_FigCaptureVideoDataSinkPipelineConfiguration._depthInferenceForCinematicVideoEnabled
+ _OBJC_IVAR_$_FigCaptureVideoPreviewSinkConfiguration._overCaptureGradientPercentInset
+ _OBJC_IVAR_$_FigCaptureVideoPreviewSinkConfiguration._primaryDisplayRegion
+ _OBJC_IVAR_$_FigFlashlightLocal._lowCurrentTorchEnabled
+ _OBJC_IVAR_$_FigMetadataObjectCaptureConnectionConfiguration._faceIDConfiguration
+ _OBJC_IVAR_$_FigMetadataObjectCaptureConnectionConfiguration._rawFrameDeliveryEnabled
+ _OBJC_IVAR_$_FigVideoCaptureConnectionConfiguration._lowLightVideoNoiseReductionEnabled
+ _OBJC_IVAR_$_FigVideoCaptureConnectionConfiguration._timewarpDestinationFrameRate
+ _OBJC_IVAR_$_FigVideoCaptureConnectionConfiguration._timewarpMode
+ _OBJC_IVAR_$_PearlSecureFDRKeyUnwrapSession._hostEphemeralKey
+ _OBJC_IVAR_$_PearlSecureFDRKeyUnwrapSession._hostUnwrapData
+ _OBJC_IVAR_$_PearlSecureSession._cameraType
+ _OBJC_IVAR_$_PearlSecureSession._sessionID
+ _OBJC_IVAR_$_PearlSecureStreamingSession._hostEphemeralKey
+ _OBJC_IVAR_$_PearlSupportDefaults._defaults
+ _OBJC_IVAR_$_PearlSupportDefaults._lock
+ _OBJC_IVAR_$_PearlUnwrapData._encryptionKey
+ _OBJC_IVAR_$_PearlUnwrapData._encryptionKeyHmac
+ _OBJC_IVAR_$_PearlUnwrapData._initializationVector
+ _OBJC_IVAR_$_PearlUnwrapData._signature
+ _OBJC_IVAR_$_PearlUnwrapData._tag
+ _OBJC_IVAR_$_SEPCameraProxy._activeSessionID
+ _OBJC_IVAR_$_SEPCameraProxy._cameraType
+ _OBJC_IVAR_$_SubjectSelection._lastNondisruptiveSwitchingFormatZoomFactor
+ _OBJC_IVAR_$_SubjectSelection._motionFilteringWeightDecayRatio
+ _OBJC_IVAR_$_SubjectSelection._vipDetectionDurationTimeInSeconds
+ _OBJC_IVAR_$_SubjectSelection._vipDetectionThreshold
+ _OBJC_IVAR_$_SubjectSelection._vipDropOffDurationTimeInSeconds
+ _OBJC_IVAR_$_SubjectSelection._vipDropOffThreshold
+ _OBJC_IVAR_$_TrackedSubject._distance
+ _OBJC_IVAR_$_TrackedSubject._firstVIPDropOffTimeStamp
+ _OBJC_IVAR_$_TrackedSubject._firstVIPSignificantTimeStamp
+ _OBJC_IVAR_$_TrackedSubject._isSignificantForApertureControl
+ _OBJC_IVAR_$_TrackedSubject._isVIPSignificant
+ _OBJC_IVAR_$_TrackedSubject._motionFilteringWeightDecayRatio
+ _OBJC_IVAR_$_TrackedSubject._motionInPreviewPixels
+ _OBJC_IVAR_$_TrackedSubject._vipConfidence
+ _OBJC_IVAR_$_TrackedSubject._vipDetectionDurationTimeInSeconds
+ _OBJC_IVAR_$_TrackedSubject._vipDetectionThreshold
+ _OBJC_IVAR_$_TrackedSubject._vipDropOffDurationTimeInSeconds
+ _OBJC_IVAR_$_TrackedSubject._vipDropOffThreshold
...
+ _OBJC_METACLASS_$_BWInferenceTextureStylesPostProcessor
...
+ _OBJC_METACLASS_$_EGStillImageAdaptiveFusionNRFNode
+ _OBJC_METACLASS_$_EGStillImageAdaptiveFusionRoutingNode
+ _OBJC_METACLASS_$_FigCaptureAngleMonitor
+ _OBJC_METACLASS_$_FigCaptureMagneticInterferenceMonitor
+ _OBJC_METACLASS_$_FigCaptureSecureVideoDataSinkConfiguration
+ _OBJC_METACLASS_$_FigCaptureSecureVideoDataSinkPipeline
+ _OBJC_METACLASS_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ _OBJC_METACLASS_$_FigCaptureTextureStyle
+ _OBJC_METACLASS_$_PearlSecureFDRKeyUnwrapSession
+ _OBJC_METACLASS_$_PearlSecureSession
+ _OBJC_METACLASS_$_PearlSecureStreamingSession
+ _OBJC_METACLASS_$_PearlSupportDefaults
+ _OBJC_METACLASS_$_PearlSupportHelper
+ _OBJC_METACLASS_$_PearlUnwrapData
+ _OBJC_METACLASS_$_SEPCameraProxy
...
+ _PhotoLibraryServicesLibrary
+ _PhotoLibraryServicesLibraryCore
+ _PhotoLibraryServicesLibraryCore.frameworkLibrary
+ _SecCertificateCopyData
+ _SecKeyCreateSignature
+ _SystemUIDisplayUtilitiesLibraryCore.frameworkLibrary
+ _V63
+ _V64_V64s
+ _V68
...
+ __OBJC_$_CLASS_METHODS_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_$_CLASS_METHODS_CMCaptureCinematicVideoTimedMetadataSampleGenerator
+ __OBJC_$_CLASS_METHODS_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_$_CLASS_METHODS_EGStillImageAdaptiveFusionRoutingNode
+ __OBJC_$_CLASS_METHODS_FigCaptureAngleMonitor
+ __OBJC_$_CLASS_METHODS_FigCaptureMagneticInterferenceMonitor
+ __OBJC_$_CLASS_METHODS_FigCaptureSecureVideoDataSinkPipeline
+ __OBJC_$_CLASS_METHODS_FigCaptureTextureStyle
+ __OBJC_$_CLASS_METHODS_PearlSecureFDRKeyUnwrapSession
+ __OBJC_$_CLASS_METHODS_PearlSecureSession
+ __OBJC_$_CLASS_METHODS_PearlSecureStreamingSession
+ __OBJC_$_CLASS_METHODS_PearlSupportDefaults
+ __OBJC_$_CLASS_METHODS_PearlSupportHelper
+ __OBJC_$_CLASS_METHODS_SEPCameraProxy
...
+ __OBJC_$_INSTANCE_METHODS_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_$_INSTANCE_METHODS_CMCaptureCinematicVideoTimedMetadataSampleGenerator
+ __OBJC_$_INSTANCE_METHODS_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_$_INSTANCE_METHODS_EGStillImageAdaptiveFusionRoutingNode
...
+ __OBJC_$_INSTANCE_METHODS_FigCaptureSecureVideoDataSinkConfiguration
+ __OBJC_$_INSTANCE_METHODS_FigCaptureSecureVideoDataSinkPipeline
+ __OBJC_$_INSTANCE_METHODS_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ __OBJC_$_INSTANCE_METHODS_FigCaptureTextureStyle
+ __OBJC_$_INSTANCE_METHODS_PearlSecureFDRKeyUnwrapSession
+ __OBJC_$_INSTANCE_METHODS_PearlSecureSession
+ __OBJC_$_INSTANCE_METHODS_PearlSecureStreamingSession
+ __OBJC_$_INSTANCE_METHODS_PearlSupportDefaults
+ __OBJC_$_INSTANCE_METHODS_PearlSupportHelper
+ __OBJC_$_INSTANCE_METHODS_PearlUnwrapData
+ __OBJC_$_INSTANCE_METHODS_SEPCameraProxy
...
+ __OBJC_$_INSTANCE_VARIABLES_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_$_INSTANCE_VARIABLES_CMCaptureCinematicVideoTimedMetadataSampleGenerator
+ __OBJC_$_INSTANCE_VARIABLES_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_$_INSTANCE_VARIABLES_EGStillImageAdaptiveFusionRoutingNode
...
+ __OBJC_$_INSTANCE_VARIABLES_FigCaptureSecureVideoDataSinkConfiguration
+ __OBJC_$_INSTANCE_VARIABLES_FigCaptureSecureVideoDataSinkPipeline
+ __OBJC_$_INSTANCE_VARIABLES_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ __OBJC_$_INSTANCE_VARIABLES_FigCaptureTextureStyle
+ __OBJC_$_INSTANCE_VARIABLES_PearlSecureFDRKeyUnwrapSession
+ __OBJC_$_INSTANCE_VARIABLES_PearlSecureSession
+ __OBJC_$_INSTANCE_VARIABLES_PearlSecureStreamingSession
+ __OBJC_$_INSTANCE_VARIABLES_PearlSupportDefaults
+ __OBJC_$_INSTANCE_VARIABLES_PearlUnwrapData
+ __OBJC_$_INSTANCE_VARIABLES_SEPCameraProxy
+ __OBJC_$_PROP_LIST_BWBaselineTextureStyleRenderer
+ __OBJC_$_PROP_LIST_BWCameraStreamingMonitor
...
+ __OBJC_$_PROP_LIST_BWInferencePostProcessor
+ __OBJC_$_PROP_LIST_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_$_PROP_LIST_CMCaptureCinematicVideoTimedMetadataSampleGenerator
+ __OBJC_$_PROP_LIST_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_$_PROP_LIST_EGStillImageAdaptiveFusionRoutingNode
...
+ __OBJC_$_PROP_LIST_FigCaptureSecureVideoDataSinkConfiguration
+ __OBJC_$_PROP_LIST_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ __OBJC_$_PROP_LIST_FigCaptureTextureStyle
+ __OBJC_$_PROP_LIST_PearlSecureFDRKeyUnwrapSession
+ __OBJC_$_PROP_LIST_PearlSecureSession
+ __OBJC_$_PROP_LIST_PearlSecureStreamingSession
+ __OBJC_$_PROP_LIST_PearlSupportDefaults
+ __OBJC_$_PROP_LIST_PearlSupportHelper
+ __OBJC_$_PROP_LIST_PearlUnwrapData
+ __OBJC_$_PROP_LIST_SEPCameraProxy
...
+ __OBJC_$_PROTOCOL_INSTANCE_METHODS_BWInferencePostProcessor
...
+ __OBJC_$_PROTOCOL_INSTANCE_METHODS_OPT_SDUDisplayRegionBlankingStateObserver
+ __OBJC_$_PROTOCOL_INSTANCE_METHODS_SDUDisplayRegionBlankingStateObserver
...
+ __OBJC_$_PROTOCOL_METHOD_TYPES_BWInferencePostProcessor
...
+ __OBJC_$_PROTOCOL_METHOD_TYPES_SDUDisplayRegionBlankingStateObserver
...
+ __OBJC_$_PROTOCOL_REFS_BWInferencePostProcessor
...
+ __OBJC_$_PROTOCOL_REFS_SDUDisplayRegionBlankingStateObserver
+ __OBJC_CLASS_PROTOCOLS_$_BWBaselineTextureStyleRenderer
+ __OBJC_CLASS_PROTOCOLS_$_BWCameraStreamingMonitor
+ __OBJC_CLASS_PROTOCOLS_$_BWCinematographyObjectTrackingNode
...
+ __OBJC_CLASS_PROTOCOLS_$_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_CLASS_PROTOCOLS_$_EGStillImageAdaptiveFusionNRFNode
...
+ __OBJC_CLASS_RO_$_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_CLASS_RO_$_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_CLASS_RO_$_EGStillImageAdaptiveFusionRoutingNode
+ __OBJC_CLASS_RO_$_FigCaptureAngleMonitor
+ __OBJC_CLASS_RO_$_FigCaptureMagneticInterferenceMonitor
+ __OBJC_CLASS_RO_$_FigCaptureSecureVideoDataSinkConfiguration
+ __OBJC_CLASS_RO_$_FigCaptureSecureVideoDataSinkPipeline
+ __OBJC_CLASS_RO_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ __OBJC_CLASS_RO_$_FigCaptureTextureStyle
+ __OBJC_CLASS_RO_$_PearlSecureFDRKeyUnwrapSession
+ __OBJC_CLASS_RO_$_PearlSecureSession
+ __OBJC_CLASS_RO_$_PearlSecureStreamingSession
+ __OBJC_CLASS_RO_$_PearlSupportDefaults
+ __OBJC_CLASS_RO_$_PearlSupportHelper
+ __OBJC_CLASS_RO_$_PearlUnwrapData
+ __OBJC_CLASS_RO_$_SEPCameraProxy
...
+ __OBJC_LABEL_PROTOCOL_$_BWInferencePostProcessor
...
+ __OBJC_LABEL_PROTOCOL_$_SDUDisplayRegionBlankingStateObserver
...
+ __OBJC_METACLASS_RO_$_BWInferenceTextureStylesPostProcessor
...
+ __OBJC_METACLASS_RO_$_EGStillImageAdaptiveFusionNRFNode
+ __OBJC_METACLASS_RO_$_EGStillImageAdaptiveFusionRoutingNode
+ __OBJC_METACLASS_RO_$_FigCaptureAngleMonitor
+ __OBJC_METACLASS_RO_$_FigCaptureMagneticInterferenceMonitor
+ __OBJC_METACLASS_RO_$_FigCaptureSecureVideoDataSinkConfiguration
+ __OBJC_METACLASS_RO_$_FigCaptureSecureVideoDataSinkPipeline
+ __OBJC_METACLASS_RO_$_FigCaptureSessionParsedSecureVideoDataSinkConfiguration
+ __OBJC_METACLASS_RO_$_FigCaptureTextureStyle
+ __OBJC_METACLASS_RO_$_PearlSecureFDRKeyUnwrapSession
+ __OBJC_METACLASS_RO_$_PearlSecureSession
+ __OBJC_METACLASS_RO_$_PearlSecureStreamingSession
+ __OBJC_METACLASS_RO_$_PearlSupportDefaults
+ __OBJC_METACLASS_RO_$_PearlSupportHelper
+ __OBJC_METACLASS_RO_$_PearlUnwrapData
+ __OBJC_METACLASS_RO_$_SEPCameraProxy
...
+ __OBJC_PROTOCOL_$_BWInferencePostProcessor
...
+ __OBJC_PROTOCOL_$_SDUDisplayRegionBlankingStateObserver
...
+ ___122-[BWPhotonicEngineNode _setupProcessingStateForTextureStyleInferencesWithSettings:sequenceNumber:portType:processingPlan:]_block_invoke
+ ___145-[BWHVSScoringNode _scheduleFrameAnalysisForYUVSampleBuffer:matchingMainSensorRawSampleBuffer:matchingSIFRSensorRawSampleBuffer:analysisEnabled:]_block_invoke
+ ___145-[BWHVSScoringNode _scheduleFrameAnalysisForYUVSampleBuffer:matchingMainSensorRawSampleBuffer:matchingSIFRSensorRawSampleBuffer:analysisEnabled:]_block_invoke_2
+ ___145-[BWHVSScoringNode _scheduleFrameAnalysisForYUVSampleBuffer:matchingMainSensorRawSampleBuffer:matchingSIFRSensorRawSampleBuffer:analysisEnabled:]_block_invoke_3
+ ___146-[FigCaptureSourceManager initWithBackings:fineGrainThermalMonitoringEnabled:apsCalibrationMonitorEnabled:useSharedCaptureSourceBackingsProvider:]_block_invoke_4
...
+ ___208-[BWFigVideoCaptureDevice setFocusModeAutoWithRect:restrictToRect:continuous:smooth:tracking:trackingLensPositionBias:trackingSeedingPoint:rangeRestrictionNear:rangeRestrictionFar:isFocusRectInOverscanSpace:]_block_invoke
+ ___208-[BWFigVideoCaptureDevice setFocusModeAutoWithRect:restrictToRect:continuous:smooth:tracking:trackingLensPositionBias:trackingSeedingPoint:rangeRestrictionNear:rangeRestrictionFar:isFocusRectInOverscanSpace:]_block_invoke_2
+ ___208-[BWFigVideoCaptureDevice setFocusModeAutoWithRect:restrictToRect:continuous:smooth:tracking:trackingLensPositionBias:trackingSeedingPoint:rangeRestrictionNear:rangeRestrictionFar:isFocusRectInOverscanSpace:]_block_invoke_3
+ ___269-[BWRealtimeCinematographyNode initWithObjectMetadataIdentifiers:cachedSimulatedAperture:captureDevice:tuningParameters:videoDepthConfiguration:smartStyleLearningEnabled:highResolutionInputEnabled:transformCinematographyDetectionsForMovieFileOutput:depthInputProvided:]_block_invoke
...
+ ___36+[PearlSupportHelper sharedInstance]_block_invoke
+ ___37+[BWLCBDatabaseManager sharedManager]_block_invoke
+ ___37-[PearlSupportHelper isInternalBuild]_block_invoke
+ ___38+[PearlSupportDefaults sharedInstance]_block_invoke
...
+ ___41-[FigCaptureAngleMonitor startMonitoring]_block_invoke
+ ___44-[BWLCBDatabaseManager databaseForPortType:]_block_invoke
+ ___44-[FigCaptureSourceManager startFaceIDUnwrap]_block_invoke
...
+ ___55+[BWCinematographyObjectTrackingNode _detectionTypeMap]_block_invoke
...
+ ___57-[BWCinematicPerceptionNode renderSampleBuffer:forInput:]_block_invoke_3
+ ___57-[BWVideoNoiseReductionNode _prepareISPProcessingSession]_block_invoke
+ ___57-[BWVideoNoiseReductionNode _prepareISPProcessingSession]_block_invoke_2
+ ___57-[BWVideoNoiseReductionNode renderSampleBuffer:forInput:]_block_invoke
...
+ ___62-[BWHVSScoringNode _runImageEmbeddingInferenceOnSampleBuffer:]_block_invoke
...
+ ___63-[BWLCBDatabaseManager _executeDatabaseStorageWorkAsync:block:]_block_invoke_2
...
+ ___66-[FigCaptureCameraSourcePipeline initiateSecureStreamingForFaceID]_block_invoke
+ ___68-[BWPersonalPhotographerSceneMonitorV1 _setupStorageSpaceCheckTimer]_block_invoke
+ ___68-[FigExternalSyncDeviceDiscoverySessionManager _activateSyncDevices]_block_invoke
+ ___69-[BWSecureSigningUtilityManager firstSecureSigningStaticDataFailure:]_block_invoke
+ ___70-[FigExternalSyncDeviceDiscoverySessionManager _deactivateSyncDevices]_block_invoke
+ ___71-[BWLCBDatabaseManager loadDatabasesForSensorConfigurationsByPortType:]_block_invoke
+ ___71-[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleIsSetup]_block_invoke
+ ___71-[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleIsSetup]_block_invoke_2
+ ___71-[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleIsSetup]_block_invoke_3
+ ___71-[BWStillImageFilterNodeResourceCoordinator _ensureTextureStyleIsSetup]_block_invoke_4
+ ___71-[BWVideoNoiseReductionNode prepareForCurrentConfigurationToBecomeLive]_block_invoke
+ ___73-[BWVideoNoiseReductionNode _waitForAsyncNoiseReductionProcessToComplete]_block_invoke
+ ___73-[BWVideoNoiseReductionNode _waitForAsyncNoiseReductionProcessToComplete]_block_invoke_2
+ ___73-[FigCaptureMagneticInterferenceMonitor _setupExitZoneTimerWithDuration:]_block_invoke
+ ___75-[BWFigVideoCaptureDevice _updateApertureFlickerMitigationOnAutofocusQueue]_block_invoke
...
+ ___86-[BWSecureSigningUtilityManager _fetchClientProvidedSensorPayloadAndHashSynchronously]_block_invoke
+ ___86-[BWSecureSigningUtilityManager clientProvidedSensorPayloadInfoForClientProvidedHash:]_block_invoke
+ ___91-[BWInferenceTextureStylesPostProcessor postProcessInferenceResults:attachingSampleBuffer:]_block_invoke
+ ___91-[BWInferenceTextureStylesPostProcessor postProcessInferenceResults:attachingSampleBuffer:]_block_invoke_2
+ ___91-[BWInferenceTextureStylesPostProcessor postProcessInferenceResults:attachingSampleBuffer:]_block_invoke_3
+ ___91-[BWInferenceTextureStylesPostProcessor postProcessInferenceResults:attachingSampleBuffer:]_block_invoke_4
+ ___96-[BWPhotonicEngineNodeResourceCoordinator _allocateMetalHeap:metalAllocatorDescriptor:settings:]_block_invoke
+ ___96-[BWPhotonicEngineNodeResourceCoordinator _allocateMetalHeap:metalAllocatorDescriptor:settings:]_block_invoke_2
...
+ ___99-[BWVideoNoiseReductionNode _asyncApplyNoiseReductionToFrontEndPyramidScalerImageFromSampleBuffer:]_block_invoke
+ ___99-[BWVideoNoiseReductionNode _asyncApplyNoiseReductionToFrontEndPyramidScalerImageFromSampleBuffer:]_block_invoke_2
+ ___BWComputeSharpnessForYUVFrame_block_invoke
+ ___BWCreateProvenanceDNGDictionary_block_invoke
+ ___BWSignProvenanceDNGDictionary_block_invoke
...
+ ___PhotoLibraryServicesLibraryCore_block_invoke
+ ___SystemUIDisplayUtilitiesLibraryCore_block_invoke
+ ___block_descriptor_113_e8_32o_e5_v8?0ls32l8
+ ___block_descriptor_114_e8_32o40o48o56o64o72o80o88o_e5_v8?0ls32l8s40l8s48l8s56l8s64l8s72l8s80l8s88l8
+ ___block_descriptor_32_e11_f16?0f8f12l
+ ___block_descriptor_32_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8l
+ ___block_descriptor_32_e18_"NSString"12?0I8l
+ ___block_descriptor_32_e23_v24?08"BWHVSFrame"16l
+ ___block_descriptor_32_e35_q24?0"BWHVSFrame"8"BWHVSFrame"16l
+ ___block_descriptor_32_e37_v32?0"NSUUID"8"TSSyncEntity"16^B24l
+ ___block_descriptor_32_e37_v32?0^v8i16i20^{?=^{__CFString}^v}24l
+ ___block_descriptor_32_e56_v28?0"FigCaptureMagneticInterferenceMonitor"8I16I20i24l
+ ___block_descriptor_33_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8l
+ ___block_descriptor_40_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8l
+ ___block_descriptor_40_e8_32o_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8ls32l8
+ ___block_descriptor_40_e8_32o_e17_v16?0"CMAngle"8ls32l8
+ ___block_descriptor_40_e8_32o_e32_v16?0"FigCaptureAngleMonitor"8ls32l8
+ ___block_descriptor_40_e8_32o_e47_v16?0"FigCaptureMagneticInterferenceMonitor"8ls32l8
+ ___block_descriptor_40_e8_32r_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8lr32l8
+ ___block_descriptor_41_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8l
+ ___block_descriptor_48_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8l
+ ___block_descriptor_48_e8_32o40r_e43_v32?0^{__SecKey=}8"NSArray"16"NSError"24lr40l8s32l8
+ ___block_descriptor_52_e8_32b_e5_v8?0ls32l8
+ ___block_descriptor_56_e8_32o40o48b_e5_v8?0ls32l8s48l8s40l8
+ ___block_descriptor_56_e8_32o40o48o_e17_(?={?=ff})16?0Q8ls32l8s40l8s48l8
+ ___block_descriptor_56_e8_32o40o48o_e8_v16?0Q8ls32l8s40l8s48l8
+ ___block_descriptor_60_e8_32o40o48b_e43_v32?0^{__SecKey=}8"NSArray"16"NSError"24ls32l8s40l8s48l8
+ ___block_descriptor_72_e39_f40?0{CGRect={CGPoint=dd}{CGSize=dd}}8l
+ ___block_descriptor_72_e8_32o40r48r56r64r_e40_v36?0"NSDictionary"8"NSError"16q24i32lr40l8r48l8r56l8r64l8s32l8
+ ___block_descriptor_72_e8_32o40r48r_e161_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiqBqBB^{OpaqueFigCaptureSource}f}8lr40l8s32l8r48l8
+ ___block_descriptor_82_e8_32o40o_e29_v24?0"<MTLSharedEvent>"8Q16ls32l8s40l8
+ ___block_descriptor_88_e8_32o40o48o56o64o72o_e5_v8?0ls32l8s40l8s48l8s56l8s64l8s72l8
...
+ ___captureSession_updateGraphConfiguration_block_invoke_3
...
+ ___getFTCinematicTrackClass_block_invoke
+ ___getFTCinematicTrackingResultClass_block_invoke
+ ___getPLGlobalValuesClass_block_invoke
+ ___getPLPhotoLibraryClass_block_invoke
+ ___getPTCinematographyFocusDisparitySamplerClass_block_invoke
+ ___getSDUDisplayRegionBlankingServiceClass_block_invoke
+ ___nrfp_createStateMachine_block_invoke_12
+ ___osLogTrace_PearlSupport
+ ___osLog_PearlSupport
+ ___stack_chk_fail
+ ___stack_chk_guard
+ ___tspp_estimateSignalBoundingBoxes_block_invoke
+ ___tspp_estimateSignalBoundingBoxes_block_invoke_2
+ __connect
+ __createDetectedObjectsSampleBufferFromSemanticMasksSampleBuffer:.sOnceToken
+ __detectionTypeMap.detectionTypeMap
+ __detectionTypeMap.onceToken
+ __os_log_error_impl
+ __overrideIgnoredExposureSignals:values:.onceToken
+ __perCamInstances
+ _applyOrClearApertureFlickerMitigation
+ _audit_stringSystemUIDisplayUtilities
+ _bwfru_textureStyleRendererClasses
+ _bwtstu_captureTypeToString
+ _calloc
+ _captureSessionRemote_IrisStillImageSinkInitiateManualPersonalPhotographerCapture
+ _captureSessionRemote_IrisStillImageSinkStartPersonalPhotographerSession
+ _captureSessionRemote_IrisStillImageSinkStopPersonalPhotographerSession
+ _captureSessionRemote_IrisStillImageSinkUpdatePersonalPhotographerOrientation
+ _captureSessionRemote_MetadataSinkCaptureFaceIDBracket
+ _captureSessionServer_deserializeTextureStyle
+ _captureSessionServer_handleSessionIrisStillImageSinkStartPersonalPhotographerSession
+ _captureSessionServer_handleSessionIrisStillImageSinkUpdatePersonalPhotographerOrientation
+ _captureSessionServer_handleSessionMetadataSinkCaptureFaceIDBracketMessage
...
+ _captureSourceRemote_ReleaseFaceIDFrameProxyIdentifier
+ _captureSourceRemote_StartFaceIDUnwrap
+ _captureSourceServer_handleSecureSigningCertificateAvailableMessage
...
+ _cosf
+ _cs_activePipelineDimensionsForOmahaConstituentDevice
...
+ _fvcd_significantSubjectsTrackingEnabledForPersonalPhotographer.sOnceToken
...
+ _getFTCinematicTrackClass
+ _getFTCinematicTrackClass.softClass
+ _getFTCinematicTrackingResultClass
+ _getFTCinematicTrackingResultClass.softClass
+ _getPLGlobalValuesClass
+ _getPLGlobalValuesClass.softClass
+ _getPLPhotoLibraryClass
+ _getPLPhotoLibraryClass.softClass
+ _getPTCinematographyFocusDisparitySamplerClass
+ _getPTCinematographyFocusDisparitySamplerClass.softClass
+ _getSDUDisplayRegionBlankingServiceClass.softClass
+ _hvscfm_duplicateInfoFromMostRecentReplacedFrame
+ _hvsframe_rawCaptureIDForSampleBuffer
+ _hvsutil_anyObjectCenterWithinRect
+ _initWithNumberOfVideoInputs:numberOfAudioInputs:numberOfMetadataInputs:numberOfActionOnlyOutputs:overCaptureEnabled:cinematicAudioEnabled:allowLowLatencyWhenPossible:timewarpTargetFramerate:useTrueVideoFileRecordingStaging:motionDataTimeMachine:videoRecordingPrimingQueueLimit:.onceToken
...
+ _kCinematicVideoRefinedCinematographyMetadataKey_CinematographyDictionary
...
+ _kFigCaptureDeferredPhotoProcessorNotificationPayloadKey_SecureSignedRawSurface_Serialized
...
+ _kFigCaptureSessionNotificationPayloadKey_SecureSignedRawSurface_Serialized
...
+ _kFigCaptureSessionUpdatePersonalPhotographerOrientationMessagePayload_Mirrored
+ _kFigCaptureSessionUpdatePersonalPhotographerOrientationMessagePayload_RotationDegrees
...
+ _kFigCaptureSourceRemoteReleaseFaceIDFrameProxyMessagePayload_FrameIdentifier
...
+ _kFigCaptureStreamImageRegistrationInfoKey_GyroHomographyConfidence
+ _kFigCaptureStreamImageRegistrationInfoKey_InliersConfidence
+ _kFigCaptureStreamImageRegistrationInfoKey_RegistrationStatus
...
+ _kFigImageControlSampleBufferProcessorProperty_ApertureFlickerMitigationEngaged
...
+ _magneticInterference_deviceMatchingCallback
+ _magneticInterference_deviceRemovalCallback
+ _magneticInterference_updateStylusData
+ _multiStreamCameraSourceNode_secureFaceIDServiceQueueCallback
+ _multiStreamCameraSourceNode_secureVideoServiceQueueCallback
...
+ _objc_msgSend$_addTextureStylesPostProcessorWithInstanceMaskInferenceType:validBufferRectAppliedToVisionFaceLandmarks:finalCropRectAppliedToFaceAndInstanceSegmentationMasks:finalCropRectAppliedToPersonSemanticMasks:
...
+ _objc_msgSend$_deactivateSyncDevices
...
+ _objc_msgSend$_inferenceAttachedMediaRequiredForTextureStyleBaseLookWithSettings:
...
+ _objc_msgSend$_startFaceIDUnwrapWithStream:outError:
...
+ _objc_msgSend$_updateFaceIDUnwrapResultWithStatus:pearlSecureSessionError:cameraStreamError:
+ _objc_msgSend$_updateOccludedState
+ _objc_msgSend$_updateTextureStyleEnableFlagsForMetadataDict:
+ _objc_msgSend$acquireBlankingAssertionForDisplayRegion:reason:restrictingToBundleIDs:
...
+ _objc_msgSend$adaptiveFusionEnabled
+ _objc_msgSend$adaptiveFusionInputFormat
+ _objc_msgSend$adaptiveFusionSupported
+ _objc_msgSend$addBlankingStateObserver:forDisplayRegion:
+ _objc_msgSend$addFrameIdentifiersForFaceIDResult:
+ _objc_msgSend$addPostProcessor:
+ _objc_msgSend$addSecureVideoDataSinkPipeline:
...
+ _objc_msgSend$asCinematographyDictionary
+ _objc_msgSend$attachMatchingHueMapToMainSampleBuffer:mainPTS:mainExposureTime:frameRate:
+ _objc_msgSend$attemptSingleImageErrorRecoveryOutput
...
+ _objc_msgSend$clearSession
+ _objc_msgSend$clientProvidedHash
+ _objc_msgSend$clientProvidedSensorPayloadInfoForClientProvidedHash:
...
+ _objc_msgSend$colorSpaceIsAppleLog
...
+ _objc_msgSend$configureInferenceEngineControllerInputForTextureStyles:
...
+ _objc_msgSend$encryptionKeyHmac
+ _objc_msgSend$ensureTextureStyleIsSetup
+ _objc_msgSend$establishSharedSecretWithSensorEphemeralKey:
+ _objc_msgSend$establishSharedSecretWithSensorEphemeralKey:sensorEphemeralKeySignature:
+ _objc_msgSend$establishSharedSecretWithSession:sensorEphemeralKey:sensorEphemeralKeySignature:
+ _objc_msgSend$ev0RawCaptureID
+ _objc_msgSend$evZeroOutputs
...
+ _objc_msgSend$externalSyncDeviceDiscoverySessionManager:connectedSyncEntitiesDidChange:
...
+ _objc_msgSend$firstSecureSigningStaticDataFailure:
...
+ _objc_msgSend$generateHostEphemeralKey
+ _objc_msgSend$generateHostEphemeralKeyWithBootNonce:
+ _objc_msgSend$generateHostEphemeralKeyWithSession:bootNonce:hostEphemeralKey:
+ _objc_msgSend$generateHostUnwrapDataWithSession:wrappedHostEncKey:wrappedHostEncKeyHmac:hostIV:hostTag:hostSignature:
...
+ _objc_msgSend$hdrErrorRecoveryEVZeroOutput
+ _objc_msgSend$hostEphemeralKey
+ _objc_msgSend$hostUnwrapData
+ _objc_msgSend$hueMapInput
...
+ _objc_msgSend$initServiceConnection
...
+ _objc_msgSend$initWithCameraType:
...
+ _objc_msgSend$initWithCaptureDevice:commandQueue:smartStyleRenderingEnabled:squareAspectRatioConfigEnabled:computeFocusDisparity:
...
+ _objc_msgSend$initWithCaptureMode:captureDevice:inferenceScheduler:threadPriority:delegate:
...
+ _objc_msgSend$initWithConvEngineSupportWithCaptureDevice:scheduler:priority:depthInferenceEnabled:aspectRatio:opticalFlowInferenceEnabled:
...
+ _objc_msgSend$initWithEncryptionKey:encryptionKeyHmac:initializationVector:tag:signature:
...
+ _objc_msgSend$initWithManagedObjectContext:
+ _objc_msgSend$initWithMetadataDictionary:
+ _objc_msgSend$initWithMetalCommandQueue:textureCache:
+ _objc_msgSend$initWithName:evZeroCount:hasEVMinus:longCount:hasHDRErrorRecoveryEVZero:
+ _objc_msgSend$initWithName:workIntervalType:
...
+ _objc_msgSend$initWithObjectMetadataIdentifiers:cachedSimulatedAperture:captureDevice:tuningParameters:videoDepthConfiguration:smartStyleLearningEnabled:highResolutionInputEnabled:transformCinematographyDetectionsForMovieFileOutput:depthInputProvided:
...
+ _objc_msgSend$initWithRequiredInferenceTypes:
...
+ _objc_msgSend$initWithStandardResolutionAttachedMediaKey:
+ _objc_msgSend$initWithTuningDictionary:totalGain:
+ _objc_msgSend$initWithTuningParametersByPortType:
+ _objc_msgSend$initWithYUVSampleBuffer:matchingMainSensorRawSampleBuffer:matchingSIFRSensorRawSampleBuffer:imageEmbeddingSampleBuffer:faceQualitySampleBuffer:subtaskGroup:subtaskWorkInterval:numberOfSubtaskThreads:
...
+ _objc_msgSend$initiateSecureStreamingForFaceID
...
+ _objc_msgSend$isDeferredAdaptiveFusionCapture:
+ _objc_msgSend$isFixedBudgetExhausted
+ _objc_msgSend$isFrontal
+ _objc_msgSend$isInternalBuild
+ _objc_msgSend$isLearnedFusionEnhancedResolutionSupported
+ _objc_msgSend$isLearnedFusionUltraHighResolutionSupported
...
+ _objc_msgSend$isSecureSigningCertificateAvailableWithTimeout:
...
+ _objc_msgSend$isTextureStyleBaseLookSupported
...
+ _objc_msgSend$isValidCameraType:
+ _objc_msgSend$issueSecureSigningClientCertificateOnQueue:completion:
+ _objc_msgSend$joinSubtaskThreadWithName:
+ _objc_msgSend$laplacianVariance
+ _objc_msgSend$latestCinematicDisparityBuffer
...
+ _objc_msgSend$learnedNRFlashSupported
+ _objc_msgSend$leaveSubtaskThread
+ _objc_msgSend$linearMixForBG:linearMixForSkin:saturation:forStyle:
+ _objc_msgSend$liveReconfigureForPipelineDimensions:
+ _objc_msgSend$liveReconfigureForRotationDegrees:
+ _objc_msgSend$liveReconfigureForSmartCropWarperFormatDimensions:
+ _objc_msgSend$loadDatabasesForSensorConfigurationsByPortType:
+ _objc_msgSend$loadInferenceNetworksForHVS
+ _objc_msgSend$longOutputs
...
+ _objc_msgSend$lowerBoundTimestampDataForClientProvidedHash:
...
+ _objc_msgSend$mediaTypeIsSecureVideo
...
+ _objc_msgSend$newReaderWithPixelBuffer:
+ _objc_msgSend$nightMode
+ _objc_msgSend$nightModeSharpness
+ _objc_msgSend$node:didSelectVitalityMode:forSettings:
...
+ _objc_msgSend$optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported
...
+ _objc_msgSend$parsedSecureVideoDataSinkConfigurations
+ _objc_msgSend$pauseDurationInSec
+ _objc_msgSend$pearlToSecureSessionError:
...
+ _objc_msgSend$pets
+ _objc_msgSend$pipelineStageWithName:priority:workgroup:maxQueuedSampleDataMessages:
+ _objc_msgSend$pixelFormatIsPackedBayerRaw
+ _objc_msgSend$pixelValueAtColumn:
+ _objc_msgSend$pointsInImageOfSize:
+ _objc_msgSend$pores
+ _objc_msgSend$portTypesWithAdaptiveFusionEnabled
+ _objc_msgSend$portTypesWithTextureStyleBaseLookEnabled
+ _objc_msgSend$precisionEstimatesPerPoint
+ _objc_msgSend$prepareWithHandler:
...
+ _objc_msgSend$processorController:didDetermineProvenanceFrame:processorInput:err:
+ _objc_msgSend$processorController:didSelectVitalityMode:forProcessorInput:
+ _objc_msgSend$provenanceDNGInfo
+ _objc_msgSend$provenanceDNGSurface
+ _objc_msgSend$provenanceDNGSurfaceSize
+ _objc_msgSend$provenanceFrameOutput
...
+ _objc_msgSend$referenceEVZeroOutput
...
+ _objc_msgSend$registerWithPearlSecureSession:
+ _objc_msgSend$registerWorkInterval:forType:
...
+ _objc_msgSend$resumeWithVideoOutputConfigurations:
+ _objc_msgSend$saturation
+ _objc_msgSend$saveDatabasesIfNeeded
+ _objc_msgSend$sealingManifestData
+ _objc_msgSend$sealingManifestUniqueIDData
+ _objc_msgSend$secureBootTicketData
+ _objc_msgSend$secureSigningPhotoCaptureEnabled
+ _objc_msgSend$secureSigningPhotoCaptureSupportEnabled
+ _objc_msgSend$secureSigningUtilityManager:didUpdateClientProvidedHash:
+ _objc_msgSend$secureStreamingForFaceIDEnabled
+ _objc_msgSend$secureVideoCaptureDimensions
+ _objc_msgSend$secureVideoConnectionConfigurations
+ _objc_msgSend$secureVideoDataConnectionConfiguration
+ _objc_msgSend$secureVideoDataSinkConfiguration
+ _objc_msgSend$secureVideoDataSinkPipelines
+ _objc_msgSend$secureVideoOutput
+ _objc_msgSend$secureVideoOutputEnabled
+ _objc_msgSend$segmentIdx
+ _objc_msgSend$semanticMasksInput
+ _objc_msgSend$sensorCertificateData
+ _objc_msgSend$sensorCertificateUniqueIDData
+ _objc_msgSend$sensorRawPoolDimensions
...
+ _objc_msgSend$sessionWithCameraType:
...
+ _objc_msgSend$setAdaptiveFusionEnabled:
+ _objc_msgSend$setAdaptiveFusionInputFormat:
...
+ _objc_msgSend$setBox:
+ _objc_msgSend$setBoxConfidence:
+ _objc_msgSend$setBrightnessValue:
+ _objc_msgSend$setBufferTypeOverride:
+ _objc_msgSend$setCachingPropertiesWhileSuspended:
+ _objc_msgSend$setCalibrationEnabled:
...
+ _objc_msgSend$setFaceAndInstanceSegmentationEnabled:
...
+ _objc_msgSend$setFinalCropRectAppliedToFaceAndInstanceSegmentationMasks:
+ _objc_msgSend$setFinalCropRectAppliedToPersonSemanticMasks:
...
+ _objc_msgSend$setFrameParameters:
...
+ _objc_msgSend$setImageEmbedding:
+ _objc_msgSend$setImageStats:
+ _objc_msgSend$setInputAGC:
+ _objc_msgSend$setInputClearHistory:
+ _objc_msgSend$setInputExposureSignals:
+ _objc_msgSend$setInputExposureTime:
+ _objc_msgSend$setInputFNumber:
+ _objc_msgSend$setInputFaceNormalizedRects:
+ _objc_msgSend$setInputFesCropRect:
+ _objc_msgSend$setInputFesOutputHeight:
+ _objc_msgSend$setInputFesOutputWidth:
+ _objc_msgSend$setInputFrameCount:
+ _objc_msgSend$setInputHrGainDownRatio:
+ _objc_msgSend$setInputHumanFullBodiesMaskPixelBuffer:
+ _objc_msgSend$setInputIspDGain:
+ _objc_msgSend$setInputLSCArray:
+ _objc_msgSend$setInputLSCGridHeight:
+ _objc_msgSend$setInputLSCGridWidth:
+ _objc_msgSend$setInputLSCModulationWeight:
...
+ _objc_msgSend$setInputPixelBufferScale0:
+ _objc_msgSend$setInputPixelBufferScale1:
+ _objc_msgSend$setInputPreIspDGain:
+ _objc_msgSend$setInputSensorArrayOutputRect:
+ _objc_msgSend$setInputSensorDGain:
+ _objc_msgSend$setInputSensorReadOutCrop:
...
+ _objc_msgSend$setInputValidRect:
+ _objc_msgSend$setInputWarpMatrix:
...
+ _objc_msgSend$setLastDetectionTime:
+ _objc_msgSend$setLastTappedTime:
+ _objc_msgSend$setLearnedFusionAETablesEnabled:
+ _objc_msgSend$setLearnedNRFlashSupported:
+ _objc_msgSend$setLinearImageHighKey:
+ _objc_msgSend$setLinearMixForBG:
+ _objc_msgSend$setLinearMixForSkin:
+ _objc_msgSend$setLowCurrentTorchEnabled:
...
+ _objc_msgSend$setNetworkInputDimensions:
...
+ _objc_msgSend$setSecureVideoCaptureDimensions:
+ _objc_msgSend$setSecureVideoOutputEnabled:
+ _objc_msgSend$setSeed:
+ _objc_msgSend$setSegmentIdx:
+ _objc_msgSend$setSelector:
+ _objc_msgSend$setSensorOrientationAngle:
+ _objc_msgSend$setSensorUnwrapData:
+ _objc_msgSend$setSensorUnwrapDataWithSession:unwrappedSensorEncKey:unwrappedSensorEncKeyHmac:sensorIV:sensorEphemeralKeySignature:
+ _objc_msgSend$setSharpnessResults:
...
+ _objc_msgSend$setSnapshottedLCBDatabaseByPortType:
...
+ _objc_msgSend$setValidBufferRectAppliedToVisionFaceLandmarks:
...
+ _objc_msgSend$sharedInstanceWithCameraType:
...
+ _objc_msgSend$singleImageErrorRecoveryInput
+ _objc_msgSend$smartStyleCompressorNodesByAttachedMediaKey
+ _objc_msgSend$snapshottedLCBDatabaseByPortType
...
+ _objc_msgSend$startTrackingRecurringWorkWithIntervals
...
+ _objc_msgSend$trustObjectData
+ _objc_msgSend$trustObjectDigestData
...
+ _objc_msgSend$udnetEnabledForPortType:sensorIDString:
...
+ _objc_msgSend$updateDatabase:forPortType:
...
+ _objc_msgSend$workIntervalType
+ _objc_msgSend$workgroup
+ _objc_msgSend$yuvInput
+ _objc_msgSend$yuvSampleBuffer
+ _objc_msgSend$zeroShutterLagEnabledByOmahaConstituentPortType
+ _objc_retainAutoreleasedReturnValue
+ _objc_retain_x10
+ _performCommand
+ _pesp_isStandardResolutionAttachmentNodeRequired
+ _setup.parseOnceToken
+ _sharedInstance.instance
+ _sharedManager.onceToken
+ _sharedManager.sharedInstance
+ _simu_createDNGDictionary.sMobileGestaltOnceToken
+ _simu_createDNGDictionary.sProductTypeString
+ _srtm_allowedPTSDelta
+ _startPersonalPhotographerSessionWithSettings:stillImageCoordinator:.sSessionID
+ _strtoull
+ _textureStylesVersion
+ _tspp_associateFaceObservationsWithInstanceMasks
+ _tspp_getCropRect
+ _vDSP_maxv
+ _vDSP_mmul
+ _vDSP_sve
...
- -[BWCinematicPerceptionNode initWithConvEngineSupportWithCaptureDevice:scheduler:priority:depthInferenceEnabled:aspectRatio:]
- -[BWDeferredProcessorController _handleDidDetermineReferenceFrameWithSortedIntermediates:]
- -[BWFigVideoCaptureDevice _initWithCaptureDevice:attributes:synchronizedStreamsAttributes:unsynchronizedStreamsAttributes:multiCamEnabled:midFrameSynchronizationEnabled:superWideAsMidFrameSynchronizationPrimary:applicationID:clientAuditToken:tccIdentity:mediaEnvironment:deviceVendor:createAutofocusSampleBufferProcessorFunction:cameraParameters:deviceClientPriority:error:]
...
- GCC_except_table678
- GCC_except_table97
- _OBJC_IVAR_$_BWFigVideoCaptureStream._lensFNumber
- ___153-[BWFigVideoCaptureDevice setFocusModeAutoWithRect:restrictToRect:continuous:smooth:rangeRestrictionNear:rangeRestrictionFar:isFocusRectInOverscanSpace:]_block_invoke
- ___153-[BWFigVideoCaptureDevice setFocusModeAutoWithRect:restrictToRect:continuous:smooth:rangeRestrictionNear:rangeRestrictionFar:isFocusRectInOverscanSpace:]_block_invoke_2
...
- ___block_descriptor_106_e8_32o40o48o56o64o72o80o_e5_v8?0ls32l8s40l8s48l8s56l8s64l8s72l8s80l8
- ___block_descriptor_32_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8l
- ___block_descriptor_33_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8l
- ___block_descriptor_40_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8l
- ___block_descriptor_40_e8_32o_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8ls32l8
- ___block_descriptor_40_e8_32r_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8lr32l8
- ___block_descriptor_72_e8_32o40r48r_e158_i16?0^{FigCaptureSourceStorage=qi^{__CFString}^{OpaqueFigSimpleMutex}CC{?=[8I]}q^{OpaqueFigCaptureSource}fBiBBiBB^{OpaqueFigCaptureSource}f}8lr40l8s32l8r48l8
...
- _objc_msgSend$initWithConfiguration:videoSourceCaptureOutputsByConnectionID:sourceStreamingSensorRawOutput:sourceStreamingHueMapOutput:sourceStreamingSemanticMasksOutput:audioSourceCaptureOutput:audioSourceCinematicAudioCaptureOutput:smartCameraInferenceOutput:detectedObjectBoxedMetadataOutputs:objectDetectionSourceOutput:metadataSourcePipelineOutputs:graph:parentPipeline:inferenceScheduler:captureDevicesByConnectionID:audioSourceDelegate:fileCoordinatorStatusDelegate:irisRequestDelegate:masterClock:workgroup:videoGreenGhostMitigationEnabled:
- _objc_msgSend$initWithConvEngineSupportWithCaptureDevice:scheduler:priority:depthInferenceEnabled:aspectRatio:
...
- _objc_msgSend$initWithObjectMetadataIdentifiers:cachedSimulatedAperture:captureDevice:tuningParameters:videoDepthConfiguration:smartStyleLearningEnabled:highResolutionInputEnabled:transformCinematographyDetectionsForMovieFileOutput:
...
+ " lcb:%d (0x%lX)"
+ "! CGRectIsEmpty( clippedCropRect )"
+ "! CGRectIsEmpty( finalCropRect )"
+ "! CGRectIsEmpty( result.faceSkinROI )"
+ "! CGRectIsEmpty( result.instanceROI )"
+ "! CGRectIsNull( validPixelRect )"
...
+ "%@ Secure Video Data Sink Pipeline"
+ "%@-%@.plist"
+ "%@-Inference"
+ "%@.MOV"
+ "%@:%@,"
...
+ "( ! err ) && ( ! unwrapSessionErr )"
+ "( ( range.location + range.length ) <= storedBuffers.count )"
+ "( camGazeInferenceType == BWInferenceTypeCamGaze || camGazeInferenceType == BWInferenceTypeApertureControlCamGaze )"
+ "( videoNoiseReductionDimensions.width >= _visOutputDimensions.width ) && ( videoNoiseReductionDimensions.height >= _visOutputDimensions.height )"
...
+ "-[BWPhotoEncoderController _addProvenanceSensorRawForEncodingScheme:sampleBuffer:]"
+ "-[BWPhotoEncoderController _addTextureStylePersonInstanceMasksForEncodingScheme:sampleBuffer:primaryOutputAspectRatio:settingsID:orientation:parentImageHandle:]"
+ "-[BWPhotonicEngineNode _setupProcessingStateForTextureStyleInferencesWithSettings:sequenceNumber:portType:processingPlan:]_block_invoke"
+ "-[BWQuickTimeMovieFileSinkNode renderSampleBuffer:forInput:]"
+ "-[BWRealtimeCinematographyNode initWithObjectMetadataIdentifiers:cachedSimulatedAperture:captureDevice:tuningParameters:videoDepthConfiguration:smartStyleLearningEnabled:highResolutionInputEnabled:transformCinematographyDetectionsForMovieFileOutput:depthInputProvided:]_block_invoke"
+ "-[BWSensorRawTimeMachine _insertSampleBuffer:frameType:]"
+ "-[BWSensorRawTimeMachine dealloc]"
+ "-[BWSkinTextureStyleRenderer renderUsingParameters:inputPixelBuffer:inputSampleBuffer:processedPixelBuffer:completionHandler:]"
+ "-[BWStillImageCoordinatorNode _startCalibrationTimerIfNeeded]"
...
+ ". Exposure signals %@"
+ ".lapse.mov"
+ "/AppleInternal/Library/Frameworks/PhotoLibraryServices.framework/PhotoLibraryServices"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/ExternalSyncDevice/FigExternalSyncDeviceDiscoverySessionManager.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Nodes/BWBaselineTextureStyleRenderer.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Nodes/BWGlobalTextureStyleRenderer.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Nodes/BWGlowTextureStyleRenderer.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Nodes/BWHVSScoringNode.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Nodes/BWSkinTextureStyleRenderer.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Utilities/BWSensorRawTimeMachine.m"
+ "/Library/Caches/com.apple.xbs/<UUID>/TemporaryDirectory.<TMP>/Sources/CameraCapture/CMCapture/Sources/Graph/Utilities/BWTextureStyleTuning.m"
+ "/System/AppleInternal/Library/Frameworks/PhotoLibraryServices.framework/PhotoLibraryServices"
+ "/System/Library/Frameworks/PhotoLibraryServices.framework/PhotoLibraryServices"
...
+ "<<<< BWBaselineTextureStyleRenderer >>>> %s: [Texture Styles] presetTuningParameters is nil in BWBaselineTextureStyleRenderer"
+ "<<<< BWBaselineTextureStyleRenderer >>>> Fig"
+ "<<<< BWCameraStreamingMonitor >>>> %s: %@: %d -> %d"
+ "<<<< BWCinematographyObjectTrackingNode >>>> Fig"
...
+ "<<<< BWGlobalTextureStyleRenderer >>>> %s: [Texture Styles] presetTuningParameters is nil in BWGlobalTextureStyleRenderer"
+ "<<<< BWGlobalTextureStyleRenderer >>>> Fig"
+ "<<<< BWGlowTextureStyleRenderer >>>> %s: [Texture Styles] presetTuningParameters is nil in BWGlowTextureStyleRenderer"
+ "<<<< BWGlowTextureStyleRenderer >>>> Fig"
+ "<<<< BWGraph >>>> %s: <%p[%{public}d][%{public}@]> started source node <%p, %@, %{public}@>"
+ "<<<< BWHVSCandidateFrameManager >>>> %s: Failed capture: frame (ID:%{public}d) will not be promoted"
+ "<<<< BWHVSCandidateFrameManager >>>> Fig"
...
+ "<<<< BWHVSUtilities >>>> Fig"
+ "<<<< BWInferenceTextureStylesPostProcessor >>>> Fig"
+ "<<<< BWIrisStagingNode >>>> %s: Marking buffer %.3f as cutting buffer because texture style preset doesn't match. lastStaged: %@ current: %@."
+ "<<<< BWIrisStagingNode >>>> %s: Skipping Live Photo SRL calculation due to manual exposure"
...
+ "<<<< BWNRFProcessorController >>>> %s: NRF detected flicker, execute flicker fallback path for '%@' (err=%d)"
+ "<<<< BWPhotonicEngineNodeResourceCoordinator >>>> %s: Re-allocating SoftISP output pools %@ -> %@ on live reconfigure"
...
+ "<<<< BWSensorRawTimeMachine >>>> Fig"
+ "<<<< BWSkinTextureStyleRenderer >>>> %s: CMITextureStylesProcessor finishProcessing failed (%d)"
+ "<<<< BWSkinTextureStyleRenderer >>>> %s: [Texture Styles] presetTuningParameters is nil in BWSkinTextureStyleRenderer"
+ "<<<< BWSkinTextureStyleRenderer >>>> Fig"
+ "<<<< BWStillImageCoordinatorNode >>>> %s: Active Omaha constituent device type has changed from '%{public}@' to '%{public}@' for captureID:%{public}lld. Updating settings"
...
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Failed to create V2H2 binned Provenance sensor raw (err:%d)"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Failed to create V2H2 sample buffer"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Failed to create dummy V2H2 binned Provenance sensor raw (err:%d)"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Failed to get V2H2 binned buffer attributes (err:%d)"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: No timestamp data found for hash"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Post-signing verification failed (err:%d)"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: Unexpectedly received Provenance sensor raw for encoding for captureID:%lld"
+ "<<<< BWStillImageMetadataUtilities >>>> %s: SecureSigning: V2H2 binning enabled for captureID:%lld"
...
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Attached Provenance sample buffer '%@' to reference frame for captureID:%lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Deferred Provenance DNG dictionary is missing for captureID:%lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Failed to create Provenance sample buffer for captureID:%{public}lld (err:%d)"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Failed to create V2H2 binned Provenance sensor raw (err:%d)"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Missing Provenance DNG dictionary for captureID:%{public}lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Missing output sample buffer for captureID:%{public}lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Missing sensor raw buffer for captureID:%{public}lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Missing sensor raw metadata for captureID:%{public}lld"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: No Provenance encoder manager for %@"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Unable to fetch Provenance DNG dictionary for captureID:%{public}lld (err:%d)"
+ "<<<< BWStillImageProcessing >>>> %s: SecureSigning: Unable to fetch sensor raw buffer tag %@ ('%@ - %@') due to err %d"
...
+ "<<<< BWStillImageProcessingNode >>>> %s: Routing sample buffer '%{public}@' for '%{private}@' (err=%{public}d) into Texture Styles Inference Processing"
+ "<<<< BWStillImageProcessingNode >>>> %s: SecureSigning: Failed to create DNG dictionary for captureID:%lld"
+ "<<<< BWStillImageProcessingNode >>>> %s: SecureSigning: Provenance sensor raw is missing for captureID:%lld"
+ "<<<< BWTextureStyleInfoMetadataNode >>>> Fig"
...
+ "<<<< CMCaptureCinematicVideoTimedMetadataSampleGenerator >>>> Fig"
+ "<<<< FigCaptureAngleMonitor >>>> %s: %p is active"
+ "<<<< FigCaptureAngleMonitor >>>> %s: %p startMonitoring"
+ "<<<< FigCaptureAngleMonitor >>>> %s: %p stopMonitoring"
+ "<<<< FigCaptureAngleMonitor >>>> Fig"
...
+ "<<<< FigCaptureDeferredPhotoProcessor >>>> %s: SecureSigning: Delivering deferred Provenance DNG (surface=%p, size=%@) for captureID:%lld"
...
+ "<<<< FigCaptureSecureVideoDataSinkPipeline >>>> Fig"
...
+ "<<<< FigCaptureSession >>>> %s: Building the still image pipeline with activePipelineDimensions:%{public}@, aspectRatio:%{public}@, activeOmahaConstituentDevice:%{public}@, portTypeForActivePipelineDimensions:%{public}@ (captureDevice.aspectRatio:%{public}@, smartCrop:%{public}d)"
+ "<<<< FigCaptureSession >>>> %s: Forced Omaha sensor orientation compensation (when disabled by client) by port type: %@"
+ "<<<< FigCaptureSession >>>> %s: Live Reconfiguring Camera Calibration Data Sink Pipeline %@ with omaha rotation correction %d"
...
+ "<<<< FigCaptureSession >>>> %s: Live reconfiguring SmartCrop Warper active format dimensions to %{public}@ for Omaha constituent device: %{public}@"
...
+ "<<<< FigCaptureSession >>>> %s: Omaha: Downgrading max quality prioritization from '%@' to '%@' for binned format"
+ "<<<< FigCaptureSession >>>> %s: Personal Photographer configuration error"
+ "<<<< FigCaptureSession >>>> %s: Reconfiguring Photonic Engine sink pipeline: newAspectRatio:%{public}@, newActivePipelineDimensions:%{public}@, newOmahaConstituentDevice:%{public}@ (sourceConfiguration.outputAspectRatio:%{public}@, omahaRotationOffset:%{public}d)"
...
+ "<<<< FigCaptureSourceManager >>>> %s: Face ID Unwrap result with status %d, pearlSecureSessionError:0x%x, internalError:%d"
...
+ "<<<< FigExternalSyncDeviceDiscoverySessionManager >>>> %s: Should not create FigExternalSyncDevice when TimeSync is doing the work"
...
+ "AdaptiveFusionRouting"
+ "AdaptiveFusionSupported"
+ "Additional Adaptive Fusion SoftISP output on-demand allocator (%@, %@)"
+ "ApertureFlickerMitigationEngaged"
+ "ApertureLimitsByPortType"
+ "ApplePearlSEPDriver"
+ "AssertMacros: %s (value = 0x%lx), version: -???, %s file: %s, line: %d\n\n"
...
+ "AuxScore"
+ "BWBaselineTextureStyleRenderer.m"
+ "BWCinematographyObjectTrackingNode.m"
+ "BWCreateProvenanceDNGDictionary"
+ "BWGlobalTextureStyleRenderer.m"
+ "BWGlowTextureStyleRenderer.m"
+ "BWHVSCandidateFrameManager.m"
+ "BWHVSScoringNode.m"
+ "BWHVSUtilities.m"
+ "BWInferenceTextureStylesPostProcessor.m"
+ "BWPhotosSoftLinking.m"
+ "BWSensorRawTimeMachine.m"
+ "BWSensorRawTimeMachine[%@] failed to insert %@ frame: %@"
+ "BWSignProvenanceDNGDictionary_block_invoke"
+ "BWSkinTextureStyleRenderer.m"
+ "BWTextureStyleInfoMetadataNode.m"
+ "BWTextureStyleTuning returned no preset tuning parameters for portType[%@] captureMode[%@] captureType[%i] preset[%@] style[%@]. Global texture style effects will fall back to default parameters — this should never happen."
+ "BWTextureStyleTuning returned no preset tuning parameters for portType[%@] captureMode[%@] captureType[%i] preset[%@] style[%@]. Glow texture style effect will fall back to default parameters — this should never happen."
+ "BWTextureStyleTuning returned no preset tuning parameters for portType[%@] captureMode[%@] captureType[%i] preset[%@] style[%@]. Skin texture style effects will fall back to default parameters — this should never happen."
+ "BWTextureStyleTuning returned no preset tuning parameters for portType[%@] captureMode[%@] captureType[%i] preset[%@]. Baseline texture style effects will fall back to default parameters — this should never happen."
...
+ "CMAngleManager.isAvailable"
+ "CMCaptureCinematicVideoMetadataSampleGenerator.m"
+ "CMISmartStyleProcessorV%u"
+ "CMITextureStylesProcessor"
+ "Calling clearSession method from abstract class."
+ "CaptureMode"
...
+ "Class getFTCinematicTrackClass(void)_block_invoke"
+ "Class getFTCinematicTrackingResultClass(void)_block_invoke"
+ "Class getPLGlobalValuesClass(void)_block_invoke"
+ "Class getPLPhotoLibraryClass(void)_block_invoke"
+ "Class getPTCinematographyFocusDisparitySamplerClass(void)_block_invoke"
+ "Class getSDUDisplayRegionBlankingServiceClass(void)_block_invoke"
+ "CmCt"
...
+ "Couldn't create OS Log for 'com.apple.BiometricKit.Library-PearlSupport'!\n"
+ "CropPenalty"
+ "CrossfadeFramecount"
+ "CrossfadeInMaxRampStrength"
+ "CrossfadeInMinRampStrength"
+ "CrossfadeOutMaxRampStrength"
+ "CrossfadeOutMinRampStrength"
+ "CrossfadeRamp"
+ "DF"
...
+ "Embrace"
+ "EnableUDNet"
+ "Error running linear assesment"
+ "ExifLensMinFNumber"
+ "ExitingMagneticZone"
...
+ "FaceLV"
+ "FaceQuality"
+ "FaceQuality-Inference"
+ "Failed to add FSINC matte metadata: FSINCMatteVersion"
...
+ "Failed to start"
+ "Failed to stop"
+ "FigCaptureAngleMonitor.m"
+ "FigCaptureCopyInternalDaemonDataContainerURL"
+ "FigCaptureMagneticInterferenceMonitorStateMachine"
+ "FigCaptureSecureVideoDataSinkPipeline.m"
+ "FigCaptureSourceFaceIDUnwrap"
+ "FigCaptureSourceRemoteIsSecureSigningCertificateAvailable"
...
+ "HardwareModel"
+ "HueMap input"
+ "ISP Color processing parameters not attached"
+ "ISP Front End Pyramid Scale0 pixel buffer not attached"
+ "ISP Front End Pyramid Scale1 pixel buffer not attached"
+ "IgnoredExposureSignals"
+ "IgnoredExposureSignalsChanged"
+ "ImageEmbedding"
+ "ImageSize"
+ "InMagneticZone"
+ "Inference Input Downscaler Node"
+ "InstanceMaskReferenceKey"
+ "IsFrontal"
+ "IsManualCapture"
+ "IsPauseFrame"
...
+ "LCB"
+ "LCBDB"
+ "LCBDatabaseByPortType"
+ "LF"
+ "LLV PostProcessor not init failed"
+ "LLV PreProcessor not init failed"
+ "LLV Processor not init failed"
+ "LLV processors not loaded"
+ "LLVNRProcessingWait"
+ "LLVNRSharedEventSignal"
+ "LLVNRSharedEventWait"
+ "LastShownBuild:BWBaselineTextureStyleRenderer.m:204"
+ "LastShownBuild:BWFigVideoCaptureDevice.m:8936"
+ "LastShownBuild:BWGlobalTextureStyleRenderer.m:195"
+ "LastShownBuild:BWGlowTextureStyleRenderer.m:202"
...
+ "LastShownBuild:BWNRFProcessorController.m:2204"
+ "LastShownBuild:BWSensorRawTimeMachine.m:267"
+ "LastShownBuild:BWSkinTextureStyleRenderer.m:215"
+ "LastShownBuild:BWStillImageMetadataUtilities.m:1574"
+ "LastShownBuild:BWTextureStyleTuning.m:262"
+ "LastShownBuild:FigCaptureSession.m:28948"
+ "LastShownBuild:FigExternalSyncDeviceDiscoverySessionManager.m:107"
+ "LastShownDate:BWBaselineTextureStyleRenderer.m:204"
+ "LastShownDate:BWFigVideoCaptureDevice.m:8936"
+ "LastShownDate:BWGlobalTextureStyleRenderer.m:195"
+ "LastShownDate:BWGlowTextureStyleRenderer.m:202"
...
+ "LastShownDate:BWNRFProcessorController.m:2204"
+ "LastShownDate:BWSensorRawTimeMachine.m:267"
+ "LastShownDate:BWSkinTextureStyleRenderer.m:215"
+ "LastShownDate:BWStillImageMetadataUtilities.m:1574"
+ "LastShownDate:BWTextureStyleTuning.m:262"
+ "LastShownDate:FigCaptureSession.m:28948"
+ "LastShownDate:FigExternalSyncDeviceDiscoverySessionManager.m:107"
+ "Laugh"
+ "Learned Fusion Enhanced Resolution output pool (%@)"
...
+ "OmahaWide"
+ "OmahaWideCamera"
+ "Optical Flow Node (Cinematic)"
+ "OriginalPresentationTimestamp"
+ "OutOfMagneticZone"
+ "PLGlobalValues"
+ "PLPhotoLibrary"
+ "PTCinematographyFocusDisparitySampler"
+ "PauseDuration"
+ "PearlSecureSessionError"
+ "PearlSupport.m"
+ "PearlSupportHelpers.m"
+ "People"
+ "PeoplePose"
+ "PercentFramesOnWide"
...
+ "PhotoProvenance"
+ "PiecemealEncodingProvenance"
+ "PiecemealEncodingTextureStyleAuxImages"
+ "PreNoiseReductionCropToStandardFormatDimensions"
...
+ "PreviousInput --> CustomInferences"
+ "PrimaryConstituentDeviceSwitchingBehaviorLockedWithDeviceSupported"
+ "PrimaryDisplayRegion"
+ "ProcessingAdaptiveFusion"
+ "ProvenanceDNGDictionary"
+ "ProvenanceExtractMetadataFromBuffer"
+ "ProvenanceSEPSignature"
+ "ProvenanceSensorRaw"
+ "QSum"
+ "Raw input"
+ "Reaction"
+ "Received NULL input sample buffer"
+ "Received nil input metadata"
...
+ "RenoWide"
+ "Rotator/"
+ "SDUDisplayRegionBlankingService"
+ "SEP/sensor device-ID mismatch (BAA:%@, manifest:%@)"
+ "SIFRRawCaptureID"
+ "SP"
+ "SPFaux"
+ "Sample buffer is nil"
+ "SbufPresentationTimestamp"
+ "Secure Video Data Remote Queue Sink"
+ "SecureSignedRawImageSurface"
+ "SecureSignedRawImageSurfaceSize"
+ "SecureSignedRawSurface"
+ "SecureSignedRawSurfaceSize"
+ "SecureSignedRawSurface_Serialized"
+ "SecureSigning: Post-signing verification failed (err:%d)"
+ "SecureSigningCertificateAvailable"
+ "SecureSigningCreateFDRService"
+ "SecureSigningFaceIDSupported"
+ "SecureSigningFetchSealingManifest"
+ "SecureSigningFetchSecureBootTicket"
+ "SecureSigningFetchSensorCertificate"
+ "SecureSigningFetchStaticProvenanceData"
+ "SecureSigningFetchTrustObject"
+ "SecureSigningPhotoCaptureEnabled"
+ "SecureSigningPhotoCaptureSupportEnabled"
+ "SecureSigningPhotoCaptureSupported"
+ "SecureSigningPhotoLibraryQuery"
+ "SecureVideo"
+ "SegmentIndex"
...
+ "SessionActive"
+ "Should not create FigExternalSyncDevice when TimeSync is doing the work"
+ "SillyFace"
+ "SimiliarityScore"
...
+ "Soft"
+ "SoftISP --> Calibration done"
+ "SoftISP_SingleImageRecovery_%@"
+ "Splash"
+ "StandardResolutionImage"
+ "Starburst"
+ "StarburstDetected"
+ "Step"
+ "Still Image live reconfiguration for active Omaha constituent device"
+ "Still image coordinator is not available"
+ "Still image requested settings are not available"
...
+ "Texture Styles Post-Processor with required inference types: %@"
...
+ "UDNet"
+ "Unable to complete ISP Color processing session"
+ "Unable to start ISP Color processing session"
+ "UnifiedEmbeddingNetworkOutput"
+ "Unrecognized underlying device type %d for Omaha variant"
+ "UpdatePersonalPhotographerOrientationMirrored"
+ "UpdatePersonalPhotographerOrientationRotationDegrees"
+ "V63"
+ "V64"
+ "V64-V64s"
+ "V64s"
...
+ "[%@: %@]"
+ "[FaceIDCompanionFormat]"
+ "[Texture Styles] presetTuningParameters is nil in BWBaselineTextureStyleRenderer"
+ "[Texture Styles] presetTuningParameters is nil in BWGlobalTextureStyleRenderer"
+ "[Texture Styles] presetTuningParameters is nil in BWGlowTextureStyleRenderer"
+ "[Texture Styles] presetTuningParameters is nil in BWSkinTextureStyleRenderer"
...
+ "[graph connectOutput:opticalFlowInferenceNode.output toInput:videoDepthNode.input pipelineStage:pipelineStage]"
...
+ "[graph connectOutput:upstreamOutput toInput:opticalFlowInferenceNode.input pipelineStage:pipelineStage]"
...
+ "[parentPipeline addNode:hvsFanOutNode error:&error]"
+ "[parentPipeline addNode:hvsScoringNode error:&error]"
+ "[parentPipeline addNode:opticalFlowInferenceNode error:&error]"
+ "[parentPipeline addNode:textureStyleInfoMetadata error:&error]"
+ "[parentPipeline addNode:timewarpMetadataNode error:&error]"
+ "[parentPipeline addNode:videoDepthNode error:&error]"
+ "[parentPipeline addNode:videoNoiseReductionNode error:&error]"
+ "[parentPipeline.graph connectOutput:hueMapOutput toInput:hvsScoringNode.hueMapInput pipelineStage:((void *)0)]"
+ "[parentPipeline.graph connectOutput:hvsScoringNode.output toInput:sceneClassifierSinkNode.input pipelineStage:hvsPipelineStage]"
+ "[parentPipeline.graph connectOutput:hvsScoringUpstreamYUVOutput toInput:hvsScoringNode.yuvInput pipelineStage:hvsPipelineStage]"
+ "[parentPipeline.graph connectOutput:previousOutput toInput:hvsFanOutNode.input pipelineStage:upstreamPipelineStage]"
+ "[parentPipeline.graph connectOutput:semanticMasksOutput toInput:hvsScoringNode.semanticMasksInput pipelineStage:((void *)0)]"
+ "[parentPipeline.graph connectOutput:sensorRawOutput toInput:hvsScoringNode.rawInput pipelineStage:((void *)0)]"
+ "[self addNode:_cinematographyObjectTrackingNode error:&error]"
+ "[self initServiceConnection]"
+ "[self isValidCameraType:cameraType]"
...
+ "[super addNode:standardResolutionAttachmentNode error:&error]"
+ "[super addNode:trackingNode error:&error]"
+ "_FigIsCurrentDispatchQueue( _input.connection.pipelineStage.queue )"
+ "_activeSessionID"
+ "_angleNotificationLock"
+ "_apertureControlSceneMonitorEnabled"
+ "_baselineTextureStyleRenderer"
+ "_calibrationTimer"
+ "_cinematicVideoParameters"
+ "_connect != ((io_object_t) 0)"
+ "_defaults"
+ "_displayRegionBlankingAssertion"
+ "_displayRegionBlankingObserver"
+ "_hostUnwrapData"
+ "_intermediatePixelBuffer"
+ "_ispStatus == kFigCaptureISPProcessingStatus_NoErr"
+ "_llvPostProcessorIBP"
+ "_llvPreProcessorIBP"
+ "_llvProcessInputPixelBuffer"
+ "_llvProcessOutputPixelBuffer"
+ "_llvProcessPixelBufferPool"
+ "_llvProcessorIBP"
+ "_llvProcessorsLoaded"
+ "_metalSharedEventListener"
+ "_metalTextureCache"
+ "_perCamInstances"
+ "_portTypeProvidingSDOFRenderingParameters"
+ "_targetPixelBufferWithTextureApplied"
+ "_textureStyle"
+ "activeExposureSignals"
...
+ "attemptSingleImageErrorRecovery"
...
+ "com.apple.bwgraph.hvs-scoring.facequality"
+ "com.apple.bwgraph.hvs-scoring.imageEmbeddings"
+ "com.apple.bwgraph.hvs-scoring.sharpness"
+ "com.apple.bwgraph.llv.processing"
...
+ "com.apple.cameracapture.provImageCaptureManifest"
+ "com.apple.cameracapture.provenance"
+ "com.apple.coremedia.bwfigvideocapturedevice.secure-signing"
+ "com.apple.coremedia.capture.hvs.scoring"
+ "com.apple.coremedia.capture.moviefile.noisereduction"
+ "com.apple.coremedia.capture.preview.cinematic_depth"
+ "com.apple.coremedia.capture.videodata.cinematic_depth"
+ "com.apple.coremedia.capturesession.secureStreamingQueue"
+ "com.apple.coremedia.faceIDUnwrapQueue"
+ "com.apple.coremedia.hvs-scoring.maskgdc.metal-completion-queue"
+ "com.apple.coremedia.hvs-scoring.maskgdc.metal-submission-queue"
+ "com.apple.pencil.pairing.app"
+ "com.apple.photos.captureMode"
+ "com.apple.still-image-heap-allocation"
+ "config"
+ "context_priorities"
+ "contexts"
...
+ "degrees"
+ "denominator"
+ "depthFilterRenderingIsAfterPreviewStitcher == __objc_no"
+ "device_sharpness_intercept"
+ "device_sharpness_slope"
+ "displayRegion: %lu"
+ "displayUUID"
+ "dngDictionary.count > 0"
+ "domain"
+ "duplicate_constraint"
+ "duplicate_max_time_msec"
+ "duplicate_thresholds"
+ "e5rt_precompiled_compute_op_create_options_set_anef_procedure_variant_hint failed"
+ "embedding"
+ "encryptionKey"
+ "encryptionKeyHmac"
+ "errorStep"
+ "evZero-%d"
+ "f16@?0f8f12"
+ "f40@?0{CGRect={CGPoint=dd}{CGSize=dd}}8"
+ "faceID"
+ "faceIDCoexistenceEnabled"
+ "faceIDCoexistenceEnabled (%d -> %d)"
+ "faceIDConfiguration"
+ "faceIDFrameProxyIdentifier"
+ "faceQualityProcessingConfiguration"
+ "face_edge_threshold"
+ "face_margin"
...
+ "frontEndPyramidScale0PixelBuffer"
+ "frontEndPyramidScale1PixelBuffer"
+ "frontal_per_context"
+ "gdcErr == 0 "
+ "globalRenderer"
...
+ "hash"
+ "hdr-error-recovery-evZero-sbuf"
+ "hingeAngle"
+ "hostEphemeralKey"
...
+ "hostTag"
+ "hueMapPixelBuffer"
+ "hvsPipelineStage.workIntervalType == FigCaptureWorkIntervalTypeNone"
+ "i16@?0^{FigCaptureSourceStorage=qi@@@@@@@^{__CFString}@^{OpaqueFigSimpleMutex}@CC{?=[8I]}q@@^{OpaqueFigCaptureSource}f@BiBB@@iqBqBB^{OpaqueFigCaptureSource}@@f}8"
+ "iOS 27.0"
+ "ignoredExposureSignals"
+ "imageEmbeddingProcessingConfiguration"
+ "inferenceMask"
...
+ "lastAvailableContentProvenanceLowerBoundTimestampData"
+ "lcbDetectionCountHist%d"
+ "learnedNRFlashSupported"
+ "legacy"
+ "lensApertureNumber"
+ "linearImage"
+ "linearImageHighKey"
+ "linearImageMetadata"
+ "localRequestedSettings"
+ "localStillImageCoordinator"
+ "log10"
+ "long-%d"
+ "lowCurrentTorchSupported"
+ "lowLightVideoNoiseReductionEnabled"
...
+ "min_thresholds"
+ "mirrored"
+ "missingSealingManifest"
+ "missingSecureBootManifest"
+ "missingSensorCert"
+ "missingTrustObject"
+ "nFaceObservations"
+ "negative_embedding"
...
+ "omahasuperwide"
+ "omahawide"
+ "optimizedUltraHighResolutionProcessingWithAspectRatioCropSupported"
...
+ "por2026"
+ "por2026_max_budget"
+ "portTypesWithAdaptiveFusionEnabled"
+ "portTypesWithTextureStyleBaseLookEnabled"
+ "positive_embedding"
+ "postSignVerifyStatus"
+ "prepareErr == 0 "
+ "preset"
+ "preset:%@ intensity:%.3f grain:%.3f"
+ "presetTuningParameters"
+ "primaryConstituentDeviceSwitchingBehaviorLockedWithDeviceSupported"
+ "primaryDisplayRegion"
...
+ "scProxyInstance"
+ "seal"
+ "secureCameraSessionErr == 0 "
+ "secureSigningPhotoCaptureSupportEnabled"
+ "secureSigningPhotoCaptureSupportEnabled (%d -> %d)"
+ "secureVideoDataDiscardsLateVideoFrames"
+ "secureVideoDataSinkPipeline"
+ "self != ((void*)0)"
+ "self.isOmahaVariant"
+ "semanticHints"
+ "sensorEphemeralKey"
...
+ "sensorRawPixelFormat == kCVPixelFormatType_VersatileSenselArray10CompandedIn8"
+ "sensorUnwrapData"
+ "sepSignErrorCode"
+ "session"
...
+ "setting aperture lock mitigation exposure configuration failed"
+ "setupErr == 0 "
...
+ "sim_threshold"
+ "similarity"
+ "singleImageErrorRecovery"
+ "skinRenderer"
+ "softlink:o:path:/System/Library/PrivateFrameworks/SystemUIDisplayUtilities.framework/SystemUIDisplayUtilities"
+ "srt_isValidFrameType( frameType )"
+ "status = BWInferenceStatusPostProcessorRuntimeError == 0 "
+ "std"
...
+ "syncEntities"
+ "target"
+ "temporalHomographyData.length == ( 3 * 3 * sizeof(Float32) )"
+ "textureStyle"
...
+ "v32@?0^v8i16i20^{?=^{__CFString}^v}24"
+ "v32@?0^{__SecKey=}8@\"NSArray\"16@\"NSError\"24"
+ "v36@?0@\"NSDictionary\"8@\"NSError\"16q24i32"
+ "v64s"
+ "vaActualFNumber"
+ "vaApertureDiameter"
+ "vaMaxTrackError"
...
+ "videoNoiseReductionDimensions.width == 2464"
+ "videoNoiseReductionNode"
+ "void *PhotoLibraryServicesLibrary(void)"
+ "void *SystemUIDisplayUtilitiesLibrary(void)"
+ "waitUntilScheduledForMaskGDC"
+ "weight"
+ "wrappedHostEncKey"
...
- "i16@?0^{FigCaptureSourceStorage=qi@@@@@@@^{__CFString}@^{OpaqueFigSimpleMutex}@CC{?=[8I]}q@@^{OpaqueFigCaptureSource}f@BiBB@@iBB^{OpaqueFigCaptureSource}@@f}8"
