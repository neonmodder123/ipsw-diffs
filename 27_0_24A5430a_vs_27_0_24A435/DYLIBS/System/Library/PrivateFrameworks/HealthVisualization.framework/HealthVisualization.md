...
```diff
 ...
 7027.0.72.2.7
-  __TEXT.__text: 0x146184
+  __TEXT.__text: 0x148af0
   __TEXT.__objc_methlist: 0x42c
-  __TEXT.__const: 0x156b4
...
-  __TEXT.__swift5_reflstr: 0x4be5
...
+ _objc_msgSend$baselineContainsVEData
+ _objc_msgSend$containsVEData
+ _objc_msgSend$context
+ _objc_msgSend$dayIndex
+ _objc_msgSend$daytimeInterval
+ _objc_msgSend$daytimeValue
+ _objc_msgSend$isExerciseCessationSignalActive
+ _objc_msgSend$overnightValue
+ _objc_msgSend$setBaselineContainsVEData:
