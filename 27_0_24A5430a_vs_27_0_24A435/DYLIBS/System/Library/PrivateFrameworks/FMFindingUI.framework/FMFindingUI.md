...
-  __TEXT.__constg_swiftt: 0x820c
-  __TEXT.__swift5_typeref: 0xa7cc
...
CStrings:
+ "FMFindingLocalizedB518String "
+ "Localizable-B518"
+ "live (applying now)"
+ "not yet created (will apply on creation)"
+ "🧭 FMR1NIContxt%@: originBody set to %{public}s; niSession %{public}s"
```
